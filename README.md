...
* \[**5228**星]\[2m] \[Py] [refirmlabs/binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,236 | 🐛 92 | 🌐 Rust | 📅 2026-08-11 固件分析工具（命令行+IDA插件）
  * [IDA插件](https://github.com/ReFirmLabs/binwalk/tree/master/src/scripts) ⭐ 14,236 | 🐛 92 | 🌐 Rust | 📅 2026-08-11
  * [binwalk](https://github.com/ReFirmLabs/binwalk/tree/master/src/binwalk) ⭐ 14,236 | 🐛 92 | 🌐 Rust | 📅 2026-08-11
...
* \[**1554**星]\[13d] \[Py] [joxeankoret/diaphora](https://github.com/joxeankoret/diaphora) ⭐ 4,370 | 🐛 35 | 🌐 Python | 📅 2026-08-18 program diffing
...
* \[**471**星]\[13d] \[C] [bootleg/ret-sync](https://github.com/bootleg/ret-sync) ⭐ 2,372 | 🐛 31 | 🌐 C | 📅 2026-02-15 在反汇编工具和调试器之间同步调试会话
  * [GDB插件](https://github.com/bootleg/ret-sync/tree/master/ext_gdb) ⭐ 2,372 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [Ghidra插件](https://github.com/bootleg/ret-sync/tree/master/ext_ghidra) ⭐ 2,372 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [IDA插件](https://github.com/bootleg/ret-sync/tree/master/ext_ida) ⭐ 2,372 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [LLDB](https://github.com/bootleg/ret-sync/tree/master/ext_lldb) ⭐ 2,372 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [OD](https://github.com/bootleg/ret-sync/tree/master/ext_olly1) ⭐ 2,372 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [OD2](https://github.com/bootleg/ret-sync/tree/master/ext_olly2) ⭐ 2,372 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [WinDgb](https://github.com/bootleg/ret-sync/tree/master/ext_windbg/sync) ⭐ 2,372 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [x64dbg](https://github.com/bootleg/ret-sync/tree/master/ext_x64dbg) ⭐ 2,372 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * 重复区段: [x64dbg->插件->新添加的](#da5688c7823802e734c39b539aa39df7) |
...
* \[**382**星]\[26d] \[C++] [google/binexport](https://github.com/google/binexport) ⭐ 1,199 | 🐛 41 | 🌐 C++ | 📅 2026-08-18 将反汇编以Protocol Buffer的形式导出为PostgreSQL数据库, 导入到BinNavi中使用
...
* \[**1365**星]\[3m] \[Py] [fireeye/flare-floss](https://github.com/fireeye/flare-floss) ⭐ 4,123 | 🐛 120 | 🌐 Python | 📅 2026-08-18 自动从恶意代码中提取反混淆后的字符串
  * [floss](https://github.com/fireeye/flare-floss/tree/master/floss) ⭐ 4,123 | 🐛 120 | 🌐 Python | 📅 2026-08-18
  * [IDA插件](https://github.com/fireeye/flare-floss/blob/master/scripts/idaplugin.py) ⭐ 4,123 | 🐛 120 | 🌐 Python | 📅 2026-08-18
...
* \[**18649**星]\[10d] \[Java] [nationalsecurityagency/ghidra](https://github.com/nationalsecurityagency/ghidra) ⭐ 72,499 | 🐛 1,916 | 🌐 Java | 📅 2026-08-18 软件逆向框架
...
* \[**34576**星]\[1m] \[C++] [x64dbg/x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,191 | 🐛 574 | 🌐 C++ | 📅 2026-08-15 Windows平台x32/x64调试器
...
* \[**5195**星]\[19d] \[Py] [mobsf/mobile-security-framework-mobsf](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,610 | 🐛 20 | 🌐 JavaScript | 📅 2026-08-17 Mobile Security Framework (MobSF) is an automated, all-in-one mobile application (Android/iOS/Windows) pen-testing, malware analysis and security assessment framework capable of performing static and dynamic analysis.
...
* \[**2051**星]\[21d] \[Py] [sensepost/objection](https://github.com/sensepost/objection) ⭐ 9,325 | 🐛 55 | 🌐 Python | 📅 2026-07-23 runtimemobile exploration
...
* \[**820**星]\[11d] [proxymanapp/proxyman](https://github.com/proxymanapp/proxyman) ⭐ 6,945 | 🐛 1,867 | 📅 2026-08-12 Modern and Delightful HTTP Debugging Proxy for macOS, iOS and Android
...
* \[**4776**星]\[12d] \[C++] [facebook/redex](https://github.com/facebook/redex) ⭐ 6,297 | 🐛 72 | 🌐 C++ | 📅 2026-08-18 Android App字节码优化器
...
* \[**431**星]\[13d] \[C] [guardianproject/orbot](https://github.com/guardianproject/orbot) ⭐ 3,480 | 🐛 91 | 🌐 Kotlin | 📅 2026-08-13 The Github home of Orbot: Tor on Android (Also available on gitlab!)
...
* \[**333**星]\[25d] \[Java] [datatheorem/trustkit-android](https://github.com/datatheorem/trustkit-android) ⭐ 603 | 🐛 25 | 🌐 Java | 📅 2026-08-17 Easy SSL pinning validation and reporting for Android.
...
* \[**12285**星]\[11d] \[Java] [signalapp/signal-android](https://github.com/signalapp/Signal-Android) ⭐ 29,211 | 🐛 488 | 🌐 Kotlin | 📅 2026-08-17 A private messenger for Android.
...
* \[**1465**星]\[3m] \[C++] [vaibhavpandeyvpz/apkstudio](https://github.com/vaibhavpandeyvpz/apkstudio) ⭐ 4,611 | 🐛 3 | 🌐 C++ | 📅 2026-01-05 Open-source, cross platform Qt based IDE for reverse-engineering Android application packages.
* \[**1793**星]\[8m] \[C++] [wrbug/dumpdex](https://github.com/wrbug/dumpdex) ⭐ 3,153 | 🐛 38 | 🌐 C++ | 📅 2020-05-15 Android脱壳
* \[**366**星]\[3m] \[Java] [patrickfav/uber-apk-signer](https://github.com/patrickfav/uber-apk-signer) ⭐ 2,708 | 🐛 11 | 🌐 Java | 📅 2023-10-30 A cli tool that helps signing and zip aligning single or multiple Android application packages (APKs) with either debug or provided release certificates. It supports v1, v2 and v3 Android signing scheme has an embedded debug keystore and auto verifies after signing.
...
* \[**10794**星]\[1m] \[Java] [konloch/bytecode-viewer](https://github.com/konloch/bytecode-viewer) ⭐ 15,600 | 🐛 103 | 🌐 Java | 📅 2026-07-17 A Java 8+ Jar & Android APK Reverse Engineering Suite (Decompiler, Editor, Debugger & More)
...
* \[**9285**星]\[1m] \[Java] [ibotpeaches/apktool](https://github.com/ibotpeaches/apktool) ⭐ 25,315 | 🐛 77 | 🌐 Java | 📅 2026-08-11 A tool for reverse engineering Android apk files
* \[**2053**星]\[1m] \[Java] [genymobile/gnirehtet](https://github.com/genymobile/gnirehtet) ⭐ 7,846 | 🐛 324 | 🌐 Java | 📅 2024-08-11 Gnirehtet provides reverse tethering for Android
...
* \[**5451**星]\[3m] \[Py] [axi0mx/ipwndfu](https://github.com/axi0mx/ipwndfu) ⭐ 7,392 | 🐛 168 | 🌐 Python | 📅 2024-02-21 open-source jailbreaking tool for many iOS devices
...
* \[**3221**星]\[5m] \[ObjC] [naituw/ipapatch](https://github.com/naituw/ipapatch) ⭐ 5,263 | 🐛 42 | 🌐 Objective-C | 📅 2026-02-27 Patch iOS Apps, The Easy Way, Without Jailbreak.
* \[**1193**星]\[15d] \[JS] [alonemonkey/frida-ios-dump](https://github.com/alonemonkey/frida-ios-dump) ⭐ 3,911 | 🐛 107 | 🌐 JavaScript | 📅 2023-05-03 pull decrypted ipa from jailbreak device
...
* \[**492**星]\[28d] \[Rust] [vadimcn/vscode-lldb](https://github.com/vadimcn/vscode-lldb) ⭐ 3,275 | 🐛 170 | 🌐 Rust | 📅 2026-06-16 A native debugger extension for VSCode based on LLDB
...
* \[**4397**星]\[12d] \[Swift] [signalapp/signal-ios](https://github.com/signalapp/Signal-iOS) ⭐ 12,200 | 🐛 139 | 🌐 Swift | 📅 2026-08-14 A private messenger for iOS.
* \[**1215**星]\[16d] \[YARA] [horsicq/detect-it-easy](https://github.com/horsicq/detect-it-easy) ⭐ 11,369 | 🐛 33 | 🌐 JavaScript | 📅 2026-08-18 Program for determining types of files for Windows, Linux and MacOS.
...
* \[**2867**星]\[12d] \[ObjC] [facebook/idb](https://github.com/facebook/idb) ⭐ 5,278 | 🐛 182 | 🌐 Swift | 📅 2026-08-19 idb is a flexible command line interface for automating iOS simulators and devices
...
* \[**1228**星]\[12d] \[C] [dynamorio/dynamorio](https://github.com/dynamorio/dynamorio) ⭐ 3,133 | 🐛 1,798 | 🌐 C | 📅 2026-08-18 Dynamic Instrumentation Tool Platform
...
* \[**4516**星]\[13d] \[Makefile] [frida/frida](https://github.com/frida/frida) ⭐ 21,665 | 🐛 1,958 | 🌐 Meson | 📅 2026-08-18 Clone this repo to build Frida
...
* \[**321**星]\[1m] \[C] [frida/frida-core](https://github.com/frida/frida-core) ⭐ 763 | 🐛 146 | 🌐 Vala | 📅 2026-08-18 Frida core library intended for static linking into bindings
...
* \[**2687**星]\[11d] \[Go] [adguardteam/adguardhome](https://github.com/adguardteam/adguardhome) ⭐ 36,200 | 🐛 1,273 | 🌐 TypeScript | 📅 2026-08-18 Network-wide ads & trackers blocking DNS server
* \[**10378**星]\[11d] \[Go] [goharbor/harbor](https://github.com/goharbor/harbor) ⭐ 29,179 | 🐛 832 | 🌐 Go | 📅 2026-08-18 An open source trusted cloud native registry project that stores, signs, and scans content.
...
* \[**5420**星]\[12d] \[Py] [mlflow/mlflow](https://github.com/mlflow/mlflow) ⭐ 27,571 | 🐛 2,041 | 🌐 Python | 📅 2026-08-19 Open source platform for the machine learning lifecycle
* \[**11402**星]\[10d] \[Java] [oracle/graal](https://github.com/oracle/graal) ⭐ 21,664 | 🐛 849 | 🌐 Java | 📅 2026-08-18 Run Programs Faster Anywhere
* \[**7020**星]\[14d] \[Go] [nats-io/nats-server](https://github.com/nats-io/nats-server) ⭐ 20,541 | 🐛 547 | 🌐 Go | 📅 2026-08-18 High-Performance server for NATS, the cloud native messaging system.
* \[**5753**星]\[18d] \[Go] [casbin/casbin](https://github.com/casbin/casbin) ⭐ 20,328 | 🐛 42 | 🌐 Go | 📅 2026-08-13 An authorization library that supports access control models like ACL, RBAC, ABAC in Golang
* \[**3608**星]\[9d] \[Pascal] [cheat-engine/cheat-engine](https://github.com/cheat-engine/cheat-engine) ⭐ 18,999 | 🐛 1,307 | 🌐 Pascal | 📅 2025-04-19 Cheat Engine. A development environment focused on modding
* \[**4610**星]\[1y] \[C] [upx/upx](https://github.com/upx/upx) ⭐ 17,784 | 🐛 26 | 🌐 C++ | 📅 2026-08-18 UPX - the Ultimate Packer for eXecutables
* \[**5226**星]\[13d] \[Shell] [denisidoro/navi](https://github.com/denisidoro/navi) ⭐ 17,455 | 🐛 110 | 🌐 Rust | 📅 2026-07-28 An interactive cheatsheet tool for the command-line
* \[**11213**星]\[2m] \[Jupyter Notebook] [selfteaching/the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 16,451 | 🐛 199 | 🌐 Jupyter Notebook | 📅 2026-05-20 One has no future if one couldn't teach themself.
* \[**2815**星]\[20d] \[C] [processhacker/processhacker](https://github.com/processhacker/processhacker) ⭐ 15,660 | 🐛 286 | 🌐 C | 📅 2026-08-19 A free, powerful, multi-purpose tool that helps you monitor system resources, debug software and detect malware.
* \[**3295**星]\[15d] \[JS] [koenkk/zigbee2mqtt](https://github.com/koenkk/zigbee2mqtt) ⭐ 15,508 | 🐛 458 | 🌐 TypeScript | 📅 2026-08-18 Zigbee
...
* \[**7748**星]\[10d] \[Go] [git-lfs/git-lfs](https://github.com/git-lfs/git-lfs) ⭐ 14,429 | 🐛 484 | 🌐 Go | 📅 2026-08-07 Git extension for versioning large files
* \[**5116**星]\[11d] \[ASP] [hq450/fancyss](https://github.com/hq450/fancyss) ⭐ 13,707 | 🐛 212 | 🌐 Shell | 📅 2026-06-01 fancyss is a project providing tools to across the GFW on asuswrt/merlin based router.
* \[**3129**星]\[13d] \[C] [qemu/qemu](https://github.com/qemu/qemu) ⭐ 13,590 | 🐛 0 | 🌐 C | 📅 2026-08-19 Official QEMU mirror. Please see
* \[**5229**星]\[4m] \[Py] [ytisf/thezoo](https://github.com/ytisf/thezoo) ⭐ 13,304 | 🐛 89 | 🌐 Python | 📅 2026-07-24 A repository of LIVE malwares for your own joy and pleasure. theZoo is a project created to make the possibility of malware analysis open and available to the public.
* \[**2344**星]\[16d] \[C] [tsl0922/ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,220 | 🐛 112 | 🌐 C | 📅 2026-08-12 Share your terminal over the web
* \[**3980**星]\[1m] \[Rust] [svenstaro/genact](https://github.com/svenstaro/genact) ⭐ 12,171 | 🐛 16 | 🌐 Rust | 📅 2026-08-01 a nonsense activity generator
* \[**3505**星]\[16d] \[C] [cyan4973/xxhash](https://github.com/cyan4973/xxhash) ⭐ 11,206 | 🐛 41 | 🌐 C | 📅 2026-07-27 Extremely fast non-cryptographic hash algorithm
...
* \[**2993**星]\[18d] \[Py] [quantaxis/quantaxis](https://github.com/quantaxis/quantaxis) ⭐ 11,014 | 🐛 239 | 🌐 Python | 📅 2026-02-28 支持任务调度 分布式部署的 股票/期货/自定义市场 数据/回测/模拟/交易/可视化 纯本地PAAS量化解决方案
...
* \[**2053**星]\[24d] \[C#] [mathewsachin/captura](https://github.com/mathewsachin/captura) ⭐ 10,786 | 🐛 116 | 🌐 C# | 📅 2026-05-25 Capture Screen, Audio, Cursor, Mouse Clicks and Keystrokes
* \[**2627**星]\[23d] \[JS] [popcorn-official/popcorn-desktop](https://github.com/popcorn-official/popcorn-desktop) ⭐ 10,633 | 🐛 65 | 🌐 TypeScript | 📅 2026-08-18 Popcorn Time is a multi-platform, free software BitTorrent client that includes an integrated media player. Desktop ( Windows / Mac / Linux ) a Butter-Project Fork
* \[**4597**星]\[12d] \[C++] [mozilla/rr](https://github.com/mozilla/rr) ⭐ 10,620 | 🐛 480 | 🌐 C++ | 📅 2026-08-16 记录与重放App的调试执行过程
* \[**5751**星]\[9m] \[C] [xoreaxeaxeax/movfuscator](https://github.com/xoreaxeaxeax/movfuscator) ⭐ 10,452 | 🐛 25 | 🌐 C | 📅 2024-05-29 C编译器，编译的二进制文件只有1个代码块。
...
* \[**3289**星]\[15d] \[C] [virustotal/yara](https://github.com/virustotal/yara) ⭐ 9,814 | 🐛 177 | 🌐 C | 📅 2026-07-30 The pattern matching swiss knife
...
* \[**5717**星]\[28d] \[JS] [swagger-api/swagger-editor](https://github.com/swagger-api/swagger-editor) ⭐ 9,460 | 🐛 32 | 🌐 JavaScript | 📅 2026-08-18 Swagger Editor
* \[**6353**星]\[2m] \[Py] [seatgeek/fuzzywuzzy](https://github.com/seatgeek/fuzzywuzzy) ⚠️ Archived Fuzzy String Matching in Python
* \[**3108**星]\[1m] \[C] [unicorn-engine/unicorn](https://github.com/unicorn-engine/unicorn) ⭐ 9,242 | 🐛 211 | 🌐 C | 📅 2026-07-30 Unicorn CPU emulator framework (ARM, AArch64, M68K, Mips, Sparc, X86)
* \[**3188**星]\[11d] \[C] [meetecho/janus-gateway](https://github.com/meetecho/janus-gateway) ⭐ 9,154 | 🐛 43 | 🌐 C | 📅 2026-07-27 Janus WebRTC Server
* \[**3960**星]\[11d] \[Py] [angr/angr](https://github.com/angr/angr) ⭐ 9,021 | 🐛 725 | 🌐 Python | 📅 2026-08-19 A powerful and user-friendly binary analysis platform!
* \[**3939**星]\[15d] \[C] [aquynh/capstone](https://github.com/aquynh/capstone) ⭐ 8,960 | 🐛 365 | 🌐 C | 📅 2026-08-13 Capstone disassembly/disassembler framework: Core (Arm, Arm64, BPF, EVM, M68K, M680X, MOS65xx, Mips, PPC, RISCV, Sparc, SystemZ, TMS320C64x, Web Assembly, X86, X86\_64, XCore) + bindings.
* \[**3844**星]\[2m] \[ObjC] [sveinbjornt/sloth](https://github.com/sveinbjornt/sloth) ⭐ 8,937 | 🐛 3 | 🌐 Objective-C | 📅 2026-05-28 Mac app that shows all open files, directories and sockets in use by all running processes. Nice GUI for lsof.
* \[**3451**星]\[19d] \[C] [mikebrady/shairport-sync](https://github.com/mikebrady/shairport-sync) ⭐ 8,815 | 🐛 17 | 🌐 C | 📅 2026-08-09 AirPlay audio player. Shairport Sync adds multi-room capability with Audio Synchronisation
* \[**2587**星]\[10d] \[C] [esnet/iperf](https://github.com/esnet/iperf) ⭐ 8,698 | 🐛 237 | 🌐 C | 📅 2026-07-10 A TCP, UDP, and SCTP network bandwidth measurement tool
* \[**4651**星]\[13d] [powershell/win32-openssh](https://github.com/powershell/win32-openssh) ⭐ 8,244 | 🐛 401 | 📅 2025-10-27 Win32 port of OpenSSH
* \[**4541**星]\[4m] \[TS] [apis-guru/graphql-voyager](https://github.com/apis-guru/graphql-voyager) ⭐ 8,159 | 🐛 106 | 🌐 TypeScript | 📅 2026-05-12
* \[**3306**星]\[19d] \[C] [microsoft/windows-driver-samples](https://github.com/microsoft/windows-driver-samples) ⭐ 7,821 | 🐛 126 | 🌐 C | 📅 2026-08-12 This repo contains driver samples prepared for use with Microsoft Visual Studio and the Windows Driver Kit (WDK). It contains both Universal Windows Driver and desktop-only driver samples.
...
* \[**4747**星]\[8d] \[C++] [paddlepaddle/paddle-lite](https://github.com/PaddlePaddle/Paddle-Lite) ⭐ 7,269 | 🐛 50 | 🌐 C++ | 📅 2026-04-27 Multi-platform high performance deep learning inference engine (『飞桨』多平台高性能深度学习预测引擎）
...
* \[**2194**星]\[13d] \[C] [armmbed/mbedtls](https://github.com/armmbed/mbedtls) ⭐ 6,878 | 🐛 1,729 | 🌐 C | 📅 2026-08-18 An open source, portable, easy to use, readable and flexible SSL library
...
* \[**2854**星]\[1m] \[Py] [espressif/esptool](https://github.com/espressif/esptool) ⭐ 6,449 | 🐛 14 | 🌐 Python | 📅 2026-08-10 ESP8266 and ESP32 serial bootloader utility
* \[**1698**星]\[21d] \[C++] [microsoft/detours](https://github.com/microsoft/detours) ⭐ 6,357 | 🐛 92 | 🌐 C++ | 📅 2026-08-05 Detours is a software package for monitoring and instrumenting API calls on Windows. It is distributed in source code form.
...
* \[**1620**星]\[16d] \[C++] [lief-project/lief](https://github.com/lief-project/lief) ⭐ 5,534 | 🐛 32 | 🌐 C++ | 📅 2026-08-15 Library to Instrument Executable Formats
...
* \[**2093**星]\[10d] \[C] [flatpak/flatpak](https://github.com/flatpak/flatpak) ⭐ 5,033 | 🐛 1,025 | 🌐 C | 📅 2026-08-18 Linux application sandboxing and distribution framework
...
* \[**2391**星]\[21d] \[Java] [mock-server/mockserver](https://github.com/mock-server/mockserver) ⭐ 4,945 | 🐛 4 | 🌐 Java | 📅 2026-08-19 MockServer enables easy mocking of any system you integrate with via HTTP or HTTPS with clients written in Java, JavaScript and Ruby. MockServer also includes a proxy that introspects all proxied traffic including encrypted SSL traffic and supports Port Forwarding, Web Proxying (i.e. HTTP proxy), HTTPS Tunneling Proxying (using HTTP CONNECT) and…
...
* \[**2052**星]\[13d] \[C++] [openthread/openthread](https://github.com/openthread/openthread) ⭐ 4,014 | 🐛 172 | 🌐 C++ | 📅 2026-08-18 OpenThread released by Google is an open-source implementation of the Thread networking protocol
...
* \[**1727**星]\[8d] \[TSQL] [brentozarultd/sql-server-first-responder-kit](https://github.com/brentozarultd/sql-server-first-responder-kit) ⭐ 3,878 | 🐛 5 | 🌐 TSQL | 📅 2026-08-11 sp\_Blitz, sp\_BlitzCache, sp\_BlitzFirst, sp\_BlitzIndex, and other SQL Server scripts for health checks and performance tuning.
...
* \[**1637**星]\[12d] \[JS] [efforg/privacybadger](https://github.com/efforg/privacybadger) ⭐ 3,808 | 🐛 144 | 🌐 JavaScript | 📅 2026-08-14 Privacy Badger is a browser extension that automatically learns to block invisible trackers.
* \[**2364**星]\[10d] \[C] [domoticz/domoticz](https://github.com/domoticz/domoticz) ⭐ 3,792 | 🐛 23 | 🌐 C++ | 📅 2026-08-18 monitor and configure various devices like: Lights, Switches, various sensors/meters like Temperature, Rain, Wind, UV, Electra, Gas, Water and much more
...
* \[**1676**星]\[10d] \[Java] [apache/geode](https://github.com/apache/geode) ⭐ 2,373 | 🐛 30 | 🌐 Java | 📅 2026-08-10 Apache Geode
...
* \[**265**星]\[3m] \[Assembly] [pret/pokeyellow](https://github.com/pret/pokeyellow) ⭐ 865 | 🐛 3 | 🌐 Assembly | 📅 2026-08-10 Disassembly of Pokemon Yellow
...
* \[**836**星]\[8d] \[C++] [tasvideos/bizhawk](https://github.com/tasvideos/bizhawk) ⭐ 2,728 | 🐛 791 | 🌐 C# | 📅 2026-08-18 BizHawk is a multi-system emulator written in C#. BizHawk provides nice features for casual gamers such as full screen, and joypad support in addition to full rerecording and debugging tools for all system cores.
...
* \[**20779**星]\[8d] \[Java] [skylot/jadx](https://github.com/skylot/jadx) ⭐ 50,122 | 🐛 443 | 🌐 Java | 📅 2026-08-05 dex 转 java 的反编译器
...
* \[**1867**星]\[1y] \[Java] [jindrapetrik/jpexs-decompiler](https://github.com/jindrapetrik/jpexs-decompiler) ⭐ 5,815 | 🐛 5 | 🌐 Java | 📅 2026-08-08 JPEXS Free Flash Decompiler
...
* \[**671**星]\[11m] \[C++] [zrax/pycdc](https://github.com/zrax/pycdc) ⭐ 4,581 | 🐛 233 | 🌐 C++ | 📅 2026-04-07 C++ python bytecode disassembler and decompiler
...
* \[**331**星]\[11d] \[Java] [leibnitz27/cfr](https://github.com/leibnitz27/cfr) ⭐ 2,666 | 🐛 150 | 🌐 Java | 📅 2026-06-04 This is the public repository for the CFR Java decompiler
* \[**673**星]\[18d] \[C#] [uxmal/reko](https://github.com/uxmal/reko) ⭐ 2,599 | 🐛 165 | 🌐 C# | 📅 2026-08-18 Reko is a binary decompiler.
* \[**347**星]\[16d] \[C#] [steamdatabase/valveresourceformat](https://github.com/steamdatabase/valveresourceformat) ⭐ 2,377 | 🐛 73 | 🌐 C# | 📅 2026-08-18 Valve's Source 2 resource file format (also known as Stupid Valve Format) parser and decompiler.
...
* \[**2439**星]\[16d] \[Py] [pwndbg/pwndbg](https://github.com/pwndbg/pwndbg) ⭐ 10,772 | 🐛 213 | 🌐 Python | 📅 2026-08-18 GDB插件，辅助漏洞开发和逆向
...
* \[**11588**星]\[12d] \[C] [radareorg/radare2](https://github.com/radareorg/radare2) ⭐ 24,593 | 🐛 821 | 🌐 C | 📅 2026-08-19 unix-like reverse engineering framework and commandline tools
...
* \[**2820**星]\[1m] \[Py] [androguard/androguard](https://github.com/androguard/androguard) ⭐ 6,198 | 🐛 46 | 🌐 Python | 📅 2026-08-13 Reverse engineering, Malware and goodware analysis of Android applications ... and more (ninja !)
...
* \[**1915**星]\[22d] \[C#] [lucasg/dependencies](https://github.com/lucasg/dependencies) ⭐ 11,760 | 🐛 142 | 🌐 C# | 📅 2024-05-15 A rewrite of the old legacy software "depends.exe" in C# for Windows devs to troubleshoot dll load dependencies issues.
* \[**1146**星]\[27d] \[C#] [perfare/il2cppdumper](https://github.com/perfare/il2cppdumper) ⭐ 9,309 | 🐛 156 | 🌐 C# | 📅 2024-08-18 Restore dll from Unity il2cpp binary file (except code)
...
* \[**2355**星]\[11d] \[C] [hfiref0x/uacme](https://github.com/hfiref0x/uacme) ⭐ 7,753 | 🐛 0 | 🌐 C | 📅 2026-07-24 Defeating Windows User Account Control
...
* \[**261**星]\[3m] \[C++] [gametechdev/presentmon](https://github.com/gametechdev/presentmon) ⭐ 2,525 | 🐛 194 | 🌐 C++ | 📅 2026-08-18 Tool for collection and processing of ETW events related to DXGI presentation.
...
* \[**249**星]\[3m] \[C++] [microsoft/krabsetw](https://github.com/microsoft/krabsetw) ⭐ 799 | 🐛 19 | 🌐 C++ | 📅 2026-08-18 KrabsETW provides a modern C++ wrapper and a .NET wrapper around the low-level ETW trace consumption functions.
...
* \[**9261**星]\[11d] \[C#] [icsharpcode/ilspy](https://github.com/icsharpcode/ilspy) ⭐ 25,885 | 🐛 185 | 🌐 C# | 📅 2026-08-18 .NET Decompiler
...
* \[**510**星]\[5m] \[Py] [rabbitstack/fibratus](https://github.com/rabbitstack/fibratus) ⭐ 2,527 | 🐛 43 | 🌐 Go | 📅 2026-08-12 Windows内核探索和跟踪工具
...
* \[**863**星]\[14d] \[C++] [henrypp/simplewall](https://github.com/henrypp/simplewall) ⭐ 8,856 | 🐛 141 | 🌐 C | 📅 2026-08-18 为Windows 过滤平台提供的配置界面
...
* \[**930**星]\[15d] \[Py] [eliben/pyelftools](https://github.com/eliben/pyelftools) ⭐ 2,271 | 🐛 55 | 🌐 Python | 📅 2026-07-30 Parsing ELF and DWARF in Python
...
* \[**1450**星]\[2m] \[C] [feralinteractive/gamemode](https://github.com/feralinteractive/gamemode) ⭐ 5,975 | 🐛 216 | 🌐 C | 📅 2026-06-15 Optimise Linux system performance on demand
...
* \[**731**星]\[17d] \[C] [strace/strace](https://github.com/strace/strace) ⭐ 2,672 | 🐛 110 | 🌐 C | 📅 2026-08-18 strace is a diagnostic, debugging and instructional userspace utility for Linux
