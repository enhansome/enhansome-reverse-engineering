...
* [全平台逆向资源: awesome-reverse-engineering](https://github.com/alphaSeclab/awesome-reverse-engineering) ⭐ 5,043 | 🐛 7 | 📅 2021-09-01:
...
* [开源远控和恶意远控分析报告: awesome-rat](https://github.com/alphaSeclab/awesome-rat) ⭐ 2,264 | 🐛 0 | 📅 2020-02-17: 开源远控工具: Windows/Linux/macOS/Android; 远控类恶意恶意代码的分析报告等
...
* 此页只包含部分内容. [查看完整版](https://github.com/alphaSeclab/awesome-reverse-engineering/blob/master/Readme_full.md) ⭐ 5,043 | 🐛 7 | 📅 2021-09-01
* 跟逆向有关的资源收集。当前包括的工具个数3500+，并根据功能进行了粗糙的分类。部分工具添加了中文描述。当前包括文章数2300+。

# 说明

[EnglishVersion](https://github.com/alphaSeclab/awesome-reverse-engineering/blob/master/Readme_en.md) ⭐ 5,043 | 🐛 7 | 📅 2021-09-01
...
* \[**664**星]\[27d] \[Py] [igogo-x86/hexrayspytools](https://github.com/igogo-x86/hexrayspytools) ⭐ 1,535 | 🐛 32 | 🌐 Python | 📅 2024-08-11 结构体和类重建插件
...
* \[**5228**星]\[2m] \[Py] [refirmlabs/binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,327 | 🐛 93 | 🌐 Rust | 📅 2026-08-11 固件分析工具（命令行+IDA插件）
  * [IDA插件](https://github.com/ReFirmLabs/binwalk/tree/master/src/scripts) ⭐ 14,327 | 🐛 93 | 🌐 Rust | 📅 2026-08-11
  * [binwalk](https://github.com/ReFirmLabs/binwalk/tree/master/src/binwalk) ⭐ 14,327 | 🐛 93 | 🌐 Rust | 📅 2026-08-11
...
* \[**382**星]\[26d] \[C++] [google/binexport](https://github.com/google/binexport) ⭐ 1,203 | 🐛 41 | 🌐 C++ | 📅 2026-09-01 将反汇编以Protocol Buffer的形式导出为PostgreSQL数据库, 导入到BinNavi中使用
...
* \[**1365**星]\[3m] \[Py] [fireeye/flare-floss](https://github.com/fireeye/flare-floss) ⭐ 4,146 | 🐛 111 | 🌐 Python | 📅 2026-09-08 自动从恶意代码中提取反混淆后的字符串
  * [floss](https://github.com/fireeye/flare-floss/tree/master/floss) ⭐ 4,146 | 🐛 111 | 🌐 Python | 📅 2026-09-08
  * [IDA插件](https://github.com/fireeye/flare-floss/blob/master/scripts/idaplugin.py) ⭐ 4,146 | 🐛 111 | 🌐 Python | 📅 2026-09-08
...
* \[**18649**星]\[10d] \[Java] [nationalsecurityagency/ghidra](https://github.com/nationalsecurityagency/ghidra) ⭐ 74,712 | 🐛 1,946 | 🌐 Java | 📅 2026-09-08 软件逆向框架

### <a id="ce70b8d45be0a3d29705763564623aca"></a>新添加的

* \[**455**星]\[9m] \[YARA] [ghidraninja/ghidra\_scripts](https://github.com/ghidraninja/ghidra_scripts) ⭐ 1,167 | 🐛 13 | 🌐 YARA | 📅 2020-10-07 Ghidra脚本
  * [binwalk](https://github.com/ghidraninja/ghidra_scripts/blob/master/binwalk.py) ⭐ 1,167 | 🐛 13 | 🌐 YARA | 📅 2020-10-07 对当前程序运行BinWalk, 标注找到的内容
  * [yara](https://github.com/ghidraninja/ghidra_scripts/blob/master/yara.py) ⭐ 1,167 | 🐛 13 | 🌐 YARA | 📅 2020-10-07 使用Yara查找加密常量
  * [swift\_demangler](https://github.com/ghidraninja/ghidra_scripts/blob/master/swift_demangler.py) ⭐ 1,167 | 🐛 13 | 🌐 YARA | 📅 2020-10-07 自动demangle Swift函数名
  * [golang\_renamer](https://github.com/ghidraninja/ghidra_scripts/blob/master/golang_renamer.py) ⭐ 1,167 | 🐛 13 | 🌐 YARA | 📅 2020-10-07 恢复stripped Go二进制文件的函数名
...
* \[**34576**星]\[1m] \[C++] [x64dbg/x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,464 | 🐛 581 | 🌐 C++ | 📅 2026-09-08 Windows平台x32/x64调试器
...
* \[**5195**星]\[19d] \[Py] [mobsf/mobile-security-framework-mobsf](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,733 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-09 Mobile Security Framework (MobSF) is an automated, all-in-one mobile application (Android/iOS/Windows) pen-testing, malware analysis and security assessment framework capable of performing static and dynamic analysis.
* \[**5084**星]\[15d] \[HTML] [owasp/owasp-mstg](https://github.com/owasp/owasp-mstg) ⭐ 13,171 | 🐛 238 | 🌐 Python | 📅 2026-09-09 关于移动App安全开发、测试和逆向的相近手册
* \[**4306**星]\[15d] \[Shell] [ashishb/android-security-awesome](https://github.com/ashishb/android-security-awesome) ⭐ 9,679 | 🐛 0 | 🌐 Makefile | 📅 2026-09-07 A collection of android security related resources
* \[**2051**星]\[21d] \[Py] [sensepost/objection](https://github.com/sensepost/objection) ⭐ 9,376 | 🐛 57 | 🌐 Python | 📅 2026-07-23 runtimemobile exploration
...
* \[**820**星]\[11d] [proxymanapp/proxyman](https://github.com/proxymanapp/proxyman) ⭐ 6,967 | 🐛 1,882 | 📅 2026-09-07 Modern and Delightful HTTP Debugging Proxy for macOS, iOS and Android
...
* \[**443**星]\[1m] \[TS] [shroudedcode/apk-mitm](https://github.com/shroudedcode/apk-mitm) ⭐ 5,105 | 🐛 83 | 🌐 TypeScript | 📅 2024-07-24
...
* \[**431**星]\[13d] \[C] [guardianproject/orbot](https://github.com/guardianproject/orbot) ⭐ 3,526 | 🐛 92 | 🌐 Kotlin | 📅 2026-09-09 The Github home of Orbot: Tor on Android (Also available on gitlab!)
...
* \[**265**星]\[11d] \[Py] [den4uk/andriller](https://github.com/den4uk/andriller) ⭐ 1,603 | 🐛 11 | 🌐 Python | 📅 2022-06-27 a collection of forensic tools for smartphones
...
* \[**267**星]\[4m] \[Py] [amimo/dcc](https://github.com/amimo/dcc) ⭐ 1,314 | 🐛 27 | 🌐 Python | 📅 2024-02-07 DCC (Dex-to-C Compiler) is method-based aot compiler that can translate DEX code to C code.
...
* \[**1213**星]\[2m] \[JS] [megatronking/httpcanary](https://github.com/megatronking/httpcanary) ⭐ 506 | 🐛 5 | 📅 2024-07-03 A powerful capture and injection tool for the Android platform
...
* \[**3462**星]\[27d] \[Java] [meituan-dianping/robust](https://github.com/meituan-dianping/robust) ⭐ 4,458 | 🐛 163 | 🌐 Java | 📅 2022-04-27 Robust is an Android HotFix solution with high compatibility and high stability. Robust can fix bugs immediately without a reboot.
...
* \[**12285**星]\[11d] \[Java] [signalapp/signal-android](https://github.com/signalapp/Signal-Android) ⭐ 29,310 | 🐛 500 | 🌐 Kotlin | 📅 2026-09-10 A private messenger for Android.

### <a id="7f353b27e45b5de6b0e6ac472b02cbf1"></a>Xposed

* \[**8756**星]\[2m] \[Java] [android-hacker/virtualxposed](https://github.com/android-hacker/virtualxposed) ⭐ 16,055 | 🐛 162 | 🌐 Java | 📅 2024-03-08 A simple app to use Xposed without root, unlock the bootloader or modify system image, etc.
...
* \[**309**星]\[1m] [bigsinger/androididchanger](https://github.com/bigsinger/androididchanger) ⭐ 631 | 🐛 28 | 🌐 Java | 📅 2026-08-14 Xposed Module for Changing Android Device Info
...
* \[**1465**星]\[3m] \[C++] [vaibhavpandeyvpz/apkstudio](https://github.com/vaibhavpandeyvpz/apkstudio) ⭐ 4,642 | 🐛 4 | 🌐 C++ | 📅 2026-01-05 Open-source, cross platform Qt based IDE for reverse-engineering Android application packages.
* \[**1793**星]\[8m] \[C++] [wrbug/dumpdex](https://github.com/wrbug/dumpdex) ⭐ 3,159 | 🐛 38 | 🌐 C++ | 📅 2020-05-15 Android脱壳
* \[**366**星]\[3m] \[Java] [patrickfav/uber-apk-signer](https://github.com/patrickfav/uber-apk-signer) ⭐ 2,738 | 🐛 11 | 🌐 Java | 📅 2023-10-30 A cli tool that helps signing and zip aligning single or multiple Android application packages (APKs) with either debug or provided release certificates. It supports v1, v2 and v3 Android signing scheme has an embedded debug keystore and auto verifies after signing.
* \[**712**星]\[2m] \[YARA] [rednaga/apkid](https://github.com/rednaga/apkid) ⭐ 2,571 | 🐛 84 | 🌐 YARA | 📅 2026-09-02 Android Application Identifier for Packers, Protectors, Obfuscators and Oddities - PEiD for Android
...
* \[**1494**星]\[9d] \[C++] [jmpews/dobby](https://github.com/jmpews/Dobby) ⭐ 4,829 | 🐛 99 | 🌐 C++ | 📅 2025-01-26 a lightweight, multi-platform, multi-architecture hook framework.
* \[**1500**星]\[27d] \[C] [iqiyi/xhook](https://github.com/iqiyi/xhook) ⭐ 4,349 | 🐛 44 | 🌐 C | 📅 2025-06-27 a PLT (Procedure Linkage Table) hook library for Android native ELF
...
* \[**10794**星]\[1m] \[Java] [konloch/bytecode-viewer](https://github.com/konloch/bytecode-viewer) ⭐ 15,637 | 🐛 103 | 🌐 Java | 📅 2026-07-17 A Java 8+ Jar & Android APK Reverse Engineering Suite (Decompiler, Editor, Debugger & More)
...
* \[**3078**星]\[2m] \[Java] [calebfenton/simplify](https://github.com/calebfenton/simplify) ⭐ 4,661 | 🐛 33 | 🌐 Java | 📅 2022-04-30 Generic Android Deobfuscator
...
* \[**9285**星]\[1m] \[Java] [ibotpeaches/apktool](https://github.com/ibotpeaches/apktool) ⭐ 25,516 | 🐛 77 | 🌐 Java | 📅 2026-09-04 A tool for reverse engineering Android apk files
* \[**2053**星]\[1m] \[Java] [genymobile/gnirehtet](https://github.com/genymobile/gnirehtet) ⭐ 7,896 | 🐛 325 | 🌐 Java | 📅 2024-08-11 Gnirehtet provides reverse tethering for Android
...
* \[**2140**星]\[2m] \[Py] [jonathansalwan/ropgadget](https://github.com/jonathansalwan/ropgadget) ⭐ 4,476 | 🐛 15 | 🌐 Python | 📅 2026-06-24 This tool lets you search your gadgets on your binaries to facilitate your ROP exploitation. ROPgadget supports ELF, PE and Mach-O format on x86, x64, ARM, ARM64, PowerPC, SPARC and MIPS architectures.
...
* \[**4248**星]\[8m] \[ObjC] [alonemonkey/monkeydev](https://github.com/alonemonkey/monkeydev) ⭐ 6,796 | 🐛 186 | 🌐 Objective-C | 📅 2022-07-09 CaptainHook Tweak、Logos Tweak and Command-line Tool、Patch iOS Apps, Without Jailbreak.
...
* \[**492**星]\[28d] \[Rust] [vadimcn/vscode-lldb](https://github.com/vadimcn/vscode-lldb) ⭐ 3,295 | 🐛 168 | 🌐 Rust | 📅 2026-08-23 A native debugger extension for VSCode based on LLDB
...
* \[**4397**星]\[12d] \[Swift] [signalapp/signal-ios](https://github.com/signalapp/Signal-iOS) ⭐ 12,230 | 🐛 147 | 🌐 Swift | 📅 2026-09-09 A private messenger for iOS.
* \[**1215**星]\[16d] \[YARA] [horsicq/detect-it-easy](https://github.com/horsicq/detect-it-easy) ⭐ 11,505 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-09 Program for determining types of files for Windows, Linux and MacOS.
...
* \[**4663**星]\[1m] \[C] [google/ios-webkit-debug-proxy](https://github.com/google/ios-webkit-debug-proxy) ⭐ 6,202 | 🐛 20 | 🌐 C | 📅 2025-07-02 A DevTools proxy (Chrome Remote Debugging Protocol) for iOS devices (Safari Remote Web Inspector).
...
* \[**2867**星]\[12d] \[ObjC] [facebook/idb](https://github.com/facebook/idb) ⭐ 5,320 | 🐛 184 | 🌐 Swift | 📅 2026-09-09 idb is a flexible command line interface for automating iOS simulators and devices
...
* \[**1630**星]\[1m] [ivrodriguezca/re-ios-apps](https://github.com/ivrodriguezca/re-ios-apps) ⭐ 2,908 | 🐛 2 | 📅 2024-04-17 A completely free, open source and online course about Reverse Engineering iOS Applications.
...
* \[**1683**星]\[2m] \[Swift] [pmusolino/wormholy](https://github.com/pmusolino/wormholy) ⭐ 2,615 | 🐛 13 | 🌐 Swift | 📅 2026-05-23 iOS network debugging, like a wizard 🧙‍♂️
...
* \[**346**星]\[4m] \[TS] [bacher09/pwgen-for-bios](https://github.com/bacher09/pwgen-for-bios) ⭐ 1,441 | 🐛 184 | 🌐 TypeScript | 📅 2026-02-05 Password generator for BIOS
...
* \[**396**星]\[4m] [ansjdnakjdnajkd/ios](https://github.com/ansjdnakjdnajkd/ios) ⭐ 1,312 | 🐛 0 | 📅 2023-11-06 iOS渗透测试最有用的工具
...
* \[**200**星]\[6m] \[PS] [mkellerman/invoke-commandas](https://github.com/mkellerman/invoke-commandas) ⭐ 486 | 🐛 1 | 🌐 PowerShell | 📅 2023-05-05 Invoke Command As System/Interactive/GMSA/User on Local/Remote machine & returns PSObjects.
...
* \[**1228**星]\[12d] \[C] [dynamorio/dynamorio](https://github.com/dynamorio/dynamorio) ⭐ 3,159 | 🐛 1,802 | 🌐 C | 📅 2026-09-10 Dynamic Instrumentation Tool Platform
...
* \[**1364**星]\[3m] \[C] [googleprojectzero/winafl](https://github.com/googleprojectzero/winafl) ⭐ 2,609 | 🐛 170 | 🌐 C | 📅 2026-03-13 A fork of AFL for fuzzing Windows binaries
...
* \[**4516**星]\[13d] \[Makefile] [frida/frida](https://github.com/frida/frida) ⭐ 21,877 | 🐛 1,962 | 🌐 Meson | 📅 2026-09-09 Clone this repo to build Frida
...
* \[**422**星]\[1y] \[Py] [dstmath/frida-unpack](https://github.com/dstmath/frida-unpack) ⭐ 1,614 | 🐛 12 | 🌐 Python | 📅 2025-06-11 基于Frida的脱壳工具
...
* \[**378**星]\[27d] \[JS] [nowsecure/r2frida](https://github.com/nowsecure/r2frida) ⭐ 1,437 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-09 Radare2 and Frida better together.
...
* \[**14349**星]\[2m] \[Py] [corentinj/real-time-voice-cloning](https://github.com/corentinj/real-time-voice-cloning) ⭐ 60,127 | 🐛 177 | 🌐 Python | 📅 2026-03-09 Clone a voice in 5 seconds to generate arbitrary speech in real-time
* \[**2687**星]\[11d] \[Go] [adguardteam/adguardhome](https://github.com/adguardteam/adguardhome) ⭐ 36,803 | 🐛 1,242 | 🌐 TypeScript | 📅 2026-09-07 Network-wide ads & trackers blocking DNS server
* \[**10378**星]\[11d] \[Go] [goharbor/harbor](https://github.com/goharbor/harbor) ⭐ 29,345 | 🐛 877 | 🌐 Go | 📅 2026-09-10 An open source trusted cloud native registry project that stores, signs, and scans content.
* \[**19766**星]\[3m] \[Jupyter Notebook] [camdavidsonpilon/probabilistic-programming-and-bayesian-methods-for-hackers](https://github.com/camdavidsonpilon/probabilistic-programming-and-bayesian-methods-for-hackers) ⭐ 28,180 | 🐛 203 | 🌐 Jupyter Notebook | 📅 2024-06-25 aka "Bayesian Methods for Hackers": An introduction to Bayesian methods + probabilistic programming with a computation/understanding-first, mathematics-second point of view. All in pure Python ;)
* \[**5420**星]\[12d] \[Py] [mlflow/mlflow](https://github.com/mlflow/mlflow) ⭐ 27,893 | 🐛 2,089 | 🌐 Python | 📅 2026-09-10 Open source platform for the machine learning lifecycle
* \[**11402**星]\[10d] \[Java] [oracle/graal](https://github.com/oracle/graal) ⭐ 21,693 | 🐛 852 | 🌐 Java | 📅 2026-09-09 Run Programs Faster Anywhere
* \[**7020**星]\[14d] \[Go] [nats-io/nats-server](https://github.com/nats-io/nats-server) ⭐ 20,691 | 🐛 533 | 🌐 Go | 📅 2026-09-10 High-Performance server for NATS, the cloud native messaging system.
* \[**5753**星]\[18d] \[Go] [casbin/casbin](https://github.com/casbin/casbin) ⭐ 20,381 | 🐛 41 | 🌐 Go | 📅 2026-09-09 An authorization library that supports access control models like ACL, RBAC, ABAC in Golang
* \[**3608**星]\[9d] \[Pascal] [cheat-engine/cheat-engine](https://github.com/cheat-engine/cheat-engine) ⭐ 19,157 | 🐛 1,307 | 🌐 Pascal | 📅 2025-04-19 Cheat Engine. A development environment focused on modding
* \[**4610**星]\[1y] \[C] [upx/upx](https://github.com/upx/upx) ⭐ 17,859 | 🐛 24 | 🌐 C++ | 📅 2026-09-09 UPX - the Ultimate Packer for eXecutables
...
* \[**11213**星]\[2m] \[Jupyter Notebook] [selfteaching/the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 16,766 | 🐛 200 | 🌐 Jupyter Notebook | 📅 2026-05-20 One has no future if one couldn't teach themself.
* \[**2815**星]\[20d] \[C] [processhacker/processhacker](https://github.com/processhacker/processhacker) ⭐ 15,920 | 🐛 290 | 🌐 C | 📅 2026-09-10 A free, powerful, multi-purpose tool that helps you monitor system resources, debug software and detect malware.
* \[**3295**星]\[15d] \[JS] [koenkk/zigbee2mqtt](https://github.com/koenkk/zigbee2mqtt) ⭐ 15,620 | 🐛 455 | 🌐 TypeScript | 📅 2026-09-10 Zigbee
...
* \[**7748**星]\[10d] \[Go] [git-lfs/git-lfs](https://github.com/git-lfs/git-lfs) ⭐ 14,484 | 🐛 477 | 🌐 Go | 📅 2026-09-02 Git extension for versioning large files
* \[**5116**星]\[11d] \[ASP] [hq450/fancyss](https://github.com/hq450/fancyss) ⭐ 13,742 | 🐛 223 | 🌐 Shell | 📅 2026-06-01 fancyss is a project providing tools to across the GFW on asuswrt/merlin based router.
* \[**3129**星]\[13d] \[C] [qemu/qemu](https://github.com/qemu/qemu) ⭐ 13,698 | 🐛 0 | 🌐 C | 📅 2026-09-09 Official QEMU mirror. Please see
* \[**5229**星]\[4m] \[Py] [ytisf/thezoo](https://github.com/ytisf/thezoo) ⭐ 13,373 | 🐛 89 | 🌐 Python | 📅 2026-07-24 A repository of LIVE malwares for your own joy and pleasure. theZoo is a project created to make the possibility of malware analysis open and available to the public.
* \[**2344**星]\[16d] \[C] [tsl0922/ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,340 | 🐛 113 | 🌐 C | 📅 2026-08-12 Share your terminal over the web
* \[**3980**星]\[1m] \[Rust] [svenstaro/genact](https://github.com/svenstaro/genact) ⭐ 12,186 | 🐛 17 | 🌐 Rust | 📅 2026-09-01 a nonsense activity generator
...
* \[**2993**星]\[18d] \[Py] [quantaxis/quantaxis](https://github.com/quantaxis/quantaxis) ⭐ 11,152 | 🐛 239 | 🌐 Python | 📅 2026-09-01 支持任务调度 分布式部署的 股票/期货/自定义市场 数据/回测/模拟/交易/可视化 纯本地PAAS量化解决方案
* \[**4003**星]\[11d] \[Go] [dexidp/dex](https://github.com/dexidp/dex) ⭐ 11,084 | 🐛 537 | 🌐 Go | 📅 2026-09-10 OpenID Connect Identity (OIDC) and OAuth 2.0 Provider with Pluggable Connectors
* \[**3908**星]\[12d] \[C++] [baldurk/renderdoc](https://github.com/baldurk/renderdoc) ⭐ 11,072 | 🐛 49 | 🌐 C++ | 📅 2026-09-09 RenderDoc is a stand-alone graphics debugging tool.
* \[**2053**星]\[24d] \[C#] [mathewsachin/captura](https://github.com/mathewsachin/captura) ⭐ 10,819 | 🐛 116 | 🌐 C# | 📅 2026-05-25 Capture Screen, Audio, Cursor, Mouse Clicks and Keystrokes
...
* \[**4597**星]\[12d] \[C++] [mozilla/rr](https://github.com/mozilla/rr) ⭐ 10,646 | 🐛 482 | 🌐 C++ | 📅 2026-08-16 记录与重放App的调试执行过程
* \[**5751**星]\[9m] \[C] [xoreaxeaxeax/movfuscator](https://github.com/xoreaxeaxeax/movfuscator) ⭐ 10,505 | 🐛 25 | 🌐 C | 📅 2024-05-29 C编译器，编译的二进制文件只有1个代码块。
* \[**2718**星]\[3m] \[Py] [drivendata/cookiecutter-data-science](https://github.com/drivendata/cookiecutter-data-science) ⭐ 10,048 | 🐛 34 | 🌐 Python | 📅 2026-08-07 A logical, reasonably standardized, but flexible project structure for doing and sharing data science work.
* \[**4857**星]\[13d] \[Go] [gcla/termshark](https://github.com/gcla/termshark) ⭐ 10,007 | 🐛 51 | 🌐 Go | 📅 2024-04-30 A terminal UI for tshark, inspired by Wireshark
* \[**3289**星]\[15d] \[C] [virustotal/yara](https://github.com/virustotal/yara) ⭐ 9,860 | 🐛 169 | 🌐 C | 📅 2026-08-25 The pattern matching swiss knife
* \[**5876**星]\[3m] \[Gnuplot] [nasa-jpl/open-source-rover](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,633 | 🐛 14 | 🌐 HTML | 📅 2026-09-03 A build-it-yourself, 6-wheel rover based on the rovers on Mars!
...
* \[**3108**星]\[1m] \[C] [unicorn-engine/unicorn](https://github.com/unicorn-engine/unicorn) ⭐ 9,314 | 🐛 215 | 🌐 C | 📅 2026-08-28 Unicorn CPU emulator framework (ARM, AArch64, M68K, Mips, Sparc, X86)
* \[**6353**星]\[2m] \[Py] [seatgeek/fuzzywuzzy](https://github.com/seatgeek/fuzzywuzzy) ⚠️ Archived Fuzzy String Matching in Python
* \[**3188**星]\[11d] \[C] [meetecho/janus-gateway](https://github.com/meetecho/janus-gateway) ⭐ 9,162 | 🐛 45 | 🌐 C | 📅 2026-09-09 Janus WebRTC Server
* \[**3960**星]\[11d] \[Py] [angr/angr](https://github.com/angr/angr) ⭐ 9,077 | 🐛 728 | 🌐 Python | 📅 2026-09-10 A powerful and user-friendly binary analysis platform!
* \[**3939**星]\[15d] \[C] [aquynh/capstone](https://github.com/aquynh/capstone) ⭐ 9,008 | 🐛 358 | 🌐 C | 📅 2026-09-08 Capstone disassembly/disassembler framework: Core (Arm, Arm64, BPF, EVM, M68K, M680X, MOS65xx, Mips, PPC, RISCV, Sparc, SystemZ, TMS320C64x, Web Assembly, X86, X86\_64, XCore) + bindings.
* \[**3844**星]\[2m] \[ObjC] [sveinbjornt/sloth](https://github.com/sveinbjornt/sloth) ⭐ 8,955 | 🐛 2 | 🌐 Objective-C | 📅 2026-08-30 Mac app that shows all open files, directories and sockets in use by all running processes. Nice GUI for lsof.
* \[**3451**星]\[19d] \[C] [mikebrady/shairport-sync](https://github.com/mikebrady/shairport-sync) ⭐ 8,846 | 🐛 28 | 🌐 C | 📅 2026-09-09 AirPlay audio player. Shairport Sync adds multi-room capability with Audio Synchronisation
* \[**2587**星]\[10d] \[C] [esnet/iperf](https://github.com/esnet/iperf) ⭐ 8,744 | 🐛 236 | 🌐 C | 📅 2026-07-10 A TCP, UDP, and SCTP network bandwidth measurement tool
* \[**4651**星]\[13d] [powershell/win32-openssh](https://github.com/powershell/win32-openssh) ⭐ 8,273 | 🐛 405 | 📅 2025-10-27 Win32 port of OpenSSH
* \[**4541**星]\[4m] \[TS] [apis-guru/graphql-voyager](https://github.com/apis-guru/graphql-voyager) ⭐ 8,168 | 🐛 106 | 🌐 TypeScript | 📅 2026-05-12
* \[**3306**星]\[19d] \[C] [microsoft/windows-driver-samples](https://github.com/microsoft/windows-driver-samples) ⭐ 7,843 | 🐛 127 | 🌐 C | 📅 2026-09-08 This repo contains driver samples prepared for use with Microsoft Visual Studio and the Windows Driver Kit (WDK). It contains both Universal Windows Driver and desktop-only driver samples.
* \[**2948**星]\[1m] \[C] [libfuse/sshfs](https://github.com/libfuse/sshfs) ⭐ 7,663 | 🐛 62 | 🌐 C | 📅 2026-08-08 A network filesystem client to connect to SSH servers
* \[**4314**星]\[15d] \[Rust] [timvisee/ffsend](https://github.com/timvisee/ffsend) ⭐ 7,410 | 🐛 33 | 🌐 Rust | 📅 2025-11-20 Easily and securely share files from the command line
...
* \[**2194**星]\[13d] \[C] [armmbed/mbedtls](https://github.com/armmbed/mbedtls) ⭐ 6,953 | 🐛 1,719 | 🌐 C | 📅 2026-09-09 An open source, portable, easy to use, readable and flexible SSL library
...
* \[**2854**星]\[1m] \[Py] [espressif/esptool](https://github.com/espressif/esptool) ⭐ 6,469 | 🐛 14 | 🌐 Python | 📅 2026-09-07 ESP8266 and ESP32 serial bootloader utility
...
* \[**3690**星]\[21d] \[JS] [lesspass/lesspass](https://github.com/lesspass/lesspass) ⭐ 6,058 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-04
...
* \[**3120**星]\[11d] \[Go] [tencent/bk-cmdb](https://github.com/tencent/bk-cmdb) ⭐ 5,744 | 🐛 92 | 🌐 Go | 📅 2026-09-04 蓝鲸智云配置平台(BlueKing CMDB)
* \[**2092**星]\[26d] [swiftonsecurity/sysmon-config](https://github.com/swiftonsecurity/sysmon-config) ⭐ 5,640 | 🐛 82 | 📅 2024-07-03 Sysmon configuration file template with default high-quality event tracing
* \[**1930**星]\[22d] \[C++] [mhammond/pywin32](https://github.com/mhammond/pywin32) ⭐ 5,601 | 🐛 396 | 🌐 C++ | 📅 2026-09-08 Python for Windows (pywin32) Extensions
* \[**1620**星]\[16d] \[C++] [lief-project/lief](https://github.com/lief-project/lief) ⭐ 5,558 | 🐛 30 | 🌐 C++ | 📅 2026-09-06 Library to Instrument Executable Formats
* \[**2211**星]\[1m] \[C++] [google/bloaty](https://github.com/google/bloaty) ⭐ 5,541 | 🐛 73 | 🌐 C++ | 📅 2026-09-09 Bloaty McBloatface: a size profiler for binaries
...
* \[**2833**星]\[2m] \[Assembly] [cirosantilli/x86-bare-metal-examples](https://github.com/cirosantilli/x86-bare-metal-examples) ⭐ 5,355 | 🐛 7 | 🌐 Assembly | 📅 2022-07-18 几十个用于学习 x86 系统编程的小型操作系统
* \[**2872**星]\[14d] \[C] [lxc/lxc](https://github.com/lxc/lxc) ⭐ 5,257 | 🐛 148 | 🌐 C | 📅 2026-09-07 LXC - Linux Containers
* \[**1816**星]\[29d] \[Go] [gdamore/tcell](https://github.com/gdamore/tcell) ⭐ 5,218 | 🐛 9 | 🌐 Go | 📅 2026-09-06 Tcell is an alternate terminal package, similar in some ways to termbox, but better in others.
...
* \[**2093**星]\[10d] \[C] [flatpak/flatpak](https://github.com/flatpak/flatpak) ⭐ 5,061 | 🐛 1,028 | 🌐 C | 📅 2026-09-07 Linux application sandboxing and distribution framework
...
* \[**2391**星]\[21d] \[Java] [mock-server/mockserver](https://github.com/mock-server/mockserver) ⭐ 4,969 | 🐛 1 | 🌐 Java | 📅 2026-09-10 MockServer enables easy mocking of any system you integrate with via HTTP or HTTPS with clients written in Java, JavaScript and Ruby. MockServer also includes a proxy that introspects all proxied traffic including encrypted SSL traffic and supports Port Forwarding, Web Proxying (i.e. HTTP proxy), HTTPS Tunneling Proxying (using HTTP CONNECT) and…
...
* \[**3749**星]\[12d] \[Go] [hashicorp/consul-template](https://github.com/hashicorp/consul-template) ⭐ 4,823 | 🐛 230 | 🌐 Go | 📅 2026-09-09 Template rendering, notifier, and supervisor for
* \[**1761**星]\[13d] \[C] [google/wuffs](https://github.com/google/wuffs) ⭐ 4,821 | 🐛 37 | 🌐 C | 📅 2026-09-02 Wrangling Untrusted File Formats Safely
...
* \[**2340**星]\[2m] \[JS] [pa11y/pa11y](https://github.com/pa11y/pa11y) ⭐ 4,519 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-07 Pa11y is your automated accessibility testing pal
...
* \[**1714**星]\[1m] \[Go] [hashicorp/memberlist](https://github.com/hashicorp/memberlist) ⭐ 4,101 | 🐛 96 | 🌐 Go | 📅 2026-08-27 Golang package for gossip based membership and failure detection
...
* \[**2052**星]\[13d] \[C++] [openthread/openthread](https://github.com/openthread/openthread) ⭐ 4,027 | 🐛 162 | 🌐 C++ | 📅 2026-09-08 OpenThread released by Google is an open-source implementation of the Thread networking protocol
...
* \[**1668**星]\[3m] \[Py] [boppreh/keyboard](https://github.com/boppreh/keyboard) ⭐ 3,966 | 🐛 414 | 🌐 Python | 📅 2026-07-10 Hook and simulate global keyboard events on Windows and Linux.
...
* \[**1637**星]\[12d] \[JS] [efforg/privacybadger](https://github.com/efforg/privacybadger) ⭐ 3,835 | 🐛 138 | 🌐 JavaScript | 📅 2026-09-08 Privacy Badger is a browser extension that automatically learns to block invisible trackers.
* \[**2364**星]\[10d] \[C] [domoticz/domoticz](https://github.com/domoticz/domoticz) ⭐ 3,802 | 🐛 21 | 🌐 C++ | 📅 2026-09-07 monitor and configure various devices like: Lights, Switches, various sensors/meters like Temperature, Rain, Wind, UV, Electra, Gas, Water and much more
* \[**2031**星]\[10m] \[C] [dekunukem/nintendo\_switch\_reverse\_engineering](https://github.com/dekunukem/nintendo_switch_reverse_engineering) ⭐ 3,779 | 🐛 92 | 🌐 C | 📅 2026-08-21 A look at inner workings of Joycon and Nintendo Switch
...
* \[**1949**星]\[17d] \[C] [microsoft/procdump-for-linux](https://github.com/microsoft/procdump-for-linux) ⭐ 3,081 | 🐛 22 | 🌐 C | 📅 2026-09-04 Linux 版本的 ProcDump
...
* \[**1786**星]\[1m] \[C++] [apitrace/apitrace](https://github.com/apitrace/apitrace) ⭐ 2,860 | 🐛 158 | 🌐 C++ | 📅 2026-06-03 Tools for tracing OpenGL, Direct3D, and other graphics APIs
...
* \[**1854**星]\[19d] \[C] [github/glb-director](https://github.com/github/glb-director) ⭐ 2,455 | 🐛 33 | 🌐 C | 📅 2026-08-31 GitHub Load Balancer Director and supporting tooling.
...
* \[**1852**星]\[1y] \[Py] [jinnlynn/genpac](https://github.com/jinnlynn/genpac) ⭐ 2,183 | 🐛 0 | 🌐 Python | 📅 2026-09-10 PAC/Dnsmasq/Wingy file Generator, working with gfwlist, support custom rules.
* \[**906**星]\[7m] \[C++] [dfhack/dfhack](https://github.com/DFHack/dfhack) ⭐ 2,045 | 🐛 1,063 | 🌐 C++ | 📅 2026-09-08 Memory hacking library for Dwarf Fortress and a set of tools that use it
...
* \[**1572**星]\[1m] \[C] [codahale/bcrypt-ruby](https://github.com/codahale/bcrypt-ruby) ⭐ 1,992 | 🐛 23 | 🌐 C | 📅 2026-06-19  Ruby binding for the OpenBSD bcrypt() password hashing algorithm, allowing you to easily store a secure hash of your users' passwords.
...
* \[**522**星]\[4m] \[Java] [java-deobfuscator/deobfuscator](https://github.com/java-deobfuscator/deobfuscator) ⭐ 1,762 | 🐛 126 | 🌐 Java | 📅 2023-04-26 Java 代码反混淆工具
...
* \[**306**星]\[2m] \[C] [nagyd/sdlpop](https://github.com/nagyd/sdlpop) ⭐ 1,281 | 🐛 80 | 🌐 C | 📅 2025-12-24 An open-source port of Prince of Persia, based on the disassembly of the DOS version.
...
* \[**1955**星]\[11d] \[Go] [solo-io/gloo](https://github.com/solo-io/gloo) ⭐ 170 | 🐛 1,878 | 🌐 Go | 📅 2026-09-09 An Envoy-Powered API Gateway
* \[**2214**星]\[18d] [getlantern/lantern-binaries](https://github.com/getlantern/lantern-binaries) ⭐ 120 | 🐛 14 | 📅 2026-09-10 Lantern installers binary downloads.
...
* \[**1422**星]\[17d] \[C++] [eteran/edb-debugger](https://github.com/eteran/edb-debugger) ⭐ 2,958 | 🐛 67 | 🌐 C++ | 📅 2026-09-05 edb is a cross platform AArch32/x86/x86-64 debugger.
* \[**836**星]\[8d] \[C++] [tasvideos/bizhawk](https://github.com/tasvideos/bizhawk) ⭐ 2,754 | 🐛 806 | 🌐 C# | 📅 2026-09-03 BizHawk is a multi-system emulator written in C#. BizHawk provides nice features for casual gamers such as full screen, and joypad support in addition to full rerecording and debugging tools for all system cores.
...
* \[**291**星]\[12d] \[Py] [sosreport/sos](https://github.com/sosreport/sos) ⭐ 597 | 🐛 164 | 🌐 Python | 📅 2026-09-09 A unified tool for collecting system logs and other debug information
...
* \[**332**星]\[8m] \[Py] [romanvm/python-web-pdb](https://github.com/romanvm/python-web-pdb) ⭐ 534 | 🐛 14 | 🌐 Python | 📅 2026-09-07 Web-based remote UI for Python's PDB debugger
...
* \[**411**星]\[13d] \[HTML] [w3c/webappsec](https://github.com/w3c/webappsec) ⭐ 669 | 🐛 104 | 🌐 HTML | 📅 2026-06-10 Web App安全工作组
...
* \[**20779**星]\[8d] \[Java] [skylot/jadx](https://github.com/skylot/jadx) ⭐ 50,396 | 🐛 446 | 🌐 Java | 📅 2026-09-08 dex 转 java 的反编译器
* \[**7733**星]\[1m] \[Java] [java-decompiler/jd-gui](https://github.com/java-decompiler/jd-gui) ⭐ 15,197 | 🐛 248 | 🌐 Java | 📅 2024-07-08 A standalone Java Decompiler GUI
* \[**1867**星]\[1y] \[Java] [jindrapetrik/jpexs-decompiler](https://github.com/jindrapetrik/jpexs-decompiler) ⭐ 5,856 | 🐛 5 | 🌐 Java | 📅 2026-08-08 JPEXS Free Flash Decompiler
* \[**3135**星]\[26d] \[Java] [deathmarine/luyten](https://github.com/deathmarine/luyten) ⭐ 5,112 | 🐛 193 | 🌐 Java | 📅 2024-07-11 An Open Source Java Decompiler Gui for Procyon
* \[**671**星]\[11m] \[C++] [zrax/pycdc](https://github.com/zrax/pycdc) ⭐ 4,614 | 🐛 233 | 🌐 C++ | 📅 2026-04-07 C++ python bytecode disassembler and decompiler
* \[**1652**星]\[12m] \[Java] [fesh0r/fernflower](https://github.com/fesh0r/fernflower) ⭐ 4,392 | 🐛 0 | 🌐 Java | 📅 2026-09-09 Unofficial mirror of FernFlower Java decompiler (All pulls should be submitted upstream)
* \[**1466**星]\[12d] \[Py] [rocky/python-uncompyle6](https://github.com/rocky/python-uncompyle6) ⭐ 4,321 | 🐛 42 | 🌐 Python | 📅 2026-04-24 Python反编译器，跨平台
* \[**331**星]\[11d] \[Java] [leibnitz27/cfr](https://github.com/leibnitz27/cfr) ⭐ 2,690 | 🐛 150 | 🌐 Java | 📅 2026-06-04 This is the public repository for the CFR Java decompiler
* \[**673**星]\[18d] \[C#] [uxmal/reko](https://github.com/uxmal/reko) ⭐ 2,602 | 🐛 165 | 🌐 C# | 📅 2026-09-07 Reko is a binary decompiler.
* \[**347**星]\[16d] \[C#] [steamdatabase/valveresourceformat](https://github.com/steamdatabase/valveresourceformat) ⭐ 2,418 | 🐛 68 | 🌐 C# | 📅 2026-09-09 Valve's Source 2 resource file format (also known as Stupid Valve Format) parser and decompiler.
...
* \[**6052**星]\[13d] \[Py] [cyrus-and/gdb-dashboard](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,247 | 🐛 19 | 🌐 Python | 📅 2026-07-17 Modular visual interface for GDB in Python
* \[**2439**星]\[16d] \[Py] [pwndbg/pwndbg](https://github.com/pwndbg/pwndbg) ⭐ 10,849 | 🐛 222 | 🌐 Python | 📅 2026-09-09 GDB插件，辅助漏洞开发和逆向
...
* \[**2568**星]\[1m] \[Py] [hugsy/gef](https://github.com/hugsy/gef) ⭐ 8,348 | 🐛 14 | 🌐 Python | 📅 2026-08-20 gdb增强工具，使用Python API，用于漏洞开发和逆向分析。
...
* \[**11588**星]\[12d] \[C] [radareorg/radare2](https://github.com/radareorg/radare2) ⭐ 24,771 | 🐛 821 | 🌐 C | 📅 2026-09-10 unix-like reverse engineering framework and commandline tools
...
* \[**2820**星]\[1m] \[Py] [androguard/androguard](https://github.com/androguard/androguard) ⭐ 6,235 | 🐛 46 | 🌐 Python | 📅 2026-09-04 Reverse engineering, Malware and goodware analysis of Android applications ... and more (ninja !)
* \[**328**星]\[5m] \[Py] [vector35/binaryninja-api](https://github.com/vector35/binaryninja-api) ⭐ 1,310 | 🐛 1,962 | 🌐 C++ | 📅 2026-09-10 Public API, examples, documentation and issues for Binary Ninja
...
* \[**296**星]\[12d] \[C++] [hasherezade/libpeconv](https://github.com/hasherezade/libpeconv) ⭐ 1,387 | 🐛 18 | 🌐 C++ | 📅 2026-04-18 用于映射和取消映射PE 文件的库
...
* \[**1915**星]\[22d] \[C#] [lucasg/dependencies](https://github.com/lucasg/dependencies) ⭐ 11,832 | 🐛 142 | 🌐 C# | 📅 2024-05-15 A rewrite of the old legacy software "depends.exe" in C# for Windows devs to troubleshoot dll load dependencies issues.
* \[**1146**星]\[27d] \[C#] [perfare/il2cppdumper](https://github.com/perfare/il2cppdumper) ⭐ 9,377 | 🐛 154 | 🌐 C# | 📅 2024-08-18 Restore dll from Unity il2cpp binary file (except code)
* \[**1333**星]\[10m] \[C] [fancycode/memorymodule](https://github.com/fancycode/memorymodule) ⭐ 3,158 | 🐛 58 | 🌐 C | 📅 2024-01-03 Library to load a DLL from memory.
...
* \[**713**星]\[5m] \[C++] [darthton/xenos](https://github.com/darthton/xenos) ⭐ 2,658 | 🐛 51 | 🌐 C++ | 📅 2021-05-17 Windows DLL 注入器
...
* \[**2355**星]\[11d] \[C] [hfiref0x/uacme](https://github.com/hfiref0x/uacme) ⭐ 7,787 | 🐛 0 | 🌐 C | 📅 2026-07-24 Defeating Windows User Account Control
...
* \[**261**星]\[3m] \[C++] [gametechdev/presentmon](https://github.com/gametechdev/presentmon) ⭐ 2,556 | 🐛 201 | 🌐 C++ | 📅 2026-09-07 Tool for collection and processing of ETW events related to DXGI presentation.
...
* \[**921**星]\[7m] \[PS] [api0cradle/ultimateapplockerbypasslist](https://github.com/api0cradle/ultimateapplockerbypasslist) ⭐ 2,082 | 🐛 10 | 🌐 PowerShell | 📅 2023-09-11 The goal of this repository is to document the most common techniques to bypass AppLocker.
...
* \[**9261**星]\[11d] \[C#] [icsharpcode/ilspy](https://github.com/icsharpcode/ilspy) ⭐ 26,042 | 🐛 171 | 🌐 C# | 📅 2026-09-09 .NET Decompiler
...
* \[**510**星]\[5m] \[Py] [rabbitstack/fibratus](https://github.com/rabbitstack/fibratus) ⭐ 2,541 | 🐛 44 | 🌐 Go | 📅 2026-09-08 Windows内核探索和跟踪工具
...
* \[**863**星]\[14d] \[C++] [henrypp/simplewall](https://github.com/henrypp/simplewall) ⭐ 8,930 | 🐛 143 | 🌐 C | 📅 2026-09-08 为Windows 过滤平台提供的配置界面
* \[**949**星]\[3m] \[C] [basil00/divert](https://github.com/basil00/divert) ⭐ 3,287 | 🐛 64 | 🌐 C | 📅 2023-03-15 用户模式数据包拦截库，适用于Win 7/8/10
* \[**360**星]\[12d] \[C#] [digitalruby/ipban](https://github.com/digitalruby/ipban) ⭐ 2,183 | 🐛 2 | 🌐 C# | 📅 2026-08-21 监视Windows/Linux系统的登录失败和不良行为，并封禁对应的IP地址。高度可配置，精简且功能强大。
...
* \[**418**星]\[15d] \[C] [samba-team/samba](https://github.com/samba-team/samba) ⭐ 1,136 | 🐛 1 | 🌐 C | 📅 2026-09-09 适用于Linux和Unix的标准Windows interoperability程序套件
...
* \[**210**星]\[3m] [adguardteam/adguardforwindows](https://github.com/adguardteam/adguardforwindows) ⭐ 891 | 🐛 164 | 📅 2026-09-09 Windows系统范围的AdBlocker
...
* \[**370**星]\[27d] \[Ruby] [winrb/winrm](https://github.com/winrb/winrm) ⭐ 423 | 🐛 29 | 🌐 Ruby | 📅 2026-09-10 在Windows中使用WinRM的功能调用原生对象的SOAP库。Ruby编写
...
* \[**787**星]\[2m] \[C] [nixos/patchelf](https://github.com/nixos/patchelf) ⭐ 4,256 | 🐛 148 | 🌐 C | 📅 2026-07-27 A small utility to modify the dynamic linker and RPATH of ELF executables
* \[**930**星]\[15d] \[Py] [eliben/pyelftools](https://github.com/eliben/pyelftools) ⭐ 2,278 | 🐛 55 | 🌐 Python | 📅 2026-07-30 Parsing ELF and DWARF in Python
...
* \[**1450**星]\[2m] \[C] [feralinteractive/gamemode](https://github.com/feralinteractive/gamemode) ⭐ 6,005 | 🐛 218 | 🌐 C | 📅 2026-06-15 Optimise Linux system performance on demand
* \[**1413**星]\[21d] \[C++] [google/nsjail](https://github.com/google/nsjail) ⭐ 4,095 | 🐛 24 | 🌐 C++ | 📅 2026-08-27 A light-weight process isolation tool, making use of Linux namespaces and seccomp-bpf syscall filters (with help of the kafel bpf language)
* \[**759**星]\[1m] \[Py] [korcankaraokcu/pince](https://github.com/korcankaraokcu/pince) ⭐ 3,081 | 🐛 6 | 🌐 Python | 📅 2026-08-24 A reverse engineering tool that'll supply the place of Cheat Engine for linux
* \[**731**星]\[17d] \[C] [strace/strace](https://github.com/strace/strace) ⭐ 2,693 | 🐛 110 | 🌐 C | 📅 2026-09-09 strace is a diagnostic, debugging and instructional userspace utility for Linux
* \[**895**星]\[29d] \[C] [buserror/simavr](https://github.com/buserror/simavr) ⭐ 1,785 | 🐛 49 | 🌐 C | 📅 2026-08-28 simavr is a lean, mean and hackable AVR simulator for linux & OSX
...
* \[**468**星]\[9d] \[C] [libreswan/libreswan](https://github.com/libreswan/libreswan) ⭐ 1,005 | 🐛 653 | 🌐 C | 📅 2026-09-10 an Internet Key Exchange (IKE) implementation for Linux.
...
* \[**441**星]\[12d] \[C] [facebook/openbmc](https://github.com/facebook/openbmc) ⭐ 687 | 🐛 59 | 🌐 C | 📅 2026-09-10 OpenBMC is an open software framework to build a complete Linux image for a Board Management Controller (BMC).
