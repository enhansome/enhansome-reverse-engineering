...
* [全平台逆向资源: awesome-reverse-engineering](https://github.com/alphaSeclab/awesome-reverse-engineering) ⭐ 5,025 | 🐛 7 | 📅 2021-09-01:
...
* 此页只包含部分内容. [查看完整版](https://github.com/alphaSeclab/awesome-reverse-engineering/blob/master/Readme_full.md) ⭐ 5,025 | 🐛 7 | 📅 2021-09-01

# 说明

[EnglishVersion](https://github.com/alphaSeclab/awesome-reverse-engineering/blob/master/Readme_en.md) ⭐ 5,025 | 🐛 7 | 📅 2021-09-01
...
* \[**737**星]\[7m] \[Py] [devttys0/ida](https://github.com/devttys0/ida) ⭐ 1,367 | 🐛 28 | 🌐 Python | 📅 2023-10-23 IDA插件/脚本/模块收集
  * [wpsearch](https://github.com/devttys0/ida/blob/master/scripts/wpsearch.py) ⭐ 1,367 | 🐛 28 | 🌐 Python | 📅 2023-10-23 查找在MIPS WPS checksum实现中常见的立即数
  * [md5hash](https://github.com/devttys0/ida/tree/master/modules/md5hash) ⭐ 1,367 | 🐛 28 | 🌐 Python | 📅 2023-10-23 纯Python版的MD5 hash实现（IDA的hashlib有问题）
  * [alleycat](https://github.com/devttys0/ida/tree/master/plugins/alleycat) ⭐ 1,367 | 🐛 28 | 🌐 Python | 📅 2023-10-23 查找向指定的函数内代码块的路径、查找两个或多个函数之间的路径、生成交互式调用图、可编程
  * [codatify](https://github.com/devttys0/ida/tree/master/plugins/codatify) ⭐ 1,367 | 🐛 28 | 🌐 Python | 📅 2023-10-23 定义IDA自动化分析时miss的ASCII字符串、函数、代码。将data段的所有未定义字节转换为DWORD（于是IDA可识别函数和跳转表指针）
  * [fluorescence](https://github.com/devttys0/ida/tree/master/plugins/fluorescence) ⭐ 1,367 | 🐛 28 | 🌐 Python | 📅 2023-10-23 高亮函数调用指令
  * [leafblower](https://github.com/devttys0/ida/tree/master/plugins/leafblower) ⭐ 1,367 | 🐛 28 | 🌐 Python | 📅 2023-10-23 识别常用的POSIX函数：printf, sprintf, memcmp, strcpy等
  * [localxrefs](https://github.com/devttys0/ida/tree/master/plugins/localxrefs) ⭐ 1,367 | 🐛 28 | 🌐 Python | 📅 2023-10-23 在当前函数内部查找所有对任意选择文本的引用
  * [mipslocalvars](https://github.com/devttys0/ida/tree/master/plugins/mipslocalvars) ⭐ 1,367 | 🐛 28 | 🌐 Python | 📅 2023-10-23 对栈上只用于存储寄存器的变量进行命名，简化栈数据分析（MISP）
  * [mipsrop](https://github.com/devttys0/ida/tree/master/plugins/mipsrop) ⭐ 1,367 | 🐛 28 | 🌐 Python | 📅 2023-10-23 在MIPS可执行代码中搜寻ROP。查找常见的ROP
  * [rizzo](https://github.com/devttys0/ida/tree/master/plugins/rizzo) ⭐ 1,367 | 🐛 28 | 🌐 Python | 📅 2023-10-23 对2个或多个IDB之间的函数进行识别和重命名，基于：函数签名、对唯一字符串/常量的引用、模糊签名、调用图
...
* \[**607**星]\[3m] \[Py] [0xgalz/virtuailor](https://github.com/0xgalz/virtuailor) ⭐ 1,394 | 🐛 12 | 🌐 Python | 📅 2021-07-04 利用IDA调试获取的信息，自动创建C++的虚表
...
* \[**1771**星]\[10d] [onethawt/idaplugins-list](https://github.com/onethawt/idaplugins-list) ⭐ 3,834 | 🐛 8 | 📅 2024-05-31 IDA插件收集
* \[**363**星]\[9m] [fr0gger/awesome-ida-x64-olly-plugin](https://github.com/fr0gger/awesome-ida-x64-olly-plugin) ⭐ 1,582 | 🐛 3 | 📅 2026-02-20 IDA x64DBG OllyDBG 插件收集
...
* \[**605**星]\[2m] \[Max] [maktm/flirtdb](https://github.com/Maktm/FLIRTDB) ⭐ 1,360 | 🐛 5 | 🌐 Max | 📅 2021-09-03 A community driven collection of IDA FLIRT signature files
* \[**321**星]\[5m] [push0ebp/sig-database](https://github.com/push0ebp/sig-database) ⭐ 903 | 🐛 5 | 📅 2022-06-27 IDA FLIRT Signature Database

##### <a id="a9a63d23d32c6c789ca4d2e146c9b6d0"></a>FLIRT签名生成

#### <a id="161e5a3437461dc8959cc923e6a18ef7"></a>Diff&\&Match工具

* \[**1554**星]\[13d] \[Py] [joxeankoret/diaphora](https://github.com/joxeankoret/diaphora) ⭐ 4,370 | 🐛 39 | 🌐 Python | 📅 2026-07-29 program diffing
...
* \[**382**星]\[26d] \[C++] [google/binexport](https://github.com/google/binexport) ⭐ 1,199 | 🐛 41 | 🌐 C++ | 📅 2026-08-13 将反汇编以Protocol Buffer的形式导出为PostgreSQL数据库, 导入到BinNavi中使用
...
* \[**376**星]\[9m] \[Py] [sibears/idagolanghelper](https://github.com/sibears/idagolanghelper) ⭐ 1,091 | 🐛 16 | 🌐 Python | 📅 2023-12-19 解析Go语言编译的二进制文件中的GoLang类型信息
...
* \[**1365**星]\[3m] \[Py] [fireeye/flare-floss](https://github.com/fireeye/flare-floss) ⭐ 4,122 | 🐛 118 | 🌐 Python | 📅 2026-08-17 自动从恶意代码中提取反混淆后的字符串
  * [floss](https://github.com/fireeye/flare-floss/tree/master/floss) ⭐ 4,122 | 🐛 118 | 🌐 Python | 📅 2026-08-17
  * [IDA插件](https://github.com/fireeye/flare-floss/blob/master/scripts/idaplugin.py) ⭐ 4,122 | 🐛 118 | 🌐 Python | 📅 2026-08-17
...
* \[**727**星]\[1y] \[Py] [keystone-engine/keypatch](https://github.com/keystone-engine/keypatch) ⭐ 1,866 | 🐛 43 | 🌐 Python | 📅 2024-09-06 汇编/补丁插件, 支持多架构, 基于Keystone引擎
...
* \[**18649**星]\[10d] \[Java] [nationalsecurityagency/ghidra](https://github.com/nationalsecurityagency/ghidra) ⭐ 72,452 | 🐛 1,916 | 🌐 Java | 📅 2026-08-17 软件逆向框架
...
* \[**34576**星]\[1m] \[C++] [x64dbg/x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,183 | 🐛 574 | 🌐 C++ | 📅 2026-08-15 Windows平台x32/x64调试器
...
* \[**5195**星]\[19d] \[Py] [mobsf/mobile-security-framework-mobsf](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,605 | 🐛 20 | 🌐 JavaScript | 📅 2026-08-17 Mobile Security Framework (MobSF) is an automated, all-in-one mobile application (Android/iOS/Windows) pen-testing, malware analysis and security assessment framework capable of performing static and dynamic analysis.
* \[**5084**星]\[15d] \[HTML] [owasp/owasp-mstg](https://github.com/owasp/owasp-mstg) ⭐ 13,119 | 🐛 231 | 🌐 Python | 📅 2026-08-14 关于移动App安全开发、测试和逆向的相近手册
* \[**4306**星]\[15d] \[Shell] [ashishb/android-security-awesome](https://github.com/ashishb/android-security-awesome) ⭐ 9,613 | 🐛 2 | 🌐 Makefile | 📅 2026-08-17 A collection of android security related resources
* \[**2051**星]\[21d] \[Py] [sensepost/objection](https://github.com/sensepost/objection) ⭐ 9,321 | 🐛 55 | 🌐 Python | 📅 2026-07-23 runtimemobile exploration
...
* \[**6094**星]\[5m] \[Java] [qihoo360/replugin](https://github.com/qihoo360/replugin) ⭐ 7,339 | 🐛 348 | 🌐 Java | 📅 2025-09-16 RePlugin - A flexible, stable, easy-to-use Android Plug-in Framework
* \[**820**星]\[11d] [proxymanapp/proxyman](https://github.com/proxymanapp/proxyman) ⭐ 6,945 | 🐛 1,865 | 📅 2026-08-12 Modern and Delightful HTTP Debugging Proxy for macOS, iOS and Android
* \[**4882**星]\[24d] \[Java] [guardianproject/haven](https://github.com/guardianproject/haven) ⭐ 6,811 | 🐛 149 | 🌐 Java | 📅 2022-10-26 通过Android应用和设备上的传感器保护自己的个人空间和财产而又不损害
* \[**4776**星]\[12d] \[C++] [facebook/redex](https://github.com/facebook/redex) ⭐ 6,297 | 🐛 72 | 🌐 C++ | 📅 2026-08-17 Android App字节码优化器
...
* \[**2011**星]\[8m] \[Py] [fsecurelabs/drozer](https://github.com/FSecureLABS/drozer) ⭐ 4,593 | 🐛 9 | 🌐 Python | 📅 2026-04-08 The Leading Security Assessment Framework for Android.
* \[**2314**星]\[1y] \[Java] [csploit/android](https://github.com/csploit/android) ⭐ 3,644 | 🐛 398 | 🌐 Java | 📅 2024-04-27 cSploit - The most complete and advanced IT security professional toolkit on Android.
* \[**431**星]\[13d] \[C] [guardianproject/orbot](https://github.com/guardianproject/orbot) ⭐ 3,476 | 🐛 90 | 🌐 Kotlin | 📅 2026-08-13 The Github home of Orbot: Tor on Android (Also available on gitlab!)
...
* \[**559**星]\[14d] \[Shell] [owasp/owasp-masvs](https://github.com/owasp/owasp-masvs) ⭐ 2,431 | 🐛 3 | 🌐 Python | 📅 2025-12-22 OWASP 移动App安全标准
...
* \[**527**星]\[4m] \[JS] [wooyundota/droidsslunpinning](https://github.com/wooyundota/droidsslunpinning) ⭐ 1,507 | 🐛 4 | 🌐 JavaScript | 📅 2020-04-07 Android certificate pinning disable tools
...
* \[**267**星]\[4m] \[Py] [amimo/dcc](https://github.com/amimo/dcc) ⭐ 1,293 | 🐛 26 | 🌐 Python | 📅 2024-02-07 DCC (Dex-to-C Compiler) is method-based aot compiler that can translate DEX code to C code.
...
* \[**284**星]\[9m] \[Py] [micropyramid/forex-python](https://github.com/micropyramid/forex-python) ⭐ 710 | 🐛 23 | 🌐 Python | 📅 2025-05-22 Foreign exchange rates, Bitcoin price index and currency conversion using ratesapi.io
...
* \[**333**星]\[25d] \[Java] [datatheorem/trustkit-android](https://github.com/datatheorem/trustkit-android) ⭐ 603 | 🐛 24 | 🌐 Java | 📅 2026-08-17 Easy SSL pinning validation and reporting for Android.
...
* \[**14557**星]\[13d] \[Java] [tencent/tinker](https://github.com/tencent/tinker) ⭐ 17,638 | 🐛 571 | 🌐 Java | 📅 2026-08-12 Tinker is a hot-fix solution library for Android, it supports dex, library and resources update without reinstall apk.
...
* \[**12285**星]\[11d] \[Java] [signalapp/signal-android](https://github.com/signalapp/Signal-Android) ⭐ 29,208 | 🐛 483 | 🌐 Kotlin | 📅 2026-08-17 A private messenger for Android.
...
* \[**1655**星]\[2m] \[Java] [tiann/epic](https://github.com/tiann/epic) ⭐ 4,554 | 🐛 18 | 🌐 Java | 📅 2023-07-22 Dynamic java method AOP hook for Android(continution of Dexposed on ART), Supporting 4.0\~10.0
...
* \[**669**星]\[12d] \[Java] [ganyao114/sandhook](https://github.com/ganyao114/sandhook) ⭐ 2,227 | 🐛 46 | 🌐 Java | 📅 2023-01-19 Android ART Hook/Native Inline Hook/Single Instruction Hook - support 4.4 - 10.0 32/64 bit - Xposed API Compat
...
* \[**309**星]\[1m] [bigsinger/androididchanger](https://github.com/bigsinger/androididchanger) ⭐ 624 | 🐛 28 | 🌐 Java | 📅 2026-08-14 Xposed Module for Changing Android Device Info
...
* \[**712**星]\[2m] \[YARA] [rednaga/apkid](https://github.com/rednaga/apkid) ⭐ 2,557 | 🐛 84 | 🌐 YARA | 📅 2026-07-27 Android Application Identifier for Packers, Protectors, Obfuscators and Oddities - PEiD for Android
* \[**811**星]\[4m] \[C] [strazzere/android-unpacker](https://github.com/strazzere/android-unpacker) ⭐ 1,179 | 🐛 0 | 🌐 C | 📅 2020-01-20 Android Unpacker presented at Defcon 22: Android Hacker Protection Level 0
...
* \[**532**星]\[7m] \[Java] [limboemu/limbo](https://github.com/limboemu/limbo) ⭐ 3,392 | 🐛 54 | 🌐 Java | 📅 2024-08-18 Limbo is a QEMU-based emulator for Android. It currently supports PC & ARM emulation for Intel x86 and ARM architecture. See our wiki
* \[**1492**星]\[1y] \[C++] [f1xpl/openauto](https://github.com/f1xpl/openauto) ⭐ 2,907 | 🐛 37 | 🌐 C++ | 📅 2024-12-12 AndroidAuto headunit emulator
...
* \[**429**星]\[4m] \[Shell] [ashishb/android-malware](https://github.com/ashishb/android-malware) ⭐ 1,219 | 🐛 0 | 🌐 Shell | 📅 2025-12-31 Collection of android malware samples
...
* \[**9285**星]\[1m] \[Java] [ibotpeaches/apktool](https://github.com/ibotpeaches/apktool) ⭐ 25,306 | 🐛 77 | 🌐 Java | 📅 2026-08-11 A tool for reverse engineering Android apk files
* \[**2053**星]\[1m] \[Java] [genymobile/gnirehtet](https://github.com/genymobile/gnirehtet) ⭐ 7,845 | 🐛 324 | 🌐 Java | 📅 2024-08-11 Gnirehtet provides reverse tethering for Android
...
* \[**2140**星]\[2m] \[Py] [jonathansalwan/ropgadget](https://github.com/jonathansalwan/ropgadget) ⭐ 4,466 | 🐛 15 | 🌐 Python | 📅 2026-06-24 This tool lets you search your gadgets on your binaries to facilitate your ROP exploitation. ROPgadget supports ELF, PE and Mach-O format on x86, x64, ARM, ARM64, PowerPC, SPARC and MIPS architectures.
...
* \[**1193**星]\[15d] \[JS] [alonemonkey/frida-ios-dump](https://github.com/alonemonkey/frida-ios-dump) ⭐ 3,910 | 🐛 107 | 🌐 JavaScript | 📅 2023-05-03 pull decrypted ipa from jailbreak device
...
* \[**384**星]\[3m] \[JS] [johnno1962/xprobeplugin](https://github.com/johnno1962/xprobeplugin) ⭐ 399 | 🐛 0 | 🌐 Objective-C++ | 📅 2024-09-24 Live Memory Browser for Apps & Xcode
...
* \[**4397**星]\[12d] \[Swift] [signalapp/signal-ios](https://github.com/signalapp/Signal-iOS) ⭐ 12,199 | 🐛 140 | 🌐 Swift | 📅 2026-08-14 A private messenger for iOS.
* \[**1215**星]\[16d] \[YARA] [horsicq/detect-it-easy](https://github.com/horsicq/detect-it-easy) ⭐ 11,361 | 🐛 33 | 🌐 JavaScript | 📅 2026-08-17 Program for determining types of files for Windows, Linux and MacOS.
...
* \[**4663**星]\[1m] \[C] [google/ios-webkit-debug-proxy](https://github.com/google/ios-webkit-debug-proxy) ⭐ 6,197 | 🐛 19 | 🌐 C | 📅 2025-07-02 A DevTools proxy (Chrome Remote Debugging Protocol) for iOS devices (Safari Remote Web Inspector).
* \[**5775**星]\[4m] \[ObjC] [square/ponydebugger](https://github.com/square/ponydebugger) ⭐ 5,854 | 🐛 46 | 🌐 Objective-C | 📅 2023-03-18 Remote network and data debugging for your native iOS app using Chrome Developer Tools
...
* \[**2867**星]\[12d] \[ObjC] [facebook/idb](https://github.com/facebook/idb) ⭐ 5,278 | 🐛 182 | 🌐 Swift | 📅 2026-08-17 idb is a flexible command line interface for automating iOS simulators and devices
* \[**2753**星]\[1m] \[Makefile] [theos/theos](https://github.com/theos/theos) ⭐ 4,908 | 🐛 72 | 🌐 Makefile | 📅 2026-08-08 A cross-platform suite of tools for building and deploying software for iOS and other platforms.
...
* \[**1299**星]\[6m] \[JS] [feross/spoof](https://github.com/feross/spoof) ⭐ 1,865 | 🐛 14 | 🌐 JavaScript | 📅 2020-11-05 Easily spoof your MAC address in macOS, Windows, & Linux!
...
* \[**346**星]\[4m] \[TS] [bacher09/pwgen-for-bios](https://github.com/bacher09/pwgen-for-bios) ⭐ 1,432 | 🐛 182 | 🌐 TypeScript | 📅 2026-02-05 Password generator for BIOS
...
* \[**396**星]\[4m] [ansjdnakjdnajkd/ios](https://github.com/ansjdnakjdnajkd/ios) ⭐ 1,306 | 🐛 0 | 📅 2023-11-06 iOS渗透测试最有用的工具
...
* \[**482**星]\[1y] \[Swift] [icepa/icepa](https://github.com/icepa/icepa) ⭐ 771 | 🐛 1 | 🌐 Swift | 📅 2024-06-02 iOS system-wide VPN based Tor client
* \[**322**星]\[2m] \[ObjC] [auth0/simplekeychain](https://github.com/auth0/simplekeychain) ⭐ 725 | 🐛 5 | 🌐 Swift | 📅 2026-07-22 A Keychain helper for iOS to make it very simple to store/obtain values from iOS Keychain
...
* \[**1228**星]\[12d] \[C] [dynamorio/dynamorio](https://github.com/dynamorio/dynamorio) ⭐ 3,132 | 🐛 1,797 | 🌐 C | 📅 2026-08-17 Dynamic Instrumentation Tool Platform
...
* \[**1364**星]\[3m] \[C] [googleprojectzero/winafl](https://github.com/googleprojectzero/winafl) ⭐ 2,602 | 🐛 170 | 🌐 C | 📅 2026-03-13 A fork of AFL for fuzzing Windows binaries
...
* \[**4516**星]\[13d] \[Makefile] [frida/frida](https://github.com/frida/frida) ⭐ 21,651 | 🐛 1,956 | 🌐 Meson | 📅 2026-08-17 Clone this repo to build Frida
...
* \[**228**星]\[13d] \[C] [frida/frida-gum](https://github.com/frida/frida-gum) ⭐ 1,003 | 🐛 207 | 🌐 C | 📅 2026-08-17 Low-level code instrumentation library used by frida-core
* \[**420**星]\[13d] \[C] [frida/frida-python](https://github.com/frida/frida-python) ⭐ 869 | 🐛 56 | 🌐 Python | 📅 2026-08-17 Frida Python bindings
...
* \[**321**星]\[1m] \[C] [frida/frida-core](https://github.com/frida/frida-core) ⭐ 763 | 🐛 145 | 🌐 Vala | 📅 2026-08-17 Frida core library intended for static linking into bindings
...
* \[**14349**星]\[2m] \[Py] [corentinj/real-time-voice-cloning](https://github.com/corentinj/real-time-voice-cloning) ⭐ 60,091 | 🐛 177 | 🌐 Python | 📅 2026-03-09 Clone a voice in 5 seconds to generate arbitrary speech in real-time
* \[**2687**星]\[11d] \[Go] [adguardteam/adguardhome](https://github.com/adguardteam/adguardhome) ⭐ 36,175 | 🐛 1,276 | 🌐 TypeScript | 📅 2026-08-17 Network-wide ads & trackers blocking DNS server
* \[**10378**星]\[11d] \[Go] [goharbor/harbor](https://github.com/goharbor/harbor) ⭐ 29,169 | 🐛 836 | 🌐 Go | 📅 2026-08-18 An open source trusted cloud native registry project that stores, signs, and scans content.
* \[**19766**星]\[3m] \[Jupyter Notebook] [camdavidsonpilon/probabilistic-programming-and-bayesian-methods-for-hackers](https://github.com/camdavidsonpilon/probabilistic-programming-and-bayesian-methods-for-hackers) ⭐ 28,166 | 🐛 203 | 🌐 Jupyter Notebook | 📅 2024-06-25 aka "Bayesian Methods for Hackers": An introduction to Bayesian methods + probabilistic programming with a computation/understanding-first, mathematics-second point of view. All in pure Python ;)
* \[**5420**星]\[12d] \[Py] [mlflow/mlflow](https://github.com/mlflow/mlflow) ⭐ 27,552 | 🐛 2,032 | 🌐 Python | 📅 2026-08-18 Open source platform for the machine learning lifecycle
* \[**11402**星]\[10d] \[Java] [oracle/graal](https://github.com/oracle/graal) ⭐ 21,663 | 🐛 849 | 🌐 Java | 📅 2026-08-17 Run Programs Faster Anywhere
* \[**7020**星]\[14d] \[Go] [nats-io/nats-server](https://github.com/nats-io/nats-server) ⭐ 20,534 | 🐛 544 | 🌐 Go | 📅 2026-08-17 High-Performance server for NATS, the cloud native messaging system.
* \[**5753**星]\[18d] \[Go] [casbin/casbin](https://github.com/casbin/casbin) ⭐ 20,327 | 🐛 42 | 🌐 Go | 📅 2026-08-13 An authorization library that supports access control models like ACL, RBAC, ABAC in Golang
* \[**3608**星]\[9d] \[Pascal] [cheat-engine/cheat-engine](https://github.com/cheat-engine/cheat-engine) ⭐ 18,987 | 🐛 1,307 | 🌐 Pascal | 📅 2025-04-19 Cheat Engine. A development environment focused on modding
* \[**4610**星]\[1y] \[C] [upx/upx](https://github.com/upx/upx) ⭐ 17,786 | 🐛 26 | 🌐 C++ | 📅 2026-08-17 UPX - the Ultimate Packer for eXecutables
* \[**5226**星]\[13d] \[Shell] [denisidoro/navi](https://github.com/denisidoro/navi) ⭐ 17,449 | 🐛 110 | 🌐 Rust | 📅 2026-07-28 An interactive cheatsheet tool for the command-line
* \[**11213**星]\[2m] \[Jupyter Notebook] [selfteaching/the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 16,438 | 🐛 199 | 🌐 Jupyter Notebook | 📅 2026-05-20 One has no future if one couldn't teach themself.
* \[**2815**星]\[20d] \[C] [processhacker/processhacker](https://github.com/processhacker/processhacker) ⭐ 15,655 | 🐛 285 | 🌐 C | 📅 2026-08-13 A free, powerful, multi-purpose tool that helps you monitor system resources, debug software and detect malware.
* \[**3295**星]\[15d] \[JS] [koenkk/zigbee2mqtt](https://github.com/koenkk/zigbee2mqtt) ⭐ 15,504 | 🐛 464 | 🌐 TypeScript | 📅 2026-08-14 Zigbee
* \[**6894**星]\[2m] \[Go] [sqshq/sampler](https://github.com/sqshq/sampler) ⭐ 14,784 | 🐛 62 | 🌐 Go | 📅 2024-02-22 A tool for shell commands execution, visualization and alerting. Configured with a simple YAML file.
* \[**7748**星]\[10d] \[Go] [git-lfs/git-lfs](https://github.com/git-lfs/git-lfs) ⭐ 14,428 | 🐛 483 | 🌐 Go | 📅 2026-08-07 Git extension for versioning large files
* \[**5116**星]\[11d] \[ASP] [hq450/fancyss](https://github.com/hq450/fancyss) ⭐ 13,705 | 🐛 212 | 🌐 Shell | 📅 2026-06-01 fancyss is a project providing tools to across the GFW on asuswrt/merlin based router.
* \[**3129**星]\[13d] \[C] [qemu/qemu](https://github.com/qemu/qemu) ⭐ 13,584 | 🐛 0 | 🌐 C | 📅 2026-08-17 Official QEMU mirror. Please see
...
* \[**2344**星]\[16d] \[C] [tsl0922/ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,212 | 🐛 112 | 🌐 C | 📅 2026-08-12 Share your terminal over the web
...
* \[**3505**星]\[16d] \[C] [cyan4973/xxhash](https://github.com/cyan4973/xxhash) ⭐ 11,202 | 🐛 41 | 🌐 C | 📅 2026-07-27 Extremely fast non-cryptographic hash algorithm
* \[**4003**星]\[11d] \[Go] [dexidp/dex](https://github.com/dexidp/dex) ⭐ 11,042 | 🐛 524 | 🌐 Go | 📅 2026-08-17 OpenID Connect Identity (OIDC) and OAuth 2.0 Provider with Pluggable Connectors
* \[**2993**星]\[18d] \[Py] [quantaxis/quantaxis](https://github.com/quantaxis/quantaxis) ⭐ 11,011 | 🐛 239 | 🌐 Python | 📅 2026-02-28 支持任务调度 分布式部署的 股票/期货/自定义市场 数据/回测/模拟/交易/可视化 纯本地PAAS量化解决方案
* \[**3908**星]\[12d] \[C++] [baldurk/renderdoc](https://github.com/baldurk/renderdoc) ⭐ 10,987 | 🐛 50 | 🌐 C++ | 📅 2026-08-15 RenderDoc is a stand-alone graphics debugging tool.
...
* \[**2627**星]\[23d] \[JS] [popcorn-official/popcorn-desktop](https://github.com/popcorn-official/popcorn-desktop) ⭐ 10,632 | 🐛 65 | 🌐 TypeScript | 📅 2026-08-17 Popcorn Time is a multi-platform, free software BitTorrent client that includes an integrated media player. Desktop ( Windows / Mac / Linux ) a Butter-Project Fork
* \[**4597**星]\[12d] \[C++] [mozilla/rr](https://github.com/mozilla/rr) ⭐ 10,619 | 🐛 480 | 🌐 C++ | 📅 2026-08-16 记录与重放App的调试执行过程
* \[**5751**星]\[9m] \[C] [xoreaxeaxeax/movfuscator](https://github.com/xoreaxeaxeax/movfuscator) ⭐ 10,339 | 🐛 25 | 🌐 C | 📅 2024-05-29 C编译器，编译的二进制文件只有1个代码块。
* \[**2718**星]\[3m] \[Py] [drivendata/cookiecutter-data-science](https://github.com/drivendata/cookiecutter-data-science) ⭐ 10,008 | 🐛 34 | 🌐 Python | 📅 2026-08-07 A logical, reasonably standardized, but flexible project structure for doing and sharing data science work.
...
* \[**5876**星]\[3m] \[Gnuplot] [nasa-jpl/open-source-rover](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,584 | 🐛 18 | 🌐 Prolog | 📅 2026-08-13 A build-it-yourself, 6-wheel rover based on the rovers on Mars!
* \[**5717**星]\[28d] \[JS] [swagger-api/swagger-editor](https://github.com/swagger-api/swagger-editor) ⭐ 9,460 | 🐛 46 | 🌐 JavaScript | 📅 2026-08-17 Swagger Editor
* \[**6353**星]\[2m] \[Py] [seatgeek/fuzzywuzzy](https://github.com/seatgeek/fuzzywuzzy) ⚠️ Archived Fuzzy String Matching in Python
* \[**3108**星]\[1m] \[C] [unicorn-engine/unicorn](https://github.com/unicorn-engine/unicorn) ⭐ 9,237 | 🐛 211 | 🌐 C | 📅 2026-07-30 Unicorn CPU emulator framework (ARM, AArch64, M68K, Mips, Sparc, X86)
* \[**3188**星]\[11d] \[C] [meetecho/janus-gateway](https://github.com/meetecho/janus-gateway) ⭐ 9,152 | 🐛 43 | 🌐 C | 📅 2026-07-27 Janus WebRTC Server
* \[**3960**星]\[11d] \[Py] [angr/angr](https://github.com/angr/angr) ⭐ 9,017 | 🐛 729 | 🌐 Python | 📅 2026-08-17 A powerful and user-friendly binary analysis platform!
...
* \[**2587**星]\[10d] \[C] [esnet/iperf](https://github.com/esnet/iperf) ⭐ 8,697 | 🐛 237 | 🌐 C | 📅 2026-07-10 A TCP, UDP, and SCTP network bandwidth measurement tool
* \[**4651**星]\[13d] [powershell/win32-openssh](https://github.com/powershell/win32-openssh) ⭐ 8,243 | 🐛 401 | 📅 2025-10-27 Win32 port of OpenSSH
...
* \[**2948**星]\[1m] \[C] [libfuse/sshfs](https://github.com/libfuse/sshfs) ⭐ 7,615 | 🐛 60 | 🌐 C | 📅 2026-08-08 A network filesystem client to connect to SSH servers
* \[**4314**星]\[15d] \[Rust] [timvisee/ffsend](https://github.com/timvisee/ffsend) ⭐ 7,372 | 🐛 33 | 🌐 Rust | 📅 2025-11-20 Easily and securely share files from the command line
...
* \[**5829**星]\[7m] \[JS] [sindresorhus/fkill-cli](https://github.com/sindresorhus/fkill-cli) ⭐ 7,000 | 🐛 6 | 🌐 JavaScript | 📅 2025-11-09 Fabulously kill processes. Cross-platform.
* \[**2194**星]\[13d] \[C] [armmbed/mbedtls](https://github.com/armmbed/mbedtls) ⭐ 6,874 | 🐛 1,729 | 🌐 C | 📅 2026-08-14 An open source, portable, easy to use, readable and flexible SSL library
...
* \[**2854**星]\[1m] \[Py] [espressif/esptool](https://github.com/espressif/esptool) ⭐ 6,447 | 🐛 14 | 🌐 Python | 📅 2026-08-10 ESP8266 and ESP32 serial bootloader utility
* \[**1698**星]\[21d] \[C++] [microsoft/detours](https://github.com/microsoft/detours) ⭐ 6,355 | 🐛 92 | 🌐 C++ | 📅 2026-08-05 Detours is a software package for monitoring and instrumenting API calls on Windows. It is distributed in source code form.
* \[**408**星]\[19d] \[Py] [crytic/slither](https://github.com/crytic/slither) ⭐ 6,347 | 🐛 471 | 🌐 Python | 📅 2026-08-12 Static Analyzer for Solidity
...
* \[**3120**星]\[11d] \[Go] [tencent/bk-cmdb](https://github.com/tencent/bk-cmdb) ⭐ 5,737 | 🐛 86 | 🌐 Go | 📅 2026-08-07 蓝鲸智云配置平台(BlueKing CMDB)
* \[**2092**星]\[26d] [swiftonsecurity/sysmon-config](https://github.com/swiftonsecurity/sysmon-config) ⭐ 5,624 | 🐛 82 | 📅 2024-07-03 Sysmon configuration file template with default high-quality event tracing
...
* \[**1620**星]\[16d] \[C++] [lief-project/lief](https://github.com/lief-project/lief) ⭐ 5,532 | 🐛 32 | 🌐 C++ | 📅 2026-08-15 Library to Instrument Executable Formats
...
* \[**2833**星]\[2m] \[Assembly] [cirosantilli/x86-bare-metal-examples](https://github.com/cirosantilli/x86-bare-metal-examples) ⭐ 5,338 | 🐛 7 | 🌐 Assembly | 📅 2022-07-18 几十个用于学习 x86 系统编程的小型操作系统
* \[**2872**星]\[14d] \[C] [lxc/lxc](https://github.com/lxc/lxc) ⭐ 5,242 | 🐛 148 | 🌐 C | 📅 2026-07-23 LXC - Linux Containers
* \[**1816**星]\[29d] \[Go] [gdamore/tcell](https://github.com/gdamore/tcell) ⭐ 5,214 | 🐛 11 | 🌐 Go | 📅 2026-08-17 Tcell is an alternate terminal package, similar in some ways to termbox, but better in others.
...
* \[**2093**星]\[10d] \[C] [flatpak/flatpak](https://github.com/flatpak/flatpak) ⭐ 5,030 | 🐛 1,024 | 🌐 C | 📅 2026-08-17 Linux application sandboxing and distribution framework
...
* \[**2391**星]\[21d] \[Java] [mock-server/mockserver](https://github.com/mock-server/mockserver) ⭐ 4,944 | 🐛 7 | 🌐 Java | 📅 2026-08-17 MockServer enables easy mocking of any system you integrate with via HTTP or HTTPS with clients written in Java, JavaScript and Ruby. MockServer also includes a proxy that introspects all proxied traffic including encrypted SSL traffic and supports Port Forwarding, Web Proxying (i.e. HTTP proxy), HTTPS Tunneling Proxying (using HTTP CONNECT) and…
...
* \[**2137**星]\[19d] \[Assembly] [pret/pokered](https://github.com/pret/pokered) ⭐ 4,880 | 🐛 22 | 🌐 Assembly | 📅 2026-08-13 disassembly of Pokémon Red/Blue
...
* \[**1761**星]\[13d] \[C] [google/wuffs](https://github.com/google/wuffs) ⭐ 4,813 | 🐛 37 | 🌐 C | 📅 2026-08-08 Wrangling Untrusted File Formats Safely
* \[**3202**星]\[1y] \[Shell] [toyodadoubi/doubi](https://github.com/toyodadoubi/doubi) ⭐ 4,690 | 🐛 13 | 🌐 Shell | 📅 2020-10-20 一个逗比写的各种逗比脚本\~
...
* \[**2003**星]\[2m] \[C++] [asmjit/asmjit](https://github.com/asmjit/asmjit) ⭐ 4,582 | 🐛 25 | 🌐 C++ | 📅 2026-03-26 Complete x86/x64 JIT and AOT Assembler for C++
...
* \[**2340**星]\[2m] \[JS] [pa11y/pa11y](https://github.com/pa11y/pa11y) ⭐ 4,488 | 🐛 47 | 🌐 JavaScript | 📅 2026-08-17 Pa11y is your automated accessibility testing pal
...
* \[**2052**星]\[13d] \[C++] [openthread/openthread](https://github.com/openthread/openthread) ⭐ 4,015 | 🐛 174 | 🌐 C++ | 📅 2026-08-18 OpenThread released by Google is an open-source implementation of the Thread networking protocol
...
* \[**1727**星]\[8d] \[TSQL] [brentozarultd/sql-server-first-responder-kit](https://github.com/brentozarultd/sql-server-first-responder-kit) ⭐ 3,877 | 🐛 5 | 🌐 TSQL | 📅 2026-08-11 sp\_Blitz, sp\_BlitzCache, sp\_BlitzFirst, sp\_BlitzIndex, and other SQL Server scripts for health checks and performance tuning.
...
* \[**1899**星]\[25d] \[C++] [acidanthera/lilu](https://github.com/acidanthera/Lilu) ⭐ 3,852 | 🐛 0 | 🌐 C | 📅 2026-03-20 Arbitrary kext and process patching on macOS
* \[**1637**星]\[12d] \[JS] [efforg/privacybadger](https://github.com/efforg/privacybadger) ⭐ 3,809 | 🐛 143 | 🌐 JavaScript | 📅 2026-08-14 Privacy Badger is a browser extension that automatically learns to block invisible trackers.
* \[**2364**星]\[10d] \[C] [domoticz/domoticz](https://github.com/domoticz/domoticz) ⭐ 3,792 | 🐛 19 | 🌐 C++ | 📅 2026-08-16 monitor and configure various devices like: Lights, Switches, various sensors/meters like Temperature, Rain, Wind, UV, Electra, Gas, Water and much more
...
* \[**1722**星]\[4m] \[Py] [anorov/cloudflare-scrape](https://github.com/anorov/cloudflare-scrape) ⭐ 3,537 | 🐛 128 | 🌐 Python | 📅 2023-10-14 A Python module to bypass Cloudflare's anti-bot page.
...
* \[**1781**星]\[26d] \[PHP] [ezyang/htmlpurifier](https://github.com/ezyang/htmlpurifier) ⭐ 3,347 | 🐛 133 | 🌐 PHP | 📅 2026-08-12 Standards compliant HTML filter written in PHP
...
* \[**1592**星]\[2m] \[ObjC] [ealeksandrov/provisionql](https://github.com/ealeksandrov/provisionql) ⭐ 2,454 | 🐛 3 | 🌐 Swift | 📅 2026-08-16 Quick Look plugin for apps and provisioning profile files
* \[**1854**星]\[19d] \[C] [github/glb-director](https://github.com/github/glb-director) ⭐ 2,451 | 🐛 33 | 🌐 C | 📅 2026-08-17 GitHub Load Balancer Director and supporting tooling.
...
* \[**1852**星]\[1y] \[Py] [jinnlynn/genpac](https://github.com/jinnlynn/genpac) ⭐ 2,187 | 🐛 0 | 🌐 Python | 📅 2026-08-18 PAC/Dnsmasq/Wingy file Generator, working with gfwlist, support custom rules.
* \[**906**星]\[7m] \[C++] [dfhack/dfhack](https://github.com/DFHack/dfhack) ⭐ 2,037 | 🐛 1,059 | 🌐 C++ | 📅 2026-08-08 Memory hacking library for Dwarf Fortress and a set of tools that use it
...
* \[**1955**星]\[11d] \[Go] [solo-io/gloo](https://github.com/solo-io/gloo) ⭐ 169 | 🐛 1,867 | 🌐 Go | 📅 2026-08-17 An Envoy-Powered API Gateway
* \[**2214**星]\[18d] [getlantern/lantern-binaries](https://github.com/getlantern/lantern-binaries) ⭐ 119 | 🐛 14 | 📅 2026-08-18 Lantern installers binary downloads.
...
* \[**836**星]\[8d] \[C++] [tasvideos/bizhawk](https://github.com/tasvideos/bizhawk) ⭐ 2,728 | 🐛 790 | 🌐 C# | 📅 2026-08-17 BizHawk is a multi-system emulator written in C#. BizHawk provides nice features for casual gamers such as full screen, and joypad support in addition to full rerecording and debugging tools for all system cores.
...
* \[**1147**星]\[5m] \[C++] [cgdb/cgdb](https://github.com/cgdb/cgdb) ⭐ 1,837 | 🐛 45 | 🌐 C | 📅 2026-02-27 Console front-end to the GNU debugger
...
* \[**560**星]\[21d] \[C#] [microsoft/miengine](https://github.com/microsoft/miengine) ⭐ 858 | 🐛 162 | 🌐 C# | 📅 2026-08-17 The Visual Studio MI Debug Engine ("MIEngine") provides an open-source Visual Studio Debugger extension that works with MI-enabled debuggers such as gdb, lldb, and clrdbg.
...
* \[**239**星]\[8m] \[C++] [strivexjun/xantidebug](https://github.com/strivexjun/xantidebug) ⭐ 684 | 🐛 3 | 🌐 C++ | 📅 2019-05-11 VMProtect 3.x Anti-debug Method Improved
...
* \[**291**星]\[12d] \[Py] [sosreport/sos](https://github.com/sosreport/sos) ⭐ 595 | 🐛 157 | 🌐 Python | 📅 2026-08-17 A unified tool for collecting system logs and other debug information
...
* \[**20779**星]\[8d] \[Java] [skylot/jadx](https://github.com/skylot/jadx) ⭐ 50,104 | 🐛 443 | 🌐 Java | 📅 2026-08-05 dex 转 java 的反编译器
...
* \[**1867**星]\[1y] \[Java] [jindrapetrik/jpexs-decompiler](https://github.com/jindrapetrik/jpexs-decompiler) ⭐ 5,808 | 🐛 5 | 🌐 Java | 📅 2026-08-08 JPEXS Free Flash Decompiler
...
* \[**1652**星]\[12m] \[Java] [fesh0r/fernflower](https://github.com/fesh0r/fernflower) ⭐ 4,364 | 🐛 0 | 🌐 Java | 📅 2026-08-13 Unofficial mirror of FernFlower Java decompiler (All pulls should be submitted upstream)
* \[**1466**星]\[12d] \[Py] [rocky/python-uncompyle6](https://github.com/rocky/python-uncompyle6) ⭐ 4,314 | 🐛 42 | 🌐 Python | 📅 2026-04-24 Python反编译器，跨平台
* \[**331**星]\[11d] \[Java] [leibnitz27/cfr](https://github.com/leibnitz27/cfr) ⭐ 2,664 | 🐛 150 | 🌐 Java | 📅 2026-06-04 This is the public repository for the CFR Java decompiler
* \[**673**星]\[18d] \[C#] [uxmal/reko](https://github.com/uxmal/reko) ⭐ 2,599 | 🐛 165 | 🌐 C# | 📅 2026-08-17 Reko is a binary decompiler.
* \[**347**星]\[16d] \[C#] [steamdatabase/valveresourceformat](https://github.com/steamdatabase/valveresourceformat) ⭐ 2,376 | 🐛 73 | 🌐 C# | 📅 2026-08-18 Valve's Source 2 resource file format (also known as Stupid Valve Format) parser and decompiler.
...
* \[**327**星]\[2m] \[C++] [silverf0x/rpcview](https://github.com/silverf0x/rpcview) ⭐ 1,069 | 🐛 15 | 🌐 C++ | 📅 2023-09-24 RpcView is a free tool to explore and decompile Microsoft RPC interfaces
...
* \[**243**星]\[3m] \[Java] [kwart/jd-cmd](https://github.com/kwart/jd-cmd) ⭐ 649 | 🐛 9 | 🌐 Java | 📅 2026-08-17 Command line Java Decompiler
...
* \[**1374**星]\[20d] \[C] [zyantific/zydis](https://github.com/zyantific/zydis) ⭐ 4,337 | 🐛 50 | 🌐 C | 📅 2026-07-27 快速的轻量级x86/x86-64 反汇编库
* \[**430**星]\[2m] \[C#] [0xd4d/iced](https://github.com/0xd4d/iced) ⭐ 3,548 | 🐛 56 | 🌐 Rust | 📅 2026-08-17 x86/x64 disassembler, instruction decoder & encoder
...
* \[**2439**星]\[16d] \[Py] [pwndbg/pwndbg](https://github.com/pwndbg/pwndbg) ⭐ 10,770 | 🐛 212 | 🌐 Python | 📅 2026-08-17 GDB插件，辅助漏洞开发和逆向
...
* \[**2568**星]\[1m] \[Py] [hugsy/gef](https://github.com/hugsy/gef) ⭐ 8,318 | 🐛 16 | 🌐 Python | 📅 2026-06-16 gdb增强工具，使用Python API，用于漏洞开发和逆向分析。
...
* \[**208**星]\[2m] \[Py] [sakhnik/nvim-gdb](https://github.com/sakhnik/nvim-gdb) ⭐ 784 | 🐛 5 | 🌐 Lua | 📅 2026-06-15 Neovim thin wrapper for GDB, LLDB and PDB
...
* \[**11588**星]\[12d] \[C] [radareorg/radare2](https://github.com/radareorg/radare2) ⭐ 24,587 | 🐛 819 | 🌐 C | 📅 2026-08-18 unix-like reverse engineering framework and commandline tools
...
* \[**328**星]\[5m] \[Py] [vector35/binaryninja-api](https://github.com/vector35/binaryninja-api) ⭐ 1,292 | 🐛 1,907 | 🌐 C++ | 📅 2026-08-18 Public API, examples, documentation and issues for Binary Ninja
...
* \[**634**星]\[10d] \[C] [thewover/donut](https://github.com/thewover/donut) ⭐ 4,683 | 🐛 37 | 🌐 C | 📅 2025-07-08 Generates x86, x64, or AMD64+x86 position-independent shellcode that loads .NET Assemblies, PE files, and other Windows payloads from memory and runs them with parameters
...
* \[**296**星]\[12d] \[C++] [hasherezade/libpeconv](https://github.com/hasherezade/libpeconv) ⭐ 1,382 | 🐛 16 | 🌐 C++ | 📅 2026-04-18 用于映射和取消映射PE 文件的库
...
* \[**1915**星]\[22d] \[C#] [lucasg/dependencies](https://github.com/lucasg/dependencies) ⭐ 11,761 | 🐛 142 | 🌐 C# | 📅 2024-05-15 A rewrite of the old legacy software "depends.exe" in C# for Windows devs to troubleshoot dll load dependencies issues.
* \[**1146**星]\[27d] \[C#] [perfare/il2cppdumper](https://github.com/perfare/il2cppdumper) ⭐ 9,307 | 🐛 156 | 🌐 C# | 📅 2024-08-18 Restore dll from Unity il2cpp binary file (except code)
...
* \[**2307**星]\[1m] \[PS] [k8gege/k8tools](https://github.com/k8gege/k8tools) ⭐ 6,197 | 🐛 10 | 🌐 PowerShell | 📅 2025-01-25 K8工具合集(内网渗透/提权工具/远程溢出/漏洞利用/扫描工具/密码破解/免杀工具/Exploit/APT/0day/Shellcode/Payload/priviledge/BypassUAC/OverFlow/WebShell/PenTest) Web GetShell Exploit(Struts2/Zimbra/Weblogic/Tomcat/Apache/Jboss/DotNetNuke/zabbix)
...
* \[**261**星]\[3m] \[C++] [gametechdev/presentmon](https://github.com/gametechdev/presentmon) ⭐ 2,526 | 🐛 194 | 🌐 C++ | 📅 2026-08-16 Tool for collection and processing of ETW events related to DXGI presentation.
...
* \[**249**星]\[3m] \[C++] [microsoft/krabsetw](https://github.com/microsoft/krabsetw) ⭐ 798 | 🐛 18 | 🌐 C++ | 📅 2026-08-17 KrabsETW provides a modern C++ wrapper and a .NET wrapper around the low-level ETW trace consumption functions.
...
* \[**921**星]\[7m] \[PS] [api0cradle/ultimateapplockerbypasslist](https://github.com/api0cradle/ultimateapplockerbypasslist) ⭐ 2,079 | 🐛 10 | 🌐 PowerShell | 📅 2023-09-11 The goal of this repository is to document the most common techniques to bypass AppLocker.
...
* \[**9261**星]\[11d] \[C#] [icsharpcode/ilspy](https://github.com/icsharpcode/ilspy) ⭐ 25,873 | 🐛 188 | 🌐 C# | 📅 2026-08-17 .NET Decompiler
...
* \[**1657**星]\[14d] \[C#] [jbevain/cecil](https://github.com/jbevain/cecil) ⭐ 2,992 | 🐛 111 | 🌐 C# | 📅 2025-09-11 C#库, 探查/修改/生成 .NET App/库
...
* \[**278**星]\[12d] \[PS] [microsoftdocs/windows-driver-docs](https://github.com/MicrosoftDocs/windows-driver-docs) ⭐ 1,059 | 🐛 9 | 🌐 OpenSCAD | 📅 2026-08-17 官方Windows驱动程序工具包文档
...
* \[**863**星]\[14d] \[C++] [henrypp/simplewall](https://github.com/henrypp/simplewall) ⭐ 8,851 | 🐛 141 | 🌐 C | 📅 2026-08-15 为Windows 过滤平台提供的配置界面
* \[**949**星]\[3m] \[C] [basil00/divert](https://github.com/basil00/divert) ⭐ 3,257 | 🐛 64 | 🌐 C | 📅 2023-03-15 用户模式数据包拦截库，适用于Win 7/8/10
* \[**360**星]\[12d] \[C#] [digitalruby/ipban](https://github.com/digitalruby/ipban) ⭐ 2,179 | 🐛 2 | 🌐 C# | 📅 2026-08-10 监视Windows/Linux系统的登录失败和不良行为，并封禁对应的IP地址。高度可配置，精简且功能强大。
...
* \[**570**星]\[1m] \[C] [hfiref0x/winobjex64](https://github.com/hfiref0x/winobjex64) ⭐ 1,967 | 🐛 1 | 🌐 C | 📅 2026-08-16 Windows对象浏览器. x64
* \[**726**星]\[2m] \[Py] [diyan/pywinrm](https://github.com/diyan/pywinrm) ⭐ 1,137 | 🐛 54 | 🌐 Python | 📅 2026-08-04 Python实现的WinRM客户端
* \[**418**星]\[15d] \[C] [samba-team/samba](https://github.com/samba-team/samba) ⭐ 1,117 | 🐛 1 | 🌐 C | 📅 2026-08-18 适用于Linux和Unix的标准Windows interoperability程序套件
...
* \[**210**星]\[3m] [adguardteam/adguardforwindows](https://github.com/adguardteam/adguardforwindows) ⭐ 879 | 🐛 212 | 📅 2026-08-17 Windows系统范围的AdBlocker
* \[**389**星]\[2m] \[C#] [microsoft/binskim](https://github.com/microsoft/binskim) ⭐ 859 | 🐛 162 | 🌐 C# | 📅 2026-08-13 二进制静态分析工具，可为PE和ELF二进制格式提供安全性和正确性分析
* \[**238**星]\[5m] \[PS] [microsoft/aaronlocker](https://github.com/microsoft/aaronlocker) ⭐ 704 | 🐛 16 | 🌐 PowerShell | 📅 2022-08-12 Windows应用程序白名单
...
* \[**930**星]\[15d] \[Py] [eliben/pyelftools](https://github.com/eliben/pyelftools) ⭐ 2,272 | 🐛 55 | 🌐 Python | 📅 2026-07-30 Parsing ELF and DWARF in Python
...
* \[**1450**星]\[2m] \[C] [feralinteractive/gamemode](https://github.com/feralinteractive/gamemode) ⭐ 5,973 | 🐛 216 | 🌐 C | 📅 2026-06-15 Optimise Linux system performance on demand
* \[**1413**星]\[21d] \[C++] [google/nsjail](https://github.com/google/nsjail) ⭐ 4,060 | 🐛 63 | 🌐 C++ | 📅 2026-07-27 A light-weight process isolation tool, making use of Linux namespaces and seccomp-bpf syscall filters (with help of the kafel bpf language)
...
* \[**731**星]\[17d] \[C] [strace/strace](https://github.com/strace/strace) ⭐ 2,671 | 🐛 110 | 🌐 C | 📅 2026-08-17 strace is a diagnostic, debugging and instructional userspace utility for Linux
...
* \[**565**星]\[12d] \[C++] [intel/linux-sgx](https://github.com/intel/linux-sgx) ⭐ 1,448 | 🐛 139 | 🌐 C++ | 📅 2026-08-13 Intel SGX for Linux\*
...
* \[**468**星]\[9d] \[C] [libreswan/libreswan](https://github.com/libreswan/libreswan) ⭐ 1,004 | 🐛 648 | 🌐 C | 📅 2026-08-17 an Internet Key Exchange (IKE) implementation for Linux.
...
* \[**441**星]\[12d] \[C] [facebook/openbmc](https://github.com/facebook/openbmc) ⭐ 683 | 🐛 60 | 🌐 C | 📅 2026-08-18 OpenBMC is an open software framework to build a complete Linux image for a Board Management Controller (BMC).
