...
* [全平台逆向资源: awesome-reverse-engineering](https://github.com/alphaSeclab/awesome-reverse-engineering) ⭐ 5,022 | 🐛 7 | 📅 2021-09-01:
...
* [开源远控和恶意远控分析报告: awesome-rat](https://github.com/alphaSeclab/awesome-rat) ⭐ 2,251 | 🐛 0 | 📅 2020-02-17: 开源远控工具: Windows/Linux/macOS/Android; 远控类恶意恶意代码的分析报告等
* [网络相关的安全资源: awesome-network-stuff](https://github.com/alphaSeclab/awesome-network-stuff) ⭐ 924 | 🐛 4 | 📅 2019-12-30:
  * 网络通信: 代理/SS/V2ray/GFW/反向代理/隧道/VPN/Tor/I2P/...
  * 网络攻击: 中间人/PortKnocking/...
  * 网络分析: 嗅探/协议分析/网络可视化/网络分析/网络诊断等
* [取证相关工具和文章: awesome-forensics](https://github.com/alphaSeclab/awesome-forensics) ⭐ 669 | 🐛 2 | 📅 2019-12-31: 近300个取开源证工具，近600与取证相关文章
* [收集的所有开源工具: sec-tool-list](https://github.com/alphaSeclab/sec-tool-list) ⭐ 618 | 🐛 3 | 📅 2020-05-25: 超过18K, 包括Markdown和Json两种格式
* [攻击性网络安全资源: awesome-cyber-security](https://github.com/alphaSeclab/awesome-cyber-security) ⭐ 499 | 🐛 0 | 📅 2019-12-23: 漏洞/渗透/物联网安全/数据渗透/Metasploit/BurpSuite/KaliLinux/C\&C/OWASP/免杀/CobaltStrike/侦查/OSINT/社工/密码/凭证/威胁狩猎/Payload/WifiHacking/无线攻击/后渗透/提权/UAC绕过/...
* [Webshell工具和分析/使用文章: awesome-webshell](https://github.com/alphaSeclab/awesome-webshell) ⭐ 184 | 🐛 0 | 📅 2019-12-30: Webshell资源收集, 包括150个Github项目, 200个左右文章

# ReverseEngineering

* 跟逆向有关的资源收集。当前包括的工具个数3500+，并根据功能进行了粗糙的分类。部分工具添加了中文描述。当前包括文章数2300+。
* 此页只包含部分内容. [查看完整版](https://github.com/alphaSeclab/awesome-reverse-engineering/blob/master/Readme_full.md) ⭐ 5,022 | 🐛 7 | 📅 2021-09-01

# 说明

[EnglishVersion](https://github.com/alphaSeclab/awesome-reverse-engineering/blob/master/Readme_en.md) ⭐ 5,022 | 🐛 7 | 📅 2021-09-01
...
* \[**1058**星]\[17d] \[Py] [fireeye/flare-ida](https://github.com/fireeye/flare-ida) ⚠️ Archived 多工具
  * [StackStrings](https://github.com/fireeye/flare-ida/blob/master/plugins/stackstrings_plugin.py) ⚠️ Archived 自动恢复手动构造的字符串
  * [Struct Typer](https://github.com/fireeye/flare-ida/blob/master/plugins/struct_typer_plugin.py) ⚠️ Archived implements the struct typing described [here](https://www.mandiant.com/blog/applying-function-types-structure-fields-ida/)
  * [ApplyCalleeType](https://github.com/fireeye/flare-ida/blob/master/python/flare/apply_callee_type.py) ⚠️ Archived specify or choose a function type for indirect calls as described [here](https://www.fireeye.com/blog/threat-research/2015/04/flare_ida_pro_script.html)
  * [argtracker](https://github.com/fireeye/flare-ida/blob/master/python/flare/argtracker.py) ⚠️ Archived 识别函数使用的静态参数
  * [idb2pat](https://github.com/fireeye/flare-ida/blob/master/python/flare/idb2pat.py) ⚠️ Archived FLIRT签名生成
  * [objc2\_analyzer](https://github.com/fireeye/flare-ida/blob/master/python/flare/objc2_analyzer.py) ⚠️ Archived 在目标Mach-O可执行文件的与Objective-C运行时相关的部分中定义的选择器引用及其实现之间创建交叉引用
  * [MSDN Annotations](https://github.com/fireeye/flare-ida/tree/master/python/flare/IDB_MSDN_Annotator) ⚠️ Archived 从XML文件中提取MSDN信息，添加到IDB数据库中
  * [ironstrings](https://github.com/fireeye/flare-ida/tree/master/python/flare/ironstrings) ⚠️ Archived 使用代码模拟执行（flare-emu）, 恢复构造的字符串
  * [Shellcode Hashes](https://github.com/fireeye/flare-ida/tree/master/shellcode_hashes) ⚠️ Archived 生成Hash数据库
* \[**737**星]\[7m] \[Py] [devttys0/ida](https://github.com/devttys0/ida) ⭐ 1,365 | 🐛 28 | 🌐 Python | 📅 2023-10-23 IDA插件/脚本/模块收集
  * [wpsearch](https://github.com/devttys0/ida/blob/master/scripts/wpsearch.py) ⭐ 1,365 | 🐛 28 | 🌐 Python | 📅 2023-10-23 查找在MIPS WPS checksum实现中常见的立即数
  * [md5hash](https://github.com/devttys0/ida/tree/master/modules/md5hash) ⭐ 1,365 | 🐛 28 | 🌐 Python | 📅 2023-10-23 纯Python版的MD5 hash实现（IDA的hashlib有问题）
  * [alleycat](https://github.com/devttys0/ida/tree/master/plugins/alleycat) ⭐ 1,365 | 🐛 28 | 🌐 Python | 📅 2023-10-23 查找向指定的函数内代码块的路径、查找两个或多个函数之间的路径、生成交互式调用图、可编程
  * [codatify](https://github.com/devttys0/ida/tree/master/plugins/codatify) ⭐ 1,365 | 🐛 28 | 🌐 Python | 📅 2023-10-23 定义IDA自动化分析时miss的ASCII字符串、函数、代码。将data段的所有未定义字节转换为DWORD（于是IDA可识别函数和跳转表指针）
  * [fluorescence](https://github.com/devttys0/ida/tree/master/plugins/fluorescence) ⭐ 1,365 | 🐛 28 | 🌐 Python | 📅 2023-10-23 高亮函数调用指令
  * [leafblower](https://github.com/devttys0/ida/tree/master/plugins/leafblower) ⭐ 1,365 | 🐛 28 | 🌐 Python | 📅 2023-10-23 识别常用的POSIX函数：printf, sprintf, memcmp, strcpy等
  * [localxrefs](https://github.com/devttys0/ida/tree/master/plugins/localxrefs) ⭐ 1,365 | 🐛 28 | 🌐 Python | 📅 2023-10-23 在当前函数内部查找所有对任意选择文本的引用
  * [mipslocalvars](https://github.com/devttys0/ida/tree/master/plugins/mipslocalvars) ⭐ 1,365 | 🐛 28 | 🌐 Python | 📅 2023-10-23 对栈上只用于存储寄存器的变量进行命名，简化栈数据分析（MISP）
  * [mipsrop](https://github.com/devttys0/ida/tree/master/plugins/mipsrop) ⭐ 1,365 | 🐛 28 | 🌐 Python | 📅 2023-10-23 在MIPS可执行代码中搜寻ROP。查找常见的ROP
  * [rizzo](https://github.com/devttys0/ida/tree/master/plugins/rizzo) ⭐ 1,365 | 🐛 28 | 🌐 Python | 📅 2023-10-23 对2个或多个IDB之间的函数进行识别和重命名，基于：函数签名、对唯一字符串/常量的引用、模糊签名、调用图
* \[**277**星]\[4m] \[Py] [jpcertcc/aa-tools](https://github.com/jpcertcc/aa-tools) ⭐ 461 | 🐛 3 | 🌐 Python | 📅 2025-08-14 多脚本
  * [apt17scan.py](https://github.com/jpcertcc/aa-tools/blob/master/apt17scan.py) ⭐ 461 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Volatility插件, 检测APT17相关的恶意代码并提取配置
  * [emdivi\_postdata\_decoder](https://github.com/jpcertcc/aa-tools/blob/master/emdivi_postdata_decoder.py) ⭐ 461 | 🐛 3 | 🌐 Python | 📅 2025-08-14 解码Emdivi post的数据
  * [emdivi\_string\_decryptor](https://github.com/jpcertcc/aa-tools/blob/master/emdivi_string_decryptor.py) ⭐ 461 | 🐛 3 | 🌐 Python | 📅 2025-08-14 IDAPython脚本, 解密Emdivi内的字符串
  * [citadel\_decryptor](https://github.com/jpcertcc/aa-tools/tree/master/citadel_decryptor) ⭐ 461 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Data decryption tool for Citadel
  * [adwind\_string\_decoder](https://github.com/jpcertcc/aa-tools/blob/master/adwind_string_decoder.py) ⭐ 461 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Python script for decoding strings inside Adwind
  * [redleavesscan](https://github.com/jpcertcc/aa-tools/blob/master/redleavesscan.py) ⭐ 461 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Volatility plugin for detecting RedLeaves and extracting its config
  * [datper\_splunk](https://github.com/jpcertcc/aa-tools/blob/master/datper_splunk.py) ⭐ 461 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Python script for detects Datper communication and adds result field to Splunk index
  * [datper\_elk](https://github.com/jpcertcc/aa-tools/blob/master/datper_elk.py) ⭐ 461 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Python script for detects Datper communication and adds result field to Elasticsearch index
  * [tscookie\_decode](https://github.com/jpcertcc/aa-tools/blob/master/tscookie_decode.py) ⭐ 461 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Python script for decrypting and parsing TSCookie configure data
  * [wellmess\_cookie\_decode](https://github.com/jpcertcc/aa-tools/blob/master/wellmess_cookie_decode.py) ⭐ 461 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Python script for decoding WellMess's cookie data (support Python2)
  * [cobaltstrikescan](https://github.com/jpcertcc/aa-tools/blob/master/cobaltstrikescan.py) ⭐ 461 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Volatility plugin for detecting Cobalt Strike Beacon and extracting its config
  * [tscookie\_data\_decode](https://github.com/jpcertcc/aa-tools/blob/master/tscookie_data_decode.py) ⭐ 461 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Python script for decrypting and parsing TSCookie configure data
* \[**318**星]\[2m] \[C] [ohjeongwook/darungrim](https://github.com/ohjeongwook/darungrim) ⭐ 365 | 🐛 4 | 📅 2020-08-22 软件补丁分析工具
  * [IDA插件](https://github.com/ohjeongwook/darungrim/tree/master/Src/IDAPlugin) ⭐ 365 | 🐛 4 | 📅 2020-08-22
  * [DGEngine](https://github.com/ohjeongwook/darungrim/tree/master/Src/DGEngine) ⭐ 365 | 🐛 4 | 📅 2020-08-22

### <a id="fb4f0c061a72fc38656691746e7c45ce"></a>结构体&&类的检测&&创建&&恢复

#### <a id="fa5ede9a4f58d4efd98585d3158be4fb"></a>未分类

* \[**931**星]\[25d] \[OCaml] [airbus-seclab/bincat](https://github.com/airbus-seclab/bincat) ⭐ 1,871 | 🐛 18 | 🌐 OCaml | 📅 2025-02-25 二进制代码静态分析工具。值分析（寄存器、内存）、污点分析、类型重建和传播（propagation）、前向/后向分析
  * 重复区段: [IDA->插件->污点分析](#34ac84853604a7741c61670f2a075d20) |
* \[**664**星]\[27d] \[Py] [igogo-x86/hexrayspytools](https://github.com/igogo-x86/hexrayspytools) ⭐ 1,531 | 🐛 32 | 🌐 Python | 📅 2024-08-11 结构体和类重建插件

#### <a id="4900b1626f10791748b20630af6d6123"></a>C++类&&虚表

* \[**607**星]\[3m] \[Py] [0xgalz/virtuailor](https://github.com/0xgalz/virtuailor) ⭐ 1,392 | 🐛 12 | 🌐 Python | 📅 2021-07-04 利用IDA调试获取的信息，自动创建C++的虚表
...
* \[**363**星]\[9m] [fr0gger/awesome-ida-x64-olly-plugin](https://github.com/fr0gger/awesome-ida-x64-olly-plugin) ⭐ 1,580 | 🐛 3 | 📅 2026-02-20 IDA x64DBG OllyDBG 插件收集
  * 重复区段: [x64dbg->插件->新添加的](#da5688c7823802e734c39b539aa39df7) |

### <a id="fabf03b862a776bbd8bcc4574943a65a"></a>外观&&主题

* \[**723**星]\[7m] \[Py] [zyantific/idaskins](https://github.com/zyantific/idaskins) ⚠️ Archived 皮肤插件

### <a id="a8f5db3ab4bc7bc3d6ca772b3b9b0b1e"></a>固件&&嵌入式设备

* \[**5228**星]\[2m] \[Py] [refirmlabs/binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,223 | 🐛 91 | 🌐 Rust | 📅 2026-08-11 固件分析工具（命令行+IDA插件）
  * [IDA插件](https://github.com/ReFirmLabs/binwalk/tree/master/src/scripts) ⭐ 14,223 | 🐛 91 | 🌐 Rust | 📅 2026-08-11
  * [binwalk](https://github.com/ReFirmLabs/binwalk/tree/master/src/binwalk) ⭐ 14,223 | 🐛 91 | 🌐 Rust | 📅 2026-08-11
* \[**492**星]\[5m] \[Py] [maddiestone/idapythonembeddedtoolkit](https://github.com/maddiestone/idapythonembeddedtoolkit) ⭐ 688 | 🐛 0 | 🌐 Python | 📅 2019-08-14 自动分析嵌入式设备的固件

### <a id="02088f4884be6c9effb0f1e9a3795e58"></a>签名(FLIRT等)&&比较(Diff)&&匹配

#### <a id="cf04b98ea9da0056c055e2050da980c1"></a>未分类

* \[**421**星]\[1m] \[C] [mcgill-dmas/kam1n0-community](https://github.com/McGill-DMaS/Kam1n0-Community) ⭐ 627 | 🐛 38 | 🌐 C | 📅 2023-03-02 汇编代码管理与分析平台(独立工具+IDA插件)
  * 重复区段: [IDA->插件->作为辅助](#83de90385d03ac8ef27360bfcdc1ab48) |
  * [IDA插件](https://github.com/McGill-DMaS/Kam1n0-Community/tree/master2.x/kam1n0-clients/ida-plugin) ⭐ 627 | 🐛 38 | 🌐 C | 📅 2023-03-02
  * [kam1n0](https://github.com/McGill-DMaS/Kam1n0-Community/tree/master2.x/kam1n0) ⭐ 627 | 🐛 38 | 🌐 C | 📅 2023-03-02

#### <a id="19360afa4287236abe47166154bc1ece"></a>FLIRT签名

##### <a id="1c9d8dfef3c651480661f98418c49197"></a>FLIRT签名收集

* \[**605**星]\[2m] \[Max] [maktm/flirtdb](https://github.com/Maktm/FLIRTDB) ⭐ 1,358 | 🐛 5 | 🌐 Max | 📅 2021-09-03 A community driven collection of IDA FLIRT signature files
* \[**321**星]\[5m] [push0ebp/sig-database](https://github.com/push0ebp/sig-database) ⭐ 902 | 🐛 5 | 📅 2022-06-27 IDA FLIRT Signature Database

##### <a id="a9a63d23d32c6c789ca4d2e146c9b6d0"></a>FLIRT签名生成

#### <a id="161e5a3437461dc8959cc923e6a18ef7"></a>Diff&\&Match工具

* \[**1554**星]\[13d] \[Py] [joxeankoret/diaphora](https://github.com/joxeankoret/diaphora) ⭐ 4,364 | 🐛 39 | 🌐 Python | 📅 2026-07-29 program diffing
...
* \[**332**星]\[1y] \[Py] [joxeankoret/pigaios](https://github.com/joxeankoret/pigaios) ⭐ 650 | 🐛 14 | 🌐 Python | 📅 2023-01-09 A tool for matching and diffing source codes directly against binaries.

#### <a id="46c9dfc585ae59fe5e6f7ddf542fb31a"></a>Yara

* \[**449**星]\[2m] \[Py] [polymorf/findcrypt-yara](https://github.com/polymorf/findcrypt-yara) ⭐ 1,732 | 🐛 10 | 🌐 Python | 📅 2024-11-19 使用Yara规则查找加密常量
  * 重复区段: [IDA->插件->加密解密](#06d2caabef97cf663bd29af2b1fe270c) |

### <a id="5e91b280aab7f242cbc37d64ddbff82f"></a>IDB操作

* \[**316**星]\[6m] \[Py] [williballenthin/python-idb](https://github.com/williballenthin/python-idb) ⚠️ Archived idb 文件解析和分析工具

### <a id="206ca17fc949b8e0ae62731d9bb244cb"></a>协作逆向&&多人操作相同IDB文件

* \[**508**星]\[11m] \[Py] [idarlingteam/idarling](https://github.com/IDArlingTeam/IDArling) ⚠️ Archived 多人协作插件
* \[**258**星]\[1y] \[C++] [dga-mi-ssi/yaco](https://github.com/dga-mi-ssi/yaco) ⭐ 324 | 🐛 13 | 🌐 C++ | 📅 2019-08-05 利用Git版本控制，同步多人对相同二进制文件的修改

### <a id="f7d311685152ac005cfce5753c006e4b"></a>与调试器同步&&通信&&交互

* \[**471**星]\[13d] \[C] [bootleg/ret-sync](https://github.com/bootleg/ret-sync) ⭐ 2,370 | 🐛 31 | 🌐 C | 📅 2026-02-15 在反汇编工具和调试器之间同步调试会话
  * [GDB插件](https://github.com/bootleg/ret-sync/tree/master/ext_gdb) ⭐ 2,370 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [Ghidra插件](https://github.com/bootleg/ret-sync/tree/master/ext_ghidra) ⭐ 2,370 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [IDA插件](https://github.com/bootleg/ret-sync/tree/master/ext_ida) ⭐ 2,370 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [LLDB](https://github.com/bootleg/ret-sync/tree/master/ext_lldb) ⭐ 2,370 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [OD](https://github.com/bootleg/ret-sync/tree/master/ext_olly1) ⭐ 2,370 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [OD2](https://github.com/bootleg/ret-sync/tree/master/ext_olly2) ⭐ 2,370 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [WinDgb](https://github.com/bootleg/ret-sync/tree/master/ext_windbg/sync) ⭐ 2,370 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [x64dbg](https://github.com/bootleg/ret-sync/tree/master/ext_x64dbg) ⭐ 2,370 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * 重复区段: [x64dbg->插件->新添加的](#da5688c7823802e734c39b539aa39df7) |
* \[**292**星]\[11m] \[C] [a1ext/labeless](https://github.com/a1ext/labeless) ⭐ 585 | 🐛 21 | 🌐 C++ | 📅 2026-02-23 在IDA和调试器之间无缝同步Label/注释等
  ...
  * [OD](https://github.com/a1ext/labeless/tree/master/labeless_olly) ⭐ 585 | 🐛 21 | 🌐 C++ | 📅 2026-02-23
  * [OD2](https://github.com/a1ext/labeless/tree/master/labeless_olly2) ⭐ 585 | 🐛 21 | 🌐 C++ | 📅 2026-02-23
  * [x64dbg](https://github.com/a1ext/labeless/tree/master/labeless_x64dbg) ⭐ 585 | 🐛 21 | 🌐 C++ | 📅 2026-02-23
...
* \[**299**星]\[4m] \[Py] [cisco-talos/ghida](https://github.com/cisco-talos/ghida) ⭐ 816 | 🐛 13 | 🌐 Python | 📅 2021-02-19 在IDA中集成Ghidra反编译器
  * 重复区段: [Ghidra->插件->与其他工具交互->IDA](#d832a81018c188bf585fcefa3ae23062) |
* \[**238**星]\[9m] \[Py] [daenerys-sre/source](https://github.com/daenerys-sre/source) ⭐ 307 | 🐛 0 | 🌐 Python | 📅 2019-04-01 使IDA和Ghidra脚本通用, 无需修改
  * 重复区段: [Ghidra->插件->与其他工具交互->IDA](#d832a81018c188bf585fcefa3ae23062) |

#### <a id="11139e7d6db4c1cef22718868f29fe12"></a>BinNavi

* \[**382**星]\[26d] \[C++] [google/binexport](https://github.com/google/binexport) ⭐ 1,202 | 🐛 42 | 🌐 C++ | 📅 2026-08-05 将反汇编以Protocol Buffer的形式导出为PostgreSQL数据库, 导入到BinNavi中使用
...
* \[**205**星]\[1y] \[Py] [fireeye/idawasm](https://github.com/fireeye/idawasm) ⚠️ Archived WebAssembly的加载器和解析器

#### <a id="1b17ac638aaa09852966306760fda46b"></a>GoLang

* \[**376**星]\[9m] \[Py] [sibears/idagolanghelper](https://github.com/sibears/idagolanghelper) ⭐ 1,090 | 🐛 16 | 🌐 Python | 📅 2023-12-19 解析Go语言编译的二进制文件中的GoLang类型信息
* \[**297**星]\[2m] \[Py] [strazzere/golang\_loader\_assist](https://github.com/strazzere/golang_loader_assist) ⭐ 660 | 🐛 1 | 🌐 Python | 📅 2020-06-22 辅助Go逆向
...
* \[**218**星]\[1y] \[Py] [nccgroup/driverbuddy](https://github.com/nccgroup/driverbuddy) ⭐ 382 | 🐛 4 | 🌐 Python | 📅 2020-01-08 辅助逆向Windows内核驱动
...
* \[**720**星]\[15d] \[Py] [idapython/src](https://github.com/idapython/src) ⚠️ Archived IDAPython源码
* \[**373**星]\[3m] \[Py] [tmr232/sark](https://github.com/tmr232/sark) ⭐ 672 | 🐛 15 | 🌐 Python | 📅 2025-02-22 IDAPython的高级抽象

#### <a id="c42137cf98d6042372b1fd43c3635135"></a>清单

* \[**258**星]\[28d] \[Py] [inforion/idapython-cheatsheet](https://github.com/inforion/idapython-cheatsheet) ⭐ 688 | 🐛 2 | 🌐 Python | 📅 2023-11-02 Scripts and cheatsheets for IDAPython
...
* \[**282**星]\[2m] \[Py] [fireeye/flare-emu](https://github.com/fireeye/flare-emu) ⭐ 958 | 🐛 7 | 🌐 Python | 📅 2025-08-14 结合Unicorn引擎, 简化模拟脚本的编写
...
* \[**269**星]\[1m] \[Py] [eset/ipyida](https://github.com/eset/ipyida) ⭐ 852 | 🐛 7 | 🌐 Python | 📅 2026-06-19 集成IPython控制台
...
* \[**943**星]\[1y] \[Py] [gaasedelen/lighthouse](https://github.com/gaasedelen/lighthouse) ⭐ 2,572 | 🐛 34 | 🌐 Python | 📅 2026-02-14 从DBI中收集代码覆盖情况，在IDA/Binja中映射、浏览、查看
  ...
  * [coverage-frida](https://github.com/gaasedelen/lighthouse/blob/master/coverage/frida/README.md) ⭐ 2,572 | 🐛 34 | 🌐 Python | 📅 2026-02-14 使用Frida收集信息
  * [coverage-pin](https://github.com/gaasedelen/lighthouse/blob/master/coverage/pin/README.md) ⭐ 2,572 | 🐛 34 | 🌐 Python | 📅 2026-02-14 使用Pin收集覆盖信息
  * [插件](https://github.com/gaasedelen/lighthouse/blob/master/plugin/lighthouse_plugin.py) ⭐ 2,572 | 🐛 34 | 🌐 Python | 📅 2026-02-14 支持IDA和BinNinja
...
* \[**386**星]\[5m] \[Py] [ynvb/die](https://github.com/ynvb/die) ⭐ 475 | 🐛 16 | 🌐 Python | 📅 2022-03-02 使用IDA调试器收集动态运行信息, 辅助静态分析
...
* \[**1672**星]\[7m] \[C++] [yegord/snowman](https://github.com/yegord/snowman) ⚠️ Archived Snowman反编译器，支持x86, AMD64, ARM。有独立的GUI工具、命令行工具、IDA/Radare2/x64dbg插件，也可以作为库使用
  ...
  * [snowman](https://github.com/yegord/snowman/tree/master/src/snowman) ⚠️ Archived QT界面
  ...
  * 重复区段: [x64dbg->插件->新添加的](#da5688c7823802e734c39b539aa39df7) |
* \[**418**星]\[3m] \[C++] [avast/retdec-idaplugin](https://github.com/avast/retdec-idaplugin) ⭐ 799 | 🐛 14 | 🌐 C++ | 📅 2025-02-03 retdec 的 IDA 插件
...
* \[**1365**星]\[3m] \[Py] [fireeye/flare-floss](https://github.com/fireeye/flare-floss) ⭐ 4,119 | 🐛 121 | 🌐 Python | 📅 2026-08-11 自动从恶意代码中提取反混淆后的字符串
  * [floss](https://github.com/fireeye/flare-floss/tree/master/floss) ⭐ 4,119 | 🐛 121 | 🌐 Python | 📅 2026-08-11
  * [IDA插件](https://github.com/fireeye/flare-floss/blob/master/scripts/idaplugin.py) ⭐ 4,119 | 🐛 121 | 🌐 Python | 📅 2026-08-11
  * 重复区段: [IDA->插件->字符串](#9dcc6c7dd980bec1f92d0cc9a2209a24) |
* \[**304**星]\[4m] \[C++] [rolfrolles/hexraysdeob](https://github.com/rolfrolles/hexraysdeob) ⭐ 804 | 🐛 1 | 🌐 C++ | 📅 2021-02-22 利用Hex-Rays microcode API破解编译器级别的混淆
...
* \[**372**星]\[3m] \[Py] [l4ys/lazyida](https://github.com/l4ys/lazyida) ⭐ 1,440 | 🐛 1 | 🌐 Python | 📅 2026-01-31 若干快速访问功能, 扫描字符串格式化漏洞
...
* \[**329**星]\[4m] \[Py] [pfalcon/scratchabit](https://github.com/pfalcon/scratchabit) ⭐ 413 | 🐛 29 | 🌐 Python | 📅 2020-11-25 交互式反汇编工具, 有与IDAPython兼容的插件API

#### <a id="03fac5b3abdbd56974894a261ce4e25f"></a>显示增强

* \[**208**星]\[1m] \[Py] [patois/idacyber](https://github.com/patois/idacyber) ⭐ 295 | 🐛 0 | 🌐 Python | 📅 2022-12-06 交互式数据可视化插件

#### <a id="3b1dba00630ce81cba525eea8fcdae08"></a>图形&&图像

* \[**2569**星]\[6m] \[Java] [google/binnavi](https://github.com/google/binnavi) ⚠️ Archived 二进制分析IDE, 对反汇编代码的控制流程图和调用图进行探查/导航/编辑/注释.(IDA插件的作用是导出反汇编)
...
* \[**504**星]\[20d] \[Py] [alexhude/uemu](https://github.com/alexhude/uemu) ⭐ 1,236 | 🐛 5 | 🌐 Python | 📅 2024-08-13 基于Unicorn的模拟器插件
* \[**282**星]\[2m] \[Py] [fireeye/flare-emu](https://github.com/fireeye/flare-emu) ⭐ 958 | 🐛 7 | 🌐 Python | 📅 2025-08-14 结合Unicorn引擎, 简化模拟脚本的编写
...
* \[**1542**星]\[28d] \[Py] [lifting-bits/mcsema](https://github.com/lifting-bits/mcsema) ⚠️ Archived 将x86, amd64, aarch64二进制文件转换成LLVM字节码
  * [IDA7插件](https://github.com/lifting-bits/mcsema/tree/master/tools/mcsema_disass/ida7) ⚠️ Archived 用于反汇编二进制文件并生成控制流程图
  * [IDA插件](https://github.com/lifting-bits/mcsema/tree/master/tools/mcsema_disass/ida) ⚠️ Archived 用于反汇编二进制文件并生成控制流程图
  * [Binja插件](https://github.com/lifting-bits/mcsema/tree/master/tools/mcsema_disass/binja) ⚠️ Archived 用于反汇编二进制文件并生成控制流程图
  * [mcsema](https://github.com/lifting-bits/mcsema/tree/master/mcsema) ⚠️ Archived
* \[**421**星]\[1m] \[C] [mcgill-dmas/kam1n0-community](https://github.com/McGill-DMaS/Kam1n0-Community) ⭐ 627 | 🐛 38 | 🌐 C | 📅 2023-03-02 汇编代码管理与分析平台(独立工具+IDA插件)
  * [IDA插件](https://github.com/McGill-DMaS/Kam1n0-Community/tree/master2.x/kam1n0-clients/ida-plugin) ⭐ 627 | 🐛 38 | 🌐 C | 📅 2023-03-02
  * [kam1n0](https://github.com/McGill-DMaS/Kam1n0-Community/tree/master2.x/kam1n0) ⭐ 627 | 🐛 38 | 🌐 C | 📅 2023-03-02
...
* \[**492**星]\[7m] \[Py] [danigargu/heap-viewer](https://github.com/danigargu/heap-viewer) ⭐ 773 | 🐛 6 | 🌐 Python | 📅 2022-07-25 查看glibc堆, 主要用于漏洞开发

#### <a id="cf2efa7e3edb24975b92d2e26ca825d2"></a>ROP

### <a id="7d557bc3d677d206ef6c5a35ca8b3a14"></a>补丁&\&Patch

* \[**727**星]\[1y] \[Py] [keystone-engine/keypatch](https://github.com/keystone-engine/keypatch) ⭐ 1,863 | 🐛 43 | 🌐 Python | 📅 2024-09-06 汇编/补丁插件, 支持多架构, 基于Keystone引擎
...
* \[**291**星]\[3m] \[Py] [a1ext/auto\_re](https://github.com/a1ext/auto_re) ⭐ 786 | 🐛 2 | 🌐 Python | 📅 2025-12-23 自动化函数重命名
...
* 2019.06 \[hitbsecconf] [#HITB2019AMS D1T2 - fn\_fuzzy: Fast Multiple Binary Diffing Triage With IDA - Takahiro Haruyama](https://www.youtube.com/watch?v=kkvNebE9amY)
...
* 2017.11 \[pediy] [\[原创\]IDAPython脚本分享 - 自动在JNI\_OnLoad下断点](https://bbs.pediy.com/thread-222998.htm)
...
* 2019.05 \[carbonblack] [fn\_fuzzy: Fast Multiple Binary Diffing Triage with IDA](https://www.carbonblack.com/2019/05/09/fn_fuzzy-fast-multiple-binary-diffing-triage-with-ida/)
...
* \[**18649**星]\[10d] \[Java] [nationalsecurityagency/ghidra](https://github.com/nationalsecurityagency/ghidra) ⭐ 72,301 | 🐛 1,912 | 🌐 Java | 📅 2026-08-10 软件逆向框架

### <a id="ce70b8d45be0a3d29705763564623aca"></a>新添加的

* \[**455**星]\[9m] \[YARA] [ghidraninja/ghidra\_scripts](https://github.com/ghidraninja/ghidra_scripts) ⭐ 1,165 | 🐛 13 | 🌐 YARA | 📅 2020-10-07 Ghidra脚本
  * [binwalk](https://github.com/ghidraninja/ghidra_scripts/blob/master/binwalk.py) ⭐ 1,165 | 🐛 13 | 🌐 YARA | 📅 2020-10-07 对当前程序运行BinWalk, 标注找到的内容
  * [yara](https://github.com/ghidraninja/ghidra_scripts/blob/master/yara.py) ⭐ 1,165 | 🐛 13 | 🌐 YARA | 📅 2020-10-07 使用Yara查找加密常量
  * [swift\_demangler](https://github.com/ghidraninja/ghidra_scripts/blob/master/swift_demangler.py) ⭐ 1,165 | 🐛 13 | 🌐 YARA | 📅 2020-10-07 自动demangle Swift函数名
  * [golang\_renamer](https://github.com/ghidraninja/ghidra_scripts/blob/master/golang_renamer.py) ⭐ 1,165 | 🐛 13 | 🌐 YARA | 📅 2020-10-07 恢复stripped Go二进制文件的函数名
* \[**204**星]\[8m] \[Java] [rolfrolles/ghidrapal](https://github.com/rolfrolles/ghidrapal) ⭐ 348 | 🐛 8 | 🌐 Java | 📅 2023-06-28 Ghidra 程序分析库(无文档)
...
* 2019.04 \[X0x6d696368] [ghidra\_scripts: GoogleSearch.py (to lookup function names via Google)](https://www.youtube.com/watch?v=BMmNg35Cjqo)
* 2019.04 \[X0x6d696368] [ghidra\_scripts: SimpleStackStrings.py (to reassemble "stack strings")](https://www.youtube.com/watch?v=K_2khlMATew)
* 2019.04 \[X0x6d696368] [ghidra\_scripts: colorCallGraphCallsTo.py (using SetBackroundColor and traversing the call graph)](https://www.youtube.com/watch?v=SHNO1ZrIQB8)
...
* 2019.04 \[X0x6d696368] [ghidra\_scripts: RC4Decryptor.py](https://www.youtube.com/watch?v=kXaHrPyZtGs)
...
* \[**34576**星]\[1m] \[C++] [x64dbg/x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,151 | 🐛 576 | 🌐 C++ | 📅 2026-08-09 Windows平台x32/x64调试器
...
* \[**1341**星]\[1m] \[C] [x64dbg/x64dbgpy](https://github.com/x64dbg/x64dbgpy) ⭐ 1,503 | 🐛 28 | 🌐 C | 📅 2023-04-05 Automating x64dbg using Python, Snapshots:
...
* 2018.01 \[kienbigmummy] [OllyDbg\_tut32](https://medium.com/p/345972799c44)
...
* \[**230**星]\[9m] \[C++] [microsoft/windbg-samples](https://github.com/microsoft/windbg-samples) ⭐ 821 | 🐛 6 | 🌐 C++ | 📅 2026-06-30 Sample extensions, scripts, and API uses for WinDbg.
* \[**279**星]\[1m] \[Py] [hugsy/defcon\_27\_windbg\_workshop](https://github.com/hugsy/defcon_27_windbg_workshop) ⭐ 747 | 🐛 0 | 🌐 Python | 📅 2024-11-01 DEFCON 27 workshop - Modern Debugging with WinDbg Preview
* \[**564**星]\[6m] \[C#] [fremag/memoscope.net](https://github.com/fremag/memoscope.net) ⭐ 710 | 🐛 8 | 🌐 C# | 📅 2020-06-25 Dump and analyze .Net applications memory ( a gui for WinDbg and ClrMd )
...
* \[**5195**星]\[19d] \[Py] [mobsf/mobile-security-framework-mobsf](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,590 | 🐛 19 | 🌐 JavaScript | 📅 2026-08-10 Mobile Security Framework (MobSF) is an automated, all-in-one mobile application (Android/iOS/Windows) pen-testing, malware analysis and security assessment framework capable of performing static and dynamic analysis.
* \[**5084**星]\[15d] \[HTML] [owasp/owasp-mstg](https://github.com/owasp/owasp-mstg) ⭐ 13,108 | 🐛 227 | 🌐 Python | 📅 2026-08-03 关于移动App安全开发、测试和逆向的相近手册
* \[**4306**星]\[15d] \[Shell] [ashishb/android-security-awesome](https://github.com/ashishb/android-security-awesome) ⭐ 9,603 | 🐛 2 | 🌐 Makefile | 📅 2026-08-10 A collection of android security related resources
* \[**2051**星]\[21d] \[Py] [sensepost/objection](https://github.com/sensepost/objection) ⭐ 9,313 | 🐛 55 | 🌐 Python | 📅 2026-07-23 runtimemobile exploration
...
* \[**820**星]\[11d] [proxymanapp/proxyman](https://github.com/proxymanapp/proxyman) ⭐ 6,937 | 🐛 1,862 | 📅 2026-08-12 Modern and Delightful HTTP Debugging Proxy for macOS, iOS and Android
* \[**4882**星]\[24d] \[Java] [guardianproject/haven](https://github.com/guardianproject/haven) ⭐ 6,809 | 🐛 149 | 🌐 Java | 📅 2022-10-26 通过Android应用和设备上的传感器保护自己的个人空间和财产而又不损害
* \[**4776**星]\[12d] \[C++] [facebook/redex](https://github.com/facebook/redex) ⭐ 6,299 | 🐛 72 | 🌐 C++ | 📅 2026-08-13 Android App字节码优化器
* \[**1925**星]\[7m] \[Java] [fuzion24/justtrustme](https://github.com/fuzion24/justtrustme) ⭐ 5,357 | 🐛 22 | 🌐 Java | 📅 2024-09-02 An xposed module that disables SSL certificate checking for the purposes of auditing an app with cert pinning
* \[**443**星]\[1m] \[TS] [shroudedcode/apk-mitm](https://github.com/shroudedcode/apk-mitm) ⭐ 5,079 | 🐛 83 | 🌐 TypeScript | 📅 2024-07-24
* \[**2011**星]\[8m] \[Py] [fsecurelabs/drozer](https://github.com/FSecureLABS/drozer) ⭐ 4,590 | 🐛 9 | 🌐 Python | 📅 2026-04-08 The Leading Security Assessment Framework for Android.
* \[**2314**星]\[1y] \[Java] [csploit/android](https://github.com/csploit/android) ⭐ 3,643 | 🐛 396 | 🌐 Java | 📅 2024-04-27 cSploit - The most complete and advanced IT security professional toolkit on Android.
* \[**431**星]\[13d] \[C] [guardianproject/orbot](https://github.com/guardianproject/orbot) ⭐ 3,467 | 🐛 89 | 🌐 Kotlin | 📅 2026-08-07 The Github home of Orbot: Tor on Android (Also available on gitlab!)
* \[**2120**星]\[9m] \[Py] [linkedin/qark](https://github.com/linkedin/qark) ⭐ 3,378 | 🐛 79 | 🌐 Python | 📅 2024-01-16 查找Android App的漏洞, 支持源码或APK文件
* \[**2095**星]\[10m] [jermic/android-crack-tool](https://github.com/jermic/android-crack-tool) ⭐ 2,942 | 🐛 15 | 📅 2022-06-23
* \[**1976**星]\[9d] \[Java] [kyson/androidgodeye](https://github.com/kyson/androidgodeye) ⭐ 2,638 | 🐛 17 | 🌐 Java | 📅 2023-01-26 AndroidGodEye:A performance monitor tool , like "Android Studio profiler" for Android , you can easily monitor the performance of your app real time in pc browser
...
* \[**1235**星]\[2m] \[Java] [find-sec-bugs/find-sec-bugs](https://github.com/find-sec-bugs/find-sec-bugs) ⭐ 2,436 | 🐛 115 | 🌐 Java | 📅 2026-03-26 The SpotBugs plugin for security audits of Java web applications and Android applications. (Also work with Kotlin, Groovy and Scala projects)
* \[**559**星]\[14d] \[Shell] [owasp/owasp-masvs](https://github.com/owasp/owasp-masvs) ⭐ 2,426 | 🐛 3 | 🌐 Python | 📅 2025-12-22 OWASP 移动App安全标准
* \[**426**星]\[19d] \[Py] [thehackingsage/hacktronian](https://github.com/thehackingsage/hacktronian) ⭐ 2,189 | 🐛 32 | 🌐 Python | 📅 2023-11-18 All in One Hacking Tool for Linux & Android
* \[**885**星]\[2m] \[C] [504ensicslabs/lime](https://github.com/504ensicslabs/lime) ⭐ 2,027 | 🐛 35 | 🌐 C | 📅 2026-04-05 LiME (formerly DMD) is a Loadable Kernel Module (LKM), which allows the acquisition of volatile memory from Linux and Linux-based devices, such as those powered by Android. The tool supports acquiring memory either to the file system of the device or over the network. LiME is unique in that it is the first tool that allows full memory captures f…
* \[**518**星]\[4m] \[Java] [megatronking/stringfog](https://github.com/megatronking/stringfog) ⭐ 2,016 | 🐛 44 | 🌐 Java | 📅 2024-07-09 一款自动对字节码中的字符串进行加密Android插件工具
* \[**358**星]\[5m] [b3nac/android-reports-and-resources](https://github.com/b3nac/android-reports-and-resources) ⭐ 1,702 | 🐛 0 | 📅 2025-09-10 A big list of Android Hackerone disclosed reports and other resources.
* \[**546**星]\[2m] [nordicsemiconductor/android-nrf-connect](https://github.com/nordicsemiconductor/android-nrf-connect) ⭐ 1,674 | 🐛 56 | 📅 2025-08-28 Documentation and issue tracker for nRF Connect for Android.
...
* \[**409**星]\[3m] \[CSS] [angea/pocorgtfo](https://github.com/angea/pocorgtfo) ⭐ 1,599 | 🐛 1 | 🌐 TeX | 📅 2024-02-11 a "Proof of Concept or GTFO" mirror with extra article index, direct links and clean PDFs.
* \[**265**星]\[11d] \[Py] [den4uk/andriller](https://github.com/den4uk/andriller) ⭐ 1,594 | 🐛 11 | 🌐 Python | 📅 2022-06-27 a collection of forensic tools for smartphones
* \[**1208**星]\[4m] \[Java] [javiersantos/piracychecker](https://github.com/javiersantos/piracychecker) ⭐ 1,570 | 🐛 25 | 🌐 Java | 📅 2026-06-04 An Android library that prevents your app from being pirated / cracked using Google Play Licensing (LVL), APK signature protection and more. API 14+ required.
* \[**225**星]\[3m] \[Java] [virb3/trustmealready](https://github.com/virb3/trustmealready) ⚠️ Archived Disable SSL verification and pinning on Android, system-wide
* \[**527**星]\[4m] \[JS] [wooyundota/droidsslunpinning](https://github.com/wooyundota/droidsslunpinning) ⭐ 1,506 | 🐛 4 | 🌐 JavaScript | 📅 2020-04-07 Android certificate pinning disable tools
* \[**1241**星]\[3m] \[Java] [whataa/pandora](https://github.com/whataa/pandora) ⭐ 1,495 | 🐛 13 | 🌐 Java | 📅 2023-11-01 an android library for debugging what we care about directly in app.
* \[**511**星]\[9d] \[Java] [happylishang/cacheemulatorchecker](https://github.com/happylishang/cacheemulatorchecker) ⭐ 1,491 | 🐛 36 | 🌐 Java | 📅 2023-12-13 Android模拟器检测，检测Android模拟器 ，获取相对真实的IMEI AndroidId 序列号 MAC地址等，作为DeviceID，应对防刷需求等
* \[**769**星]\[1y] \[C] [ele7enxxh/android-inline-hook](https://github.com/ele7enxxh/android-inline-hook) ⭐ 1,400 | 🐛 15 | 🌐 C | 📅 2020-06-23 thumb16 thumb32 arm32 inlineHook in Android
* \[**379**星]\[6m] \[Makefile] [crifan/android\_app\_security\_crack](https://github.com/crifan/android_app_security_crack) ⭐ 1,311 | 🐛 4 | 🌐 Makefile | 📅 2024-10-07 安卓应用的安全和破解
* \[**267**星]\[4m] \[Py] [amimo/dcc](https://github.com/amimo/dcc) ⭐ 1,295 | 🐛 26 | 🌐 Python | 📅 2024-02-07 DCC (Dex-to-C Compiler) is method-based aot compiler that can translate DEX code to C code.
* \[**800**星]\[3m] [sh4hin/androl4b](https://github.com/sh4hin/androl4b) ⭐ 1,167 | 🐛 5 | 📅 2023-05-31 用于评估Android应用程序，逆向工程和恶意软件分析的虚拟机
* \[**668**星]\[2m] [doridori/android-security-reference](https://github.com/doridori/android-security-reference) ⭐ 992 | 🐛 5 | 📅 2025-03-24 A W\.I.P Android Security Ref
* \[**482**星]\[2m] \[JS] [lyxhh/lxhtoolhttpdecrypt](https://github.com/lyxhh/lxhtoolhttpdecrypt) ⭐ 949 | 🐛 20 | 🌐 JavaScript | 📅 2025-07-12 Simple Android/iOS protocol analysis and utilization tool
* \[**810**星]\[4m] \[Scala] [antox/antox](https://github.com/antox/antox) ⚠️ Archived Android client for Project Tox - Secure Peer to Peer Messaging
* \[**608**星]\[7m] \[JS] [vincentcox/stacoan](https://github.com/vincentcox/stacoan) ⭐ 868 | 🐛 11 | 🌐 JavaScript | 📅 2021-04-27 StaCoAn is a crossplatform tool which aids developers, bugbounty hunters and ethical hackers performing static code analysis on mobile applications.
* \[**284**星]\[9m] \[Py] [micropyramid/forex-python](https://github.com/micropyramid/forex-python) ⭐ 709 | 🐛 23 | 🌐 Python | 📅 2025-05-22 Foreign exchange rates, Bitcoin price index and currency conversion using ratesapi.io
* \[**541**星]\[1y] \[Java] [jaredrummler/apkparser](https://github.com/jaredrummler/apkparser) ⭐ 671 | 🐛 14 | 🌐 Java | 📅 2024-06-24 APK parser for Android
* \[**333**星]\[25d] \[Java] [datatheorem/trustkit-android](https://github.com/datatheorem/trustkit-android) ⭐ 603 | 🐛 25 | 🌐 Java | 📅 2026-04-24 Easy SSL pinning validation and reporting for Android.
* \[**450**星]\[12m] \[Kotlin] [shadowsocks/kcptun-android](https://github.com/shadowsocks/kcptun-android) ⭐ 576 | 🐛 8 | 🌐 Shell | 📅 2023-02-18 kcptun for Android.
...
* \[**408**星]\[1y] \[Java] [testwhat/smaliex](https://github.com/testwhat/smaliex) ⭐ 553 | 🐛 27 | 🌐 Java | 📅 2025-04-27 A wrapper to get de-optimized dex from odex/oat/vdex.
* \[**1213**星]\[2m] \[JS] [megatronking/httpcanary](https://github.com/megatronking/httpcanary) ⭐ 494 | 🐛 5 | 📅 2024-07-03 A powerful capture and injection tool for the Android platform
* \[**208**星]\[26d] \[C] [derrekr/fastboot3ds](https://github.com/derrekr/fastboot3ds) ⭐ 448 | 🐛 9 | 🌐 C | 📅 2022-05-26 A homebrew bootloader for the Nintendo 3DS that is similar to android's fastboot.
* \[**234**星]\[3m] \[C] [grant-h/qu1ckr00t](https://github.com/grant-h/qu1ckr00t) ⭐ 444 | 🐛 6 | 🌐 C | 📅 2020-02-26 A PoC application demonstrating the power of an Android kernel arbitrary R/W.
* \[**229**星]\[8m] \[Java] [jieyushi/luffy](https://github.com/jieyushi/luffy) ⭐ 395 | 🐛 4 | 🌐 Java | 📅 2019-04-24 Android字节码插件，编译期间动态修改代码，改造添加全埋点日志采集功能模块，对常见控件进行监听处理
...
* \[**14557**星]\[13d] \[Java] [tencent/tinker](https://github.com/tencent/tinker) ⭐ 17,657 | 🐛 571 | 🌐 Java | 📅 2026-08-12 Tinker is a hot-fix solution library for Android, it supports dex, library and resources update without reinstall apk.
* \[**3462**星]\[27d] \[Java] [meituan-dianping/robust](https://github.com/meituan-dianping/robust) ⭐ 4,455 | 🐛 163 | 🌐 Java | 📅 2022-04-27 Robust is an Android HotFix solution with high compatibility and high stability. Robust can fix bugs immediately without a reboot.
...
* \[**12285**星]\[11d] \[Java] [signalapp/signal-android](https://github.com/signalapp/Signal-Android) ⭐ 29,190 | 🐛 478 | 🌐 Kotlin | 📅 2026-08-13 A private messenger for Android.

### <a id="7f353b27e45b5de6b0e6ac472b02cbf1"></a>Xposed

* \[**8756**星]\[2m] \[Java] [android-hacker/virtualxposed](https://github.com/android-hacker/virtualxposed) ⭐ 16,047 | 🐛 161 | 🌐 Java | 📅 2024-03-08 A simple app to use Xposed without root, unlock the bootloader or modify system image, etc.
* \[**2034**星]\[12d] \[Java] [elderdrivers/edxposed](https://github.com/elderdrivers/edxposed) ⭐ 5,664 | 🐛 55 | 🌐 Java | 📅 2022-04-12 Elder driver Xposed Framework.
* \[**1655**星]\[2m] \[Java] [tiann/epic](https://github.com/tiann/epic) ⭐ 4,558 | 🐛 18 | 🌐 Java | 📅 2023-07-22 Dynamic java method AOP hook for Android(continution of Dexposed on ART), Supporting 4.0\~10.0
* \[**1726**星]\[1y] \[Java] [ac-pm/inspeckage](https://github.com/ac-pm/inspeckage) ⭐ 2,978 | 🐛 59 | 🌐 Java | 📅 2020-09-22 Android Package Inspector - dynamic analysis with api hooks, start unexported activities and more. (Xposed Module)
* \[**669**星]\[12d] \[Java] [ganyao114/sandhook](https://github.com/ganyao114/sandhook) ⭐ 2,229 | 🐛 46 | 🌐 Java | 📅 2023-01-19 Android ART Hook/Native Inline Hook/Single Instruction Hook - support 4.4 - 10.0 32/64 bit - Xposed API Compat
* \[**1296**星]\[2m] \[Java] [android-hacker/exposed](https://github.com/android-hacker/exposed) ⭐ 1,555 | 🐛 5 | 🌐 Java | 📅 2021-12-01 A library to use Xposed without root or recovery(or modify system image etc..).
* \[**309**星]\[13d] \[Java] [ganyao114/sandvxposed](https://github.com/ganyao114/sandvxposed) ⭐ 1,055 | 🐛 45 | 🌐 Java | 📅 2021-11-18 Xposed environment without root (OS 5.0 - 10.0)
* \[**790**星]\[8m] \[Java] [blankeer/mdwechat](https://github.com/blankeer/mdwechat) ⭐ 961 | 🐛 38 | 🌐 Java | 📅 2019-05-04 一个能让微信 Material Design 化的 Xposed 模块
* \[**309**星]\[1m] [bigsinger/androididchanger](https://github.com/bigsinger/androididchanger) ⭐ 622 | 🐛 28 | 📅 2020-06-10 Xposed Module for Changing Android Device Info
...
* \[**1465**星]\[3m] \[C++] [vaibhavpandeyvpz/apkstudio](https://github.com/vaibhavpandeyvpz/apkstudio) ⭐ 4,601 | 🐛 3 | 🌐 C++ | 📅 2026-01-05 Open-source, cross platform Qt based IDE for reverse-engineering Android application packages.
* \[**1793**星]\[8m] \[C++] [wrbug/dumpdex](https://github.com/wrbug/dumpdex) ⭐ 3,153 | 🐛 38 | 🌐 C++ | 📅 2020-05-15 Android脱壳
* \[**366**星]\[3m] \[Java] [patrickfav/uber-apk-signer](https://github.com/patrickfav/uber-apk-signer) ⭐ 2,705 | 🐛 11 | 🌐 Java | 📅 2023-10-30 A cli tool that helps signing and zip aligning single or multiple Android application packages (APKs) with either debug or provided release certificates. It supports v1, v2 and v3 Android signing scheme has an embedded debug keystore and auto verifies after signing.
* \[**712**星]\[2m] \[YARA] [rednaga/apkid](https://github.com/rednaga/apkid) ⭐ 2,553 | 🐛 84 | 🌐 YARA | 📅 2026-07-27 Android Application Identifier for Packers, Protectors, Obfuscators and Oddities - PEiD for Android
* \[**811**星]\[4m] \[C] [strazzere/android-unpacker](https://github.com/strazzere/android-unpacker) ⭐ 1,178 | 🐛 0 | 🌐 C | 📅 2020-01-20 Android Unpacker presented at Defcon 22: Android Hacker Protection Level 0
* \[**322**星]\[6m] \[Shell] [1n3/reverseapk](https://github.com/1n3/reverseapk) ⭐ 866 | 🐛 1 | 🌐 Shell | 📅 2022-12-21 Quickly analyze and reverse engineer Android packages

### <a id="596b6cf8fd36bc4c819335f12850a915"></a>HOOK

* \[**1494**星]\[9d] \[C++] [jmpews/dobby](https://github.com/jmpews/Dobby) ⭐ 4,806 | 🐛 98 | 🌐 C++ | 📅 2025-01-26 a lightweight, multi-platform, multi-architecture hook framework.
* \[**1500**星]\[27d] \[C] [iqiyi/xhook](https://github.com/iqiyi/xhook) ⭐ 4,345 | 🐛 44 | 🌐 C | 📅 2025-06-27 a PLT (Procedure Linkage Table) hook library for Android native ELF
* \[**804**星]\[25d] \[C++] [aslody/whale](https://github.com/aslody/whale) ⭐ 1,668 | 🐛 50 | 🌐 C++ | 📅 2020-12-13 Hook Framework for Android/IOS/Linux/MacOS
* \[**530**星]\[7m] \[Java] [aslody/andhook](https://github.com/asLody/AndHook) ⭐ 782 | 🐛 29 | 🌐 Java | 📅 2019-05-30 Android dynamic instrumentation framework
* \[**361**星]\[8m] \[C] [turing-technician/fasthook](https://github.com/turing-technician/fasthook) ⭐ 586 | 🐛 16 | 🌐 C | 📅 2019-05-15 Android ART Hook

### <a id="5afa336e229e4c38ad378644c484734a"></a>Emulator&&模拟器

* \[**532**星]\[7m] \[Java] [limboemu/limbo](https://github.com/limboemu/limbo) ⭐ 3,388 | 🐛 54 | 🌐 Java | 📅 2024-08-18 Limbo is a QEMU-based emulator for Android. It currently supports PC & ARM emulation for Intel x86 and ARM architecture. See our wiki
* \[**1492**星]\[1y] \[C++] [f1xpl/openauto](https://github.com/f1xpl/openauto) ⭐ 2,904 | 🐛 37 | 🌐 C++ | 📅 2024-12-12 AndroidAuto headunit emulator
* \[**471**星]\[3m] \[Java] [strazzere/anti-emulator](https://github.com/strazzere/anti-emulator) ⭐ 836 | 🐛 4 | 🌐 Java | 📅 2021-01-22 Android Anti-Emulator

### <a id="0a668d220ce74e11ed2738c4e3ae3c9e"></a>IDA

### <a id="bb9f8e636857320abf0502c19af6c763"></a>Debug&&调试

* \[**10794**星]\[1m] \[Java] [konloch/bytecode-viewer](https://github.com/konloch/bytecode-viewer) ⭐ 15,592 | 🐛 103 | 🌐 Java | 📅 2026-07-17 A Java 8+ Jar & Android APK Reverse Engineering Suite (Decompiler, Editor, Debugger & More)
* \[**6762**星]\[10m] \[Java] [amitshekhariitbhu/android-debug-database](https://github.com/amitshekhariitbhu/android-debug-database) ⭐ 8,675 | 🐛 83 | 🌐 Java | 📅 2026-02-05 A library for debugging android databases and shared preferences - Make Debugging Great Again

### <a id="f975a85510f714ec3cc2551e868e75b8"></a>Malware&&恶意代码

* \[**429**星]\[4m] \[Shell] [ashishb/android-malware](https://github.com/ashishb/android-malware) ⭐ 1,218 | 🐛 0 | 🌐 Shell | 📅 2025-12-31 Collection of android malware samples
* \[**347**星]\[3m] \[Java] [droidefense/engine](https://github.com/droidefense/engine) ⭐ 481 | 🐛 27 | 🌐 Java | 📅 2022-12-14 Droidefense: Advance Android Malware Analysis Framework

### <a id="1d83ca6d8b02950be10ac8e4b8a2d976"></a>Obfuscate&&混淆

* \[**3078**星]\[2m] \[Java] [calebfenton/simplify](https://github.com/calebfenton/simplify) ⭐ 4,657 | 🐛 32 | 🌐 Java | 📅 2022-04-30 Generic Android Deobfuscator
* \[**294**星]\[4m] \[C] [shadowsocks/simple-obfs-android](https://github.com/shadowsocks/simple-obfs-android) ⭐ 452 | 🐛 6 | 🌐 C | 📅 2026-01-20 A simple obfuscating tool for Android

### <a id="6d2b758b3269bac7d69a2d2c8b45194c"></a>ReverseEngineering

* \[**9285**星]\[1m] \[Java] [ibotpeaches/apktool](https://github.com/ibotpeaches/apktool) ⭐ 25,268 | 🐛 77 | 🌐 Java | 📅 2026-08-11 A tool for reverse engineering Android apk files
* \[**2053**星]\[1m] \[Java] [genymobile/gnirehtet](https://github.com/genymobile/gnirehtet) ⭐ 7,833 | 🐛 323 | 🌐 Java | 📅 2024-08-11 Gnirehtet provides reverse tethering for Android
* \[**545**星]\[20d] [maddiestone/androidappre](https://github.com/maddiestone/androidappre) ⭐ 1,555 | 🐛 5 | 📅 2024-04-10 Android App Reverse Engineering Workshop
...
* \[**267**星]\[10m] \[Dockerfile] [cryptax/androidre](https://github.com/cryptax/androidre) ⭐ 606 | 🐛 1 | 🌐 Reason | 📅 2026-05-03 用于Android 逆向的 Docker 容器
* \[**246**星]\[28d] \[C++] [strazzere/android-scripts](https://github.com/strazzere/android-scripts) ⭐ 424 | 🐛 0 | 🌐 C++ | 📅 2020-05-03 Android逆向脚本收集
...
* \[**2140**星]\[2m] \[Py] [jonathansalwan/ropgadget](https://github.com/jonathansalwan/ropgadget) ⭐ 4,462 | 🐛 15 | 🌐 Python | 📅 2026-06-24 This tool lets you search your gadgets on your binaries to facilitate your ROP exploitation. ROPgadget supports ELF, PE and Mach-O format on x86, x64, ARM, ARM64, PowerPC, SPARC and MIPS architectures.
* \[**2540**星]\[10m] \[ObjC] [nygard/class-dump](https://github.com/nygard/class-dump) ⭐ 3,585 | 🐛 41 | 🌐 Objective-C | 📅 2022-04-06 Generate Objective-C headers from Mach-O files.
* \[**399**星]\[2m] \[Logos] [limneos/classdump-dyld](https://github.com/limneos/classdump-dyld) ⭐ 619 | 🐛 14 | 🌐 Logos | 📅 2022-01-14 Class-dump any Mach-o file without extracting it from dyld\_shared\_cache
* \[**265**星]\[8m] \[ObjC] [devaukz/macho-kit](https://github.com/devaukz/macho-kit) ⭐ 561 | 🐛 10 | 🌐 Objective-C | 📅 2022-08-10 A C/Objective-C library for parsing Mach-O files.
...
* \[**5451**星]\[3m] \[Py] [axi0mx/ipwndfu](https://github.com/axi0mx/ipwndfu) ⭐ 7,388 | 🐛 168 | 🌐 Python | 📅 2024-02-21 open-source jailbreaking tool for many iOS devices
* \[**4248**星]\[8m] \[ObjC] [alonemonkey/monkeydev](https://github.com/alonemonkey/monkeydev) ⭐ 6,798 | 🐛 186 | 🌐 Objective-C | 📅 2022-07-09 CaptainHook Tweak、Logos Tweak and Command-line Tool、Patch iOS Apps, Without Jailbreak.
* \[**5390**星]\[6m] \[C] [pwn20wndstuff/undecimus](https://github.com/pwn20wndstuff/undecimus) ⭐ 6,620 | 🐛 197 | 🌐 C | 📅 2021-08-01 unc0ver jailbreak for iOS 11.0 - 12.4
* \[**3221**星]\[5m] \[ObjC] [naituw/ipapatch](https://github.com/naituw/ipapatch) ⭐ 5,262 | 🐛 42 | 🌐 Objective-C | 📅 2026-02-27 Patch iOS Apps, The Easy Way, Without Jailbreak.
* \[**1193**星]\[15d] \[JS] [alonemonkey/frida-ios-dump](https://github.com/alonemonkey/frida-ios-dump) ⭐ 3,904 | 🐛 107 | 🌐 JavaScript | 📅 2023-05-03 pull decrypted ipa from jailbreak device
  * 重复区段: [DBI->Frida->工具->新添加的](#54836a155de0c15b56f43634cd9cfecf) |
* \[**287**星]\[7m] \[Shell] [0ki/mikrotik-tools](https://github.com/0ki/mikrotik-tools) ⭐ 592 | 🐛 3 | 🌐 Shell | 📅 2020-02-19 Tools for Mikrotik devices -  universal jailbreak tool
* \[**404**星]\[1y] \[C] [coalfire-research/ios-11.1.2-15b202-jailbreak](https://github.com/coalfire-research/ios-11.1.2-15b202-jailbreak) ⭐ 438 | 🐛 9 | 🌐 C | 📅 2021-04-06 iOS 11.1.2 (15B202) Jailbreak
...
* \[**492**星]\[28d] \[Rust] [vadimcn/vscode-lldb](https://github.com/vadimcn/vscode-lldb) ⭐ 3,274 | 🐛 169 | 🌐 Rust | 📅 2026-06-16 A native debugger extension for VSCode based on LLDB
* \[**784**星]\[3m] \[C++] [nodejs/llnode](https://github.com/nodejs/llnode) ⭐ 1,168 | 🐛 69 | 🌐 C++ | 📅 2024-12-21 An lldb plugin for Node.js and V8, which enables inspection of JavaScript states for insights into Node.js processes and their core dumps.
...
* \[**6203**星]\[3m] \[ObjC] [johnno1962/injectionforxcode](https://github.com/johnno1962/injectionforxcode) ⭐ 6,537 | 🐛 76 | 🌐 Objective-C | 📅 2022-08-04 Runtime Code Injection for Objective-C & Swift
* \[**1409**星]\[1m] \[Swift] [johnno1962/injectioniii](https://github.com/johnno1962/injectioniii) ⭐ 4,637 | 🐛 4 | 🌐 Objective-C | 📅 2026-06-14 Re-write of Injection for Xcode in (mostly) Swift4
* \[**2057**星]\[19d] \[ObjC] [ios-control/ios-deploy](https://github.com/ios-control/ios-deploy) ⭐ 3,637 | 🐛 45 | 🌐 Objective-C | 📅 2024-06-24 Install and debug iPhone apps from the command line, without using Xcode
* \[**1606**星]\[2m] \[Swift] [indragiek/inappviewdebugger](https://github.com/indragiek/inappviewdebugger) ⭐ 1,921 | 🐛 2 | 🌐 Swift | 📅 2024-01-02 A UIView debugger (like Reveal or Xcode) that can be embedded in an app for on-device view debugging
* \[**572**星]\[1m] \[ObjC] [hdb-li/lldebugtool](https://github.com/hdb-li/lldebugtool) ⭐ 743 | 🐛 24 | 🌐 Objective-C | 📅 2024-07-16 LLDebugTool is a debugging tool for developers and testers that can help you analyze and manipulate data in non-xcode situations.
* \[**384**星]\[3m] \[JS] [johnno1962/xprobeplugin](https://github.com/johnno1962/xprobeplugin) ⭐ 400 | 🐛 0 | 🌐 Objective-C++ | 📅 2024-09-24 Live Memory Browser for Apps & Xcode
...
* \[**10966**星]\[10d] \[ObjC] [flipboard/flex](https://github.com/flipboard/flex) ⭐ 14,629 | 🐛 49 | 🌐 Objective-C | 📅 2026-06-11 An in-app debugging and exploration tool for iOS
* \[**4397**星]\[12d] \[Swift] [signalapp/signal-ios](https://github.com/signalapp/Signal-iOS) ⭐ 12,195 | 🐛 140 | 🌐 Swift | 📅 2026-08-12 A private messenger for iOS.
* \[**1215**星]\[16d] \[YARA] [horsicq/detect-it-easy](https://github.com/horsicq/detect-it-easy) ⭐ 11,334 | 🐛 34 | 🌐 JavaScript | 📅 2026-08-11 Program for determining types of files for Windows, Linux and MacOS.
* \[**2733**星]\[26d] \[ObjC] [dantheman827/ios-app-signer](https://github.com/dantheman827/ios-app-signer) ⭐ 6,313 | 🐛 123 | 🌐 Objective-C | 📅 2025-09-01 This is an app for OS X that can (re)sign apps and bundle them into ipa files that are ready to be installed on an iOS device.
* \[**4663**星]\[1m] \[C] [google/ios-webkit-debug-proxy](https://github.com/google/ios-webkit-debug-proxy) ⭐ 6,192 | 🐛 19 | 🌐 C | 📅 2025-07-02 A DevTools proxy (Chrome Remote Debugging Protocol) for iOS devices (Safari Remote Web Inspector).
* \[**5775**星]\[4m] \[ObjC] [square/ponydebugger](https://github.com/square/ponydebugger) ⭐ 5,852 | 🐛 46 | 🌐 Objective-C | 📅 2023-03-18 Remote network and data debugging for your native iOS app using Chrome Developer Tools
* \[**3686**星]\[4m] \[C] [facebook/fishhook](https://github.com/facebook/fishhook) ⭐ 5,424 | 🐛 39 | 🌐 C | 📅 2024-08-01 A library that enables dynamically rebinding symbols in Mach-O binaries running on iOS.
* \[**2867**星]\[12d] \[ObjC] [facebook/idb](https://github.com/facebook/idb) ⭐ 5,271 | 🐛 182 | 🌐 Swift | 📅 2026-08-12 idb is a flexible command line interface for automating iOS simulators and devices
* \[**2753**星]\[1m] \[Makefile] [theos/theos](https://github.com/theos/theos) ⭐ 4,902 | 🐛 73 | 🌐 Makefile | 📅 2026-08-08 A cross-platform suite of tools for building and deploying software for iOS and other platforms.
* \[**3327**星]\[3m] \[Swift] [yagiz/bagel](https://github.com/yagiz/bagel) ⭐ 4,423 | 🐛 37 | 🌐 Swift | 📅 2024-08-20 a little native network debugging tool for iOS
* \[**2708**星]\[2m] \[ObjC] [kjcracks/clutch](https://github.com/kjcracks/clutch) ⭐ 3,821 | 🐛 43 | 🌐 Objective-C | 📅 2024-11-15 Fast iOS executable dumper
...
* \[**840**星]\[9d] \[JS] [cypress-io/cypress-example-recipes](https://github.com/cypress-io/cypress-example-recipes) ⭐ 3,480 | 🐛 18 | 🌐 JavaScript | 📅 2026-07-16 Various recipes for testing common scenarios with Cypress
* \[**1442**星]\[28d] \[ObjC] [nabla-c0d3/ssl-kill-switch2](https://github.com/nabla-c0d3/ssl-kill-switch2) ⭐ 3,308 | 🐛 19 | 🌐 Objective-C | 📅 2023-07-09 Blackbox tool to disable SSL certificate validation - including certificate pinning - within iOS and OS X Apps
...
* \[**1630**星]\[1m] [ivrodriguezca/re-ios-apps](https://github.com/ivrodriguezca/re-ios-apps) ⭐ 2,893 | 🐛 2 | 📅 2024-04-17 A completely free, open source and online course about Reverse Engineering iOS Applications.
* \[**310**星]\[28d] \[Swift] [securing/iossecuritysuite](https://github.com/securing/iossecuritysuite) ⭐ 2,709 | 🐛 7 | 🌐 Swift | 📅 2026-08-05 iOS platform security & anti-tampering Swift library
* \[**1801**星]\[1y] [aozhimin/ios-monitor-platform](https://github.com/aozhimin/ios-monitor-platform) ⭐ 2,622 | 🐛 23 | 📅 2018-10-13
* \[**1683**星]\[2m] \[Swift] [pmusolino/wormholy](https://github.com/pmusolino/wormholy) ⭐ 2,613 | 🐛 11 | 🌐 Swift | 📅 2026-05-23 iOS network debugging, like a wizard 🧙‍♂️
* \[**1642**星]\[7m] \[Objective-C++] [tencent/oomdetector](https://github.com/tencent/oomdetector) ⭐ 2,348 | 🐛 38 | 🌐 Objective-C++ | 📅 2023-02-21 OOMDetector is a memory monitoring component for iOS which provides you with OOM monitoring, memory allocation monitoring, memory leak detection and other functions.
* \[**462**星]\[15d] \[Java] [dsheirer/sdrtrunk](https://github.com/dsheirer/sdrtrunk) ⭐ 2,156 | 🐛 436 | 🌐 Java | 📅 2026-08-01 A cross-platform java application for decoding, monitoring, recording and streaming trunked mobile and related radio protocols using Software Defined Radios (SDR). Website:
* \[**1239**星]\[8d] \[C] [datatheorem/trustkit](https://github.com/datatheorem/trustkit) ⭐ 2,140 | 🐛 34 | 🌐 Objective-C | 📅 2026-08-12 Easy SSL pinning validation and reporting for iOS, macOS, tvOS and watchOS.
* \[**604**星]\[2m] [siguza/ios-resources](https://github.com/siguza/ios-resources) ⭐ 1,961 | 🐛 4 | 📅 2025-05-24 Useful resources for iOS hacking
...
* \[**1299**星]\[6m] \[JS] [feross/spoof](https://github.com/feross/spoof) ⭐ 1,863 | 🐛 14 | 🌐 JavaScript | 📅 2020-11-05 Easily spoof your MAC address in macOS, Windows, & Linux!
* \[**796**星]\[13d] \[Shell] [aqzt/kjyw](https://github.com/aqzt/kjyw) ⭐ 1,863 | 🐛 7 | 🌐 Shell | 📅 2025-07-01 快捷运维，代号kjyw，项目基于shell、python，运维脚本工具库，收集各类运维常用工具脚本，实现快速安装nginx、mysql、php、redis、nagios、运维经常使用的脚本等等...
* \[**1113**星]\[1y] \[ObjC] [neoneggplant/eggshell](https://github.com/neoneggplant/eggshell) ⭐ 1,765 | 🐛 56 | 🌐 Objective-C | 📅 2021-03-25 iOS/macOS/Linux Remote Administration Tool
...
* \[**263**星]\[14d] \[ObjC] [strongbox-password-safe/strongbox](https://github.com/strongbox-password-safe/strongbox) ⭐ 1,451 | 🐛 227 | 🌐 Objective-C | 📅 2026-07-17 A KeePass/Password Safe Client for iOS and OS X
* \[**346**星]\[4m] \[TS] [bacher09/pwgen-for-bios](https://github.com/bacher09/pwgen-for-bios) ⭐ 1,432 | 🐛 181 | 🌐 TypeScript | 📅 2026-02-05 Password generator for BIOS
* \[**907**星]\[4m] \[ObjC] [ptoomey3/keychain-dumper](https://github.com/ptoomey3/keychain-dumper) ⭐ 1,420 | 🐛 19 | 🌐 Objective-C | 📅 2024-08-15 A tool to check which keychain items are available to an attacker once an iOS device has been jailbroken
* \[**396**星]\[4m] [ansjdnakjdnajkd/ios](https://github.com/ansjdnakjdnajkd/ios) ⭐ 1,304 | 🐛 0 | 📅 2023-11-06 iOS渗透测试最有用的工具
...
* \[**662**星]\[1y] \[Py] [deepzec/bad-pdf](https://github.com/deepzec/bad-pdf) ⭐ 1,150 | 🐛 2 | 🌐 Python | 📅 2025-10-20 create malicious PDF file to steal NTLM(NTLMv1/NTLMv2) Hashes from windows machines
* \[**1001**星]\[2m] \[ObjC] [lmirosevic/gbdeviceinfo](https://github.com/lmirosevic/gbdeviceinfo) ⭐ 1,143 | 🐛 2 | 🌐 Objective-C | 📅 2026-01-02 Detects the hardware, software and display of the current iOS or Mac OS X device at runtime.
...
* \[**651**星]\[9m] \[ObjC] [chenxiancai/stcobfuscator](https://github.com/chenxiancai/stcobfuscator) ⭐ 824 | 🐛 28 | 🌐 Objective-C | 📅 2019-03-25 iOS全局自动化 代码混淆 工具！支持cocoapod组件代码一并 混淆，完美避开hardcode方法、静态库方法和系统库方法！
* \[**482**星]\[1y] \[Swift] [icepa/icepa](https://github.com/icepa/icepa) ⭐ 770 | 🐛 1 | 🌐 Swift | 📅 2024-06-02 iOS system-wide VPN based Tor client
* \[**322**星]\[2m] \[ObjC] [auth0/simplekeychain](https://github.com/auth0/simplekeychain) ⭐ 724 | 🐛 5 | 🌐 Swift | 📅 2026-07-22 A Keychain helper for iOS to make it very simple to store/obtain values from iOS Keychain
* \[**471**星]\[8m] \[C++] [everettjf/machoexplorer](https://github.com/everettjf/machoexplorer) ⭐ 632 | 🐛 1 | 🌐 C++ | 📅 2026-06-06 MachO文件查看器，支持Windows和macOS
* \[**238**星]\[4m] \[Swift] [shadowsocksr-live/ishadowsocksr](https://github.com/shadowsocksr-live/ishadowsocksr) ⭐ 603 | 🐛 12 | 🌐 C | 📅 2024-04-29 ShadowsocksR for iOS, come from
* \[**349**星]\[19d] \[C] [jedisct1/swift-sodium](https://github.com/jedisct1/swift-sodium) ⭐ 553 | 🐛 0 | 🌐 C | 📅 2026-05-04 Safe and easy to use crypto for iOS and macOS
* \[**340**星]\[3m] \[C] [trailofbits/cb-multios](https://github.com/trailofbits/cb-multios) ⭐ 540 | 🐛 26 | 🌐 C | 📅 2023-06-29 DARPA Challenges Sets for Linux, Windows, and macOS
...
* \[**371**星]\[18d] \[Shell] [matthewpierson/1033-ota-downgrader](https://github.com/matthewpierson/1033-ota-downgrader) ⭐ 500 | 🐛 43 | 🌐 Shell | 📅 2019-12-13 First ever tool to downgrade ANY iPhone 5s, ANY iPad Air and (almost any) iPad Mini 2 to 10.3.3 with OTA blobs + checkm8!
...
* \[**219**星]\[6m] \[ObjC] [rickyzhang82/tethering](https://github.com/rickyzhang82/tethering) ⭐ 367 | 🐛 0 | 🌐 Objective-C | 📅 2025-08-25 Proxy and DNS Server on iOS
* \[**382**星]\[11m] \[C] [coolstar/electra1131](https://github.com/coolstar/electra1131) ⭐ 366 | 🐛 12 | 🌐 C | 📅 2019-01-21 electra1131: Electra for iOS 11.0 - 11.3.1
* \[**211**星]\[13d] \[TS] [bevry/getmac](https://github.com/bevry/getmac) ⭐ 361 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-12 Get the mac address of the current machine you are on via Node.js
* \[**223**星]\[12m] \[AppleScript] [lifepillar/csvkeychain](https://github.com/lifepillar/csvkeychain) ⚠️ Archived Import/export between Apple Keychain.app and plain CSV file.
* \[**244**星]\[7m] \[JS] [we11cheng/wcshadowrocket](https://github.com/we11cheng/wcshadowrocket) ⭐ 352 | 🐛 9 | 🌐 JavaScript | 📅 2021-05-18 iOS Shadowrocket(砸壳重签,仅供参考,添加节点存在问题)。另一个fq项目potatso源码参见:
* \[**247**星]\[1m] \[C++] [s0uthwest/futurerestore](https://github.com/s0uthwest/futurerestore) ⚠️ Archived iOS upgrade and downgrade tool utilizing SHSH blobs
* \[**239**星]\[1y] \[ObjC] [lmirosevic/gbping](https://github.com/lmirosevic/gbping) ⭐ 276 | 🐛 18 | 🌐 Objective-C | 📅 2019-03-20 Highly accurate ICMP Ping controller for iOS
* \[**478**星]\[15d] [pixelcyber/thor](https://github.com/pixelcyber/thor) ⭐ 50 | 🐛 7 | 📅 2022-09-05 HTTP Sniffer/Capture on iOS for Network Debug & Inspect.
...
* \[**4042**星]\[3m] \[JS] [cuckoosandbox/cuckoo](https://github.com/cuckoosandbox/cuckoo) ⚠️ Archived Cuckoo Sandbox is an automated dynamic malware analysis system
* \[**308**星]\[2m] \[Py] [hatching/vmcloak](https://github.com/hatching/vmcloak) ⭐ 520 | 🐛 65 | 🌐 Python | 📅 2024-05-14 Automated Virtual Machine Generation and Cloaking for Cuckoo Sandbox.
* \[**225**星]\[1y] \[PHP] [cuckoosandbox/monitor](https://github.com/cuckoosandbox/monitor) ⭐ 353 | 🐛 46 | 🌐 PHP | 📅 2024-06-28 The new Cuckoo Monitor.
* \[**238**星]\[7m] \[Py] [cuckoosandbox/community](https://github.com/cuckoosandbox/community) ⭐ 336 | 🐛 134 | 🌐 Python | 📅 2023-02-22 Repository of modules and signatures contributed by the community
* \[**220**星]\[4m] \[Shell] [blacktop/docker-cuckoo](https://github.com/blacktop/docker-cuckoo) ⚠️ Archived Cuckoo Sandbox Dockerfile
* \[**236**星]\[4m] \[Py] [brad-sp/cuckoo-modified](https://github.com/brad-sp/cuckoo-modified) ⭐ 274 | 🐛 48 | 🌐 Python | 📅 2019-09-09 Modified edition of cuckoo
...
* \[**1228**星]\[12d] \[C] [dynamorio/dynamorio](https://github.com/dynamorio/dynamorio) ⭐ 3,132 | 🐛 1,798 | 🌐 C | 📅 2026-08-12 Dynamic Instrumentation Tool Platform
* \[**1388**星]\[12d] \[C] [dynamorio/drmemory](https://github.com/dynamorio/drmemory) ⭐ 2,739 | 🐛 1,047 | 🌐 C | 📅 2025-12-13 Memory Debugger for Windows, Linux, Mac, and Android

#### <a id="ff0abe26a37095f6575195950e0b7f94"></a>新添加的

* \[**1364**星]\[3m] \[C] [googleprojectzero/winafl](https://github.com/googleprojectzero/winafl) ⭐ 2,598 | 🐛 170 | 🌐 C | 📅 2026-03-13 A fork of AFL for fuzzing Windows binaries
...
* \[**299**星]\[2m] \[C] [vusec/vuzzer](https://github.com/vusec/vuzzer) ⭐ 386 | 🐛 8 | 🌐 C | 📅 2019-10-28 depends heavily on a modeified version of DataTracker, which in turn depends on LibDFT pintool.
...
* \[**4516**星]\[13d] \[Makefile] [frida/frida](https://github.com/frida/frida) ⭐ 21,614 | 🐛 1,956 | 🌐 Meson | 📅 2026-08-12 Clone this repo to build Frida

#### <a id="54836a155de0c15b56f43634cd9cfecf"></a>新添加的

* \[**1193**星]\[15d] \[JS] [alonemonkey/frida-ios-dump](https://github.com/alonemonkey/frida-ios-dump) ⭐ 3,904 | 🐛 107 | 🌐 JavaScript | 📅 2023-05-03 pull decrypted ipa from jailbreak device
  * 重复区段: [Apple->越狱->工具](#ff19d5d94315d035bbcb3ef0c348c75b) |
* \[**513**星]\[1m] \[JS] [iddoeldor/frida-snippets](https://github.com/iddoeldor/frida-snippets) ⭐ 2,532 | 🐛 5 | 🌐 JavaScript | 📅 2024-11-29 Hand-crafted Frida examples
...
* \[**422**星]\[1y] \[Py] [dstmath/frida-unpack](https://github.com/dstmath/frida-unpack) ⭐ 1,608 | 🐛 12 | 🌐 Python | 📅 2025-06-11 基于Frida的脱壳工具
* \[**332**星]\[15d] \[JS] [chichou/bagbak](https://github.com/ChiChou/bagbak) ⭐ 1,483 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-24 Yet another frida based iOS dumpdecrypted, works on iOS 13 with checkra1n and supports decrypting app extensions
* \[**559**星]\[1m] \[JS] [nccgroup/house](https://github.com/nccgroup/house) ⭐ 1,465 | 🐛 16 | 🌐 JavaScript | 📅 2021-06-03 运行时手机 App 分析工具包, 带Web GUI
* \[**645**星]\[16d] \[Py] [igio90/dwarf](https://github.com/igio90/dwarf) ⭐ 1,317 | 🐛 5 | 🌐 Python | 📅 2024-05-16 Full featured multi arch/os debugger built on top of PyQt5 and frida
* \[**243**星]\[19d] \[JS] [frenchyeti/dexcalibur](https://github.com/frenchyeti/dexcalibur) ⭐ 1,167 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-11 Dynamic binary instrumentation tool designed for Android application and powered by Frida. It disassembles dex, analyzes it statically, generates hooks, discovers reflected methods, stores intercepted data and does new things from it. Its aim is to be an all-in-one Android reverse engineering platform.
* \[**228**星]\[13d] \[C] [frida/frida-gum](https://github.com/frida/frida-gum) ⭐ 1,002 | 🐛 206 | 🌐 C | 📅 2026-08-12 Low-level code instrumentation library used by frida-core
* \[**420**星]\[13d] \[C] [frida/frida-python](https://github.com/frida/frida-python) ⭐ 868 | 🐛 56 | 🌐 Python | 📅 2026-08-12 Frida Python bindings
* \[**283**星]\[8m] \[Py] [nightbringer21/fridump](https://github.com/nightbringer21/fridump) ⭐ 856 | 🐛 26 | 🌐 Python | 📅 2024-08-07 A universal memory dumper using Frida
* \[**321**星]\[1m] \[C] [frida/frida-core](https://github.com/frida/frida-core) ⭐ 756 | 🐛 146 | 🌐 Vala | 📅 2026-08-12 Frida core library intended for static linking into bindings
...
* \[**584**星]\[1y] \[Java] [federicodotta/brida](https://github.com/federicodotta/brida) ⭐ 1,886 | 🐛 11 | 🌐 Java | 📅 2025-10-30 The new bridge between Burp Suite and Frida!
...
* \[**378**星]\[27d] \[JS] [nowsecure/r2frida](https://github.com/nowsecure/r2frida) ⭐ 1,431 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-12 Radare2 and Frida better together.
...
* \[**578**星]\[1y] \[C++] [qbdi/qbdi](https://github.com/QBDI/QBDI) ⭐ 1,805 | 🐛 19 | 🌐 C++ | 📅 2026-07-24 A Dynamic Binary Instrumentation framework based on LLVM.
...
* \[**14349**星]\[2m] \[Py] [corentinj/real-time-voice-cloning](https://github.com/corentinj/real-time-voice-cloning) ⭐ 60,085 | 🐛 176 | 🌐 Python | 📅 2026-03-09 Clone a voice in 5 seconds to generate arbitrary speech in real-time
* \[**2687**星]\[11d] \[Go] [adguardteam/adguardhome](https://github.com/adguardteam/adguardhome) ⭐ 36,085 | 🐛 1,271 | 🌐 TypeScript | 📅 2026-08-12 Network-wide ads & trackers blocking DNS server
* \[**10378**星]\[11d] \[Go] [goharbor/harbor](https://github.com/goharbor/harbor) ⭐ 29,148 | 🐛 857 | 🌐 Go | 📅 2026-08-13 An open source trusted cloud native registry project that stores, signs, and scans content.
* \[**19766**星]\[3m] \[Jupyter Notebook] [camdavidsonpilon/probabilistic-programming-and-bayesian-methods-for-hackers](https://github.com/camdavidsonpilon/probabilistic-programming-and-bayesian-methods-for-hackers) ⭐ 28,194 | 🐛 203 | 🌐 Jupyter Notebook | 📅 2024-06-25 aka "Bayesian Methods for Hackers": An introduction to Bayesian methods + probabilistic programming with a computation/understanding-first, mathematics-second point of view. All in pure Python ;)
* \[**5420**星]\[12d] \[Py] [mlflow/mlflow](https://github.com/mlflow/mlflow) ⭐ 27,490 | 🐛 2,024 | 🌐 Python | 📅 2026-08-13 Open source platform for the machine learning lifecycle
* \[**11402**星]\[10d] \[Java] [oracle/graal](https://github.com/oracle/graal) ⭐ 21,661 | 🐛 842 | 🌐 Java | 📅 2026-08-12 Run Programs Faster Anywhere
* \[**7020**星]\[14d] \[Go] [nats-io/nats-server](https://github.com/nats-io/nats-server) ⭐ 20,483 | 🐛 544 | 🌐 Go | 📅 2026-08-12 High-Performance server for NATS, the cloud native messaging system.
* \[**5753**星]\[18d] \[Go] [casbin/casbin](https://github.com/casbin/casbin) ⭐ 20,322 | 🐛 42 | 🌐 Go | 📅 2026-08-06 An authorization library that supports access control models like ACL, RBAC, ABAC in Golang
* \[**3608**星]\[9d] \[Pascal] [cheat-engine/cheat-engine](https://github.com/cheat-engine/cheat-engine) ⭐ 18,949 | 🐛 1,306 | 🌐 Pascal | 📅 2025-04-19 Cheat Engine. A development environment focused on modding
* \[**4610**星]\[1y] \[C] [upx/upx](https://github.com/upx/upx) ⭐ 17,770 | 🐛 26 | 🌐 C++ | 📅 2026-08-11 UPX - the Ultimate Packer for eXecutables
* \[**5226**星]\[13d] \[Shell] [denisidoro/navi](https://github.com/denisidoro/navi) ⭐ 17,423 | 🐛 108 | 🌐 Rust | 📅 2026-07-28 An interactive cheatsheet tool for the command-line
* \[**11213**星]\[2m] \[Jupyter Notebook] [selfteaching/the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 16,297 | 🐛 199 | 🌐 Jupyter Notebook | 📅 2026-05-20 One has no future if one couldn't teach themself.
* \[**2815**星]\[20d] \[C] [processhacker/processhacker](https://github.com/processhacker/processhacker) ⭐ 15,623 | 🐛 279 | 🌐 C | 📅 2026-08-12 A free, powerful, multi-purpose tool that helps you monitor system resources, debug software and detect malware.
* \[**3295**星]\[15d] \[JS] [koenkk/zigbee2mqtt](https://github.com/koenkk/zigbee2mqtt) ⭐ 15,496 | 🐛 462 | 🌐 TypeScript | 📅 2026-08-12 Zigbee
* \[**6894**星]\[2m] \[Go] [sqshq/sampler](https://github.com/sqshq/sampler) ⭐ 14,736 | 🐛 62 | 🌐 Go | 📅 2024-02-22 A tool for shell commands execution, visualization and alerting. Configured with a simple YAML file.
* \[**7748**星]\[10d] \[Go] [git-lfs/git-lfs](https://github.com/git-lfs/git-lfs) ⭐ 14,422 | 🐛 479 | 🌐 Go | 📅 2026-08-07 Git extension for versioning large files
* \[**5116**星]\[11d] \[ASP] [hq450/fancyss](https://github.com/hq450/fancyss) ⭐ 13,702 | 🐛 212 | 🌐 Shell | 📅 2026-06-01 fancyss is a project providing tools to across the GFW on asuswrt/merlin based router.
* \[**3129**星]\[13d] \[C] [qemu/qemu](https://github.com/qemu/qemu) ⭐ 13,560 | 🐛 0 | 🌐 C | 📅 2026-08-13 Official QEMU mirror. Please see
* \[**5229**星]\[4m] \[Py] [ytisf/thezoo](https://github.com/ytisf/thezoo) ⭐ 13,289 | 🐛 89 | 🌐 Python | 📅 2026-07-24 A repository of LIVE malwares for your own joy and pleasure. theZoo is a project created to make the possibility of malware analysis open and available to the public.
* \[**2344**星]\[16d] \[C] [tsl0922/ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,189 | 🐛 111 | 🌐 C | 📅 2026-08-12 Share your terminal over the web
* \[**3980**星]\[1m] \[Rust] [svenstaro/genact](https://github.com/svenstaro/genact) ⭐ 12,163 | 🐛 15 | 🌐 Rust | 📅 2026-08-01 a nonsense activity generator
* \[**3505**星]\[16d] \[C] [cyan4973/xxhash](https://github.com/cyan4973/xxhash) ⭐ 11,199 | 🐛 40 | 🌐 C | 📅 2026-07-27 Extremely fast non-cryptographic hash algorithm
* \[**4003**星]\[11d] \[Go] [dexidp/dex](https://github.com/dexidp/dex) ⭐ 11,034 | 🐛 520 | 🌐 Go | 📅 2026-08-10 OpenID Connect Identity (OIDC) and OAuth 2.0 Provider with Pluggable Connectors
* \[**2993**星]\[18d] \[Py] [quantaxis/quantaxis](https://github.com/quantaxis/quantaxis) ⭐ 11,003 | 🐛 239 | 🌐 Python | 📅 2026-02-28 支持任务调度 分布式部署的 股票/期货/自定义市场 数据/回测/模拟/交易/可视化 纯本地PAAS量化解决方案
* \[**3908**星]\[12d] \[C++] [baldurk/renderdoc](https://github.com/baldurk/renderdoc) ⭐ 10,969 | 🐛 51 | 🌐 C++ | 📅 2026-08-11 RenderDoc is a stand-alone graphics debugging tool.
* \[**2053**星]\[24d] \[C#] [mathewsachin/captura](https://github.com/mathewsachin/captura) ⭐ 10,782 | 🐛 116 | 🌐 C# | 📅 2026-05-25 Capture Screen, Audio, Cursor, Mouse Clicks and Keystrokes
* \[**2627**星]\[23d] \[JS] [popcorn-official/popcorn-desktop](https://github.com/popcorn-official/popcorn-desktop) ⭐ 10,631 | 🐛 65 | 🌐 TypeScript | 📅 2026-08-13 Popcorn Time is a multi-platform, free software BitTorrent client that includes an integrated media player. Desktop ( Windows / Mac / Linux ) a Butter-Project Fork
* \[**4597**星]\[12d] \[C++] [mozilla/rr](https://github.com/mozilla/rr) ⭐ 10,618 | 🐛 478 | 🌐 C++ | 📅 2026-08-11 记录与重放App的调试执行过程
* \[**5751**星]\[9m] \[C] [xoreaxeaxeax/movfuscator](https://github.com/xoreaxeaxeax/movfuscator) ⭐ 10,255 | 🐛 25 | 🌐 C | 📅 2024-05-29 C编译器，编译的二进制文件只有1个代码块。
* \[**2718**星]\[3m] \[Py] [drivendata/cookiecutter-data-science](https://github.com/drivendata/cookiecutter-data-science) ⭐ 10,005 | 🐛 34 | 🌐 Python | 📅 2026-08-07 A logical, reasonably standardized, but flexible project structure for doing and sharing data science work.
* \[**4857**星]\[13d] \[Go] [gcla/termshark](https://github.com/gcla/termshark) ⭐ 9,956 | 🐛 50 | 🌐 Go | 📅 2024-04-30 A terminal UI for tshark, inspired by Wireshark
* \[**3289**星]\[15d] \[C] [virustotal/yara](https://github.com/virustotal/yara) ⭐ 9,803 | 🐛 176 | 🌐 C | 📅 2026-07-30 The pattern matching swiss knife
* \[**5876**星]\[3m] \[Gnuplot] [nasa-jpl/open-source-rover](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,569 | 🐛 18 | 🌐 Prolog | 📅 2026-08-13 A build-it-yourself, 6-wheel rover based on the rovers on Mars!
* \[**5717**星]\[28d] \[JS] [swagger-api/swagger-editor](https://github.com/swagger-api/swagger-editor) ⭐ 9,462 | 🐛 41 | 🌐 JavaScript | 📅 2026-08-10 Swagger Editor
* \[**6353**星]\[2m] \[Py] [seatgeek/fuzzywuzzy](https://github.com/seatgeek/fuzzywuzzy) ⚠️ Archived Fuzzy String Matching in Python
* \[**3108**星]\[1m] \[C] [unicorn-engine/unicorn](https://github.com/unicorn-engine/unicorn) ⭐ 9,229 | 🐛 209 | 🌐 C | 📅 2026-07-30 Unicorn CPU emulator framework (ARM, AArch64, M68K, Mips, Sparc, X86)
* \[**3188**星]\[11d] \[C] [meetecho/janus-gateway](https://github.com/meetecho/janus-gateway) ⭐ 9,146 | 🐛 43 | 🌐 C | 📅 2026-07-27 Janus WebRTC Server
* \[**3960**星]\[11d] \[Py] [angr/angr](https://github.com/angr/angr) ⭐ 9,009 | 🐛 696 | 🌐 Python | 📅 2026-08-12 A powerful and user-friendly binary analysis platform!
* \[**3939**星]\[15d] \[C] [aquynh/capstone](https://github.com/aquynh/capstone) ⭐ 8,945 | 🐛 360 | 🌐 C | 📅 2026-08-12 Capstone disassembly/disassembler framework: Core (Arm, Arm64, BPF, EVM, M68K, M680X, MOS65xx, Mips, PPC, RISCV, Sparc, SystemZ, TMS320C64x, Web Assembly, X86, X86\_64, XCore) + bindings.
* \[**3844**星]\[2m] \[ObjC] [sveinbjornt/sloth](https://github.com/sveinbjornt/sloth) ⭐ 8,931 | 🐛 3 | 🌐 Objective-C | 📅 2026-05-28 Mac app that shows all open files, directories and sockets in use by all running processes. Nice GUI for lsof.
* \[**3451**星]\[19d] \[C] [mikebrady/shairport-sync](https://github.com/mikebrady/shairport-sync) ⭐ 8,806 | 🐛 14 | 🌐 C | 📅 2026-08-09 AirPlay audio player. Shairport Sync adds multi-room capability with Audio Synchronisation
* \[**2587**星]\[10d] \[C] [esnet/iperf](https://github.com/esnet/iperf) ⭐ 8,684 | 🐛 236 | 🌐 C | 📅 2026-07-10 A TCP, UDP, and SCTP network bandwidth measurement tool
* \[**4651**星]\[13d] [powershell/win32-openssh](https://github.com/powershell/win32-openssh) ⭐ 8,237 | 🐛 401 | 📅 2025-10-27 Win32 port of OpenSSH
* \[**4541**星]\[4m] \[TS] [apis-guru/graphql-voyager](https://github.com/apis-guru/graphql-voyager) ⭐ 8,157 | 🐛 106 | 🌐 TypeScript | 📅 2026-05-12
* \[**3306**星]\[19d] \[C] [microsoft/windows-driver-samples](https://github.com/microsoft/windows-driver-samples) ⭐ 7,816 | 🐛 125 | 🌐 C | 📅 2026-08-12 This repo contains driver samples prepared for use with Microsoft Visual Studio and the Windows Driver Kit (WDK). It contains both Universal Windows Driver and desktop-only driver samples.
* \[**2948**星]\[1m] \[C] [libfuse/sshfs](https://github.com/libfuse/sshfs) ⭐ 7,607 | 🐛 60 | 🌐 C | 📅 2026-08-08 A network filesystem client to connect to SSH servers
* \[**4314**星]\[15d] \[Rust] [timvisee/ffsend](https://github.com/timvisee/ffsend) ⭐ 7,369 | 🐛 33 | 🌐 Rust | 📅 2025-11-20 Easily and securely share files from the command line
* \[**4747**星]\[8d] \[C++] [paddlepaddle/paddle-lite](https://github.com/PaddlePaddle/Paddle-Lite) ⭐ 7,269 | 🐛 51 | 🌐 C++ | 📅 2026-04-27 Multi-platform high performance deep learning inference engine (『飞桨』多平台高性能深度学习预测引擎）
* \[**5829**星]\[7m] \[JS] [sindresorhus/fkill-cli](https://github.com/sindresorhus/fkill-cli) ⭐ 6,998 | 🐛 6 | 🌐 JavaScript | 📅 2025-11-09 Fabulously kill processes. Cross-platform.
* \[**2194**星]\[13d] \[C] [armmbed/mbedtls](https://github.com/armmbed/mbedtls) ⭐ 6,868 | 🐛 1,734 | 🌐 C | 📅 2026-08-04 An open source, portable, easy to use, readable and flexible SSL library
...
* \[**2621**星]\[2m] [pditommaso/awesome-pipeline](https://github.com/pditommaso/awesome-pipeline) ⭐ 6,618 | 🐛 34 | 📅 2026-08-04 A curated list of awesome pipeline toolkits inspired by Awesome Sysadmin
* \[**4060**星]\[2m] \[JS] [sigalor/whatsapp-web-reveng](https://github.com/sigalor/whatsapp-web-reveng) ⭐ 6,489 | 🐛 157 | 🌐 JavaScript | 📅 2024-04-22 WhatsApp Web API逆向与重新实现
* \[**2854**星]\[1m] \[Py] [espressif/esptool](https://github.com/espressif/esptool) ⭐ 6,438 | 🐛 13 | 🌐 Python | 📅 2026-08-10 ESP8266 and ESP32 serial bootloader utility
* \[**1698**星]\[21d] \[C++] [microsoft/detours](https://github.com/microsoft/detours) ⭐ 6,353 | 🐛 91 | 🌐 C++ | 📅 2026-08-05 Detours is a software package for monitoring and instrumenting API calls on Windows. It is distributed in source code form.
* \[**5007**星]\[2m] \[Py] [snare/voltron](https://github.com/snare/voltron) ⭐ 6,346 | 🐛 85 | 🌐 Python | 📅 2025-01-30 A hacky debugger UI for hackers
* \[**408**星]\[19d] \[Py] [crytic/slither](https://github.com/crytic/slither) ⭐ 6,343 | 🐛 468 | 🌐 Python | 📅 2026-08-12 Static Analyzer for Solidity
* \[**3233**星]\[25d] \[C] [tmate-io/tmate](https://github.com/tmate-io/tmate) ⭐ 6,103 | 🐛 129 | 🌐 C | 📅 2026-07-29 Instant Terminal Sharing
* \[**3690**星]\[21d] \[JS] [lesspass/lesspass](https://github.com/lesspass/lesspass) ⭐ 6,051 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-12
* \[**3954**星]\[16d] \[Go] [eranyanay/1m-go-websockets](https://github.com/eranyanay/1m-go-websockets) ⭐ 5,998 | 🐛 3 | 🌐 Go | 📅 2022-08-14 handling 1M websockets connections in Go
* \[**3768**星]\[2m] \[Go] [microsoft/ethr](https://github.com/microsoft/ethr) ⭐ 5,865 | 🐛 51 | 🌐 Go | 📅 2026-07-03 Ethr is a Network Performance Measurement Tool for TCP, UDP & HTTP.
* \[**2631**星]\[8m] [leandromoreira/linux-network-performance-parameters](https://github.com/leandromoreira/linux-network-performance-parameters) ⭐ 5,811 | 🐛 3 | 📅 2026-06-03 Learn where some of the network sysctl variables fit into the Linux/Kernel network flow
* \[**3120**星]\[11d] \[Go] [tencent/bk-cmdb](https://github.com/tencent/bk-cmdb) ⭐ 5,734 | 🐛 85 | 🌐 Go | 📅 2026-08-07 蓝鲸智云配置平台(BlueKing CMDB)
* \[**2092**星]\[26d] [swiftonsecurity/sysmon-config](https://github.com/swiftonsecurity/sysmon-config) ⭐ 5,619 | 🐛 82 | 📅 2024-07-03 Sysmon configuration file template with default high-quality event tracing
* \[**1930**星]\[22d] \[C++] [mhammond/pywin32](https://github.com/mhammond/pywin32) ⭐ 5,596 | 🐛 397 | 🌐 C++ | 📅 2026-07-15 Python for Windows (pywin32) Extensions
* \[**2211**星]\[1m] \[C++] [google/bloaty](https://github.com/google/bloaty) ⭐ 5,531 | 🐛 71 | 🌐 C++ | 📅 2026-05-31 Bloaty McBloatface: a size profiler for binaries
* \[**1620**星]\[16d] \[C++] [lief-project/lief](https://github.com/lief-project/lief) ⭐ 5,522 | 🐛 32 | 🌐 C++ | 📅 2026-08-07 Library to Instrument Executable Formats
* \[**2898**星]\[8m] \[C] [p-h-c/phc-winner-argon2](https://github.com/p-h-c/phc-winner-argon2) ⭐ 5,346 | 🐛 102 | 🌐 C | 📅 2024-08-06 The password hash Argon2, winner of PHC
* \[**2833**星]\[2m] \[Assembly] [cirosantilli/x86-bare-metal-examples](https://github.com/cirosantilli/x86-bare-metal-examples) ⭐ 5,334 | 🐛 7 | 🌐 Assembly | 📅 2022-07-18 几十个用于学习 x86 系统编程的小型操作系统
* \[**2872**星]\[14d] \[C] [lxc/lxc](https://github.com/lxc/lxc) ⭐ 5,239 | 🐛 148 | 🌐 C | 📅 2026-07-23 LXC - Linux Containers
* \[**1816**星]\[29d] \[Go] [gdamore/tcell](https://github.com/gdamore/tcell) ⭐ 5,212 | 🐛 10 | 🌐 Go | 📅 2026-08-11 Tcell is an alternate terminal package, similar in some ways to termbox, but better in others.
...
* \[**2093**星]\[10d] \[C] [flatpak/flatpak](https://github.com/flatpak/flatpak) ⭐ 5,022 | 🐛 1,016 | 🌐 C | 📅 2026-08-12 Linux application sandboxing and distribution framework
...
* \[**2132**星]\[20d] [goq/telegram-list](https://github.com/goq/telegram-list) ⭐ 4,964 | 🐛 22 | 📅 2026-08-05 List of telegram groups, channels & bots // Список интересных групп, каналов и ботов телеграма // Список чатов для программистов
* \[**2391**星]\[21d] \[Java] [mock-server/mockserver](https://github.com/mock-server/mockserver) ⭐ 4,938 | 🐛 4 | 🌐 Java | 📅 2026-08-12 MockServer enables easy mocking of any system you integrate with via HTTP or HTTPS with clients written in Java, JavaScript and Ruby. MockServer also includes a proxy that introspects all proxied traffic including encrypted SSL traffic and supports Port Forwarding, Web Proxying (i.e. HTTP proxy), HTTPS Tunneling Proxying (using HTTP CONNECT) and…
* \[**4600**星]\[12m] \[Py] [ecthros/uncaptcha2](https://github.com/ecthros/uncaptcha2) ⭐ 4,918 | 🐛 6 | 🌐 Python | 📅 2019-01-18 defeating the latest version of ReCaptcha with 91% accuracy
...
* \[**2137**星]\[19d] \[Assembly] [pret/pokered](https://github.com/pret/pokered) ⭐ 4,876 | 🐛 22 | 🌐 Assembly | 📅 2026-08-10 disassembly of Pokémon Red/Blue
* \[**3749**星]\[12d] \[Go] [hashicorp/consul-template](https://github.com/hashicorp/consul-template) ⭐ 4,825 | 🐛 231 | 🌐 Go | 📅 2026-07-13 Template rendering, notifier, and supervisor for
* \[**1761**星]\[13d] \[C] [google/wuffs](https://github.com/google/wuffs) ⭐ 4,803 | 🐛 37 | 🌐 C | 📅 2026-08-08 Wrangling Untrusted File Formats Safely
* \[**3202**星]\[1y] \[Shell] [toyodadoubi/doubi](https://github.com/toyodadoubi/doubi) ⭐ 4,692 | 🐛 13 | 🌐 Shell | 📅 2020-10-20 一个逗比写的各种逗比脚本\~
* \[**2615**星]\[1m] \[JS] [knownsec/kcon](https://github.com/knownsec/kcon) ⭐ 4,658 | 🐛 5 | 🌐 JavaScript | 📅 2024-08-28 KCon is a famous Hacker Con powered by Knownsec Team.
* \[**2003**星]\[2m] \[C++] [asmjit/asmjit](https://github.com/asmjit/asmjit) ⭐ 4,573 | 🐛 25 | 🌐 C++ | 📅 2026-03-26 Complete x86/x64 JIT and AOT Assembler for C++
...
* \[**2340**星]\[2m] \[JS] [pa11y/pa11y](https://github.com/pa11y/pa11y) ⭐ 4,485 | 🐛 46 | 🌐 JavaScript | 📅 2026-08-10 Pa11y is your automated accessibility testing pal
...
* \[**2535**星]\[3m] \[Java] [jboss-javassist/javassist](https://github.com/jboss-javassist/javassist) ⭐ 4,232 | 🐛 254 | 🌐 Java | 📅 2026-06-21 Java bytecode engineering toolkit
* \[**2848**星]\[6m] \[Py] [instantbox/instantbox](https://github.com/instantbox/instantbox) ⭐ 4,177 | 🐛 8 | 🌐 Python | 📅 2024-03-12 Get a clean, ready-to-go Linux box in seconds.
...
* \[**1714**星]\[1m] \[Go] [hashicorp/memberlist](https://github.com/hashicorp/memberlist) ⭐ 4,095 | 🐛 95 | 🌐 Go | 📅 2026-08-03 Golang package for gossip based membership and failure detection
* \[**2217**星]\[14d] \[Go] [google/mtail](https://github.com/google/mtail) ⭐ 4,024 | 🐛 59 | 🌐 Go | 📅 2026-03-19 extract whitebox monitoring data from application logs for collection in a timeseries database
* \[**2052**星]\[13d] \[C++] [openthread/openthread](https://github.com/openthread/openthread) ⭐ 4,012 | 🐛 165 | 🌐 C++ | 📅 2026-08-13 OpenThread released by Google is an open-source implementation of the Thread networking protocol
* \[**3280**星]\[29d] \[Java] [oldmanpushcart/greys-anatomy](https://github.com/oldmanpushcart/greys-anatomy) ⭐ 4,007 | 🐛 75 | 🌐 Java | 📅 2022-10-25 Java诊断工具
* \[**1668**星]\[3m] \[Py] [boppreh/keyboard](https://github.com/boppreh/keyboard) ⭐ 3,961 | 🐛 416 | 🌐 Python | 📅 2026-07-10 Hook and simulate global keyboard events on Windows and Linux.
* \[**1727**星]\[8d] \[TSQL] [brentozarultd/sql-server-first-responder-kit](https://github.com/brentozarultd/sql-server-first-responder-kit) ⭐ 3,875 | 🐛 5 | 🌐 TSQL | 📅 2026-08-11 sp\_Blitz, sp\_BlitzCache, sp\_BlitzFirst, sp\_BlitzIndex, and other SQL Server scripts for health checks and performance tuning.
...
* \[**1899**星]\[25d] \[C++] [acidanthera/lilu](https://github.com/acidanthera/Lilu) ⭐ 3,857 | 🐛 0 | 🌐 C | 📅 2026-03-20 Arbitrary kext and process patching on macOS
* \[**1637**星]\[12d] \[JS] [efforg/privacybadger](https://github.com/efforg/privacybadger) ⭐ 3,803 | 🐛 143 | 🌐 JavaScript | 📅 2026-08-12 Privacy Badger is a browser extension that automatically learns to block invisible trackers.
* \[**2364**星]\[10d] \[C] [domoticz/domoticz](https://github.com/domoticz/domoticz) ⭐ 3,791 | 🐛 20 | 🌐 C++ | 📅 2026-08-12 monitor and configure various devices like: Lights, Switches, various sensors/meters like Temperature, Rain, Wind, UV, Electra, Gas, Water and much more
* \[**2031**星]\[10m] \[C] [dekunukem/nintendo\_switch\_reverse\_engineering](https://github.com/dekunukem/nintendo_switch_reverse_engineering) ⭐ 3,770 | 🐛 92 | 🌐 C | 📅 2022-07-14 A look at inner workings of Joycon and Nintendo Switch
* \[**2305**星]\[2m] \[C] [moby/hyperkit](https://github.com/moby/hyperkit) ⭐ 3,718 | 🐛 53 | 🌐 C | 📅 2023-04-28 A toolkit for embedding hypervisor capabilities in your application
* \[**2760**星]\[10d] \[TS] [webhintio/hint](https://github.com/webhintio/hint) ⭐ 3,700 | 🐛 530 | 🌐 TypeScript | 📅 2026-07-21
* \[**2474**星]\[25d] \[JS] [vitaly-t/pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,554 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-26 PostgreSQL interface for Node.js
* \[**3219**星]\[2m] \[TS] [google/incremental-dom](https://github.com/google/incremental-dom) ⚠️ Archived An in-place DOM diffing library
* \[**1722**星]\[4m] \[Py] [anorov/cloudflare-scrape](https://github.com/anorov/cloudflare-scrape) ⭐ 3,534 | 🐛 128 | 🌐 Python | 📅 2023-10-14 A Python module to bypass Cloudflare's anti-bot page.
* \[**3052**星]\[4m] \[C++] [google/robotstxt](https://github.com/google/robotstxt) ⭐ 3,472 | 🐛 12 | 🌐 C++ | 📅 2026-04-01 The repository contains Google's robots.txt parser and matcher as a C++ library (compliant to C++11).
* \[**1781**星]\[26d] \[PHP] [ezyang/htmlpurifier](https://github.com/ezyang/htmlpurifier) ⭐ 3,354 | 🐛 133 | 🌐 PHP | 📅 2026-08-12 Standards compliant HTML filter written in PHP
* \[**1863**星]\[10d] \[C++] [pytorch/glow](https://github.com/pytorch/glow) ⚠️ Archived Compiler for Neural Network hardware accelerators
* \[**1624**星]\[9m] \[JS] [localtunnel/server](https://github.com/localtunnel/server) ⭐ 3,319 | 🐛 93 | 🌐 JavaScript | 📅 2024-03-20 server for localtunnel.me
* \[**1877**星]\[25d] \[Java] [adoptopenjdk/jitwatch](https://github.com/adoptopenjdk/jitwatch) ⭐ 3,303 | 🐛 18 | 🌐 Java | 📅 2025-12-28 Log analyser / visualiser for Java HotSpot JIT compiler. Inspect inlining decisions, hot methods, bytecode, and assembly. View results in the JavaFX user interface.
* \[**1672**星]\[7m] \[C] [easyhook/easyhook](https://github.com/easyhook/easyhook) ⭐ 3,288 | 🐛 186 | 🌐 C | 📅 2024-01-25 The reinvention of Windows API Hooking
...
* \[**637**星]\[21d] \[PS] [olafhartong/sysmon-modular](https://github.com/olafhartong/sysmon-modular) ⭐ 3,111 | 🐛 49 | 🌐 PowerShell | 📅 2026-08-10 sysmon配置模块收集
* \[**1949**星]\[17d] \[C] [microsoft/procdump-for-linux](https://github.com/microsoft/procdump-for-linux) ⭐ 3,079 | 🐛 21 | 🌐 C | 📅 2026-07-29 Linux 版本的 ProcDump
* \[**2808**星]\[10m] \[Py] [plasma-disassembler/plasma](https://github.com/plasma-disassembler/plasma) ⭐ 3,072 | 🐛 15 | 🌐 Python | 📅 2021-08-31 Plasma is an interactive disassembler for x86/ARM/MIPS. It can generates indented pseudo-code with colored syntax.
* \[**2260**星]\[13d] [dumb-password-rules/dumb-password-rules](https://github.com/dumb-password-rules/dumb-password-rules) ⭐ 3,022 | 🐛 62 | 🌐 Nunjucks | 📅 2026-08-11 Shaming sites with dumb password rules.
* \[**1786**星]\[1m] \[C++] [apitrace/apitrace](https://github.com/apitrace/apitrace) ⭐ 2,856 | 🐛 158 | 🌐 C++ | 📅 2026-06-03 Tools for tracing OpenGL, Direct3D, and other graphics APIs
* \[**1756**星]\[16d] \[PHP] [wordpress/wordpress-coding-standards](https://github.com/wordpress/wordpress-coding-standards) ⭐ 2,823 | 🐛 263 | 🌐 PHP | 📅 2026-08-10 PHP\_CodeSniffer rules (sniffs) to enforce WordPress coding conventions
...
* \[**1851**星]\[1y] \[Java] [yeriomin/yalpstore](https://github.com/yeriomin/yalpstore) ⭐ 2,542 | 🐛 19 | 🌐 Java | 📅 2022-09-27 Download apks from Google Play Store
...
* \[**1562**星]\[1m] \[C] [p-gen/smenu](https://github.com/p-gen/smenu) ⭐ 2,491 | 🐛 4 | 🌐 C | 📅 2026-04-17 Terminal utility that reads words from standard input or from a file and creates an interactive selection window just below the cursor. The selected word(s) are sent to standard output for further processing.
...
* \[**2478**星]\[11m] \[JS] [weixin/miaow](https://github.com/weixin/Miaow) ⭐ 2,477 | 🐛 20 | 🌐 JavaScript | 📅 2019-03-04 A set of plugins for Sketch include drawing links & marks, UI Kit & Color sync, font & text replacing.
* \[**1592**星]\[2m] \[ObjC] [ealeksandrov/provisionql](https://github.com/ealeksandrov/provisionql) ⭐ 2,455 | 🐛 3 | 🌐 Swift | 📅 2026-07-19 Quick Look plugin for apps and provisioning profile files
* \[**1854**星]\[19d] \[C] [github/glb-director](https://github.com/github/glb-director) ⭐ 2,447 | 🐛 33 | 🌐 C | 📅 2026-08-04 GitHub Load Balancer Director and supporting tooling.
...
* \[**1837**星]\[3m] \[Go] [influxdata/kapacitor](https://github.com/influxdata/kapacitor) ⭐ 2,374 | 🐛 833 | 🌐 Go | 📅 2026-08-10 Open source framework for processing, monitoring, and alerting on time series data
* \[**1676**星]\[10d] \[Java] [apache/geode](https://github.com/apache/geode) ⭐ 2,374 | 🐛 29 | 🌐 Java | 📅 2026-08-10 Apache Geode
...
* \[**1852**星]\[1y] \[Py] [jinnlynn/genpac](https://github.com/jinnlynn/genpac) ⭐ 2,187 | 🐛 0 | 🌐 Python | 📅 2026-08-13 PAC/Dnsmasq/Wingy file Generator, working with gfwlist, support custom rules.
* \[**906**星]\[7m] \[C++] [dfhack/dfhack](https://github.com/DFHack/dfhack) ⭐ 2,038 | 🐛 1,058 | 🌐 C++ | 📅 2026-08-08 Memory hacking library for Dwarf Fortress and a set of tools that use it
* \[**1848**星]\[9m] \[Py] [netflix-skunkworks/stethoscope](https://github.com/Netflix-Skunkworks/stethoscope) ⭐ 2,006 | 🐛 44 | 🌐 Python | 📅 2023-08-01 Personalized, user-focused recommendations for employee information security.
* \[**1572**星]\[1m] \[C] [codahale/bcrypt-ruby](https://github.com/codahale/bcrypt-ruby) ⭐ 1,996 | 🐛 19 | 🌐 C | 📅 2026-06-19  Ruby binding for the OpenBSD bcrypt() password hashing algorithm, allowing you to easily store a secure hash of your users' passwords.
* \[**1659**星]\[25d] \[JS] [tylerbrock/mongo-hacker](https://github.com/tylerbrock/mongo-hacker) ⭐ 1,797 | 🐛 5 | 🌐 JavaScript | 📅 2022-09-17 MongoDB Shell Enhancements for Hackers
* \[**1562**星]\[19d] \[Java] [gchq/gaffer](https://github.com/gchq/Gaffer) ⚠️ Archived A large-scale entity and relation database supporting aggregation of properties
* \[**522**星]\[4m] \[Java] [java-deobfuscator/deobfuscator](https://github.com/java-deobfuscator/deobfuscator) ⭐ 1,751 | 🐛 127 | 🌐 Java | 📅 2023-04-26 Java 代码反混淆工具
* \[**1584**星]\[1y] \[C] [qihoo360/phptrace](https://github.com/qihoo360/phptrace) ⭐ 1,663 | 🐛 28 | 🌐 C | 📅 2018-11-28 A tracing and troubleshooting tool for PHP scripts.
* \[**587**星]\[6m] [nshalabi/sysmontools](https://github.com/nshalabi/sysmontools) ⭐ 1,657 | 🐛 0 | 🌐 TypeScript | 📅 2026-04-04 Utilities for Sysmon
* \[**449**星]\[12m] \[C++] [ntquery/scylla](https://github.com/ntquery/scylla) ⭐ 1,413 | 🐛 23 | 🌐 C++ | 📅 2023-04-05 Imports Reconstructor
* \[**966**星]\[7m] \[PHP] [jenssegers/optimus](https://github.com/jenssegers/optimus) ⭐ 1,275 | 🐛 14 | 🌐 PHP | 📅 2024-03-27  id transformation With this library, you can transform your internal id's to obfuscated integers based on Knuth's integer has和
* \[**306**星]\[2m] \[C] [nagyd/sdlpop](https://github.com/nagyd/sdlpop) ⭐ 1,272 | 🐛 78 | 🌐 C | 📅 2025-12-24 An open-source port of Prince of Persia, based on the disassembly of the DOS version.
* \[**240**星]\[4m] \[JS] [consensys/surya](https://github.com/consensys/surya) ⭐ 1,171 | 🐛 8 | 🌐 JavaScript | 📅 2025-06-26 A set of utilities for exploring Solidity contracts
* \[**895**星]\[12m] \[JS] [levskaya/jslinux-deobfuscated](https://github.com/levskaya/jslinux-deobfuscated) ⭐ 1,073 | 🐛 0 | 🌐 JavaScript | 📅 2019-01-15 An old version of Mr. Bellard's JSLinux rewritten to be human readable, hand deobfuscated and annotated.
...
* \[**523**星]\[2m] [mhaggis/sysmon-dfir](https://github.com/mhaggis/sysmon-dfir) ⭐ 942 | 🐛 0 | 📅 2023-12-12 Sources, configuration and how to detect evil things utilizing Microsoft Sysmon.
* \[**706**星]\[1y] \[Jupyter Notebook] [anishathalye/obfuscated-gradients](https://github.com/anishathalye/obfuscated-gradients) ⭐ 912 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2023-06-10 Obfuscated Gradients Give a False Sense of Security: Circumventing Defenses to Adversarial Examples
...
* \[**265**星]\[3m] \[Assembly] [pret/pokeyellow](https://github.com/pret/pokeyellow) ⭐ 863 | 🐛 3 | 🌐 Assembly | 📅 2026-08-10 Disassembly of Pokemon Yellow
* \[**446**星]\[11m] \[Batchfile] [ion-storm/sysmon-config](https://github.com/ion-storm/sysmon-config) ⭐ 827 | 🐛 6 | 🌐 PowerShell | 📅 2023-11-05 Advanced Sysmon configuration, Installer & Auto Updater with high-quality event tracing
* \[**658**星]\[10m] \[Jupyter Notebook] [supercowpowers/data\_hacking](https://github.com/SuperCowPowers/data_hacking) ⭐ 783 | 🐛 8 | 🌐 Jupyter Notebook | 📅 2019-03-05 Data Hacking Project
* \[**657**星]\[1y] \[Rust] [endgameinc/xori](https://github.com/endgameinc/xori) ⭐ 722 | 🐛 35 | 🌐 Rust | 📅 2023-01-25 Xori is an automation-ready disassembly and static analysis library for PE32, 32+ and shellcode
* \[**308**星]\[25d] \[Py] [baderj/domain\_generation\_algorithms](https://github.com/baderj/domain_generation_algorithms) ⭐ 691 | 🐛 0 | 🌐 Python | 📅 2026-06-04 域名生成算法
...
* \[**383**星]\[1y] \[HTML] [maestron/reverse-engineering-tutorials](https://github.com/maestron/reverse-engineering-tutorials) ⭐ 531 | 🐛 0 | 🌐 HTML | 📅 2018-09-02 Reverse Engineering Tutorials
* \[**291**星]\[28d] \[C] [tomb5/tomb5](https://github.com/tomb5/tomb5) ⭐ 513 | 🐛 26 | 🌐 C | 📅 2022-02-03 Chronicles Disassembly translated to C source code.
...
* \[**214**星]\[2m] \[Py] [rpisec/llvm-deobfuscator](https://github.com/rpisec/llvm-deobfuscator) ⭐ 431 | 🐛 5 | 🌐 Python | 📅 2021-05-16
* \[**211**星]\[12m] \[Java] [neo23x0/fnord](https://github.com/neo23x0/fnord) ⭐ 303 | 🐛 1 | 🌐 Shell | 📅 2022-02-12 Pattern Extractor for Obfuscated Code
* \[**1955**星]\[11d] \[Go] [solo-io/gloo](https://github.com/solo-io/gloo) ⭐ 169 | 🐛 1,862 | 🌐 Go | 📅 2026-08-13 An Envoy-Powered API Gateway
* \[**2214**星]\[18d] [getlantern/lantern-binaries](https://github.com/getlantern/lantern-binaries) ⭐ 119 | 🐛 14 | 📅 2026-08-13 Lantern installers binary downloads.
...
* \[**534**星]\[12d] \[Py] [angr/angr-doc](https://github.com/angr/angr-doc) ⚠️ Archived Documentation for the angr suite
* \[**305**星]\[2m] \[Py] [salls/angrop](https://github.com/salls/angrop) ⭐ 9 | 🐛 0 | 🌐 Python | 📅 2024-05-31 a rop gadget finder and chain builder
...
* \[**1422**星]\[17d] \[C++] [eteran/edb-debugger](https://github.com/eteran/edb-debugger) ⭐ 2,945 | 🐛 67 | 🌐 C++ | 📅 2026-08-10 edb is a cross platform AArch32/x86/x86-64 debugger.
* \[**836**星]\[8d] \[C++] [tasvideos/bizhawk](https://github.com/tasvideos/bizhawk) ⭐ 2,728 | 🐛 789 | 🌐 C# | 📅 2026-08-09 BizHawk is a multi-system emulator written in C#. BizHawk provides nice features for casual gamers such as full screen, and joypad support in addition to full rerecording and debugging tools for all system cores.
* \[**1413**星]\[19d] \[Go] [cosmos72/gomacro](https://github.com/cosmos72/gomacro) ⭐ 2,288 | 🐛 49 | 🌐 Go | 📅 2026-08-02 Interactive Go interpreter and debugger with REPL, Eval, generics and Lisp-like macros
* \[**1450**星]\[10d] \[Go] [google/gapid](https://github.com/google/gapid) ⭐ 2,239 | 🐛 337 | 🌐 Go | 📅 2024-05-08 Graphics API Debugger
...
* \[**1147**星]\[5m] \[C++] [cgdb/cgdb](https://github.com/cgdb/cgdb) ⭐ 1,836 | 🐛 45 | 🌐 C | 📅 2026-02-27 Console front-end to the GNU debugger
* \[**1275**星]\[4m] \[Go] [solo-io/squash](https://github.com/solo-io/squash) ⭐ 1,767 | 🐛 87 | 🌐 Go | 📅 2022-06-09 The debugger for microservices
* \[**377**星]\[1m] \[Py] [pdbpp/pdbpp](https://github.com/pdbpp/pdbpp) ⭐ 1,465 | 🐛 108 | 🌐 Python | 📅 2024-04-15 pdb++, a drop-in replacement for pdb (the Python debugger)
...
* \[**560**星]\[21d] \[C#] [microsoft/miengine](https://github.com/microsoft/miengine) ⭐ 857 | 🐛 163 | 🌐 C# | 📅 2026-08-12 The Visual Studio MI Debug Engine ("MIEngine") provides an open-source Visual Studio Debugger extension that works with MI-enabled debuggers such as gdb, lldb, and clrdbg.
* \[**285**星]\[2m] \[C++] [changeofpace/viviennevmm](https://github.com/changeofpace/viviennevmm) ⭐ 829 | 🐛 3 | 🌐 C++ | 📅 2020-09-07 VivienneVMM is a stealthy debugging framework implemented via an Intel VT-x hypervisor.
* \[**418**星]\[26d] \[C++] [simonkagstrom/kcov](https://github.com/simonkagstrom/kcov) ⭐ 826 | 🐛 88 | 🌐 C++ | 📅 2026-08-07 Code coverage tool for compiled programs, Python and Bash which uses debugging information to collect and report data without special compilation options
* \[**239**星]\[8m] \[C++] [strivexjun/xantidebug](https://github.com/strivexjun/xantidebug) ⭐ 679 | 🐛 3 | 🌐 C++ | 📅 2019-05-11 VMProtect 3.x Anti-debug Method Improved
* \[**521**星]\[1y] \[C] [wubingzheng/memleax](https://github.com/wubingzheng/memleax) ⭐ 654 | 🐛 11 | 🌐 C | 📅 2018-11-03 debugs memory leak of running process. Not maintained anymore, try `libleak` please.
...
* \[**291**星]\[12d] \[Py] [sosreport/sos](https://github.com/sosreport/sos) ⭐ 594 | 🐛 160 | 🌐 Python | 📅 2026-08-12 A unified tool for collecting system logs and other debug information
* \[**200**星]\[6m] \[C++] [rainers/cv2pdb](https://github.com/rainers/cv2pdb) ⭐ 552 | 🐛 21 | 🌐 C++ | 📅 2026-01-17 converter of DMD CodeView/DWARF debug information to PDB files
* \[**332**星]\[8m] \[Py] [romanvm/python-web-pdb](https://github.com/romanvm/python-web-pdb) ⭐ 533 | 🐛 18 | 🌐 Python | 📅 2026-08-12 Web-based remote UI for Python's PDB debugger
* \[**306**星]\[21d] \[Java] [widdix/aws-s3-virusscan](https://github.com/widdix/aws-s3-virusscan) ⚠️ Archived Free Antivirus for S3 Buckets
* \[**462**星]\[5m] \[C++] [emoon/prodbg](https://github.com/emoon/prodbg) ⭐ 520 | 🐛 114 | 🌐 C++ | 📅 2021-04-09 Debugging the way it's meant to be done
* \[**272**星]\[4m] \[Py] [mariovilas/winappdbg](https://github.com/mariovilas/winappdbg) ⭐ 485 | 🐛 3 | 🌐 Python | 📅 2026-03-24 WinAppDbg Debugger
* \[**270**星]\[21d] \[Py] [ionelmc/python-manhole](https://github.com/ionelmc/python-manhole) ⭐ 402 | 🐛 9 | 🌐 Python | 📅 2024-07-04 Debugging manhole for python applications.
* \[**218**星]\[2m] \[Py] [nteseyes/pylane](https://github.com/nteseyes/pylane) ⭐ 359 | 🐛 2 | 🌐 Python | 📅 2022-11-06 An python vm injector with debug tools, based on gdb.
* \[**250**星]\[2m] \[Py] [quantopian/qdb](https://github.com/quantopian/qdb) ⭐ 317 | 🐛 6 | 🌐 Python | 📅 2023-09-25 Quantopian Remote Debugger for Python
* \[**239**星]\[8m] \[Py] [beeware/bugjar](https://github.com/beeware/bugjar) ⭐ 256 | 🐛 9 | 🌐 Python | 📅 2026-05-11 A interactive graphical debugger for Python code.
* \[**220**星]\[9m] [letoram/senseye](https://github.com/letoram/senseye) ⭐ 253 | 🐛 1 | 📅 2019-04-14 Dynamic Visual Debugging / Reverse Engineering Toolsuite
* \[**233**星]\[2m] \[Py] [gilligan/vim-lldb](https://github.com/gilligan/vim-lldb) ⭐ 246 | 🐛 8 | 🌐 Python | 📅 2021-09-10 lldb debugger integration plugin for vim
* \[**240**星]\[6m] \[C++] [facebook/ds2](https://github.com/facebook/ds2) ⚠️ Archived Debug server for lldb.
* \[**209**星]\[2m] \[C] [joyent/mdb\_v8](https://github.com/joyent/mdb_v8) ⭐ 243 | 🐛 36 | 🌐 C | 📅 2024-11-15 postmortem debugging for Node.js and other V8-based programs
...
* \[**1106**星]\[14d] \[OCaml] [binaryanalysisplatform/bap](https://github.com/binaryanalysisplatform/bap) ⭐ 2,248 | 🐛 43 | 🌐 OCaml | 📅 2026-05-07 Binary Analysis Platform
* \[**411**星]\[13d] \[HTML] [w3c/webappsec](https://github.com/w3c/webappsec) ⭐ 668 | 🐛 104 | 🌐 HTML | 📅 2026-06-10 Web App安全工作组
* \[**299**星]\[17d] \[JS] [w3c/webappsec-trusted-types](https://github.com/w3c/webappsec-trusted-types) ⭐ 661 | 🐛 55 | 🌐 JavaScript | 📅 2026-08-10 A browser API to prevent DOM-Based Cross Site Scripting in modern web applications.
...
* \[**20779**星]\[8d] \[Java] [skylot/jadx](https://github.com/skylot/jadx) ⭐ 50,043 | 🐛 442 | 🌐 Java | 📅 2026-08-05 dex 转 java 的反编译器
* \[**7733**星]\[1m] \[Java] [java-decompiler/jd-gui](https://github.com/java-decompiler/jd-gui) ⭐ 15,172 | 🐛 248 | 🌐 Java | 📅 2024-07-08 A standalone Java Decompiler GUI
* \[**1867**星]\[1y] \[Java] [jindrapetrik/jpexs-decompiler](https://github.com/jindrapetrik/jpexs-decompiler) ⭐ 5,791 | 🐛 5 | 🌐 Java | 📅 2026-08-08 JPEXS Free Flash Decompiler
* \[**3135**星]\[26d] \[Java] [deathmarine/luyten](https://github.com/deathmarine/luyten) ⭐ 5,110 | 🐛 193 | 🌐 Java | 📅 2024-07-11 An Open Source Java Decompiler Gui for Procyon
* \[**671**星]\[11m] \[C++] [zrax/pycdc](https://github.com/zrax/pycdc) ⭐ 4,581 | 🐛 234 | 🌐 C++ | 📅 2026-04-07 C++ python bytecode disassembler and decompiler
* \[**1652**星]\[12m] \[Java] [fesh0r/fernflower](https://github.com/fesh0r/fernflower) ⭐ 4,359 | 🐛 0 | 🌐 Java | 📅 2026-08-12 Unofficial mirror of FernFlower Java decompiler (All pulls should be submitted upstream)
* \[**1466**星]\[12d] \[Py] [rocky/python-uncompyle6](https://github.com/rocky/python-uncompyle6) ⭐ 4,317 | 🐛 42 | 🌐 Python | 📅 2026-04-24 Python反编译器，跨平台
* \[**331**星]\[11d] \[Java] [leibnitz27/cfr](https://github.com/leibnitz27/cfr) ⭐ 2,658 | 🐛 150 | 🌐 Java | 📅 2026-06-04 This is the public repository for the CFR Java decompiler
* \[**673**星]\[18d] \[C#] [uxmal/reko](https://github.com/uxmal/reko) ⭐ 2,599 | 🐛 165 | 🌐 C# | 📅 2026-08-12 Reko is a binary decompiler.
* \[**347**星]\[16d] \[C#] [steamdatabase/valveresourceformat](https://github.com/steamdatabase/valveresourceformat) ⭐ 2,370 | 🐛 74 | 🌐 C# | 📅 2026-08-13 Valve's Source 2 resource file format (also known as Stupid Valve Format) parser and decompiler.
* \[**1084**星]\[4m] \[Py] [storyyeller/krakatau](https://github.com/storyyeller/krakatau) ⭐ 2,241 | 🐛 25 | 🌐 Rust | 📅 2026-04-07 Java decompiler, assembler, and disassembler
...
* \[**327**星]\[2m] \[C++] [silverf0x/rpcview](https://github.com/silverf0x/rpcview) ⭐ 1,068 | 🐛 15 | 🌐 C++ | 📅 2023-09-24 RpcView is a free tool to explore and decompile Microsoft RPC interfaces
...
* \[**240**星]\[2m] \[Java] [ata4/bspsrc](https://github.com/ata4/bspsrc) ⭐ 858 | 🐛 38 | 🌐 Java | 📅 2026-04-11 A Source engine map decompiler
* \[**283**星]\[8m] \[Shell] [venshine/decompile-apk](https://github.com/venshine/decompile-apk) ⭐ 820 | 🐛 6 | 🌐 Shell | 📅 2025-06-14 APK 反编译
* \[**538**星]\[6m] \[Java] [java-decompiler/jd-eclipse](https://github.com/java-decompiler/jd-eclipse) ⭐ 732 | 🐛 36 | 🌐 Java | 📅 2019-07-17 A Java Decompiler Eclipse plugin
* \[**243**星]\[3m] \[Java] [kwart/jd-cmd](https://github.com/kwart/jd-cmd) ⭐ 649 | 🐛 8 | 🌐 Java | 📅 2026-08-03 Command line Java Decompiler
* \[**232**星]\[1y] \[C++] [wwwg/wasmdec](https://github.com/wwwg/wasmdec) ⭐ 426 | 🐛 12 | 🌐 C++ | 📅 2024-02-07 WebAssembly to C decompiler
...
* \[**1374**星]\[20d] \[C] [zyantific/zydis](https://github.com/zyantific/zydis) ⭐ 4,324 | 🐛 51 | 🌐 C | 📅 2026-07-27 快速的轻量级x86/x86-64 反汇编库
* \[**430**星]\[2m] \[C#] [0xd4d/iced](https://github.com/0xd4d/iced) ⭐ 3,551 | 🐛 55 | 🌐 Rust | 📅 2026-08-12 x86/x64 disassembler, instruction decoder & encoder
* \[**835**星]\[8d] \[GLSL] [khronosgroup/spirv-cross](https://github.com/khronosgroup/spirv-cross) ⭐ 2,484 | 🐛 150 | 🌐 GLSL | 📅 2026-07-31  a practical tool and library for performing reflection on SPIR-V and disassembling SPIR-V back to high level languages.
...
* \[**246**星]\[5m] \[Py] [bontchev/pcodedmp](https://github.com/bontchev/pcodedmp) ⭐ 490 | 🐛 3 | 🌐 Python | 📅 2021-06-12 A VBA p-code disassembler
...
* \[**6052**星]\[13d] \[Py] [cyrus-and/gdb-dashboard](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,239 | 🐛 19 | 🌐 Python | 📅 2026-07-17 Modular visual interface for GDB in Python
* \[**2439**星]\[16d] \[Py] [pwndbg/pwndbg](https://github.com/pwndbg/pwndbg) ⭐ 10,755 | 🐛 210 | 🌐 Python | 📅 2026-08-09 GDB插件，辅助漏洞开发和逆向
* \[**7019**星]\[10d] \[JS] [cs01/gdbgui](https://github.com/cs01/gdbgui) ⭐ 10,348 | 🐛 179 | 🌐 TypeScript | 📅 2025-06-29 Browser-based frontend to gdb (gnu debugger). Add breakpoints, view the stack, visualize data structures, and more in C, C++, Go, Rust, and Fortran. Run gdbgui from the terminal and a new tab will open in your browser.
* \[**2568**星]\[1m] \[Py] [hugsy/gef](https://github.com/hugsy/gef) ⭐ 8,314 | 🐛 16 | 🌐 Python | 📅 2026-06-16 gdb增强工具，使用Python API，用于漏洞开发和逆向分析。
...
* \[**452**星]\[3m] \[Py] [scwuaptx/pwngdb](https://github.com/scwuaptx/pwngdb) ⭐ 971 | 🐛 14 | 🌐 Python | 📅 2025-08-29 gdb for pwn
...
* \[**446**星]\[1y] \[Py] [jfoote/exploitable](https://github.com/jfoote/exploitable) ⭐ 749 | 🐛 8 | 🌐 Python | 📅 2022-08-13 The 'exploitable' GDB plugin. I don't work at CERT anymore, but here is the original homepage:
* \[**244**星]\[2m] \[JS] [bet4it/hyperpwn](https://github.com/bet4it/hyperpwn) ⭐ 640 | 🐛 3 | 🌐 JavaScript | 📅 2025-04-28 A hyper plugin to provide a flexible GDB GUI with the help of GEF, pwndbg or peda
...
* \[**1419**星]\[9m] \[C] [namhyung/uftrace](https://github.com/namhyung/uftrace) ⭐ 3,451 | 🐛 398 | 🌐 C | 📅 2026-08-09 Function (graph) tracer for user-space
...
* \[**11588**星]\[12d] \[C] [radareorg/radare2](https://github.com/radareorg/radare2) ⭐ 24,562 | 🐛 823 | 🌐 C | 📅 2026-08-12 unix-like reverse engineering framework and commandline tools

### <a id="6922457cb0d4b6b87a34caf39aa31dfe"></a>新添加的

* \[**339**星]\[28d] \[TeX] [radareorg/radare2book](https://github.com/radareorg/radare2book) ⭐ 904 | 🐛 42 | 🌐 C | 📅 2026-08-11 Radare2 official book
* \[**259**星]\[1m] \[C] [radareorg/r2dec-js](https://github.com/radareorg/r2dec-js) ⭐ 606 | 🐛 35 | 🌐 JavaScript | 📅 2026-07-27 radare2插件,将汇编代码反编译为C伪代码
...
* \[**258**星]\[4m] \[Rust] [radareorg/radeco](https://github.com/radareorg/radeco) ⭐ 396 | 🐛 91 | 🌐 Rust | 📅 2026-05-06 radare2-based decompiler and symbol executor
...
* \[**2820**星]\[1m] \[Py] [androguard/androguard](https://github.com/androguard/androguard) ⭐ 6,190 | 🐛 46 | 🌐 Python | 📅 2026-06-05 Reverse engineering, Malware and goodware analysis of Android applications ... and more (ninja !)
* \[**328**星]\[5m] \[Py] [vector35/binaryninja-api](https://github.com/vector35/binaryninja-api) ⭐ 1,290 | 🐛 1,920 | 🌐 C++ | 📅 2026-08-13 Public API, examples, documentation and issues for Binary Ninja
...
* \[**634**星]\[10d] \[C] [thewover/donut](https://github.com/thewover/donut) ⭐ 4,686 | 🐛 36 | 🌐 C | 📅 2025-07-08 Generates x86, x64, or AMD64+x86 position-independent shellcode that loads .NET Assemblies, PE files, and other Windows payloads from memory and runs them with parameters
* \[**388**星]\[1y] \[Assembly] [hasherezade/pe\_to\_shellcode](https://github.com/hasherezade/pe_to_shellcode) ⭐ 2,790 | 🐛 16 | 🌐 C++ | 📅 2025-08-30 Converts PE into a shellcode
* \[**877**星]\[8m] \[Py] [erocarrera/pefile](https://github.com/erocarrera/pefile) ⭐ 2,062 | 🐛 65 | 🌐 Python | 📅 2026-08-12 pefile is a Python module to read and work with PE (Portable Executable) files
* \[**344**星]\[1y] \[Assembly] [egebalci/amber](https://github.com/egebalci/amber) ⭐ 1,433 | 🐛 5 | 🌐 Go | 📅 2024-02-22 反射式PE加壳器，用于绕过安全产品和缓解措施
* \[**296**星]\[12d] \[C++] [hasherezade/libpeconv](https://github.com/hasherezade/libpeconv) ⭐ 1,380 | 🐛 16 | 🌐 C++ | 📅 2026-04-18 用于映射和取消映射PE 文件的库
* \[**537**星]\[1y] \[C#] [ghostpack/safetykatz](https://github.com/ghostpack/safetykatz) ⭐ 1,329 | 🐛 5 | 🌐 C# | 📅 2019-10-01 Mimikatz和 .NET PE Loader的结合
...
* \[**316**星]\[24d] \[C++] [trailofbits/pe-parse](https://github.com/trailofbits/pe-parse) ⭐ 907 | 🐛 17 | 🌐 C++ | 📅 2026-08-05 Principled, lightweight C/C++ PE parser
* \[**315**星]\[14d] \[VBA] [itm4n/vba-runpe](https://github.com/itm4n/vba-runpe) ⚠️ Archived A VBA implementation of the RunPE technique or how to bypass application whitelisting.
* \[**285**星]\[7m] \[Java] [katjahahn/portex](https://github.com/katjahahn/portex) ⭐ 532 | 🐛 3 | 🌐 Scala | 📅 2026-04-03 Java library to analyse Portable Executable files with a special focus on malware analysis and PE malformation robustness
* \[**337**星]\[5m] \[C] [merces/pev](https://github.com/merces/pev) ⭐ 3 | 🐛 0 | 📅 2023-04-20 The PE file analysis toolkit
...
* \[**1915**星]\[22d] \[C#] [lucasg/dependencies](https://github.com/lucasg/dependencies) ⭐ 11,754 | 🐛 142 | 🌐 C# | 📅 2024-05-15 A rewrite of the old legacy software "depends.exe" in C# for Windows devs to troubleshoot dll load dependencies issues.
* \[**1146**星]\[27d] \[C#] [perfare/il2cppdumper](https://github.com/perfare/il2cppdumper) ⭐ 9,295 | 🐛 156 | 🌐 C# | 📅 2024-08-18 Restore dll from Unity il2cpp binary file (except code)
* \[**1333**星]\[10m] \[C] [fancycode/memorymodule](https://github.com/fancycode/memorymodule) ⭐ 3,154 | 🐛 58 | 🌐 C | 📅 2024-01-03 Library to load a DLL from memory.
* \[**793**星]\[11m] \[C#] [terminals-origin/terminals](https://github.com/terminals-origin/terminals) ⭐ 1,365 | 🐛 177 | 🌐 C# | 📅 2026-03-22 Terminals is a secure, multi tab terminal services/remote desktop client. It uses Terminal Services ActiveX Client (mstscax.dll). The project started from the need of controlling multiple connections simultaneously. It is a complete replacement for the mstsc.exe (Terminal Services) client. This is official source moved from Codeplex.
* \[**363**星]\[19d] \[C#] [3f/dllexport](https://github.com/3f/dllexport) ⭐ 1,097 | 🐛 22 | 🌐 C# | 📅 2025-06-08 .NET DllExport
* \[**230**星]\[1y] \[C#] [misaka-mikoto-tech/monohooker](https://github.com/Misaka-Mikoto-Tech/MonoHooker) ⭐ 1,057 | 🐛 9 | 🌐 C# | 📅 2023-09-22 hook C# method at runtime without modify dll file (such as UnityEditor.dll)
* \[**215**星]\[6m] \[C#] [erfg12/memory.dll](https://github.com/erfg12/memory.dll) ⭐ 975 | 🐛 23 | 🌐 C# | 📅 2025-11-26 C# Hacking library for making PC game trainers.
* \[**388**星]\[7m] \[C++] [hasherezade/dll\_to\_exe](https://github.com/hasherezade/dll_to_exe) ⭐ 815 | 🐛 2 | 🌐 C++ | 📅 2023-07-23 Converts a DLL into EXE
* \[**240**星]\[10m] \[C++] [wbenny/detoursnt](https://github.com/wbenny/detoursnt) ⭐ 682 | 🐛 1 | 🌐 C++ | 📅 2025-11-25 Detours with just single dependency - NTDLL
...
* \[**713**星]\[5m] \[C++] [darthton/xenos](https://github.com/darthton/xenos) ⭐ 2,629 | 🐛 51 | 🌐 C++ | 📅 2021-05-17 Windows DLL 注入器
* \[**588**星]\[2m] \[PS] [monoxgas/srdi](https://github.com/monoxgas/srdi) ⭐ 2,546 | 🐛 16 | 🌐 PowerShell | 📅 2023-11-15 Shellcode implementation of Reflective DLL Injection. Convert DLLs to position independent shellcode
...
* 2018.09 \[pediy] [\[原创\]win10\_arm64 驱动注入dll 到 arm32程序](https://bbs.pediy.com/thread-247032.htm)
...
* \[**299**星]\[11m] \[C++] [anhkgg/superdllhijack](https://github.com/anhkgg/superdllhijack) ⭐ 1,035 | 🐛 5 | 🌐 C++ | 📅 2021-11-10 一种通用Dll劫持技术，不再需要手工导出Dll的函数接口了
* \[**431**星]\[7m] \[Pascal] [mojtabatajik/robber](https://github.com/mojtabatajik/robber) ⭐ 798 | 🐛 0 | 🌐 Pascal | 📅 2026-07-08 查找易于发生DLL劫持的可执行文件
...
* \[**2355**星]\[11d] \[C] [hfiref0x/uacme](https://github.com/hfiref0x/uacme) ⭐ 7,750 | 🐛 0 | 🌐 C | 📅 2026-07-24 Defeating Windows User Account Control
* \[**2307**星]\[1m] \[PS] [k8gege/k8tools](https://github.com/k8gege/k8tools) ⭐ 6,196 | 🐛 10 | 🌐 PowerShell | 📅 2025-01-25 K8工具合集(内网渗透/提权工具/远程溢出/漏洞利用/扫描工具/密码破解/免杀工具/Exploit/APT/0day/Shellcode/Payload/priviledge/BypassUAC/OverFlow/WebShell/PenTest) Web GetShell Exploit(Struts2/Zimbra/Weblogic/Tomcat/Apache/Jboss/DotNetNuke/zabbix)
...
* \[**206**星]\[1y] \[JS] [jpcertcc/sysmonsearch](https://github.com/jpcertcc/sysmonsearch) ⭐ 432 | 🐛 15 | 🌐 JavaScript | 📅 2023-12-22 Investigate suspicious activity by visualizing Sysmon's event log
...
* \[**1228**星]\[10d] \[JS] [jpcertcc/logontracer](https://github.com/jpcertcc/logontracer) ⭐ 3,209 | 🐛 21 | 🌐 Python | 📅 2026-08-02 通过可视化和分析Windows事件日志来调查恶意的Windows登录
* \[**609**星]\[19d] \[PS] [sbousseaden/evtx-attack-samples](https://github.com/sbousseaden/evtx-attack-samples) ⭐ 2,604 | 🐛 5 | 🌐 HTML | 📅 2023-01-24 与特定攻击和利用后渗透技术相关的Windows事件样例
* \[**261**星]\[3m] \[C++] [gametechdev/presentmon](https://github.com/gametechdev/presentmon) ⭐ 2,521 | 🐛 197 | 🌐 C++ | 📅 2026-08-12 Tool for collection and processing of ETW events related to DXGI presentation.
* \[**479**星]\[5m] \[PS] [sans-blue-team/deepbluecli](https://github.com/sans-blue-team/deepbluecli) ⭐ 2,427 | 🐛 13 | 🌐 PowerShell | 📅 2023-10-14 a PowerShell Module for Threat Hunting via Windows Event Logs
...
* \[**446**星]\[9m] \[PS] [nsacyber/event-forwarding-guidance](https://github.com/nsacyber/Event-Forwarding-Guidance) ⭐ 890 | 🐛 8 | 🌐 PowerShell | 📅 2020-11-17 帮助管理员使用Windows事件转发（WEF）收集与安全相关的Windows事件日志
* \[**282**星]\[3m] \[C#] [fireeye/silketw](https://github.com/fireeye/silketw) ⚠️ Archived flexible C# wrappers for ETW
* \[**249**星]\[3m] \[C++] [microsoft/krabsetw](https://github.com/microsoft/krabsetw) ⭐ 796 | 🐛 18 | 🌐 C++ | 📅 2026-08-12 KrabsETW provides a modern C++ wrapper and a .NET wrapper around the low-level ETW trace consumption functions.
* \[**393**星]\[10m] \[Py] [williballenthin/python-evtx](https://github.com/williballenthin/python-evtx) ⭐ 777 | 🐛 24 | 🌐 Python | 📅 2026-03-19 纯Python编写的Windows事件日志解析器
* \[**504**星]\[10m] \[C#] [lowleveldesign/wtrace](https://github.com/lowleveldesign/wtrace) ⭐ 695 | 🐛 0 | 🌐 C# | 📅 2025-10-15 Command line tracing tool for Windows, based on ETW.
* \[**341**星]\[1y] \[C++] [qax-a-team/eventcleaner](https://github.com/QAX-A-Team/EventCleaner) ⭐ 609 | 🐛 8 | 🌐 C++ | 📅 2018-09-07 A tool mainly to erase specified records from Windows event logs, with additional functionalities.
...
* \[**282**星]\[10m] \[C#] [nsacyber/windows-event-log-messages](https://github.com/nsacyber/Windows-Event-Log-Messages) ⚠️ Archived 检索Windows二进制文件中嵌入的Windows事件日志消息的定义，并以discoverable的格式提供它们
...
* \[**921**星]\[7m] \[PS] [api0cradle/ultimateapplockerbypasslist](https://github.com/api0cradle/ultimateapplockerbypasslist) ⭐ 2,078 | 🐛 10 | 🌐 PowerShell | 📅 2023-09-11 The goal of this repository is to document the most common techniques to bypass AppLocker.
...
* \[**9261**星]\[11d] \[C#] [icsharpcode/ilspy](https://github.com/icsharpcode/ilspy) ⭐ 25,850 | 🐛 200 | 🌐 C# | 📅 2026-08-12 .NET Decompiler
...
* \[**1657**星]\[14d] \[C#] [jbevain/cecil](https://github.com/jbevain/cecil) ⭐ 2,991 | 🐛 110 | 🌐 C# | 📅 2025-09-11 C#库, 探查/修改/生成 .NET App/库
* \[**217**星]\[11m] \[C#] [rainwayapp/warden](https://github.com/rainwayapp/warden) ⚠️ Archived Warden.NET is an easy to use process management library for keeping track of processes on Windows.

### <a id="6d2fe834b7662ecdd48c17163f732daf"></a>Environment&&环境&&配置

* \[**1347**星]\[1m] \[Go] [securitywithoutborders/hardentools](https://github.com/securitywithoutborders/hardentools) ⭐ 3,105 | 🐛 12 | 🌐 Go | 📅 2025-08-10 禁用许多有危险的Windows功能
...
* \[**508**星]\[17d] \[PS] [stefanscherer/packer-windows](https://github.com/stefanscherer/packer-windows) ⭐ 1,365 | 🐛 17 | 🌐 PowerShell | 📅 2025-06-08 Windows Packer 模板：Win10, Server 2016, 1709, 1803, 1809, 2019, 1903, Insider with Docker
...
* \[**1348**星]\[22d] \[C] [intel/haxm](https://github.com/intel/haxm) ⚠️ Archived Intel 开源的英特尔硬件加速执行管理器，通过硬件辅助的虚拟化引擎，加速 Windows/macOS 主机上的 IA emulation（(x86/ x86\_64) ）
* \[**1011**星]\[1y] \[C] [ionescu007/simplevisor](https://github.com/ionescu007/simplevisor) ⭐ 1,980 | 🐛 11 | 🌐 C | 📅 2024-05-08 英特尔VT-x虚拟机管理程序，简单、可移植。支持Windows和UEFI
* \[**717**星]\[23d] \[C++] [tandasat/hyperplatform](https://github.com/tandasat/hyperplatform) ⚠️ Archived 基于Intel VT-x的虚拟机管理程序，旨在在Windows上提供精简的VM-exit过滤平台
* \[**570**星]\[12m] \[C] [asamy/ksm](https://github.com/asamy/ksm) ⭐ 863 | 🐛 13 | 🌐 C | 📅 2021-10-20 快速、hackable且简单的x64 VT-x虚拟机管理程序，支持Windows和Linux
  * 重复区段: [Linux->工具->新添加](#203d00ef3396d68f5277c90279f4ebf3) |

### <a id="c3cda3278305549f4c21df25cbf638a4"></a>内核&&驱动

* \[**781**星]\[19d] [axtmueller/windows-kernel-explorer](https://github.com/axtmueller/windows-kernel-explorer) ⭐ 2,714 | 🐛 0 | 📅 2025-12-14 Windows内核研究工具
* \[**510**星]\[5m] \[Py] [rabbitstack/fibratus](https://github.com/rabbitstack/fibratus) ⭐ 2,516 | 🐛 43 | 🌐 Go | 📅 2026-08-12 Windows内核探索和跟踪工具
* \[**479**星]\[1m] \[C] [jkornev/hidden](https://github.com/jkornev/hidden) ⭐ 2,050 | 🐛 13 | 🌐 C | 📅 2022-07-13 Windows驱动，带用户模式接口：隐藏文件系统和注册表对象、保护进程等
* \[**933**星]\[9m] \[C] [microsoft/windows-driver-frameworks](https://github.com/microsoft/windows-driver-frameworks) ⭐ 1,320 | 🐛 8 | 🌐 C | 📅 2024-09-10 Windows驱动框架(WDF)
* \[**278**星]\[12d] \[PS] [microsoftdocs/windows-driver-docs](https://github.com/MicrosoftDocs/windows-driver-docs) ⭐ 1,057 | 🐛 7 | 🌐 OpenSCAD | 📅 2026-08-07 官方Windows驱动程序工具包文档

### <a id="920b69cea1fc334bbc21a957dd0d9f6f"></a>注册表

* \[**288**星]\[8m] \[Py] [williballenthin/python-registry](https://github.com/williballenthin/python-registry) ⭐ 447 | 🐛 20 | 🌐 Python | 📅 2025-01-27 用于对Windows NT注册表文件进行纯读取访问的Python库
...
* \[**725**星]\[2m] \[HTML] [j00ru/windows-syscalls](https://github.com/j00ru/windows-syscalls) ⭐ 2,629 | 🐛 3 | 🌐 HTML | 📅 2025-12-30 Windows 系统调用表(NT/2000/XP/2003/Vista/2008/7/2012/8/10)
* \[**328**星]\[2m] \[C] [hfiref0x/syscalltables](https://github.com/hfiref0x/syscalltables) ⭐ 1,455 | 🐛 0 | 🌐 C | 📅 2026-07-04 Windows NT x64系统调用表

### <a id="1afda3039b4ab9a3a1f60b179ccb3e76"></a>其他

* \[**863**星]\[14d] \[C++] [henrypp/simplewall](https://github.com/henrypp/simplewall) ⭐ 8,834 | 🐛 143 | 🌐 C | 📅 2026-08-12 为Windows 过滤平台提供的配置界面
* \[**949**星]\[3m] \[C] [basil00/divert](https://github.com/basil00/divert) ⭐ 3,254 | 🐛 64 | 🌐 C | 📅 2023-03-15 用户模式数据包拦截库，适用于Win 7/8/10
* \[**360**星]\[12d] \[C#] [digitalruby/ipban](https://github.com/digitalruby/ipban) ⭐ 2,176 | 🐛 2 | 🌐 C# | 📅 2026-08-10 监视Windows/Linux系统的登录失败和不良行为，并封禁对应的IP地址。高度可配置，精简且功能强大。
...
* \[**570**星]\[1m] \[C] [hfiref0x/winobjex64](https://github.com/hfiref0x/winobjex64) ⭐ 1,966 | 🐛 1 | 🌐 C | 📅 2026-08-08 Windows对象浏览器. x64
* \[**726**星]\[2m] \[Py] [diyan/pywinrm](https://github.com/diyan/pywinrm) ⭐ 1,137 | 🐛 54 | 🌐 Python | 📅 2026-08-04 Python实现的WinRM客户端
* \[**418**星]\[15d] \[C] [samba-team/samba](https://github.com/samba-team/samba) ⭐ 1,117 | 🐛 1 | 🌐 C | 📅 2026-08-11 适用于Linux和Unix的标准Windows interoperability程序套件
...
* \[**210**星]\[3m] [adguardteam/adguardforwindows](https://github.com/adguardteam/adguardforwindows) ⭐ 875 | 🐛 213 | 📅 2026-07-28 Windows系统范围的AdBlocker
* \[**389**星]\[2m] \[C#] [microsoft/binskim](https://github.com/microsoft/binskim) ⭐ 858 | 🐛 162 | 🌐 C# | 📅 2026-08-13 二进制静态分析工具，可为PE和ELF二进制格式提供安全性和正确性分析
* \[**238**星]\[5m] \[PS] [microsoft/aaronlocker](https://github.com/microsoft/aaronlocker) ⭐ 705 | 🐛 16 | 🌐 PowerShell | 📅 2022-08-12 Windows应用程序白名单
...
* \[**233**星]\[10m] \[Go] [masterzen/winrm](https://github.com/masterzen/winrm) ⭐ 479 | 🐛 50 | 🌐 Go | 📅 2026-04-07 Windows远程命令执行，命令行工具+库，Go编写
* \[**370**星]\[27d] \[Ruby] [winrb/winrm](https://github.com/winrb/winrm) ⭐ 423 | 🐛 32 | 🌐 Ruby | 📅 2025-10-30 在Windows中使用WinRM的功能调用原生对象的SOAP库。Ruby编写
* \[**226**星]\[1y] \[C++] [rexdf/commandtrayhost](https://github.com/rexdf/commandtrayhost) ⭐ 420 | 🐛 19 | 🌐 C++ | 📅 2020-11-13 监控Windows systray的命令行工具
* \[**232**星]\[1y] \[C++] [ionescu007/simpleator](https://github.com/ionescu007/simpleator) ⭐ 403 | 🐛 5 | 🌐 C++ | 📅 2018-12-10 Windows x64用户模式应用程序模拟器
* \[**205**星]\[3m] \[C] [jasonwhite/ducible](https://github.com/jasonwhite/ducible) ⚠️ Archived 使PE和PDB的构建具有可复制性
...
* \[**787**星]\[2m] \[C] [nixos/patchelf](https://github.com/nixos/patchelf) ⭐ 4,236 | 🐛 146 | 🌐 C | 📅 2026-07-27 A small utility to modify the dynamic linker and RPATH of ELF executables
* \[**930**星]\[15d] \[Py] [eliben/pyelftools](https://github.com/eliben/pyelftools) ⭐ 2,269 | 🐛 56 | 🌐 Python | 📅 2026-07-30 Parsing ELF and DWARF in Python
...
* \[**233**星]\[2m] \[C] [elfmaster/libelfmaster](https://github.com/elfmaster/libelfmaster) ⭐ 455 | 🐛 18 | 🌐 C | 📅 2026-01-26 Secure ELF parsing/loading library for forensics reconstruction of malware, and robust reverse engineering tools
...
* 2019.10 \[aliyun] [64 位 elf 的 one\_gadget 通杀思路](https://xz.aliyun.com/t/6598)
...
* 2018.10 \[k3170makan] [Introduction to the ELF Format (Part VI) : More Relocation tricks - r\_addend execution (Part 3)](http://blog.k3170makan.com/2018/10/introduction-to-elf-format-part-vi-more.html)
...
* 2018.10 \[k3170makan] [Introduction to the ELF Format (Part V) : Understanding C start up .init\_array and .fini\_array sections](http://blog.k3170makan.com/2018/10/introduction-to-elf-format-part-v.html)
...
* \[**1450**星]\[2m] \[C] [feralinteractive/gamemode](https://github.com/feralinteractive/gamemode) ⭐ 5,963 | 🐛 215 | 🌐 C | 📅 2026-06-15 Optimise Linux system performance on demand
* \[**1413**星]\[21d] \[C++] [google/nsjail](https://github.com/google/nsjail) ⭐ 4,046 | 🐛 61 | 🌐 C++ | 📅 2026-07-27 A light-weight process isolation tool, making use of Linux namespaces and seccomp-bpf syscall filters (with help of the kafel bpf language)
* \[**759**星]\[1m] \[Py] [korcankaraokcu/pince](https://github.com/korcankaraokcu/pince) ⭐ 3,053 | 🐛 6 | 🌐 Python | 📅 2026-08-08 A reverse engineering tool that'll supply the place of Cheat Engine for linux
* \[**731**星]\[17d] \[C] [strace/strace](https://github.com/strace/strace) ⭐ 2,667 | 🐛 110 | 🌐 C | 📅 2026-08-10 strace is a diagnostic, debugging and instructional userspace utility for Linux
* \[**895**星]\[29d] \[C] [buserror/simavr](https://github.com/buserror/simavr) ⭐ 1,782 | 🐛 51 | 🌐 C | 📅 2026-08-09 simavr is a lean, mean and hackable AVR simulator for linux & OSX
* \[**565**星]\[12d] \[C++] [intel/linux-sgx](https://github.com/intel/linux-sgx) ⭐ 1,448 | 🐛 140 | 🌐 C++ | 📅 2026-08-12 Intel SGX for Linux\*
* \[**741**星]\[2m] \[C] [yrp604/rappel](https://github.com/yrp604/rappel) ⭐ 1,276 | 🐛 2 | 🌐 C | 📅 2024-03-07 A linux-based assembly REPL for x86, amd64, armv7, and armv8
* \[**536**星]\[5m] \[C++] [nytrorst/shellcodecompiler](https://github.com/nytrorst/shellcodecompiler) ⭐ 1,160 | 🐛 1 | 🌐 C++ | 📅 2024-09-01 将C/C ++样式代码编译成一个小的、与位置无关且无NULL的Shellcode，用于Windows（x86和x64）和Linux（x86和x64）
* \[**509**星]\[8m] \[C] [iovisor/ply](https://github.com/iovisor/ply) ⭐ 1,030 | 🐛 8 | 🌐 C | 📅 2025-08-22 Dynamic Tracing in Linux
* \[**468**星]\[9d] \[C] [libreswan/libreswan](https://github.com/libreswan/libreswan) ⭐ 1,004 | 🐛 635 | 🌐 C | 📅 2026-08-13 an Internet Key Exchange (IKE) implementation for Linux.
* \[**354**星]\[2m] \[C] [seccomp/libseccomp](https://github.com/seccomp/libseccomp) ⭐ 929 | 🐛 53 | 🌐 C | 📅 2026-07-01 an easy to use, platform independent, interface to the Linux Kernel's syscall filtering mechanism
* \[**570**星]\[12m] \[C] [asamy/ksm](https://github.com/asamy/ksm) ⭐ 863 | 🐛 13 | 🌐 C | 📅 2021-10-20 快速、hackable且简单的x64 VT-x虚拟机管理程序，支持Windows和Linux
...
* \[**560**星]\[2m] \[Py] [autotest/autotest](https://github.com/autotest/autotest) ⭐ 723 | 🐛 123 | 🌐 Python | 📅 2024-02-21 Fully automated tests on Linux
* \[**441**星]\[12d] \[C] [facebook/openbmc](https://github.com/facebook/openbmc) ⭐ 683 | 🐛 60 | 🌐 C | 📅 2026-08-13 OpenBMC is an open software framework to build a complete Linux image for a Board Management Controller (BMC).
* \[**228**星]\[8m] \[C] [wkz/ply](https://github.com/wkz/ply) ⭐ 434 | 🐛 4 | 🌐 C | 📅 2025-12-02 Light-weight Dynamic Tracer for Linux
