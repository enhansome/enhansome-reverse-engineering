...
* [全平台逆向资源: awesome-reverse-engineering](https://github.com/alphaSeclab/awesome-reverse-engineering) ⭐ 5,048 | 🐛 7 | 📅 2021-09-01:
...
* 此页只包含部分内容. [查看完整版](https://github.com/alphaSeclab/awesome-reverse-engineering/blob/master/Readme_full.md) ⭐ 5,048 | 🐛 7 | 📅 2021-09-01
* 跟逆向有关的资源收集。当前包括的工具个数3500+，并根据功能进行了粗糙的分类。部分工具添加了中文描述。当前包括文章数2300+。

# 说明

[EnglishVersion](https://github.com/alphaSeclab/awesome-reverse-engineering/blob/master/Readme_en.md) ⭐ 5,048 | 🐛 7 | 📅 2021-09-01
...
* \[**5228**星]\[2m] \[Py] [refirmlabs/binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,337 | 🐛 92 | 🌐 Rust | 📅 2026-08-11 固件分析工具（命令行+IDA插件）
  * [IDA插件](https://github.com/ReFirmLabs/binwalk/tree/master/src/scripts) ⭐ 14,337 | 🐛 92 | 🌐 Rust | 📅 2026-08-11
  * [binwalk](https://github.com/ReFirmLabs/binwalk/tree/master/src/binwalk) ⭐ 14,337 | 🐛 92 | 🌐 Rust | 📅 2026-08-11
...
* \[**1554**星]\[13d] \[Py] [joxeankoret/diaphora](https://github.com/joxeankoret/diaphora) ⭐ 4,397 | 🐛 48 | 🌐 Python | 📅 2026-09-04 program diffing
...
* \[**382**星]\[26d] \[C++] [google/binexport](https://github.com/google/binexport) ⭐ 1,204 | 🐛 42 | 🌐 C++ | 📅 2026-09-10 将反汇编以Protocol Buffer的形式导出为PostgreSQL数据库, 导入到BinNavi中使用
...
* \[**1365**星]\[3m] \[Py] [fireeye/flare-floss](https://github.com/fireeye/flare-floss) ⭐ 4,148 | 🐛 117 | 🌐 Python | 📅 2026-09-13 自动从恶意代码中提取反混淆后的字符串
  * [floss](https://github.com/fireeye/flare-floss/tree/master/floss) ⭐ 4,148 | 🐛 117 | 🌐 Python | 📅 2026-09-13
  * [IDA插件](https://github.com/fireeye/flare-floss/blob/master/scripts/idaplugin.py) ⭐ 4,148 | 🐛 117 | 🌐 Python | 📅 2026-09-13
...
* \[**18649**星]\[10d] \[Java] [nationalsecurityagency/ghidra](https://github.com/nationalsecurityagency/ghidra) ⭐ 75,303 | 🐛 1,954 | 🌐 Java | 📅 2026-09-11 软件逆向框架
...
* \[**34576**星]\[1m] \[C++] [x64dbg/x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,501 | 🐛 585 | 🌐 C++ | 📅 2026-09-14 Windows平台x32/x64调试器
...
* \[**5195**星]\[19d] \[Py] [mobsf/mobile-security-framework-mobsf](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,762 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-09 Mobile Security Framework (MobSF) is an automated, all-in-one mobile application (Android/iOS/Windows) pen-testing, malware analysis and security assessment framework capable of performing static and dynamic analysis.
* \[**5084**星]\[15d] \[HTML] [owasp/owasp-mstg](https://github.com/owasp/owasp-mstg) ⭐ 13,181 | 🐛 241 | 🌐 Python | 📅 2026-09-13 关于移动App安全开发、测试和逆向的相近手册
* \[**4306**星]\[15d] \[Shell] [ashishb/android-security-awesome](https://github.com/ashishb/android-security-awesome) ⭐ 9,688 | 🐛 0 | 🌐 Makefile | 📅 2026-09-07 A collection of android security related resources
* \[**2051**星]\[21d] \[Py] [sensepost/objection](https://github.com/sensepost/objection) ⭐ 9,384 | 🐛 57 | 🌐 Python | 📅 2026-07-23 runtimemobile exploration
...
* \[**4776**星]\[12d] \[C++] [facebook/redex](https://github.com/facebook/redex) ⭐ 6,301 | 🐛 73 | 🌐 C++ | 📅 2026-09-13 Android App字节码优化器
...
* \[**443**星]\[1m] \[TS] [shroudedcode/apk-mitm](https://github.com/shroudedcode/apk-mitm) ⭐ 5,109 | 🐛 83 | 🌐 TypeScript | 📅 2024-07-24
* \[**2011**星]\[8m] \[Py] [fsecurelabs/drozer](https://github.com/FSecureLABS/drozer) ⭐ 4,611 | 🐛 9 | 🌐 Python | 📅 2026-04-08 The Leading Security Assessment Framework for Android.
...
* \[**431**星]\[13d] \[C] [guardianproject/orbot](https://github.com/guardianproject/orbot) ⭐ 3,537 | 🐛 84 | 🌐 Kotlin | 📅 2026-09-13 The Github home of Orbot: Tor on Android (Also available on gitlab!)
* \[**2120**星]\[9m] \[Py] [linkedin/qark](https://github.com/linkedin/qark) ⭐ 3,386 | 🐛 79 | 🌐 Python | 📅 2024-01-16 查找Android App的漏洞, 支持源码或APK文件
...
* \[**559**星]\[14d] \[Shell] [owasp/owasp-masvs](https://github.com/owasp/owasp-masvs) ⭐ 2,448 | 🐛 4 | 🌐 Python | 📅 2025-12-22 OWASP 移动App安全标准
* \[**1235**星]\[2m] \[Java] [find-sec-bugs/find-sec-bugs](https://github.com/find-sec-bugs/find-sec-bugs) ⭐ 2,445 | 🐛 115 | 🌐 Java | 📅 2026-03-26 The SpotBugs plugin for security audits of Java web applications and Android applications. (Also work with Kotlin, Groovy and Scala projects)
...
* \[**546**星]\[2m] [nordicsemiconductor/android-nrf-connect](https://github.com/nordicsemiconductor/android-nrf-connect) ⭐ 1,694 | 🐛 57 | 📅 2025-08-28 Documentation and issue tracker for nRF Connect for Android.
...
* \[**409**星]\[3m] \[CSS] [angea/pocorgtfo](https://github.com/angea/pocorgtfo) ⭐ 1,611 | 🐛 1 | 🌐 TeX | 📅 2024-02-11 a "Proof of Concept or GTFO" mirror with extra article index, direct links and clean PDFs.
* \[**265**星]\[11d] \[Py] [den4uk/andriller](https://github.com/den4uk/andriller) ⭐ 1,607 | 🐛 12 | 🌐 Python | 📅 2022-06-27 a collection of forensic tools for smartphones
...
* \[**511**星]\[9d] \[Java] [happylishang/cacheemulatorchecker](https://github.com/happylishang/cacheemulatorchecker) ⭐ 1,490 | 🐛 36 | 🌐 Java | 📅 2023-12-13 Android模拟器检测，检测Android模拟器 ，获取相对真实的IMEI AndroidId 序列号 MAC地址等，作为DeviceID，应对防刷需求等
...
* \[**12285**星]\[11d] \[Java] [signalapp/signal-android](https://github.com/signalapp/Signal-Android) ⭐ 29,331 | 🐛 504 | 🌐 Kotlin | 📅 2026-09-10 A private messenger for Android.

### <a id="7f353b27e45b5de6b0e6ac472b02cbf1"></a>Xposed

* \[**8756**星]\[2m] \[Java] [android-hacker/virtualxposed](https://github.com/android-hacker/virtualxposed) ⭐ 16,058 | 🐛 162 | 🌐 Java | 📅 2024-03-08 A simple app to use Xposed without root, unlock the bootloader or modify system image, etc.
...
* \[**1465**星]\[3m] \[C++] [vaibhavpandeyvpz/apkstudio](https://github.com/vaibhavpandeyvpz/apkstudio) ⭐ 4,649 | 🐛 4 | 🌐 C++ | 📅 2026-01-05 Open-source, cross platform Qt based IDE for reverse-engineering Android application packages.
* \[**1793**星]\[8m] \[C++] [wrbug/dumpdex](https://github.com/wrbug/dumpdex) ⭐ 3,159 | 🐛 38 | 🌐 C++ | 📅 2020-05-15 Android脱壳
* \[**366**星]\[3m] \[Java] [patrickfav/uber-apk-signer](https://github.com/patrickfav/uber-apk-signer) ⭐ 2,744 | 🐛 11 | 🌐 Java | 📅 2023-10-30 A cli tool that helps signing and zip aligning single or multiple Android application packages (APKs) with either debug or provided release certificates. It supports v1, v2 and v3 Android signing scheme has an embedded debug keystore and auto verifies after signing.
* \[**712**星]\[2m] \[YARA] [rednaga/apkid](https://github.com/rednaga/apkid) ⭐ 2,573 | 🐛 84 | 🌐 YARA | 📅 2026-09-02 Android Application Identifier for Packers, Protectors, Obfuscators and Oddities - PEiD for Android
...
* \[**1492**星]\[1y] \[C++] [f1xpl/openauto](https://github.com/f1xpl/openauto) ⭐ 2,921 | 🐛 37 | 🌐 C++ | 📅 2024-12-12 AndroidAuto headunit emulator
...
* \[**10794**星]\[1m] \[Java] [konloch/bytecode-viewer](https://github.com/konloch/bytecode-viewer) ⭐ 15,643 | 🐛 103 | 🌐 Java | 📅 2026-07-17 A Java 8+ Jar & Android APK Reverse Engineering Suite (Decompiler, Editor, Debugger & More)
...
* \[**429**星]\[4m] \[Shell] [ashishb/android-malware](https://github.com/ashishb/android-malware) ⭐ 1,226 | 🐛 0 | 🌐 Shell | 📅 2025-12-31 Collection of android malware samples
...
* \[**9285**星]\[1m] \[Java] [ibotpeaches/apktool](https://github.com/ibotpeaches/apktool) ⭐ 25,556 | 🐛 77 | 🌐 Java | 📅 2026-09-04 A tool for reverse engineering Android apk files
* \[**2053**星]\[1m] \[Java] [genymobile/gnirehtet](https://github.com/genymobile/gnirehtet) ⭐ 7,904 | 🐛 326 | 🌐 Java | 📅 2024-08-11 Gnirehtet provides reverse tethering for Android
...
* \[**5451**星]\[3m] \[Py] [axi0mx/ipwndfu](https://github.com/axi0mx/ipwndfu) ⭐ 7,413 | 🐛 168 | 🌐 Python | 📅 2024-02-21 open-source jailbreaking tool for many iOS devices
...
* \[**5390**星]\[6m] \[C] [pwn20wndstuff/undecimus](https://github.com/pwn20wndstuff/undecimus) ⭐ 6,617 | 🐛 197 | 🌐 C | 📅 2021-08-01 unc0ver jailbreak for iOS 11.0 - 12.4
...
* \[**492**星]\[28d] \[Rust] [vadimcn/vscode-lldb](https://github.com/vadimcn/vscode-lldb) ⭐ 3,299 | 🐛 170 | 🌐 Rust | 📅 2026-08-23 A native debugger extension for VSCode based on LLDB
...
* \[**10966**星]\[10d] \[ObjC] [flipboard/flex](https://github.com/flipboard/flex) ⭐ 14,635 | 🐛 50 | 🌐 Objective-C | 📅 2026-06-11 An in-app debugging and exploration tool for iOS
* \[**4397**星]\[12d] \[Swift] [signalapp/signal-ios](https://github.com/signalapp/Signal-iOS) ⭐ 12,237 | 🐛 146 | 🌐 Swift | 📅 2026-09-11 A private messenger for iOS.
* \[**1215**星]\[16d] \[YARA] [horsicq/detect-it-easy](https://github.com/horsicq/detect-it-easy) ⭐ 11,528 | 🐛 34 | 🌐 JavaScript | 📅 2026-09-14 Program for determining types of files for Windows, Linux and MacOS.
...
* \[**4663**星]\[1m] \[C] [google/ios-webkit-debug-proxy](https://github.com/google/ios-webkit-debug-proxy) ⭐ 6,204 | 🐛 20 | 🌐 C | 📅 2025-07-02 A DevTools proxy (Chrome Remote Debugging Protocol) for iOS devices (Safari Remote Web Inspector).
* \[**5775**星]\[4m] \[ObjC] [square/ponydebugger](https://github.com/square/ponydebugger) ⭐ 5,849 | 🐛 46 | 🌐 Objective-C | 📅 2023-03-18 Remote network and data debugging for your native iOS app using Chrome Developer Tools
...
* \[**2867**星]\[12d] \[ObjC] [facebook/idb](https://github.com/facebook/idb) ⭐ 5,329 | 🐛 183 | 🌐 Swift | 📅 2026-09-12 idb is a flexible command line interface for automating iOS simulators and devices
...
* \[**310**星]\[28d] \[Swift] [securing/iossecuritysuite](https://github.com/securing/iossecuritysuite) ⭐ 2,722 | 🐛 8 | 🌐 Swift | 📅 2026-08-05 iOS platform security & anti-tampering Swift library
...
* \[**462**星]\[15d] \[Java] [dsheirer/sdrtrunk](https://github.com/dsheirer/sdrtrunk) ⭐ 2,181 | 🐛 447 | 🌐 Java | 📅 2026-08-01 A cross-platform java application for decoding, monitoring, recording and streaming trunked mobile and related radio protocols using Software Defined Radios (SDR). Website:
...
* \[**263**星]\[14d] \[ObjC] [strongbox-password-safe/strongbox](https://github.com/strongbox-password-safe/strongbox) ⭐ 1,461 | 🐛 230 | 🌐 Objective-C | 📅 2026-07-17 A KeePass/Password Safe Client for iOS and OS X
...
* \[**1228**星]\[12d] \[C] [dynamorio/dynamorio](https://github.com/dynamorio/dynamorio) ⭐ 3,161 | 🐛 1,804 | 🌐 C | 📅 2026-09-13 Dynamic Instrumentation Tool Platform
...
* \[**4516**星]\[13d] \[Makefile] [frida/frida](https://github.com/frida/frida) ⭐ 21,922 | 🐛 1,962 | 🌐 Meson | 📅 2026-09-09 Clone this repo to build Frida
...
* \[**420**星]\[13d] \[C] [frida/frida-python](https://github.com/frida/frida-python) ⭐ 873 | 🐛 56 | 🌐 Python | 📅 2026-09-09 Frida Python bindings
...
* \[**321**星]\[1m] \[C] [frida/frida-core](https://github.com/frida/frida-core) ⭐ 771 | 🐛 146 | 🌐 Vala | 📅 2026-09-13 Frida core library intended for static linking into bindings
...
* \[**584**星]\[1y] \[Java] [federicodotta/brida](https://github.com/federicodotta/brida) ⭐ 1,894 | 🐛 11 | 🌐 Java | 📅 2025-10-30 The new bridge between Burp Suite and Frida!
...
* \[**378**星]\[27d] \[JS] [nowsecure/r2frida](https://github.com/nowsecure/r2frida) ⭐ 1,439 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-13 Radare2 and Frida better together.
...
* \[**578**星]\[1y] \[C++] [qbdi/qbdi](https://github.com/QBDI/QBDI) ⭐ 1,820 | 🐛 20 | 🌐 C++ | 📅 2026-09-02 A Dynamic Binary Instrumentation framework based on LLVM.
...
* \[**14349**星]\[2m] \[Py] [corentinj/real-time-voice-cloning](https://github.com/corentinj/real-time-voice-cloning) ⭐ 60,132 | 🐛 177 | 🌐 Python | 📅 2026-03-09 Clone a voice in 5 seconds to generate arbitrary speech in real-time
* \[**2687**星]\[11d] \[Go] [adguardteam/adguardhome](https://github.com/adguardteam/adguardhome) ⭐ 36,870 | 🐛 1,245 | 🌐 TypeScript | 📅 2026-09-11 Network-wide ads & trackers blocking DNS server
* \[**10378**星]\[11d] \[Go] [goharbor/harbor](https://github.com/goharbor/harbor) ⭐ 29,359 | 🐛 894 | 🌐 Go | 📅 2026-09-11 An open source trusted cloud native registry project that stores, signs, and scans content.
...
* \[**5420**星]\[12d] \[Py] [mlflow/mlflow](https://github.com/mlflow/mlflow) ⭐ 27,937 | 🐛 2,094 | 🌐 Python | 📅 2026-09-14 Open source platform for the machine learning lifecycle
* \[**11402**星]\[10d] \[Java] [oracle/graal](https://github.com/oracle/graal) ⭐ 21,700 | 🐛 850 | 🌐 Java | 📅 2026-09-14 Run Programs Faster Anywhere
* \[**7020**星]\[14d] \[Go] [nats-io/nats-server](https://github.com/nats-io/nats-server) ⭐ 20,699 | 🐛 536 | 🌐 Go | 📅 2026-09-13 High-Performance server for NATS, the cloud native messaging system.
* \[**5753**星]\[18d] \[Go] [casbin/casbin](https://github.com/casbin/casbin) ⭐ 20,386 | 🐛 38 | 🌐 Go | 📅 2026-09-11 An authorization library that supports access control models like ACL, RBAC, ABAC in Golang
* \[**3608**星]\[9d] \[Pascal] [cheat-engine/cheat-engine](https://github.com/cheat-engine/cheat-engine) ⭐ 19,174 | 🐛 1,309 | 🌐 Pascal | 📅 2025-04-19 Cheat Engine. A development environment focused on modding
* \[**4610**星]\[1y] \[C] [upx/upx](https://github.com/upx/upx) ⭐ 17,872 | 🐛 21 | 🌐 C++ | 📅 2026-09-13 UPX - the Ultimate Packer for eXecutables
* \[**5226**星]\[13d] \[Shell] [denisidoro/navi](https://github.com/denisidoro/navi) ⭐ 17,542 | 🐛 112 | 🌐 Rust | 📅 2026-07-28 An interactive cheatsheet tool for the command-line
* \[**11213**星]\[2m] \[Jupyter Notebook] [selfteaching/the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 16,813 | 🐛 200 | 🌐 Jupyter Notebook | 📅 2026-05-20 One has no future if one couldn't teach themself.
* \[**2815**星]\[20d] \[C] [processhacker/processhacker](https://github.com/processhacker/processhacker) ⭐ 15,975 | 🐛 286 | 🌐 C | 📅 2026-09-13 A free, powerful, multi-purpose tool that helps you monitor system resources, debug software and detect malware.
* \[**3295**星]\[15d] \[JS] [koenkk/zigbee2mqtt](https://github.com/koenkk/zigbee2mqtt) ⭐ 15,632 | 🐛 457 | 🌐 TypeScript | 📅 2026-09-12 Zigbee
* \[**6894**星]\[2m] \[Go] [sqshq/sampler](https://github.com/sqshq/sampler) ⭐ 14,798 | 🐛 62 | 🌐 Go | 📅 2024-02-22 A tool for shell commands execution, visualization and alerting. Configured with a simple YAML file.
* \[**7748**星]\[10d] \[Go] [git-lfs/git-lfs](https://github.com/git-lfs/git-lfs) ⭐ 14,490 | 🐛 477 | 🌐 Go | 📅 2026-09-02 Git extension for versioning large files
* \[**5116**星]\[11d] \[ASP] [hq450/fancyss](https://github.com/hq450/fancyss) ⭐ 13,751 | 🐛 224 | 🌐 Shell | 📅 2026-06-01 fancyss is a project providing tools to across the GFW on asuswrt/merlin based router.
* \[**3129**星]\[13d] \[C] [qemu/qemu](https://github.com/qemu/qemu) ⭐ 13,719 | 🐛 0 | 🌐 C | 📅 2026-09-14 Official QEMU mirror. Please see
...
* \[**2344**星]\[16d] \[C] [tsl0922/ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,363 | 🐛 113 | 🌐 C | 📅 2026-08-12 Share your terminal over the web
* \[**3980**星]\[1m] \[Rust] [svenstaro/genact](https://github.com/svenstaro/genact) ⭐ 12,190 | 🐛 16 | 🌐 Rust | 📅 2026-09-01 a nonsense activity generator
* \[**3505**星]\[16d] \[C] [cyan4973/xxhash](https://github.com/cyan4973/xxhash) ⭐ 11,245 | 🐛 44 | 🌐 C | 📅 2026-07-27 Extremely fast non-cryptographic hash algorithm
* \[**2993**星]\[18d] \[Py] [quantaxis/quantaxis](https://github.com/quantaxis/quantaxis) ⭐ 11,191 | 🐛 240 | 🌐 Python | 📅 2026-09-01 支持任务调度 分布式部署的 股票/期货/自定义市场 数据/回测/模拟/交易/可视化 纯本地PAAS量化解决方案
* \[**4003**星]\[11d] \[Go] [dexidp/dex](https://github.com/dexidp/dex) ⭐ 11,092 | 🐛 543 | 🌐 Go | 📅 2026-09-14 OpenID Connect Identity (OIDC) and OAuth 2.0 Provider with Pluggable Connectors
* \[**3908**星]\[12d] \[C++] [baldurk/renderdoc](https://github.com/baldurk/renderdoc) ⭐ 11,082 | 🐛 53 | 🌐 C++ | 📅 2026-09-13 RenderDoc is a stand-alone graphics debugging tool.
* \[**2053**星]\[24d] \[C#] [mathewsachin/captura](https://github.com/mathewsachin/captura) ⭐ 10,830 | 🐛 116 | 🌐 C# | 📅 2026-05-25 Capture Screen, Audio, Cursor, Mouse Clicks and Keystrokes
* \[**2627**星]\[23d] \[JS] [popcorn-official/popcorn-desktop](https://github.com/popcorn-official/popcorn-desktop) ⭐ 10,685 | 🐛 66 | 🌐 TypeScript | 📅 2026-09-04 Popcorn Time is a multi-platform, free software BitTorrent client that includes an integrated media player. Desktop ( Windows / Mac / Linux ) a Butter-Project Fork
* \[**4597**星]\[12d] \[C++] [mozilla/rr](https://github.com/mozilla/rr) ⭐ 10,651 | 🐛 481 | 🌐 C++ | 📅 2026-09-14 记录与重放App的调试执行过程
...
* \[**2718**星]\[3m] \[Py] [drivendata/cookiecutter-data-science](https://github.com/drivendata/cookiecutter-data-science) ⭐ 10,054 | 🐛 34 | 🌐 Python | 📅 2026-08-07 A logical, reasonably standardized, but flexible project structure for doing and sharing data science work.
...
* \[**5876**星]\[3m] \[Gnuplot] [nasa-jpl/open-source-rover](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,643 | 🐛 14 | 🌐 HTML | 📅 2026-09-03 A build-it-yourself, 6-wheel rover based on the rovers on Mars!
...
* \[**3108**星]\[1m] \[C] [unicorn-engine/unicorn](https://github.com/unicorn-engine/unicorn) ⭐ 9,332 | 🐛 215 | 🌐 C | 📅 2026-08-28 Unicorn CPU emulator framework (ARM, AArch64, M68K, Mips, Sparc, X86)
...
* \[**3960**星]\[11d] \[Py] [angr/angr](https://github.com/angr/angr) ⭐ 9,088 | 🐛 737 | 🌐 Python | 📅 2026-09-14 A powerful and user-friendly binary analysis platform!
* \[**3939**星]\[15d] \[C] [aquynh/capstone](https://github.com/aquynh/capstone) ⭐ 9,016 | 🐛 358 | 🌐 C | 📅 2026-09-10 Capstone disassembly/disassembler framework: Core (Arm, Arm64, BPF, EVM, M68K, M680X, MOS65xx, Mips, PPC, RISCV, Sparc, SystemZ, TMS320C64x, Web Assembly, X86, X86\_64, XCore) + bindings.
* \[**3844**星]\[2m] \[ObjC] [sveinbjornt/sloth](https://github.com/sveinbjornt/sloth) ⭐ 8,959 | 🐛 2 | 🌐 Objective-C | 📅 2026-08-30 Mac app that shows all open files, directories and sockets in use by all running processes. Nice GUI for lsof.
* \[**3451**星]\[19d] \[C] [mikebrady/shairport-sync](https://github.com/mikebrady/shairport-sync) ⭐ 8,847 | 🐛 16 | 🌐 C | 📅 2026-09-13 AirPlay audio player. Shairport Sync adds multi-room capability with Audio Synchronisation
* \[**2587**星]\[10d] \[C] [esnet/iperf](https://github.com/esnet/iperf) ⭐ 8,754 | 🐛 238 | 🌐 C | 📅 2026-07-10 A TCP, UDP, and SCTP network bandwidth measurement tool
...
* \[**2948**星]\[1m] \[C] [libfuse/sshfs](https://github.com/libfuse/sshfs) ⭐ 7,668 | 🐛 64 | 🌐 C | 📅 2026-08-08 A network filesystem client to connect to SSH servers
...
* \[**4747**星]\[8d] \[C++] [paddlepaddle/paddle-lite](https://github.com/PaddlePaddle/Paddle-Lite) ⭐ 7,275 | 🐛 48 | 🌐 C++ | 📅 2026-04-27 Multi-platform high performance deep learning inference engine (『飞桨』多平台高性能深度学习预测引擎）
...
* \[**2194**星]\[13d] \[C] [armmbed/mbedtls](https://github.com/armmbed/mbedtls) ⭐ 6,956 | 🐛 1,719 | 🌐 C | 📅 2026-09-10 An open source, portable, easy to use, readable and flexible SSL library
...
* \[**2854**星]\[1m] \[Py] [espressif/esptool](https://github.com/espressif/esptool) ⭐ 6,476 | 🐛 15 | 🌐 Python | 📅 2026-09-10 ESP8266 and ESP32 serial bootloader utility
...
* \[**3233**星]\[25d] \[C] [tmate-io/tmate](https://github.com/tmate-io/tmate) ⭐ 6,124 | 🐛 129 | 🌐 C | 📅 2026-07-29 Instant Terminal Sharing
* \[**3690**星]\[21d] \[JS] [lesspass/lesspass](https://github.com/lesspass/lesspass) ⭐ 6,060 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-13
...
* \[**3120**星]\[11d] \[Go] [tencent/bk-cmdb](https://github.com/tencent/bk-cmdb) ⭐ 5,748 | 🐛 93 | 🌐 Go | 📅 2026-09-04 蓝鲸智云配置平台(BlueKing CMDB)
...
* \[**1620**星]\[16d] \[C++] [lief-project/lief](https://github.com/lief-project/lief) ⭐ 5,563 | 🐛 30 | 🌐 C++ | 📅 2026-09-06 Library to Instrument Executable Formats
* \[**2211**星]\[1m] \[C++] [google/bloaty](https://github.com/google/bloaty) ⭐ 5,541 | 🐛 72 | 🌐 C++ | 📅 2026-09-10 Bloaty McBloatface: a size profiler for binaries
* \[**2898**星]\[8m] \[C] [p-h-c/phc-winner-argon2](https://github.com/p-h-c/phc-winner-argon2) ⭐ 5,371 | 🐛 102 | 🌐 C | 📅 2024-08-06 The password hash Argon2, winner of PHC
* \[**2833**星]\[2m] \[Assembly] [cirosantilli/x86-bare-metal-examples](https://github.com/cirosantilli/x86-bare-metal-examples) ⭐ 5,361 | 🐛 7 | 🌐 Assembly | 📅 2022-07-18 几十个用于学习 x86 系统编程的小型操作系统
* \[**2872**星]\[14d] \[C] [lxc/lxc](https://github.com/lxc/lxc) ⭐ 5,261 | 🐛 148 | 🌐 C | 📅 2026-09-07 LXC - Linux Containers
* \[**1816**星]\[29d] \[Go] [gdamore/tcell](https://github.com/gdamore/tcell) ⭐ 5,219 | 🐛 8 | 🌐 Go | 📅 2026-09-14 Tcell is an alternate terminal package, similar in some ways to termbox, but better in others.
...
* \[**2093**星]\[10d] \[C] [flatpak/flatpak](https://github.com/flatpak/flatpak) ⭐ 5,066 | 🐛 1,027 | 🌐 C | 📅 2026-09-07 Linux application sandboxing and distribution framework
...
* \[**2132**星]\[20d] [goq/telegram-list](https://github.com/goq/telegram-list) ⭐ 4,969 | 🐛 23 | 📅 2026-08-30 List of telegram groups, channels & bots // Список интересных групп, каналов и ботов телеграма // Список чатов для программистов
* \[**2137**星]\[19d] \[Assembly] [pret/pokered](https://github.com/pret/pokered) ⭐ 4,918 | 🐛 22 | 🌐 Assembly | 📅 2026-08-27 disassembly of Pokémon Red/Blue
...
* \[**1761**星]\[13d] \[C] [google/wuffs](https://github.com/google/wuffs) ⭐ 4,824 | 🐛 37 | 🌐 C | 📅 2026-09-02 Wrangling Untrusted File Formats Safely
...
* \[**2003**星]\[2m] \[C++] [asmjit/asmjit](https://github.com/asmjit/asmjit) ⭐ 4,603 | 🐛 19 | 🌐 C++ | 📅 2026-09-08 Complete x86/x64 JIT and AOT Assembler for C++
* \[**2340**星]\[2m] \[JS] [pa11y/pa11y](https://github.com/pa11y/pa11y) ⭐ 4,525 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-07 Pa11y is your automated accessibility testing pal
...
* \[**1714**星]\[1m] \[Go] [hashicorp/memberlist](https://github.com/hashicorp/memberlist) ⭐ 4,104 | 🐛 96 | 🌐 Go | 📅 2026-08-27 Golang package for gossip based membership and failure detection
...
* \[**2052**星]\[13d] \[C++] [openthread/openthread](https://github.com/openthread/openthread) ⭐ 4,028 | 🐛 156 | 🌐 C++ | 📅 2026-09-12 OpenThread released by Google is an open-source implementation of the Thread networking protocol
...
* \[**1727**星]\[8d] \[TSQL] [brentozarultd/sql-server-first-responder-kit](https://github.com/brentozarultd/sql-server-first-responder-kit) ⭐ 3,899 | 🐛 2 | 🌐 TSQL | 📅 2026-09-12 sp\_Blitz, sp\_BlitzCache, sp\_BlitzFirst, sp\_BlitzIndex, and other SQL Server scripts for health checks and performance tuning.
...
* \[**1637**星]\[12d] \[JS] [efforg/privacybadger](https://github.com/efforg/privacybadger) ⭐ 3,837 | 🐛 138 | 🌐 JavaScript | 📅 2026-09-11 Privacy Badger is a browser extension that automatically learns to block invisible trackers.
* \[**2364**星]\[10d] \[C] [domoticz/domoticz](https://github.com/domoticz/domoticz) ⭐ 3,803 | 🐛 24 | 🌐 C++ | 📅 2026-09-10 monitor and configure various devices like: Lights, Switches, various sensors/meters like Temperature, Rain, Wind, UV, Electra, Gas, Water and much more
...
* \[**1781**星]\[26d] \[PHP] [ezyang/htmlpurifier](https://github.com/ezyang/htmlpurifier) ⭐ 3,355 | 🐛 135 | 🌐 PHP | 📅 2026-09-05 Standards compliant HTML filter written in PHP
...
* \[**1877**星]\[25d] \[Java] [adoptopenjdk/jitwatch](https://github.com/adoptopenjdk/jitwatch) ⭐ 3,308 | 🐛 18 | 🌐 Java | 📅 2026-09-09 Log analyser / visualiser for Java HotSpot JIT compiler. Inspect inlining decisions, hot methods, bytecode, and assembly. View results in the JavaFX user interface.
...
* \[**1949**星]\[17d] \[C] [microsoft/procdump-for-linux](https://github.com/microsoft/procdump-for-linux) ⭐ 3,082 | 🐛 22 | 🌐 C | 📅 2026-09-10 Linux 版本的 ProcDump
...
* \[**1854**星]\[19d] \[C] [github/glb-director](https://github.com/github/glb-director) ⭐ 2,455 | 🐛 34 | 🌐 C | 📅 2026-09-14 GitHub Load Balancer Director and supporting tooling.
...
* \[**1676**星]\[10d] \[Java] [apache/geode](https://github.com/apache/geode) ⭐ 2,384 | 🐛 25 | 🌐 Java | 📅 2026-09-14 Apache Geode
...
* \[**1852**星]\[1y] \[Py] [jinnlynn/genpac](https://github.com/jinnlynn/genpac) ⭐ 2,183 | 🐛 0 | 🌐 Python | 📅 2026-09-14 PAC/Dnsmasq/Wingy file Generator, working with gfwlist, support custom rules.
* \[**906**星]\[7m] \[C++] [dfhack/dfhack](https://github.com/DFHack/dfhack) ⭐ 2,044 | 🐛 1,063 | 🌐 C++ | 📅 2026-09-14 Memory hacking library for Dwarf Fortress and a set of tools that use it
...
* \[**449**星]\[12m] \[C++] [ntquery/scylla](https://github.com/ntquery/scylla) ⭐ 1,429 | 🐛 23 | 🌐 C++ | 📅 2023-04-05 Imports Reconstructor
* \[**306**星]\[2m] \[C] [nagyd/sdlpop](https://github.com/nagyd/sdlpop) ⭐ 1,280 | 🐛 81 | 🌐 C | 📅 2025-12-24 An open-source port of Prince of Persia, based on the disassembly of the DOS version.
...
* \[**2214**星]\[18d] [getlantern/lantern-binaries](https://github.com/getlantern/lantern-binaries) ⭐ 120 | 🐛 14 | 📅 2026-09-14 Lantern installers binary downloads.
...
* \[**836**星]\[8d] \[C++] [tasvideos/bizhawk](https://github.com/tasvideos/bizhawk) ⭐ 2,758 | 🐛 809 | 🌐 C# | 📅 2026-09-12 BizHawk is a multi-system emulator written in C#. BizHawk provides nice features for casual gamers such as full screen, and joypad support in addition to full rerecording and debugging tools for all system cores.
...
* \[**1147**星]\[5m] \[C++] [cgdb/cgdb](https://github.com/cgdb/cgdb) ⭐ 1,843 | 🐛 46 | 🌐 C | 📅 2026-02-27 Console front-end to the GNU debugger
...
* \[**423**星]\[4m] \[C++] [cobaltfusion/debugviewpp](https://github.com/cobaltfusion/debugviewpp) ⭐ 1,268 | 🐛 98 | 🌐 C++ | 📅 2026-04-25 DebugView++, collects, views, filters your application logs, and highlights information that is important to you!
...
* \[**291**星]\[12d] \[Py] [sosreport/sos](https://github.com/sosreport/sos) ⭐ 599 | 🐛 164 | 🌐 Python | 📅 2026-09-13 A unified tool for collecting system logs and other debug information
...
* \[**20779**星]\[8d] \[Java] [skylot/jadx](https://github.com/skylot/jadx) ⭐ 50,458 | 🐛 445 | 🌐 Java | 📅 2026-09-12 dex 转 java 的反编译器
* \[**7733**星]\[1m] \[Java] [java-decompiler/jd-gui](https://github.com/java-decompiler/jd-gui) ⭐ 15,202 | 🐛 248 | 🌐 Java | 📅 2024-07-08 A standalone Java Decompiler GUI
* \[**1867**星]\[1y] \[Java] [jindrapetrik/jpexs-decompiler](https://github.com/jindrapetrik/jpexs-decompiler) ⭐ 5,867 | 🐛 2 | 🌐 Java | 📅 2026-09-13 JPEXS Free Flash Decompiler
...
* \[**671**星]\[11m] \[C++] [zrax/pycdc](https://github.com/zrax/pycdc) ⭐ 4,617 | 🐛 233 | 🌐 C++ | 📅 2026-04-07 C++ python bytecode disassembler and decompiler
* \[**1652**星]\[12m] \[Java] [fesh0r/fernflower](https://github.com/fesh0r/fernflower) ⭐ 4,397 | 🐛 0 | 🌐 Java | 📅 2026-09-11 Unofficial mirror of FernFlower Java decompiler (All pulls should be submitted upstream)
...
* \[**347**星]\[16d] \[C#] [steamdatabase/valveresourceformat](https://github.com/steamdatabase/valveresourceformat) ⭐ 2,421 | 🐛 64 | 🌐 C# | 📅 2026-09-13 Valve's Source 2 resource file format (also known as Stupid Valve Format) parser and decompiler.
* \[**1084**星]\[4m] \[Py] [storyyeller/krakatau](https://github.com/storyyeller/krakatau) ⭐ 2,249 | 🐛 26 | 🌐 Rust | 📅 2026-09-11 Java decompiler, assembler, and disassembler
...
* \[**1374**星]\[20d] \[C] [zyantific/zydis](https://github.com/zyantific/zydis) ⭐ 4,363 | 🐛 51 | 🌐 C | 📅 2026-07-27 快速的轻量级x86/x86-64 反汇编库
* \[**430**星]\[2m] \[C#] [0xd4d/iced](https://github.com/0xd4d/iced) ⭐ 3,562 | 🐛 61 | 🌐 Rust | 📅 2026-09-09 x86/x64 disassembler, instruction decoder & encoder
* \[**835**星]\[8d] \[GLSL] [khronosgroup/spirv-cross](https://github.com/khronosgroup/spirv-cross) ⭐ 2,512 | 🐛 152 | 🌐 GLSL | 📅 2026-09-07  a practical tool and library for performing reflection on SPIR-V and disassembling SPIR-V back to high level languages.
...
* \[**2439**星]\[16d] \[Py] [pwndbg/pwndbg](https://github.com/pwndbg/pwndbg) ⭐ 10,864 | 🐛 225 | 🌐 Python | 📅 2026-09-14 GDB插件，辅助漏洞开发和逆向
...
* \[**2568**星]\[1m] \[Py] [hugsy/gef](https://github.com/hugsy/gef) ⭐ 8,355 | 🐛 15 | 🌐 Python | 📅 2026-08-20 gdb增强工具，使用Python API，用于漏洞开发和逆向分析。
...
* \[**11588**星]\[12d] \[C] [radareorg/radare2](https://github.com/radareorg/radare2) ⭐ 24,792 | 🐛 823 | 🌐 C | 📅 2026-09-14 unix-like reverse engineering framework and commandline tools
...
* \[**2820**星]\[1m] \[Py] [androguard/androguard](https://github.com/androguard/androguard) ⭐ 6,242 | 🐛 46 | 🌐 Python | 📅 2026-09-04 Reverse engineering, Malware and goodware analysis of Android applications ... and more (ninja !)
* \[**328**星]\[5m] \[Py] [vector35/binaryninja-api](https://github.com/vector35/binaryninja-api) ⭐ 1,312 | 🐛 1,961 | 🌐 C++ | 📅 2026-09-12 Public API, examples, documentation and issues for Binary Ninja
...
* \[**1915**星]\[22d] \[C#] [lucasg/dependencies](https://github.com/lucasg/dependencies) ⭐ 11,836 | 🐛 142 | 🌐 C# | 📅 2024-05-15 A rewrite of the old legacy software "depends.exe" in C# for Windows devs to troubleshoot dll load dependencies issues.
* \[**1146**星]\[27d] \[C#] [perfare/il2cppdumper](https://github.com/perfare/il2cppdumper) ⭐ 9,385 | 🐛 154 | 🌐 C# | 📅 2024-08-18 Restore dll from Unity il2cpp binary file (except code)
...
* \[**214**星]\[26d] \[C++] [chuyu-team/mint](https://github.com/Chuyu-Team/MINT) ⭐ 433 | 🐛 0 | 🌐 C | 📅 2024-08-12 Contains the definitions for the Windows Internal UserMode API from ntdll.dll, samlib.dll and winsta.dll.
...
* \[**713**星]\[5m] \[C++] [darthton/xenos](https://github.com/darthton/xenos) ⭐ 2,660 | 🐛 51 | 🌐 C++ | 📅 2021-05-17 Windows DLL 注入器
...
* \[**2355**星]\[11d] \[C] [hfiref0x/uacme](https://github.com/hfiref0x/uacme) ⭐ 7,796 | 🐛 0 | 🌐 C | 📅 2026-07-24 Defeating Windows User Account Control
...
* \[**1228**星]\[10d] \[JS] [jpcertcc/logontracer](https://github.com/jpcertcc/logontracer) ⭐ 3,235 | 🐛 22 | 🌐 Python | 📅 2026-08-02 通过可视化和分析Windows事件日志来调查恶意的Windows登录
...
* \[**261**星]\[3m] \[C++] [gametechdev/presentmon](https://github.com/gametechdev/presentmon) ⭐ 2,562 | 🐛 202 | 🌐 C++ | 📅 2026-09-13 Tool for collection and processing of ETW events related to DXGI presentation.
* \[**479**星]\[5m] \[PS] [sans-blue-team/deepbluecli](https://github.com/sans-blue-team/deepbluecli) ⭐ 2,430 | 🐛 13 | 🌐 PowerShell | 📅 2023-10-14 a PowerShell Module for Threat Hunting via Windows Event Logs
...
* \[**249**星]\[3m] \[C++] [microsoft/krabsetw](https://github.com/microsoft/krabsetw) ⭐ 803 | 🐛 21 | 🌐 C++ | 📅 2026-08-22 KrabsETW provides a modern C++ wrapper and a .NET wrapper around the low-level ETW trace consumption functions.
...
* \[**9261**星]\[11d] \[C#] [icsharpcode/ilspy](https://github.com/icsharpcode/ilspy) ⭐ 26,061 | 🐛 176 | 🌐 C# | 📅 2026-09-14 .NET Decompiler
...
* \[**510**星]\[5m] \[Py] [rabbitstack/fibratus](https://github.com/rabbitstack/fibratus) ⭐ 2,542 | 🐛 44 | 🌐 Go | 📅 2026-09-12 Windows内核探索和跟踪工具
...
* \[**863**星]\[14d] \[C++] [henrypp/simplewall](https://github.com/henrypp/simplewall) ⭐ 8,950 | 🐛 143 | 🌐 C | 📅 2026-09-08 为Windows 过滤平台提供的配置界面
* \[**949**星]\[3m] \[C] [basil00/divert](https://github.com/basil00/divert) ⭐ 3,293 | 🐛 64 | 🌐 C | 📅 2023-03-15 用户模式数据包拦截库，适用于Win 7/8/10
* \[**360**星]\[12d] \[C#] [digitalruby/ipban](https://github.com/digitalruby/ipban) ⭐ 2,185 | 🐛 2 | 🌐 C# | 📅 2026-08-21 监视Windows/Linux系统的登录失败和不良行为，并封禁对应的IP地址。高度可配置，精简且功能强大。
...
* \[**418**星]\[15d] \[C] [samba-team/samba](https://github.com/samba-team/samba) ⭐ 1,139 | 🐛 1 | 🌐 C | 📅 2026-09-13 适用于Linux和Unix的标准Windows interoperability程序套件
...
* \[**210**星]\[3m] [adguardteam/adguardforwindows](https://github.com/adguardteam/adguardforwindows) ⭐ 886 | 🐛 164 | 📅 2026-09-09 Windows系统范围的AdBlocker
* \[**389**星]\[2m] \[C#] [microsoft/binskim](https://github.com/microsoft/binskim) ⭐ 860 | 🐛 161 | 🌐 C# | 📅 2026-09-12 二进制静态分析工具，可为PE和ELF二进制格式提供安全性和正确性分析
...
* \[**370**星]\[27d] \[Ruby] [winrb/winrm](https://github.com/winrb/winrm) ⭐ 423 | 🐛 22 | 🌐 Ruby | 📅 2026-09-13 在Windows中使用WinRM的功能调用原生对象的SOAP库。Ruby编写
...
* \[**787**星]\[2m] \[C] [nixos/patchelf](https://github.com/nixos/patchelf) ⭐ 4,262 | 🐛 148 | 🌐 C | 📅 2026-07-27 A small utility to modify the dynamic linker and RPATH of ELF executables
...
* \[**1450**星]\[2m] \[C] [feralinteractive/gamemode](https://github.com/feralinteractive/gamemode) ⭐ 6,009 | 🐛 219 | 🌐 C | 📅 2026-06-15 Optimise Linux system performance on demand
* \[**1413**星]\[21d] \[C++] [google/nsjail](https://github.com/google/nsjail) ⭐ 4,103 | 🐛 34 | 🌐 C++ | 📅 2026-08-27 A light-weight process isolation tool, making use of Linux namespaces and seccomp-bpf syscall filters (with help of the kafel bpf language)
* \[**759**星]\[1m] \[Py] [korcankaraokcu/pince](https://github.com/korcankaraokcu/pince) ⭐ 3,087 | 🐛 6 | 🌐 Python | 📅 2026-09-13 A reverse engineering tool that'll supply the place of Cheat Engine for linux
* \[**731**星]\[17d] \[C] [strace/strace](https://github.com/strace/strace) ⭐ 2,699 | 🐛 110 | 🌐 C | 📅 2026-09-13 strace is a diagnostic, debugging and instructional userspace utility for Linux
...
* \[**468**星]\[9d] \[C] [libreswan/libreswan](https://github.com/libreswan/libreswan) ⭐ 1,005 | 🐛 659 | 🌐 C | 📅 2026-09-13 an Internet Key Exchange (IKE) implementation for Linux.
