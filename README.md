...
* [全平台逆向资源: awesome-reverse-engineering](https://github.com/alphaSeclab/awesome-reverse-engineering) ⭐ 5,030 | 🐛 7 | 📅 2021-09-01:
...
* [开源远控和恶意远控分析报告: awesome-rat](https://github.com/alphaSeclab/awesome-rat) ⭐ 2,254 | 🐛 0 | 📅 2020-02-17: 开源远控工具: Windows/Linux/macOS/Android; 远控类恶意恶意代码的分析报告等
...
* 此页只包含部分内容. [查看完整版](https://github.com/alphaSeclab/awesome-reverse-engineering/blob/master/Readme_full.md) ⭐ 5,030 | 🐛 7 | 📅 2021-09-01

# 说明

[EnglishVersion](https://github.com/alphaSeclab/awesome-reverse-engineering/blob/master/Readme_en.md) ⭐ 5,030 | 🐛 7 | 📅 2021-09-01
...
* \[**664**星]\[27d] \[Py] [igogo-x86/hexrayspytools](https://github.com/igogo-x86/hexrayspytools) ⭐ 1,532 | 🐛 32 | 🌐 Python | 📅 2024-08-11 结构体和类重建插件
...
* \[**363**星]\[9m] [fr0gger/awesome-ida-x64-olly-plugin](https://github.com/fr0gger/awesome-ida-x64-olly-plugin) ⭐ 1,583 | 🐛 2 | 📅 2026-02-20 IDA x64DBG OllyDBG 插件收集
...
* \[**5228**星]\[2m] \[Py] [refirmlabs/binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,243 | 🐛 92 | 🌐 Rust | 📅 2026-08-11 固件分析工具（命令行+IDA插件）
  * [IDA插件](https://github.com/ReFirmLabs/binwalk/tree/master/src/scripts) ⭐ 14,243 | 🐛 92 | 🌐 Rust | 📅 2026-08-11
  * [binwalk](https://github.com/ReFirmLabs/binwalk/tree/master/src/binwalk) ⭐ 14,243 | 🐛 92 | 🌐 Rust | 📅 2026-08-11
...
* \[**1365**星]\[3m] \[Py] [fireeye/flare-floss](https://github.com/fireeye/flare-floss) ⭐ 4,125 | 🐛 124 | 🌐 Python | 📅 2026-08-19 自动从恶意代码中提取反混淆后的字符串
  * [floss](https://github.com/fireeye/flare-floss/tree/master/floss) ⭐ 4,125 | 🐛 124 | 🌐 Python | 📅 2026-08-19
  * [IDA插件](https://github.com/fireeye/flare-floss/blob/master/scripts/idaplugin.py) ⭐ 4,125 | 🐛 124 | 🌐 Python | 📅 2026-08-19
...
* \[**291**星]\[3m] \[Py] [a1ext/auto\_re](https://github.com/a1ext/auto_re) ⭐ 786 | 🐛 2 | 🌐 Python | 📅 2026-08-19 自动化函数重命名
...
* \[**18649**星]\[10d] \[Java] [nationalsecurityagency/ghidra](https://github.com/nationalsecurityagency/ghidra) ⭐ 72,539 | 🐛 1,919 | 🌐 Java | 📅 2026-08-18 软件逆向框架
...
* \[**34576**星]\[1m] \[C++] [x64dbg/x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,204 | 🐛 574 | 🌐 C++ | 📅 2026-08-15 Windows平台x32/x64调试器
...
* \[**5195**星]\[19d] \[Py] [mobsf/mobile-security-framework-mobsf](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,615 | 🐛 20 | 🌐 JavaScript | 📅 2026-08-17 Mobile Security Framework (MobSF) is an automated, all-in-one mobile application (Android/iOS/Windows) pen-testing, malware analysis and security assessment framework capable of performing static and dynamic analysis.
* \[**5084**星]\[15d] \[HTML] [owasp/owasp-mstg](https://github.com/owasp/owasp-mstg) ⭐ 13,122 | 🐛 235 | 🌐 Python | 📅 2026-08-14 关于移动App安全开发、测试和逆向的相近手册
* \[**4306**星]\[15d] \[Shell] [ashishb/android-security-awesome](https://github.com/ashishb/android-security-awesome) ⭐ 9,618 | 🐛 1 | 🌐 Makefile | 📅 2026-08-19 A collection of android security related resources
* \[**2051**星]\[21d] \[Py] [sensepost/objection](https://github.com/sensepost/objection) ⭐ 9,328 | 🐛 55 | 🌐 Python | 📅 2026-07-23 runtimemobile exploration
...
* \[**820**星]\[11d] [proxymanapp/proxyman](https://github.com/proxymanapp/proxyman) ⭐ 6,948 | 🐛 1,869 | 📅 2026-08-12 Modern and Delightful HTTP Debugging Proxy for macOS, iOS and Android
...
* \[**1925**星]\[7m] \[Java] [fuzion24/justtrustme](https://github.com/fuzion24/justtrustme) ⭐ 5,359 | 🐛 22 | 🌐 Java | 📅 2024-09-02 An xposed module that disables SSL certificate checking for the purposes of auditing an app with cert pinning
* \[**443**星]\[1m] \[TS] [shroudedcode/apk-mitm](https://github.com/shroudedcode/apk-mitm) ⭐ 5,082 | 🐛 83 | 🌐 TypeScript | 📅 2024-07-24
* \[**2011**星]\[8m] \[Py] [fsecurelabs/drozer](https://github.com/FSecureLABS/drozer) ⭐ 4,594 | 🐛 9 | 🌐 Python | 📅 2026-04-08 The Leading Security Assessment Framework for Android.
* \[**2314**星]\[1y] \[Java] [csploit/android](https://github.com/csploit/android) ⭐ 3,645 | 🐛 398 | 🌐 Java | 📅 2024-04-27 cSploit - The most complete and advanced IT security professional toolkit on Android.
* \[**431**星]\[13d] \[C] [guardianproject/orbot](https://github.com/guardianproject/orbot) ⭐ 3,483 | 🐛 91 | 🌐 Kotlin | 📅 2026-08-13 The Github home of Orbot: Tor on Android (Also available on gitlab!)
...
* \[**559**星]\[14d] \[Shell] [owasp/owasp-masvs](https://github.com/owasp/owasp-masvs) ⭐ 2,434 | 🐛 3 | 🌐 Python | 📅 2025-12-22 OWASP 移动App安全标准
...
* \[**409**星]\[3m] \[CSS] [angea/pocorgtfo](https://github.com/angea/pocorgtfo) ⭐ 1,602 | 🐛 1 | 🌐 TeX | 📅 2024-02-11 a "Proof of Concept or GTFO" mirror with extra article index, direct links and clean PDFs.
...
* \[**1213**星]\[2m] \[JS] [megatronking/httpcanary](https://github.com/megatronking/httpcanary) ⭐ 497 | 🐛 5 | 📅 2024-07-03 A powerful capture and injection tool for the Android platform
...
* \[**229**星]\[8m] \[Java] [jieyushi/luffy](https://github.com/jieyushi/luffy) ⭐ 398 | 🐛 4 | 🌐 Java | 📅 2019-04-24 Android字节码插件，编译期间动态修改代码，改造添加全埋点日志采集功能模块，对常见控件进行监听处理
...
* \[**12285**星]\[11d] \[Java] [signalapp/signal-android](https://github.com/signalapp/Signal-Android) ⭐ 29,224 | 🐛 481 | 🌐 Kotlin | 📅 2026-08-19 A private messenger for Android.

### <a id="7f353b27e45b5de6b0e6ac472b02cbf1"></a>Xposed

* \[**8756**星]\[2m] \[Java] [android-hacker/virtualxposed](https://github.com/android-hacker/virtualxposed) ⭐ 16,053 | 🐛 161 | 🌐 Java | 📅 2024-03-08 A simple app to use Xposed without root, unlock the bootloader or modify system image, etc.
...
* \[**322**星]\[6m] \[Shell] [1n3/reverseapk](https://github.com/1n3/reverseapk) ⭐ 868 | 🐛 1 | 🌐 Shell | 📅 2022-12-21 Quickly analyze and reverse engineer Android packages

### <a id="596b6cf8fd36bc4c819335f12850a915"></a>HOOK

* \[**1494**星]\[9d] \[C++] [jmpews/dobby](https://github.com/jmpews/Dobby) ⭐ 4,808 | 🐛 99 | 🌐 C++ | 📅 2025-01-26 a lightweight, multi-platform, multi-architecture hook framework.
* \[**1500**星]\[27d] \[C] [iqiyi/xhook](https://github.com/iqiyi/xhook) ⭐ 4,346 | 🐛 44 | 🌐 C | 📅 2025-06-27 a PLT (Procedure Linkage Table) hook library for Android native ELF
...
* \[**10794**星]\[1m] \[Java] [konloch/bytecode-viewer](https://github.com/konloch/bytecode-viewer) ⭐ 15,603 | 🐛 103 | 🌐 Java | 📅 2026-07-17 A Java 8+ Jar & Android APK Reverse Engineering Suite (Decompiler, Editor, Debugger & More)
...
* \[**429**星]\[4m] \[Shell] [ashishb/android-malware](https://github.com/ashishb/android-malware) ⭐ 1,220 | 🐛 0 | 🌐 Shell | 📅 2025-12-31 Collection of android malware samples
...
* \[**9285**星]\[1m] \[Java] [ibotpeaches/apktool](https://github.com/ibotpeaches/apktool) ⭐ 25,322 | 🐛 77 | 🌐 Java | 📅 2026-08-11 A tool for reverse engineering Android apk files
...
* \[**3221**星]\[5m] \[ObjC] [naituw/ipapatch](https://github.com/naituw/ipapatch) ⭐ 5,266 | 🐛 42 | 🌐 Objective-C | 📅 2026-02-27 Patch iOS Apps, The Easy Way, Without Jailbreak.
* \[**1193**星]\[15d] \[JS] [alonemonkey/frida-ios-dump](https://github.com/alonemonkey/frida-ios-dump) ⭐ 3,914 | 🐛 107 | 🌐 JavaScript | 📅 2023-05-03 pull decrypted ipa from jailbreak device
...
* \[**10966**星]\[10d] \[ObjC] [flipboard/flex](https://github.com/flipboard/flex) ⭐ 14,628 | 🐛 49 | 🌐 Objective-C | 📅 2026-06-11 An in-app debugging and exploration tool for iOS
* \[**4397**星]\[12d] \[Swift] [signalapp/signal-ios](https://github.com/signalapp/Signal-iOS) ⭐ 12,200 | 🐛 141 | 🌐 Swift | 📅 2026-08-19 A private messenger for iOS.
* \[**1215**星]\[16d] \[YARA] [horsicq/detect-it-easy](https://github.com/horsicq/detect-it-easy) ⭐ 11,376 | 🐛 33 | 🌐 JavaScript | 📅 2026-08-18 Program for determining types of files for Windows, Linux and MacOS.
...
* \[**2867**星]\[12d] \[ObjC] [facebook/idb](https://github.com/facebook/idb) ⭐ 5,281 | 🐛 181 | 🌐 Swift | 📅 2026-08-20 idb is a flexible command line interface for automating iOS simulators and devices
...
* \[**462**星]\[15d] \[Java] [dsheirer/sdrtrunk](https://github.com/dsheirer/sdrtrunk) ⭐ 2,162 | 🐛 436 | 🌐 Java | 📅 2026-08-01 A cross-platform java application for decoding, monitoring, recording and streaming trunked mobile and related radio protocols using Software Defined Radios (SDR). Website:
...
* \[**796**星]\[13d] \[Shell] [aqzt/kjyw](https://github.com/aqzt/kjyw) ⭐ 1,865 | 🐛 7 | 🌐 Shell | 📅 2025-07-01 快捷运维，代号kjyw，项目基于shell、python，运维脚本工具库，收集各类运维常用工具脚本，实现快速安装nginx、mysql、php、redis、nagios、运维经常使用的脚本等等...
...
* \[**346**星]\[4m] \[TS] [bacher09/pwgen-for-bios](https://github.com/bacher09/pwgen-for-bios) ⭐ 1,433 | 🐛 182 | 🌐 TypeScript | 📅 2026-02-05 Password generator for BIOS
...
* \[**1228**星]\[12d] \[C] [dynamorio/dynamorio](https://github.com/dynamorio/dynamorio) ⭐ 3,134 | 🐛 1,802 | 🌐 C | 📅 2026-08-20 Dynamic Instrumentation Tool Platform
...
* \[**4516**星]\[13d] \[Makefile] [frida/frida](https://github.com/frida/frida) ⭐ 21,674 | 🐛 1,958 | 🌐 Meson | 📅 2026-08-18 Clone this repo to build Frida
...
* \[**228**星]\[13d] \[C] [frida/frida-gum](https://github.com/frida/frida-gum) ⭐ 1,005 | 🐛 206 | 🌐 C | 📅 2026-08-18 Low-level code instrumentation library used by frida-core
...
* \[**584**星]\[1y] \[Java] [federicodotta/brida](https://github.com/federicodotta/brida) ⭐ 1,889 | 🐛 11 | 🌐 Java | 📅 2025-10-30 The new bridge between Burp Suite and Frida!
...
* \[**2687**星]\[11d] \[Go] [adguardteam/adguardhome](https://github.com/adguardteam/adguardhome) ⭐ 36,228 | 🐛 1,275 | 🌐 TypeScript | 📅 2026-08-19 Network-wide ads & trackers blocking DNS server
* \[**10378**星]\[11d] \[Go] [goharbor/harbor](https://github.com/goharbor/harbor) ⭐ 29,188 | 🐛 835 | 🌐 Go | 📅 2026-08-19 An open source trusted cloud native registry project that stores, signs, and scans content.
...
* \[**5420**星]\[12d] \[Py] [mlflow/mlflow](https://github.com/mlflow/mlflow) ⭐ 27,588 | 🐛 2,049 | 🌐 Python | 📅 2026-08-20 Open source platform for the machine learning lifecycle
* \[**11402**星]\[10d] \[Java] [oracle/graal](https://github.com/oracle/graal) ⭐ 21,666 | 🐛 847 | 🌐 Java | 📅 2026-08-20 Run Programs Faster Anywhere
* \[**7020**星]\[14d] \[Go] [nats-io/nats-server](https://github.com/nats-io/nats-server) ⭐ 20,549 | 🐛 549 | 🌐 Go | 📅 2026-08-19 High-Performance server for NATS, the cloud native messaging system.
...
* \[**3608**星]\[9d] \[Pascal] [cheat-engine/cheat-engine](https://github.com/cheat-engine/cheat-engine) ⭐ 19,010 | 🐛 1,306 | 🌐 Pascal | 📅 2025-04-19 Cheat Engine. A development environment focused on modding
* \[**4610**星]\[1y] \[C] [upx/upx](https://github.com/upx/upx) ⭐ 17,792 | 🐛 26 | 🌐 C++ | 📅 2026-08-19 UPX - the Ultimate Packer for eXecutables
* \[**5226**星]\[13d] \[Shell] [denisidoro/navi](https://github.com/denisidoro/navi) ⭐ 17,461 | 🐛 110 | 🌐 Rust | 📅 2026-07-28 An interactive cheatsheet tool for the command-line
* \[**11213**星]\[2m] \[Jupyter Notebook] [selfteaching/the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 16,551 | 🐛 200 | 🌐 Jupyter Notebook | 📅 2026-05-20 One has no future if one couldn't teach themself.
* \[**2815**星]\[20d] \[C] [processhacker/processhacker](https://github.com/processhacker/processhacker) ⭐ 15,664 | 🐛 286 | 🌐 C | 📅 2026-08-19 A free, powerful, multi-purpose tool that helps you monitor system resources, debug software and detect malware.
* \[**3295**星]\[15d] \[JS] [koenkk/zigbee2mqtt](https://github.com/koenkk/zigbee2mqtt) ⭐ 15,513 | 🐛 452 | 🌐 TypeScript | 📅 2026-08-18 Zigbee
...
* \[**7748**星]\[10d] \[Go] [git-lfs/git-lfs](https://github.com/git-lfs/git-lfs) ⭐ 14,432 | 🐛 484 | 🌐 Go | 📅 2026-08-19 Git extension for versioning large files
...
* \[**3129**星]\[13d] \[C] [qemu/qemu](https://github.com/qemu/qemu) ⭐ 13,593 | 🐛 0 | 🌐 C | 📅 2026-08-19 Official QEMU mirror. Please see
* \[**5229**星]\[4m] \[Py] [ytisf/thezoo](https://github.com/ytisf/thezoo) ⭐ 13,306 | 🐛 89 | 🌐 Python | 📅 2026-07-24 A repository of LIVE malwares for your own joy and pleasure. theZoo is a project created to make the possibility of malware analysis open and available to the public.
* \[**2344**星]\[16d] \[C] [tsl0922/ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,227 | 🐛 112 | 🌐 C | 📅 2026-08-12 Share your terminal over the web
* \[**3980**星]\[1m] \[Rust] [svenstaro/genact](https://github.com/svenstaro/genact) ⭐ 12,174 | 🐛 16 | 🌐 Rust | 📅 2026-08-01 a nonsense activity generator
* \[**3505**星]\[16d] \[C] [cyan4973/xxhash](https://github.com/cyan4973/xxhash) ⭐ 11,212 | 🐛 41 | 🌐 C | 📅 2026-07-27 Extremely fast non-cryptographic hash algorithm
...
* \[**2993**星]\[18d] \[Py] [quantaxis/quantaxis](https://github.com/quantaxis/quantaxis) ⭐ 11,018 | 🐛 239 | 🌐 Python | 📅 2026-02-28 支持任务调度 分布式部署的 股票/期货/自定义市场 数据/回测/模拟/交易/可视化 纯本地PAAS量化解决方案
...
* \[**2627**星]\[23d] \[JS] [popcorn-official/popcorn-desktop](https://github.com/popcorn-official/popcorn-desktop) ⭐ 10,632 | 🐛 65 | 🌐 TypeScript | 📅 2026-08-19 Popcorn Time is a multi-platform, free software BitTorrent client that includes an integrated media player. Desktop ( Windows / Mac / Linux ) a Butter-Project Fork
* \[**4597**星]\[12d] \[C++] [mozilla/rr](https://github.com/mozilla/rr) ⭐ 10,622 | 🐛 480 | 🌐 C++ | 📅 2026-08-16 记录与重放App的调试执行过程
* \[**5751**星]\[9m] \[C] [xoreaxeaxeax/movfuscator](https://github.com/xoreaxeaxeax/movfuscator) ⭐ 10,477 | 🐛 25 | 🌐 C | 📅 2024-05-29 C编译器，编译的二进制文件只有1个代码块。
* \[**2718**星]\[3m] \[Py] [drivendata/cookiecutter-data-science](https://github.com/drivendata/cookiecutter-data-science) ⭐ 10,011 | 🐛 34 | 🌐 Python | 📅 2026-08-07 A logical, reasonably standardized, but flexible project structure for doing and sharing data science work.
...
* \[**3108**星]\[1m] \[C] [unicorn-engine/unicorn](https://github.com/unicorn-engine/unicorn) ⭐ 9,247 | 🐛 212 | 🌐 C | 📅 2026-07-30 Unicorn CPU emulator framework (ARM, AArch64, M68K, Mips, Sparc, X86)
* \[**3188**星]\[11d] \[C] [meetecho/janus-gateway](https://github.com/meetecho/janus-gateway) ⭐ 9,154 | 🐛 43 | 🌐 C | 📅 2026-07-27 Janus WebRTC Server
* \[**3960**星]\[11d] \[Py] [angr/angr](https://github.com/angr/angr) ⭐ 9,023 | 🐛 725 | 🌐 Python | 📅 2026-08-19 A powerful and user-friendly binary analysis platform!
* \[**3939**星]\[15d] \[C] [aquynh/capstone](https://github.com/aquynh/capstone) ⭐ 8,963 | 🐛 366 | 🌐 C | 📅 2026-08-13 Capstone disassembly/disassembler framework: Core (Arm, Arm64, BPF, EVM, M68K, M680X, MOS65xx, Mips, PPC, RISCV, Sparc, SystemZ, TMS320C64x, Web Assembly, X86, X86\_64, XCore) + bindings.
* \[**3844**星]\[2m] \[ObjC] [sveinbjornt/sloth](https://github.com/sveinbjornt/sloth) ⭐ 8,939 | 🐛 3 | 🌐 Objective-C | 📅 2026-05-28 Mac app that shows all open files, directories and sockets in use by all running processes. Nice GUI for lsof.
* \[**3451**星]\[19d] \[C] [mikebrady/shairport-sync](https://github.com/mikebrady/shairport-sync) ⭐ 8,819 | 🐛 18 | 🌐 C | 📅 2026-08-09 AirPlay audio player. Shairport Sync adds multi-room capability with Audio Synchronisation
* \[**2587**星]\[10d] \[C] [esnet/iperf](https://github.com/esnet/iperf) ⭐ 8,699 | 🐛 238 | 🌐 C | 📅 2026-07-10 A TCP, UDP, and SCTP network bandwidth measurement tool
...
* \[**3306**星]\[19d] \[C] [microsoft/windows-driver-samples](https://github.com/microsoft/windows-driver-samples) ⭐ 7,823 | 🐛 126 | 🌐 C | 📅 2026-08-12 This repo contains driver samples prepared for use with Microsoft Visual Studio and the Windows Driver Kit (WDK). It contains both Universal Windows Driver and desktop-only driver samples.
* \[**2948**星]\[1m] \[C] [libfuse/sshfs](https://github.com/libfuse/sshfs) ⭐ 7,616 | 🐛 61 | 🌐 C | 📅 2026-08-08 A network filesystem client to connect to SSH servers
...
* \[**2194**星]\[13d] \[C] [armmbed/mbedtls](https://github.com/armmbed/mbedtls) ⭐ 6,885 | 🐛 1,728 | 🌐 C | 📅 2026-08-18 An open source, portable, easy to use, readable and flexible SSL library
...
* \[**1698**星]\[21d] \[C++] [microsoft/detours](https://github.com/microsoft/detours) ⭐ 6,359 | 🐛 92 | 🌐 C++ | 📅 2026-08-05 Detours is a software package for monitoring and instrumenting API calls on Windows. It is distributed in source code form.
* \[**5007**星]\[2m] \[Py] [snare/voltron](https://github.com/snare/voltron) ⭐ 6,346 | 🐛 85 | 🌐 Python | 📅 2025-01-30 A hacky debugger UI for hackers
* \[**408**星]\[19d] \[Py] [crytic/slither](https://github.com/crytic/slither) ⭐ 6,345 | 🐛 474 | 🌐 Python | 📅 2026-08-19 Static Analyzer for Solidity
...
* \[**1930**星]\[22d] \[C++] [mhammond/pywin32](https://github.com/mhammond/pywin32) ⭐ 5,599 | 🐛 398 | 🌐 C++ | 📅 2026-08-18 Python for Windows (pywin32) Extensions
* \[**1620**星]\[16d] \[C++] [lief-project/lief](https://github.com/lief-project/lief) ⭐ 5,537 | 🐛 32 | 🌐 C++ | 📅 2026-08-15 Library to Instrument Executable Formats
...
* \[**2898**星]\[8m] \[C] [p-h-c/phc-winner-argon2](https://github.com/p-h-c/phc-winner-argon2) ⭐ 5,354 | 🐛 102 | 🌐 C | 📅 2024-08-06 The password hash Argon2, winner of PHC
...
* \[**1816**星]\[29d] \[Go] [gdamore/tcell](https://github.com/gdamore/tcell) ⭐ 5,215 | 🐛 9 | 🌐 Go | 📅 2026-08-18 Tcell is an alternate terminal package, similar in some ways to termbox, but better in others.
...
* \[**2093**星]\[10d] \[C] [flatpak/flatpak](https://github.com/flatpak/flatpak) ⭐ 5,039 | 🐛 1,019 | 🌐 C | 📅 2026-08-20 Linux application sandboxing and distribution framework
...
* \[**2391**星]\[21d] \[Java] [mock-server/mockserver](https://github.com/mock-server/mockserver) ⭐ 4,945 | 🐛 10 | 🌐 Java | 📅 2026-08-19 MockServer enables easy mocking of any system you integrate with via HTTP or HTTPS with clients written in Java, JavaScript and Ruby. MockServer also includes a proxy that introspects all proxied traffic including encrypted SSL traffic and supports Port Forwarding, Web Proxying (i.e. HTTP proxy), HTTPS Tunneling Proxying (using HTTP CONNECT) and…
...
* \[**2137**星]\[19d] \[Assembly] [pret/pokered](https://github.com/pret/pokered) ⭐ 4,887 | 🐛 22 | 🌐 Assembly | 📅 2026-08-13 disassembly of Pokémon Red/Blue
...
* \[**1761**星]\[13d] \[C] [google/wuffs](https://github.com/google/wuffs) ⭐ 4,814 | 🐛 37 | 🌐 C | 📅 2026-08-08 Wrangling Untrusted File Formats Safely
...
* \[**2340**星]\[2m] \[JS] [pa11y/pa11y](https://github.com/pa11y/pa11y) ⭐ 4,490 | 🐛 47 | 🌐 JavaScript | 📅 2026-08-17 Pa11y is your automated accessibility testing pal
...
* \[**2052**星]\[13d] \[C++] [openthread/openthread](https://github.com/openthread/openthread) ⭐ 4,015 | 🐛 173 | 🌐 C++ | 📅 2026-08-20 OpenThread released by Google is an open-source implementation of the Thread networking protocol
...
* \[**1727**星]\[8d] \[TSQL] [brentozarultd/sql-server-first-responder-kit](https://github.com/brentozarultd/sql-server-first-responder-kit) ⭐ 3,880 | 🐛 5 | 🌐 TSQL | 📅 2026-08-11 sp\_Blitz, sp\_BlitzCache, sp\_BlitzFirst, sp\_BlitzIndex, and other SQL Server scripts for health checks and performance tuning.
...
* \[**1637**星]\[12d] \[JS] [efforg/privacybadger](https://github.com/efforg/privacybadger) ⭐ 3,810 | 🐛 143 | 🌐 JavaScript | 📅 2026-08-19 Privacy Badger is a browser extension that automatically learns to block invisible trackers.
* \[**2364**星]\[10d] \[C] [domoticz/domoticz](https://github.com/domoticz/domoticz) ⭐ 3,793 | 🐛 25 | 🌐 C++ | 📅 2026-08-19 monitor and configure various devices like: Lights, Switches, various sensors/meters like Temperature, Rain, Wind, UV, Electra, Gas, Water and much more
...
* \[**1949**星]\[17d] \[C] [microsoft/procdump-for-linux](https://github.com/microsoft/procdump-for-linux) ⭐ 3,082 | 🐛 21 | 🌐 C | 📅 2026-08-19 Linux 版本的 ProcDump
...
* \[**1852**星]\[1y] \[Py] [jinnlynn/genpac](https://github.com/jinnlynn/genpac) ⭐ 2,187 | 🐛 0 | 🌐 Python | 📅 2026-08-20 PAC/Dnsmasq/Wingy file Generator, working with gfwlist, support custom rules.
* \[**906**星]\[7m] \[C++] [dfhack/dfhack](https://github.com/DFHack/dfhack) ⭐ 2,038 | 🐛 1,062 | 🌐 C++ | 📅 2026-08-19 Memory hacking library for Dwarf Fortress and a set of tools that use it
...
* \[**1572**星]\[1m] \[C] [codahale/bcrypt-ruby](https://github.com/codahale/bcrypt-ruby) ⭐ 1,995 | 🐛 19 | 🌐 C | 📅 2026-06-19  Ruby binding for the OpenBSD bcrypt() password hashing algorithm, allowing you to easily store a secure hash of your users' passwords.
...
* \[**291**星]\[28d] \[C] [tomb5/tomb5](https://github.com/tomb5/tomb5) ⭐ 517 | 🐛 26 | 🌐 C | 📅 2022-02-03 Chronicles Disassembly translated to C source code.
...
* \[**1955**星]\[11d] \[Go] [solo-io/gloo](https://github.com/solo-io/gloo) ⭐ 169 | 🐛 1,867 | 🌐 Go | 📅 2026-08-20 An Envoy-Powered API Gateway
* \[**2214**星]\[18d] [getlantern/lantern-binaries](https://github.com/getlantern/lantern-binaries) ⭐ 119 | 🐛 14 | 📅 2026-08-20 Lantern installers binary downloads.
...
* \[**836**星]\[8d] \[C++] [tasvideos/bizhawk](https://github.com/tasvideos/bizhawk) ⭐ 2,728 | 🐛 794 | 🌐 C# | 📅 2026-08-18 BizHawk is a multi-system emulator written in C#. BizHawk provides nice features for casual gamers such as full screen, and joypad support in addition to full rerecording and debugging tools for all system cores.
...
* \[**560**星]\[21d] \[C#] [microsoft/miengine](https://github.com/microsoft/miengine) ⭐ 858 | 🐛 163 | 🌐 C# | 📅 2026-08-17 The Visual Studio MI Debug Engine ("MIEngine") provides an open-source Visual Studio Debugger extension that works with MI-enabled debuggers such as gdb, lldb, and clrdbg.
* \[**285**星]\[2m] \[C++] [changeofpace/viviennevmm](https://github.com/changeofpace/viviennevmm) ⭐ 830 | 🐛 3 | 🌐 C++ | 📅 2020-09-07 VivienneVMM is a stealthy debugging framework implemented via an Intel VT-x hypervisor.
...
* \[**239**星]\[8m] \[C++] [strivexjun/xantidebug](https://github.com/strivexjun/xantidebug) ⭐ 686 | 🐛 3 | 🌐 C++ | 📅 2019-05-11 VMProtect 3.x Anti-debug Method Improved
...
* \[**291**星]\[12d] \[Py] [sosreport/sos](https://github.com/sosreport/sos) ⭐ 595 | 🐛 157 | 🌐 Python | 📅 2026-08-18 A unified tool for collecting system logs and other debug information
...
* \[**20779**星]\[8d] \[Java] [skylot/jadx](https://github.com/skylot/jadx) ⭐ 50,132 | 🐛 441 | 🌐 Java | 📅 2026-08-19 dex 转 java 的反编译器
...
* \[**1867**星]\[1y] \[Java] [jindrapetrik/jpexs-decompiler](https://github.com/jindrapetrik/jpexs-decompiler) ⭐ 5,819 | 🐛 5 | 🌐 Java | 📅 2026-08-08 JPEXS Free Flash Decompiler
...
* \[**347**星]\[16d] \[C#] [steamdatabase/valveresourceformat](https://github.com/steamdatabase/valveresourceformat) ⭐ 2,379 | 🐛 73 | 🌐 C# | 📅 2026-08-19 Valve's Source 2 resource file format (also known as Stupid Valve Format) parser and decompiler.
...
* \[**1374**星]\[20d] \[C] [zyantific/zydis](https://github.com/zyantific/zydis) ⭐ 4,339 | 🐛 51 | 🌐 C | 📅 2026-07-27 快速的轻量级x86/x86-64 反汇编库
...
* \[**1419**星]\[9m] \[C] [namhyung/uftrace](https://github.com/namhyung/uftrace) ⭐ 3,456 | 🐛 398 | 🌐 C | 📅 2026-08-09 Function (graph) tracer for user-space
...
* \[**11588**星]\[12d] \[C] [radareorg/radare2](https://github.com/radareorg/radare2) ⭐ 24,603 | 🐛 830 | 🌐 C | 📅 2026-08-19 unix-like reverse engineering framework and commandline tools
...
* \[**328**星]\[5m] \[Py] [vector35/binaryninja-api](https://github.com/vector35/binaryninja-api) ⭐ 1,291 | 🐛 1,905 | 🌐 C++ | 📅 2026-08-19 Public API, examples, documentation and issues for Binary Ninja
...
* \[**634**星]\[10d] \[C] [thewover/donut](https://github.com/thewover/donut) ⭐ 4,686 | 🐛 37 | 🌐 C | 📅 2025-07-08 Generates x86, x64, or AMD64+x86 position-independent shellcode that loads .NET Assemblies, PE files, and other Windows payloads from memory and runs them with parameters
...
* \[**344**星]\[1y] \[Assembly] [egebalci/amber](https://github.com/egebalci/amber) ⭐ 1,435 | 🐛 5 | 🌐 Go | 📅 2024-02-22 反射式PE加壳器，用于绕过安全产品和缓解措施
...
* \[**316**星]\[24d] \[C++] [trailofbits/pe-parse](https://github.com/trailofbits/pe-parse) ⭐ 908 | 🐛 17 | 🌐 C++ | 📅 2026-08-05 Principled, lightweight C/C++ PE parser
...
* \[**1146**星]\[27d] \[C#] [perfare/il2cppdumper](https://github.com/perfare/il2cppdumper) ⭐ 9,315 | 🐛 156 | 🌐 C# | 📅 2024-08-18 Restore dll from Unity il2cpp binary file (except code)
...
* \[**713**星]\[5m] \[C++] [darthton/xenos](https://github.com/darthton/xenos) ⭐ 2,634 | 🐛 51 | 🌐 C++ | 📅 2021-05-17 Windows DLL 注入器
...
* \[**2307**星]\[1m] \[PS] [k8gege/k8tools](https://github.com/k8gege/k8tools) ⭐ 6,198 | 🐛 10 | 🌐 PowerShell | 📅 2025-01-25 K8工具合集(内网渗透/提权工具/远程溢出/漏洞利用/扫描工具/密码破解/免杀工具/Exploit/APT/0day/Shellcode/Payload/priviledge/BypassUAC/OverFlow/WebShell/PenTest) Web GetShell Exploit(Struts2/Zimbra/Weblogic/Tomcat/Apache/Jboss/DotNetNuke/zabbix)
...
* \[**1228**星]\[10d] \[JS] [jpcertcc/logontracer](https://github.com/jpcertcc/logontracer) ⭐ 3,212 | 🐛 21 | 🌐 Python | 📅 2026-08-02 通过可视化和分析Windows事件日志来调查恶意的Windows登录
...
* \[**261**星]\[3m] \[C++] [gametechdev/presentmon](https://github.com/gametechdev/presentmon) ⭐ 2,526 | 🐛 195 | 🌐 C++ | 📅 2026-08-19 Tool for collection and processing of ETW events related to DXGI presentation.
...
* \[**249**星]\[3m] \[C++] [microsoft/krabsetw](https://github.com/microsoft/krabsetw) ⭐ 799 | 🐛 19 | 🌐 C++ | 📅 2026-08-20 KrabsETW provides a modern C++ wrapper and a .NET wrapper around the low-level ETW trace consumption functions.
...
* \[**921**星]\[7m] \[PS] [api0cradle/ultimateapplockerbypasslist](https://github.com/api0cradle/ultimateapplockerbypasslist) ⭐ 2,080 | 🐛 10 | 🌐 PowerShell | 📅 2023-09-11 The goal of this repository is to document the most common techniques to bypass AppLocker.
...
* \[**9261**星]\[11d] \[C#] [icsharpcode/ilspy](https://github.com/icsharpcode/ilspy) ⭐ 25,895 | 🐛 188 | 🌐 C# | 📅 2026-08-19 .NET Decompiler
...
* \[**510**星]\[5m] \[Py] [rabbitstack/fibratus](https://github.com/rabbitstack/fibratus) ⭐ 2,530 | 🐛 42 | 🌐 Go | 📅 2026-08-19 Windows内核探索和跟踪工具
...
* \[**863**星]\[14d] \[C++] [henrypp/simplewall](https://github.com/henrypp/simplewall) ⭐ 8,864 | 🐛 141 | 🌐 C | 📅 2026-08-18 为Windows 过滤平台提供的配置界面
* \[**949**星]\[3m] \[C] [basil00/divert](https://github.com/basil00/divert) ⭐ 3,258 | 🐛 64 | 🌐 C | 📅 2023-03-15 用户模式数据包拦截库，适用于Win 7/8/10
...
* \[**726**星]\[2m] \[Py] [diyan/pywinrm](https://github.com/diyan/pywinrm) ⭐ 1,136 | 🐛 54 | 🌐 Python | 📅 2026-08-04 Python实现的WinRM客户端
...
* \[**210**星]\[3m] [adguardteam/adguardforwindows](https://github.com/adguardteam/adguardforwindows) ⭐ 879 | 🐛 210 | 📅 2026-08-17 Windows系统范围的AdBlocker
...
* \[**1413**星]\[21d] \[C++] [google/nsjail](https://github.com/google/nsjail) ⭐ 4,062 | 🐛 65 | 🌐 C++ | 📅 2026-07-27 A light-weight process isolation tool, making use of Linux namespaces and seccomp-bpf syscall filters (with help of the kafel bpf language)
...
* \[**565**星]\[12d] \[C++] [intel/linux-sgx](https://github.com/intel/linux-sgx) ⭐ 1,449 | 🐛 138 | 🌐 C++ | 📅 2026-08-13 Intel SGX for Linux\*
...
* \[**468**星]\[9d] \[C] [libreswan/libreswan](https://github.com/libreswan/libreswan) ⭐ 1,005 | 🐛 646 | 🌐 C | 📅 2026-08-19 an Internet Key Exchange (IKE) implementation for Linux.
