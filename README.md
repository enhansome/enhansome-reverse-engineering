...
* [全平台逆向资源: awesome-reverse-engineering](https://github.com/alphaSeclab/awesome-reverse-engineering) ⭐ 5,066 | 🐛 8 | 📅 2021-09-01:
...
* 此页只包含部分内容. [查看完整版](https://github.com/alphaSeclab/awesome-reverse-engineering/blob/master/Readme_full.md) ⭐ 5,066 | 🐛 8 | 📅 2021-09-01
* 跟逆向有关的资源收集。当前包括的工具个数3500+，并根据功能进行了粗糙的分类。部分工具添加了中文描述。当前包括文章数2300+。

# 说明

[EnglishVersion](https://github.com/alphaSeclab/awesome-reverse-engineering/blob/master/Readme_en.md) ⭐ 5,066 | 🐛 8 | 📅 2021-09-01
...
* \[**664**星]\[27d] \[Py] [igogo-x86/hexrayspytools](https://github.com/igogo-x86/hexrayspytools) ⭐ 1,537 | 🐛 31 | 🌐 Python | 📅 2024-08-11 结构体和类重建插件
...
* \[**5228**星]\[2m] \[Py] [refirmlabs/binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,370 | 🐛 96 | 🌐 Rust | 📅 2026-08-11 固件分析工具（命令行+IDA插件）
  * [IDA插件](https://github.com/ReFirmLabs/binwalk/tree/master/src/scripts) ⭐ 14,370 | 🐛 96 | 🌐 Rust | 📅 2026-08-11
  * [binwalk](https://github.com/ReFirmLabs/binwalk/tree/master/src/binwalk) ⭐ 14,370 | 🐛 96 | 🌐 Rust | 📅 2026-08-11
...
* \[**1554**星]\[13d] \[Py] [joxeankoret/diaphora](https://github.com/joxeankoret/diaphora) ⭐ 4,409 | 🐛 35 | 🌐 Python | 📅 2026-09-04 program diffing
* \[**360**星]\[1m] \[Py] [checkpointsw/karta](https://github.com/checkpointsw/karta) ⭐ 911 | 🐛 10 | 🌐 Python | 📅 2026-03-31 source code assisted fast binary matching plugin for IDA
...
* \[**471**星]\[13d] \[C] [bootleg/ret-sync](https://github.com/bootleg/ret-sync) ⭐ 2,390 | 🐛 31 | 🌐 C | 📅 2026-02-15 在反汇编工具和调试器之间同步调试会话
  * [GDB插件](https://github.com/bootleg/ret-sync/tree/master/ext_gdb) ⭐ 2,390 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [Ghidra插件](https://github.com/bootleg/ret-sync/tree/master/ext_ghidra) ⭐ 2,390 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [IDA插件](https://github.com/bootleg/ret-sync/tree/master/ext_ida) ⭐ 2,390 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [LLDB](https://github.com/bootleg/ret-sync/tree/master/ext_lldb) ⭐ 2,390 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [OD](https://github.com/bootleg/ret-sync/tree/master/ext_olly1) ⭐ 2,390 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [OD2](https://github.com/bootleg/ret-sync/tree/master/ext_olly2) ⭐ 2,390 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [WinDgb](https://github.com/bootleg/ret-sync/tree/master/ext_windbg/sync) ⭐ 2,390 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [x64dbg](https://github.com/bootleg/ret-sync/tree/master/ext_x64dbg) ⭐ 2,390 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * 重复区段: [x64dbg->插件->新添加的](#da5688c7823802e734c39b539aa39df7) |
...
* \[**382**星]\[26d] \[C++] [google/binexport](https://github.com/google/binexport) ⭐ 1,206 | 🐛 42 | 🌐 C++ | 📅 2026-09-15 将反汇编以Protocol Buffer的形式导出为PostgreSQL数据库, 导入到BinNavi中使用
...
* \[**727**星]\[1y] \[Py] [keystone-engine/keypatch](https://github.com/keystone-engine/keypatch) ⭐ 1,870 | 🐛 43 | 🌐 Python | 📅 2024-09-06 汇编/补丁插件, 支持多架构, 基于Keystone引擎
...
* \[**18649**星]\[10d] \[Java] [nationalsecurityagency/ghidra](https://github.com/nationalsecurityagency/ghidra) ⭐ 79,689 | 🐛 1,959 | 🌐 Java | 📅 2026-09-25 软件逆向框架
...
* \[**34576**星]\[1m] \[C++] [x64dbg/x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,606 | 🐛 572 | 🌐 C++ | 📅 2026-09-26 Windows平台x32/x64调试器
...
* \[**5195**星]\[19d] \[Py] [mobsf/mobile-security-framework-mobsf](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,836 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-26 Mobile Security Framework (MobSF) is an automated, all-in-one mobile application (Android/iOS/Windows) pen-testing, malware analysis and security assessment framework capable of performing static and dynamic analysis.
* \[**5084**星]\[15d] \[HTML] [owasp/owasp-mstg](https://github.com/owasp/owasp-mstg) ⭐ 13,205 | 🐛 243 | 🌐 Python | 📅 2026-09-20 关于移动App安全开发、测试和逆向的相近手册
...
* \[**2051**星]\[21d] \[Py] [sensepost/objection](https://github.com/sensepost/objection) ⭐ 9,408 | 🐛 58 | 🌐 Python | 📅 2026-09-17 runtimemobile exploration
...
* \[**4882**星]\[24d] \[Java] [guardianproject/haven](https://github.com/guardianproject/haven) ⭐ 6,816 | 🐛 150 | 🌐 Java | 📅 2022-10-26 通过Android应用和设备上的传感器保护自己的个人空间和财产而又不损害
* \[**4776**星]\[12d] \[C++] [facebook/redex](https://github.com/facebook/redex) ⭐ 6,301 | 🐛 74 | 🌐 C++ | 📅 2026-09-26 Android App字节码优化器
* \[**1925**星]\[7m] \[Java] [fuzion24/justtrustme](https://github.com/fuzion24/justtrustme) ⭐ 5,366 | 🐛 22 | 🌐 Java | 📅 2024-09-02 An xposed module that disables SSL certificate checking for the purposes of auditing an app with cert pinning
...
* \[**2314**星]\[1y] \[Java] [csploit/android](https://github.com/csploit/android) ⭐ 3,655 | 🐛 400 | 🌐 Java | 📅 2024-04-27 cSploit - The most complete and advanced IT security professional toolkit on Android.
* \[**431**星]\[13d] \[C] [guardianproject/orbot](https://github.com/guardianproject/orbot) ⭐ 3,574 | 🐛 82 | 🌐 Kotlin | 📅 2026-09-22 The Github home of Orbot: Tor on Android (Also available on gitlab!)
...
* \[**559**星]\[14d] \[Shell] [owasp/owasp-masvs](https://github.com/owasp/owasp-masvs) ⭐ 2,453 | 🐛 13 | 🌐 Python | 📅 2026-09-21 OWASP 移动App安全标准
...
* \[**358**星]\[5m] [b3nac/android-reports-and-resources](https://github.com/b3nac/android-reports-and-resources) ⭐ 1,714 | 🐛 1 | 📅 2025-09-10 A big list of Android Hackerone disclosed reports and other resources.
...
* \[**265**星]\[11d] \[Py] [den4uk/andriller](https://github.com/den4uk/andriller) ⭐ 1,611 | 🐛 12 | 🌐 Python | 📅 2022-06-27 a collection of forensic tools for smartphones
...
* \[**379**星]\[6m] \[Makefile] [crifan/android\_app\_security\_crack](https://github.com/crifan/android_app_security_crack) ⭐ 1,316 | 🐛 4 | 🌐 Makefile | 📅 2024-10-07 安卓应用的安全和破解
...
* \[**1213**星]\[2m] \[JS] [megatronking/httpcanary](https://github.com/megatronking/httpcanary) ⭐ 512 | 🐛 5 | 📅 2024-07-03 A powerful capture and injection tool for the Android platform
...
* \[**5080**星]\[2m] \[Java] [meituan-dianping/walle](https://github.com/meituan-dianping/walle) ⭐ 6,856 | 🐛 109 | 🌐 Java | 📅 2024-05-30 Android Signature V2 Scheme签名下的新一代渠道包打包神器

### <a id="767078c52aca04c452c095f49ad73956"></a>收集

### <a id="17408290519e1ca7745233afea62c43c"></a>各类App

* \[**12285**星]\[11d] \[Java] [signalapp/signal-android](https://github.com/signalapp/Signal-Android) ⭐ 29,388 | 🐛 500 | 🌐 Kotlin | 📅 2026-09-25 A private messenger for Android.
...
* \[**2034**星]\[12d] \[Java] [elderdrivers/edxposed](https://github.com/elderdrivers/edxposed) ⭐ 5,670 | 🐛 54 | 🌐 Java | 📅 2022-04-12 Elder driver Xposed Framework.
...
* \[**1465**星]\[3m] \[C++] [vaibhavpandeyvpz/apkstudio](https://github.com/vaibhavpandeyvpz/apkstudio) ⭐ 4,666 | 🐛 4 | 🌐 C++ | 📅 2026-01-05 Open-source, cross platform Qt based IDE for reverse-engineering Android application packages.
* \[**1793**星]\[8m] \[C++] [wrbug/dumpdex](https://github.com/wrbug/dumpdex) ⭐ 3,160 | 🐛 38 | 🌐 C++ | 📅 2020-05-15 Android脱壳
* \[**366**星]\[3m] \[Java] [patrickfav/uber-apk-signer](https://github.com/patrickfav/uber-apk-signer) ⭐ 2,756 | 🐛 11 | 🌐 Java | 📅 2023-10-30 A cli tool that helps signing and zip aligning single or multiple Android application packages (APKs) with either debug or provided release certificates. It supports v1, v2 and v3 Android signing scheme has an embedded debug keystore and auto verifies after signing.
...
* \[**1494**星]\[9d] \[C++] [jmpews/dobby](https://github.com/jmpews/Dobby) ⭐ 4,834 | 🐛 98 | 🌐 C++ | 📅 2025-01-26 a lightweight, multi-platform, multi-architecture hook framework.
...
* \[**532**星]\[7m] \[Java] [limboemu/limbo](https://github.com/limboemu/limbo) ⭐ 3,427 | 🐛 54 | 🌐 Java | 📅 2024-08-18 Limbo is a QEMU-based emulator for Android. It currently supports PC & ARM emulation for Intel x86 and ARM architecture. See our wiki
...
* \[**9285**星]\[1m] \[Java] [ibotpeaches/apktool](https://github.com/ibotpeaches/apktool) ⭐ 25,672 | 🐛 78 | 🌐 Java | 📅 2026-09-21 A tool for reverse engineering Android apk files
* \[**2053**星]\[1m] \[Java] [genymobile/gnirehtet](https://github.com/genymobile/gnirehtet) ⭐ 7,942 | 🐛 326 | 🌐 Java | 📅 2024-08-11 Gnirehtet provides reverse tethering for Android
...
* \[**5451**星]\[3m] \[Py] [axi0mx/ipwndfu](https://github.com/axi0mx/ipwndfu) ⭐ 7,424 | 🐛 168 | 🌐 Python | 📅 2024-02-21 open-source jailbreaking tool for many iOS devices
...
* \[**10966**星]\[10d] \[ObjC] [flipboard/flex](https://github.com/flipboard/flex) ⭐ 14,641 | 🐛 50 | 🌐 Objective-C | 📅 2026-06-11 An in-app debugging and exploration tool for iOS
* \[**4397**星]\[12d] \[Swift] [signalapp/signal-ios](https://github.com/signalapp/Signal-iOS) ⭐ 12,247 | 🐛 148 | 🌐 Swift | 📅 2026-09-23 A private messenger for iOS.
* \[**1215**星]\[16d] \[YARA] [horsicq/detect-it-easy](https://github.com/horsicq/detect-it-easy) ⭐ 11,594 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-25 Program for determining types of files for Windows, Linux and MacOS.
...
* \[**5775**星]\[4m] \[ObjC] [square/ponydebugger](https://github.com/square/ponydebugger) ⭐ 5,847 | 🐛 46 | 🌐 Objective-C | 📅 2023-03-18 Remote network and data debugging for your native iOS app using Chrome Developer Tools
...
* \[**2867**星]\[12d] \[ObjC] [facebook/idb](https://github.com/facebook/idb) ⭐ 5,342 | 🐛 179 | 🌐 Swift | 📅 2026-09-25 idb is a flexible command line interface for automating iOS simulators and devices
* \[**2753**星]\[1m] \[Makefile] [theos/theos](https://github.com/theos/theos) ⭐ 4,919 | 🐛 72 | 🌐 Makefile | 📅 2026-09-18 A cross-platform suite of tools for building and deploying software for iOS and other platforms.
...
* \[**310**星]\[28d] \[Swift] [securing/iossecuritysuite](https://github.com/securing/iossecuritysuite) ⭐ 2,730 | 🐛 7 | 🌐 Swift | 📅 2026-08-05 iOS platform security & anti-tampering Swift library
...
* \[**462**星]\[15d] \[Java] [dsheirer/sdrtrunk](https://github.com/dsheirer/sdrtrunk) ⭐ 2,194 | 🐛 453 | 🌐 Java | 📅 2026-08-01 A cross-platform java application for decoding, monitoring, recording and streaming trunked mobile and related radio protocols using Software Defined Radios (SDR). Website:
...
* \[**796**星]\[13d] \[Shell] [aqzt/kjyw](https://github.com/aqzt/kjyw) ⭐ 1,869 | 🐛 6 | 🌐 Shell | 📅 2025-07-01 快捷运维，代号kjyw，项目基于shell、python，运维脚本工具库，收集各类运维常用工具脚本，实现快速安装nginx、mysql、php、redis、nagios、运维经常使用的脚本等等...
...
* \[**346**星]\[4m] \[TS] [bacher09/pwgen-for-bios](https://github.com/bacher09/pwgen-for-bios) ⭐ 1,448 | 🐛 184 | 🌐 TypeScript | 📅 2026-02-05 Password generator for BIOS
...
* \[**308**星]\[2m] \[Py] [hatching/vmcloak](https://github.com/hatching/vmcloak) ⭐ 522 | 🐛 65 | 🌐 Python | 📅 2024-05-14 Automated Virtual Machine Generation and Cloaking for Cuckoo Sandbox.
...
* \[**1228**星]\[12d] \[C] [dynamorio/dynamorio](https://github.com/dynamorio/dynamorio) ⭐ 3,165 | 🐛 1,812 | 🌐 C | 📅 2026-09-26 Dynamic Instrumentation Tool Platform
...
* \[**4516**星]\[13d] \[Makefile] [frida/frida](https://github.com/frida/frida) ⭐ 22,040 | 🐛 1,965 | 🌐 Meson | 📅 2026-09-25 Clone this repo to build Frida
...
* \[**228**星]\[13d] \[C] [frida/frida-gum](https://github.com/frida/frida-gum) ⭐ 1,022 | 🐛 202 | 🌐 C | 📅 2026-09-25 Low-level code instrumentation library used by frida-core
* \[**420**星]\[13d] \[C] [frida/frida-python](https://github.com/frida/frida-python) ⭐ 873 | 🐛 56 | 🌐 Python | 📅 2026-09-25 Frida Python bindings
...
* \[**321**星]\[1m] \[C] [frida/frida-core](https://github.com/frida/frida-core) ⭐ 774 | 🐛 146 | 🌐 Vala | 📅 2026-09-25 Frida core library intended for static linking into bindings
...
* \[**378**星]\[27d] \[JS] [nowsecure/r2frida](https://github.com/nowsecure/r2frida) ⭐ 1,443 | 🐛 47 | 🌐 TypeScript | 📅 2026-09-25 Radare2 and Frida better together.
...
* \[**2687**星]\[11d] \[Go] [adguardteam/adguardhome](https://github.com/adguardteam/adguardhome) ⭐ 37,070 | 🐛 1,259 | 🌐 TypeScript | 📅 2026-09-25 Network-wide ads & trackers blocking DNS server
* \[**10378**星]\[11d] \[Go] [goharbor/harbor](https://github.com/goharbor/harbor) ⭐ 29,457 | 🐛 914 | 🌐 Go | 📅 2026-09-25 An open source trusted cloud native registry project that stores, signs, and scans content.
...
* \[**5420**星]\[12d] \[Py] [mlflow/mlflow](https://github.com/mlflow/mlflow) ⭐ 28,138 | 🐛 2,134 | 🌐 Python | 📅 2026-09-26 Open source platform for the machine learning lifecycle
* \[**11402**星]\[10d] \[Java] [oracle/graal](https://github.com/oracle/graal) ⭐ 21,715 | 🐛 853 | 🌐 Java | 📅 2026-09-26 Run Programs Faster Anywhere
* \[**7020**星]\[14d] \[Go] [nats-io/nats-server](https://github.com/nats-io/nats-server) ⭐ 20,772 | 🐛 458 | 🌐 Go | 📅 2026-09-25 High-Performance server for NATS, the cloud native messaging system.
...
* \[**3608**星]\[9d] \[Pascal] [cheat-engine/cheat-engine](https://github.com/cheat-engine/cheat-engine) ⭐ 19,225 | 🐛 1,311 | 🌐 Pascal | 📅 2025-04-19 Cheat Engine. A development environment focused on modding
* \[**4610**星]\[1y] \[C] [upx/upx](https://github.com/upx/upx) ⭐ 17,901 | 🐛 21 | 🌐 C++ | 📅 2026-09-25 UPX - the Ultimate Packer for eXecutables
* \[**5226**星]\[13d] \[Shell] [denisidoro/navi](https://github.com/denisidoro/navi) ⭐ 17,637 | 🐛 111 | 🌐 Rust | 📅 2026-09-20 An interactive cheatsheet tool for the command-line
* \[**11213**星]\[2m] \[Jupyter Notebook] [selfteaching/the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 17,216 | 🐛 200 | 🌐 Jupyter Notebook | 📅 2026-05-20 One has no future if one couldn't teach themself.
* \[**2815**星]\[20d] \[C] [processhacker/processhacker](https://github.com/processhacker/processhacker) ⭐ 16,100 | 🐛 296 | 🌐 C | 📅 2026-09-26 A free, powerful, multi-purpose tool that helps you monitor system resources, debug software and detect malware.
* \[**3295**星]\[15d] \[JS] [koenkk/zigbee2mqtt](https://github.com/koenkk/zigbee2mqtt) ⭐ 15,667 | 🐛 457 | 🌐 TypeScript | 📅 2026-09-23 Zigbee
* \[**6894**星]\[2m] \[Go] [sqshq/sampler](https://github.com/sqshq/sampler) ⭐ 14,807 | 🐛 62 | 🌐 Go | 📅 2024-02-22 A tool for shell commands execution, visualization and alerting. Configured with a simple YAML file.
...
* \[**5116**星]\[11d] \[ASP] [hq450/fancyss](https://github.com/hq450/fancyss) ⭐ 13,774 | 🐛 224 | 🌐 Shell | 📅 2026-06-01 fancyss is a project providing tools to across the GFW on asuswrt/merlin based router.
* \[**3129**星]\[13d] \[C] [qemu/qemu](https://github.com/qemu/qemu) ⭐ 13,764 | 🐛 0 | 🌐 C | 📅 2026-09-25 Official QEMU mirror. Please see
* \[**5229**星]\[4m] \[Py] [ytisf/thezoo](https://github.com/ytisf/thezoo) ⭐ 13,413 | 🐛 90 | 🌐 Python | 📅 2026-09-14 A repository of LIVE malwares for your own joy and pleasure. theZoo is a project created to make the possibility of malware analysis open and available to the public.
* \[**2344**星]\[16d] \[C] [tsl0922/ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,422 | 🐛 115 | 🌐 C | 📅 2026-08-12 Share your terminal over the web
* \[**3980**星]\[1m] \[Rust] [svenstaro/genact](https://github.com/svenstaro/genact) ⭐ 12,205 | 🐛 16 | 🌐 Rust | 📅 2026-09-01 a nonsense activity generator
* \[**3505**星]\[16d] \[C] [cyan4973/xxhash](https://github.com/cyan4973/xxhash) ⭐ 11,288 | 🐛 7 | 🌐 C | 📅 2026-09-20 Extremely fast non-cryptographic hash algorithm
* \[**2993**星]\[18d] \[Py] [quantaxis/quantaxis](https://github.com/quantaxis/quantaxis) ⭐ 11,236 | 🐛 240 | 🌐 Python | 📅 2026-09-18 支持任务调度 分布式部署的 股票/期货/自定义市场 数据/回测/模拟/交易/可视化 纯本地PAAS量化解决方案
...
* \[**3908**星]\[12d] \[C++] [baldurk/renderdoc](https://github.com/baldurk/renderdoc) ⭐ 11,118 | 🐛 52 | 🌐 C++ | 📅 2026-09-23 RenderDoc is a stand-alone graphics debugging tool.
* \[**2053**星]\[24d] \[C#] [mathewsachin/captura](https://github.com/mathewsachin/captura) ⭐ 10,839 | 🐛 116 | 🌐 C# | 📅 2026-05-25 Capture Screen, Audio, Cursor, Mouse Clicks and Keystrokes
* \[**2627**星]\[23d] \[JS] [popcorn-official/popcorn-desktop](https://github.com/popcorn-official/popcorn-desktop) ⭐ 10,689 | 🐛 65 | 🌐 TypeScript | 📅 2026-09-04 Popcorn Time is a multi-platform, free software BitTorrent client that includes an integrated media player. Desktop ( Windows / Mac / Linux ) a Butter-Project Fork
* \[**4597**星]\[12d] \[C++] [mozilla/rr](https://github.com/mozilla/rr) ⭐ 10,676 | 🐛 481 | 🌐 C++ | 📅 2026-09-19 记录与重放App的调试执行过程
...
* \[**4857**星]\[13d] \[Go] [gcla/termshark](https://github.com/gcla/termshark) ⭐ 10,022 | 🐛 51 | 🌐 Go | 📅 2024-04-30 A terminal UI for tshark, inspired by Wireshark
* \[**3289**星]\[15d] \[C] [virustotal/yara](https://github.com/virustotal/yara) ⭐ 9,894 | 🐛 167 | 🌐 C | 📅 2026-09-23 The pattern matching swiss knife
* \[**5876**星]\[3m] \[Gnuplot] [nasa-jpl/open-source-rover](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,670 | 🐛 17 | 🌐 HTML | 📅 2026-09-03 A build-it-yourself, 6-wheel rover based on the rovers on Mars!
* \[**5717**星]\[28d] \[JS] [swagger-api/swagger-editor](https://github.com/swagger-api/swagger-editor) ⭐ 9,468 | 🐛 29 | 🌐 JavaScript | 📅 2026-09-25 Swagger Editor
* \[**3108**星]\[1m] \[C] [unicorn-engine/unicorn](https://github.com/unicorn-engine/unicorn) ⭐ 9,368 | 🐛 220 | 🌐 C | 📅 2026-08-28 Unicorn CPU emulator framework (ARM, AArch64, M68K, Mips, Sparc, X86)
* \[**6353**星]\[2m] \[Py] [seatgeek/fuzzywuzzy](https://github.com/seatgeek/fuzzywuzzy) ⚠️ Archived Fuzzy String Matching in Python
* \[**3188**星]\[11d] \[C] [meetecho/janus-gateway](https://github.com/meetecho/janus-gateway) ⭐ 9,171 | 🐛 40 | 🌐 C | 📅 2026-09-23 Janus WebRTC Server
* \[**3960**星]\[11d] \[Py] [angr/angr](https://github.com/angr/angr) ⭐ 9,112 | 🐛 728 | 🌐 Python | 📅 2026-09-25 A powerful and user-friendly binary analysis platform!
* \[**3939**星]\[15d] \[C] [aquynh/capstone](https://github.com/aquynh/capstone) ⭐ 9,042 | 🐛 353 | 🌐 C | 📅 2026-09-24 Capstone disassembly/disassembler framework: Core (Arm, Arm64, BPF, EVM, M68K, M680X, MOS65xx, Mips, PPC, RISCV, Sparc, SystemZ, TMS320C64x, Web Assembly, X86, X86\_64, XCore) + bindings.
...
* \[**3451**星]\[19d] \[C] [mikebrady/shairport-sync](https://github.com/mikebrady/shairport-sync) ⭐ 8,867 | 🐛 13 | 🌐 C | 📅 2026-09-25 AirPlay audio player. Shairport Sync adds multi-room capability with Audio Synchronisation
* \[**2587**星]\[10d] \[C] [esnet/iperf](https://github.com/esnet/iperf) ⭐ 8,780 | 🐛 239 | 🌐 C | 📅 2026-09-25 A TCP, UDP, and SCTP network bandwidth measurement tool
* \[**4651**星]\[13d] [powershell/win32-openssh](https://github.com/powershell/win32-openssh) ⭐ 8,293 | 🐛 408 | 📅 2026-09-23 Win32 port of OpenSSH
* \[**4541**星]\[4m] \[TS] [apis-guru/graphql-voyager](https://github.com/apis-guru/graphql-voyager) ⭐ 8,169 | 🐛 106 | 🌐 TypeScript | 📅 2026-05-12
* \[**3306**星]\[19d] \[C] [microsoft/windows-driver-samples](https://github.com/microsoft/windows-driver-samples) ⭐ 7,858 | 🐛 129 | 🌐 C | 📅 2026-09-25 This repo contains driver samples prepared for use with Microsoft Visual Studio and the Windows Driver Kit (WDK). It contains both Universal Windows Driver and desktop-only driver samples.
* \[**2948**星]\[1m] \[C] [libfuse/sshfs](https://github.com/libfuse/sshfs) ⭐ 7,678 | 🐛 63 | 🌐 C | 📅 2026-09-16 A network filesystem client to connect to SSH servers
* \[**4314**星]\[15d] \[Rust] [timvisee/ffsend](https://github.com/timvisee/ffsend) ⭐ 7,418 | 🐛 34 | 🌐 Rust | 📅 2025-11-20 Easily and securely share files from the command line
* \[**4747**星]\[8d] \[C++] [paddlepaddle/paddle-lite](https://github.com/PaddlePaddle/Paddle-Lite) ⭐ 7,278 | 🐛 47 | 🌐 C++ | 📅 2026-04-27 Multi-platform high performance deep learning inference engine (『飞桨』多平台高性能深度学习预测引擎）
...
* \[**2194**星]\[13d] \[C] [armmbed/mbedtls](https://github.com/armmbed/mbedtls) ⭐ 6,968 | 🐛 1,733 | 🌐 C | 📅 2026-09-25 An open source, portable, easy to use, readable and flexible SSL library
* \[**6454**星]\[9m] \[HTML] [open-power-workgroup/hospital](https://github.com/open-power-workgroup/hospital) ⭐ 6,707 | 🐛 48 | 🌐 HTML | 📅 2020-10-27 OpenPower工作组收集汇总的医院开放数据
* \[**2621**星]\[2m] [pditommaso/awesome-pipeline](https://github.com/pditommaso/awesome-pipeline) ⭐ 6,628 | 🐛 33 | 📅 2026-09-25 A curated list of awesome pipeline toolkits inspired by Awesome Sysadmin
...
* \[**2854**星]\[1m] \[Py] [espressif/esptool](https://github.com/espressif/esptool) ⭐ 6,494 | 🐛 15 | 🌐 Python | 📅 2026-09-25 ESP8266 and ESP32 serial bootloader utility
...
* \[**408**星]\[19d] \[Py] [crytic/slither](https://github.com/crytic/slither) ⭐ 6,373 | 🐛 479 | 🌐 Python | 📅 2026-09-23 Static Analyzer for Solidity
...
* \[**2092**星]\[26d] [swiftonsecurity/sysmon-config](https://github.com/swiftonsecurity/sysmon-config) ⭐ 5,662 | 🐛 83 | 📅 2024-07-03 Sysmon configuration file template with default high-quality event tracing
...
* \[**1620**星]\[16d] \[C++] [lief-project/lief](https://github.com/lief-project/lief) ⭐ 5,574 | 🐛 37 | 🌐 C++ | 📅 2026-09-06 Library to Instrument Executable Formats
* \[**2211**星]\[1m] \[C++] [google/bloaty](https://github.com/google/bloaty) ⭐ 5,551 | 🐛 72 | 🌐 C++ | 📅 2026-09-24 Bloaty McBloatface: a size profiler for binaries
* \[**2898**星]\[8m] \[C] [p-h-c/phc-winner-argon2](https://github.com/p-h-c/phc-winner-argon2) ⭐ 5,376 | 🐛 102 | 🌐 C | 📅 2024-08-06 The password hash Argon2, winner of PHC
* \[**2833**星]\[2m] \[Assembly] [cirosantilli/x86-bare-metal-examples](https://github.com/cirosantilli/x86-bare-metal-examples) ⭐ 5,370 | 🐛 7 | 🌐 Assembly | 📅 2022-07-18 几十个用于学习 x86 系统编程的小型操作系统
* \[**2872**星]\[14d] \[C] [lxc/lxc](https://github.com/lxc/lxc) ⭐ 5,265 | 🐛 151 | 🌐 C | 📅 2026-09-07 LXC - Linux Containers
...
* \[**3131**星]\[2m] \[CSS] [readthedocs/sphinx\_rtd\_theme](https://github.com/readthedocs/sphinx_rtd_theme) ⭐ 5,091 | 🐛 276 | 🌐 Sass | 📅 2026-01-12 Sphinx theme for readthedocs.org
* \[**2093**星]\[10d] \[C] [flatpak/flatpak](https://github.com/flatpak/flatpak) ⭐ 5,073 | 🐛 1,018 | 🌐 C | 📅 2026-09-25 Linux application sandboxing and distribution framework
...
* \[**2391**星]\[21d] \[Java] [mock-server/mockserver](https://github.com/mock-server/mockserver) ⭐ 4,976 | 🐛 1 | 🌐 Java | 📅 2026-09-26 MockServer enables easy mocking of any system you integrate with via HTTP or HTTPS with clients written in Java, JavaScript and Ruby. MockServer also includes a proxy that introspects all proxied traffic including encrypted SSL traffic and supports Port Forwarding, Web Proxying (i.e. HTTP proxy), HTTPS Tunneling Proxying (using HTTP CONNECT) and…
...
* \[**2137**星]\[19d] \[Assembly] [pret/pokered](https://github.com/pret/pokered) ⭐ 4,943 | 🐛 22 | 🌐 Assembly | 📅 2026-09-22 disassembly of Pokémon Red/Blue
...
* \[**1761**星]\[13d] \[C] [google/wuffs](https://github.com/google/wuffs) ⭐ 4,840 | 🐛 38 | 🌐 C | 📅 2026-09-16 Wrangling Untrusted File Formats Safely
* \[**3749**星]\[12d] \[Go] [hashicorp/consul-template](https://github.com/hashicorp/consul-template) ⭐ 4,824 | 🐛 230 | 🌐 Go | 📅 2026-09-25 Template rendering, notifier, and supervisor for
...
* \[**2340**星]\[2m] \[JS] [pa11y/pa11y](https://github.com/pa11y/pa11y) ⭐ 4,556 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-21 Pa11y is your automated accessibility testing pal
...
* \[**1714**星]\[1m] \[Go] [hashicorp/memberlist](https://github.com/hashicorp/memberlist) ⭐ 4,113 | 🐛 98 | 🌐 Go | 📅 2026-09-21 Golang package for gossip based membership and failure detection
* \[**1779**星]\[29d] [17mon/china\_ip\_list](https://github.com/17mon/china_ip_list) ⭐ 4,097 | 🐛 19 | 📅 2025-03-04
* \[**2052**星]\[13d] \[C++] [openthread/openthread](https://github.com/openthread/openthread) ⭐ 4,036 | 🐛 159 | 🌐 C++ | 📅 2026-09-25 OpenThread released by Google is an open-source implementation of the Thread networking protocol
* \[**2217**星]\[14d] \[Go] [google/mtail](https://github.com/google/mtail) ⭐ 4,032 | 🐛 61 | 🌐 Go | 📅 2026-03-19 extract whitebox monitoring data from application logs for collection in a timeseries database
...
* \[**1637**星]\[12d] \[JS] [efforg/privacybadger](https://github.com/efforg/privacybadger) ⭐ 3,849 | 🐛 106 | 🌐 JavaScript | 📅 2026-09-25 Privacy Badger is a browser extension that automatically learns to block invisible trackers.
* \[**2364**星]\[10d] \[C] [domoticz/domoticz](https://github.com/domoticz/domoticz) ⭐ 3,811 | 🐛 29 | 🌐 C++ | 📅 2026-09-23 monitor and configure various devices like: Lights, Switches, various sensors/meters like Temperature, Rain, Wind, UV, Electra, Gas, Water and much more
...
* \[**1722**星]\[4m] \[Py] [anorov/cloudflare-scrape](https://github.com/anorov/cloudflare-scrape) ⭐ 3,540 | 🐛 128 | 🌐 Python | 📅 2023-10-14 A Python module to bypass Cloudflare's anti-bot page.
...
* \[**637**星]\[21d] \[PS] [olafhartong/sysmon-modular](https://github.com/olafhartong/sysmon-modular) ⭐ 3,142 | 🐛 51 | 🌐 Go | 📅 2026-09-18 sysmon配置模块收集
...
* \[**2260**星]\[13d] [dumb-password-rules/dumb-password-rules](https://github.com/dumb-password-rules/dumb-password-rules) ⭐ 3,020 | 🐛 63 | 🌐 Nunjucks | 📅 2026-09-08 Shaming sites with dumb password rules.
* \[**1786**星]\[1m] \[C++] [apitrace/apitrace](https://github.com/apitrace/apitrace) ⭐ 2,861 | 🐛 158 | 🌐 C++ | 📅 2026-09-25 Tools for tracing OpenGL, Direct3D, and other graphics APIs
...
* \[**1676**星]\[10d] \[Java] [apache/geode](https://github.com/apache/geode) ⭐ 2,386 | 🐛 17 | 🌐 Java | 📅 2026-09-25 Apache Geode
...
* \[**1852**星]\[1y] \[Py] [jinnlynn/genpac](https://github.com/jinnlynn/genpac) ⭐ 2,182 | 🐛 0 | 🌐 Python | 📅 2026-09-26 PAC/Dnsmasq/Wingy file Generator, working with gfwlist, support custom rules.
* \[**906**星]\[7m] \[C++] [dfhack/dfhack](https://github.com/DFHack/dfhack) ⭐ 2,044 | 🐛 1,007 | 🌐 C++ | 📅 2026-09-26 Memory hacking library for Dwarf Fortress and a set of tools that use it
...
* \[**265**星]\[3m] \[Assembly] [pret/pokeyellow](https://github.com/pret/pokeyellow) ⭐ 879 | 🐛 3 | 🌐 Assembly | 📅 2026-09-02 Disassembly of Pokemon Yellow
...
* \[**1955**星]\[11d] \[Go] [solo-io/gloo](https://github.com/solo-io/gloo) ⭐ 169 | 🐛 1,872 | 🌐 Go | 📅 2026-09-25 An Envoy-Powered API Gateway
* \[**2214**星]\[18d] [getlantern/lantern-binaries](https://github.com/getlantern/lantern-binaries) ⭐ 120 | 🐛 14 | 📅 2026-09-26 Lantern installers binary downloads.
...
* \[**1422**星]\[17d] \[C++] [eteran/edb-debugger](https://github.com/eteran/edb-debugger) ⭐ 2,965 | 🐛 67 | 🌐 C++ | 📅 2026-09-05 edb is a cross platform AArch32/x86/x86-64 debugger.
* \[**836**星]\[8d] \[C++] [tasvideos/bizhawk](https://github.com/tasvideos/bizhawk) ⭐ 2,766 | 🐛 810 | 🌐 C# | 📅 2026-09-20 BizHawk is a multi-system emulator written in C#. BizHawk provides nice features for casual gamers such as full screen, and joypad support in addition to full rerecording and debugging tools for all system cores.
...
* \[**560**星]\[21d] \[C#] [microsoft/miengine](https://github.com/microsoft/miengine) ⭐ 860 | 🐛 164 | 🌐 C# | 📅 2026-09-22 The Visual Studio MI Debug Engine ("MIEngine") provides an open-source Visual Studio Debugger extension that works with MI-enabled debuggers such as gdb, lldb, and clrdbg.
...
* \[**291**星]\[12d] \[Py] [sosreport/sos](https://github.com/sosreport/sos) ⭐ 599 | 🐛 153 | 🌐 Python | 📅 2026-09-25 A unified tool for collecting system logs and other debug information
...
* \[**299**星]\[17d] \[JS] [w3c/webappsec-trusted-types](https://github.com/w3c/webappsec-trusted-types) ⭐ 662 | 🐛 59 | 🌐 JavaScript | 📅 2026-09-08 A browser API to prevent DOM-Based Cross Site Scripting in modern web applications.
...
* \[**20779**星]\[8d] \[Java] [skylot/jadx](https://github.com/skylot/jadx) ⭐ 50,633 | 🐛 452 | 🌐 Java | 📅 2026-09-25 dex 转 java 的反编译器
...
* \[**1652**星]\[12m] \[Java] [fesh0r/fernflower](https://github.com/fesh0r/fernflower) ⭐ 4,408 | 🐛 0 | 🌐 Java | 📅 2026-09-25 Unofficial mirror of FernFlower Java decompiler (All pulls should be submitted upstream)
* \[**1466**星]\[12d] \[Py] [rocky/python-uncompyle6](https://github.com/rocky/python-uncompyle6) ⭐ 4,323 | 🐛 44 | 🌐 Python | 📅 2026-04-24 Python反编译器，跨平台
* \[**331**星]\[11d] \[Java] [leibnitz27/cfr](https://github.com/leibnitz27/cfr) ⭐ 2,704 | 🐛 151 | 🌐 Java | 📅 2026-06-04 This is the public repository for the CFR Java decompiler
* \[**673**星]\[18d] \[C#] [uxmal/reko](https://github.com/uxmal/reko) ⭐ 2,606 | 🐛 165 | 🌐 C# | 📅 2026-09-11 Reko is a binary decompiler.
* \[**347**星]\[16d] \[C#] [steamdatabase/valveresourceformat](https://github.com/steamdatabase/valveresourceformat) ⭐ 2,455 | 🐛 64 | 🌐 C# | 📅 2026-09-25 Valve's Source 2 resource file format (also known as Stupid Valve Format) parser and decompiler.
* \[**1084**星]\[4m] \[Py] [storyyeller/krakatau](https://github.com/storyyeller/krakatau) ⭐ 2,256 | 🐛 26 | 🌐 Rust | 📅 2026-09-25 Java decompiler, assembler, and disassembler
...
* \[**283**星]\[8m] \[Shell] [venshine/decompile-apk](https://github.com/venshine/decompile-apk) ⭐ 824 | 🐛 6 | 🌐 Shell | 📅 2025-06-14 APK 反编译
...
* \[**243**星]\[3m] \[Java] [kwart/jd-cmd](https://github.com/kwart/jd-cmd) ⭐ 655 | 🐛 10 | 🌐 Java | 📅 2026-09-21 Command line Java Decompiler
...
* \[**1374**星]\[20d] \[C] [zyantific/zydis](https://github.com/zyantific/zydis) ⭐ 4,378 | 🐛 51 | 🌐 C | 📅 2026-07-27 快速的轻量级x86/x86-64 反汇编库
* \[**430**星]\[2m] \[C#] [0xd4d/iced](https://github.com/0xd4d/iced) ⭐ 3,571 | 🐛 61 | 🌐 Rust | 📅 2026-09-16 x86/x64 disassembler, instruction decoder & encoder
...
* \[**627**星]\[3m] \[C] [gdabah/distorm](https://github.com/gdabah/distorm) ⭐ 1,340 | 🐛 16 | 🌐 C | 📅 2023-10-10 Powerful Disassembler Library For x86/AMD64
...
* \[**6052**星]\[13d] \[Py] [cyrus-and/gdb-dashboard](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,258 | 🐛 19 | 🌐 Python | 📅 2026-07-17 Modular visual interface for GDB in Python
* \[**2439**星]\[16d] \[Py] [pwndbg/pwndbg](https://github.com/pwndbg/pwndbg) ⭐ 10,958 | 🐛 215 | 🌐 Python | 📅 2026-09-21 GDB插件，辅助漏洞开发和逆向
...
* \[**2568**星]\[1m] \[Py] [hugsy/gef](https://github.com/hugsy/gef) ⭐ 8,371 | 🐛 15 | 🌐 Python | 📅 2026-08-20 gdb增强工具，使用Python API，用于漏洞开发和逆向分析。
* \[**3784**星]\[11m] \[Py] [longld/peda](https://github.com/longld/peda) ⭐ 6,154 | 🐛 76 | 🌐 Python | 📅 2024-07-29 Python Exploit Development Assistance for GDB
...
* \[**11588**星]\[12d] \[C] [radareorg/radare2](https://github.com/radareorg/radare2) ⭐ 24,873 | 🐛 819 | 🌐 C | 📅 2026-09-26 unix-like reverse engineering framework and commandline tools
...
* \[**2820**星]\[1m] \[Py] [androguard/androguard](https://github.com/androguard/androguard) ⭐ 6,294 | 🐛 1 | 🌐 Python | 📅 2026-09-22 Reverse engineering, Malware and goodware analysis of Android applications ... and more (ninja !)
* \[**328**星]\[5m] \[Py] [vector35/binaryninja-api](https://github.com/vector35/binaryninja-api) ⭐ 1,320 | 🐛 1,972 | 🌐 C++ | 📅 2026-09-25 Public API, examples, documentation and issues for Binary Ninja
...
* \[**634**星]\[10d] \[C] [thewover/donut](https://github.com/thewover/donut) ⭐ 4,712 | 🐛 37 | 🌐 C | 📅 2025-07-08 Generates x86, x64, or AMD64+x86 position-independent shellcode that loads .NET Assemblies, PE files, and other Windows payloads from memory and runs them with parameters
...
* \[**1915**星]\[22d] \[C#] [lucasg/dependencies](https://github.com/lucasg/dependencies) ⭐ 11,858 | 🐛 143 | 🌐 C# | 📅 2024-05-15 A rewrite of the old legacy software "depends.exe" in C# for Windows devs to troubleshoot dll load dependencies issues.
* \[**1146**星]\[27d] \[C#] [perfare/il2cppdumper](https://github.com/perfare/il2cppdumper) ⭐ 9,435 | 🐛 155 | 🌐 C# | 📅 2024-08-18 Restore dll from Unity il2cpp binary file (except code)
...
* \[**713**星]\[5m] \[C++] [darthton/xenos](https://github.com/darthton/xenos) ⭐ 2,669 | 🐛 52 | 🌐 C++ | 📅 2021-05-17 Windows DLL 注入器
...
* \[**299**星]\[11m] \[C++] [anhkgg/superdllhijack](https://github.com/anhkgg/superdllhijack) ⭐ 1,040 | 🐛 5 | 🌐 C++ | 📅 2021-11-10 一种通用Dll劫持技术，不再需要手工导出Dll的函数接口了
...
* \[**2355**星]\[11d] \[C] [hfiref0x/uacme](https://github.com/hfiref0x/uacme) ⭐ 7,802 | 🐛 0 | 🌐 C | 📅 2026-07-24 Defeating Windows User Account Control
...
* \[**1228**星]\[10d] \[JS] [jpcertcc/logontracer](https://github.com/jpcertcc/logontracer) ⭐ 3,277 | 🐛 22 | 🌐 Python | 📅 2026-08-02 通过可视化和分析Windows事件日志来调查恶意的Windows登录
...
* \[**261**星]\[3m] \[C++] [gametechdev/presentmon](https://github.com/gametechdev/presentmon) ⭐ 2,584 | 🐛 201 | 🌐 C++ | 📅 2026-09-25 Tool for collection and processing of ETW events related to DXGI presentation.
...
* \[**9261**星]\[11d] \[C#] [icsharpcode/ilspy](https://github.com/icsharpcode/ilspy) ⭐ 26,142 | 🐛 180 | 🌐 C# | 📅 2026-09-25 .NET Decompiler
...
* \[**1657**星]\[14d] \[C#] [jbevain/cecil](https://github.com/jbevain/cecil) ⭐ 3,001 | 🐛 114 | 🌐 C# | 📅 2025-09-11 C#库, 探查/修改/生成 .NET App/库
...
* \[**510**星]\[5m] \[Py] [rabbitstack/fibratus](https://github.com/rabbitstack/fibratus) ⭐ 2,552 | 🐛 44 | 🌐 Go | 📅 2026-09-24 Windows内核探索和跟踪工具
* \[**479**星]\[1m] \[C] [jkornev/hidden](https://github.com/jkornev/hidden) ⭐ 2,059 | 🐛 13 | 🌐 C | 📅 2022-07-13 Windows驱动，带用户模式接口：隐藏文件系统和注册表对象、保护进程等
...
* \[**278**星]\[12d] \[PS] [microsoftdocs/windows-driver-docs](https://github.com/MicrosoftDocs/windows-driver-docs) ⭐ 1,070 | 🐛 9 | 🌐 OpenSCAD | 📅 2026-09-15 官方Windows驱动程序工具包文档
...
* \[**725**星]\[2m] \[HTML] [j00ru/windows-syscalls](https://github.com/j00ru/windows-syscalls) ⭐ 2,649 | 🐛 3 | 🌐 HTML | 📅 2025-12-30 Windows 系统调用表(NT/2000/XP/2003/Vista/2008/7/2012/8/10)
...
* \[**863**星]\[14d] \[C++] [henrypp/simplewall](https://github.com/henrypp/simplewall) ⭐ 9,063 | 🐛 143 | 🌐 C | 📅 2026-09-18 为Windows 过滤平台提供的配置界面
* \[**949**星]\[3m] \[C] [basil00/divert](https://github.com/basil00/divert) ⭐ 3,296 | 🐛 65 | 🌐 C | 📅 2023-03-15 用户模式数据包拦截库，适用于Win 7/8/10
* \[**360**星]\[12d] \[C#] [digitalruby/ipban](https://github.com/digitalruby/ipban) ⭐ 2,196 | 🐛 3 | 🌐 C# | 📅 2026-08-21 监视Windows/Linux系统的登录失败和不良行为，并封禁对应的IP地址。高度可配置，精简且功能强大。
...
* \[**570**星]\[1m] \[C] [hfiref0x/winobjex64](https://github.com/hfiref0x/winobjex64) ⭐ 1,980 | 🐛 0 | 🌐 C | 📅 2026-09-01 Windows对象浏览器. x64
* \[**418**星]\[15d] \[C] [samba-team/samba](https://github.com/samba-team/samba) ⭐ 1,144 | 🐛 1 | 🌐 C | 📅 2026-09-25 适用于Linux和Unix的标准Windows interoperability程序套件
* \[**726**星]\[2m] \[Py] [diyan/pywinrm](https://github.com/diyan/pywinrm) ⭐ 1,136 | 🐛 54 | 🌐 Python | 📅 2026-08-04 Python实现的WinRM客户端
* \[**228**星]\[3m] \[C] [leecher1337/ntvdmx64](https://github.com/leecher1337/ntvdmx64) ⭐ 953 | 🐛 91 | 🌐 C | 📅 2026-08-28 在64位版本上执行Windows DOS版的 NTVDM
* \[**208**星]\[10m] \[C] [hzqst/unicorn\_pe](https://github.com/hzqst/unicorn_pe) ⚠️ Archived 模拟Windows PE文件的代码执行，基于Unicorn
* \[**210**星]\[3m] [adguardteam/adguardforwindows](https://github.com/adguardteam/adguardforwindows) ⭐ 890 | 🐛 163 | 📅 2026-09-09 Windows系统范围的AdBlocker
...
* \[**787**星]\[2m] \[C] [nixos/patchelf](https://github.com/nixos/patchelf) ⭐ 4,269 | 🐛 150 | 🌐 C | 📅 2026-07-27 A small utility to modify the dynamic linker and RPATH of ELF executables
* \[**930**星]\[15d] \[Py] [eliben/pyelftools](https://github.com/eliben/pyelftools) ⭐ 2,281 | 🐛 57 | 🌐 Python | 📅 2026-07-30 Parsing ELF and DWARF in Python
...
* \[**1450**星]\[2m] \[C] [feralinteractive/gamemode](https://github.com/feralinteractive/gamemode) ⭐ 6,022 | 🐛 219 | 🌐 C | 📅 2026-06-15 Optimise Linux system performance on demand
...
* \[**759**星]\[1m] \[Py] [korcankaraokcu/pince](https://github.com/korcankaraokcu/pince) ⭐ 3,107 | 🐛 6 | 🌐 Python | 📅 2026-09-18 A reverse engineering tool that'll supply the place of Cheat Engine for linux
* \[**731**星]\[17d] \[C] [strace/strace](https://github.com/strace/strace) ⭐ 2,707 | 🐛 109 | 🌐 C | 📅 2026-09-15 strace is a diagnostic, debugging and instructional userspace utility for Linux
* \[**895**星]\[29d] \[C] [buserror/simavr](https://github.com/buserror/simavr) ⭐ 1,787 | 🐛 44 | 🌐 C | 📅 2026-09-25 simavr is a lean, mean and hackable AVR simulator for linux & OSX
...
* \[**468**星]\[9d] \[C] [libreswan/libreswan](https://github.com/libreswan/libreswan) ⭐ 1,005 | 🐛 667 | 🌐 C | 📅 2026-09-26 an Internet Key Exchange (IKE) implementation for Linux.
...
* \[**393**星]\[2m] \[Shell] [yadominjinta/atilo](https://github.com/yadominjinta/atilo) ⭐ 827 | 🐛 7 | 🌐 Python | 📅 2023-01-26 Linux installer for termux
