...
* [全平台逆向资源: awesome-reverse-engineering](https://github.com/alphaSeclab/awesome-reverse-engineering) ⭐ 5,023 | 🐛 7 | 📅 2021-09-01:
...
* 此页只包含部分内容. [查看完整版](https://github.com/alphaSeclab/awesome-reverse-engineering/blob/master/Readme_full.md) ⭐ 5,023 | 🐛 7 | 📅 2021-09-01

# 说明

[EnglishVersion](https://github.com/alphaSeclab/awesome-reverse-engineering/blob/master/Readme_en.md) ⭐ 5,023 | 🐛 7 | 📅 2021-09-01
...
* \[**737**星]\[7m] \[Py] [devttys0/ida](https://github.com/devttys0/ida) ⭐ 1,366 | 🐛 28 | 🌐 Python | 📅 2023-10-23 IDA插件/脚本/模块收集
  * [wpsearch](https://github.com/devttys0/ida/blob/master/scripts/wpsearch.py) ⭐ 1,366 | 🐛 28 | 🌐 Python | 📅 2023-10-23 查找在MIPS WPS checksum实现中常见的立即数
  * [md5hash](https://github.com/devttys0/ida/tree/master/modules/md5hash) ⭐ 1,366 | 🐛 28 | 🌐 Python | 📅 2023-10-23 纯Python版的MD5 hash实现（IDA的hashlib有问题）
  * [alleycat](https://github.com/devttys0/ida/tree/master/plugins/alleycat) ⭐ 1,366 | 🐛 28 | 🌐 Python | 📅 2023-10-23 查找向指定的函数内代码块的路径、查找两个或多个函数之间的路径、生成交互式调用图、可编程
  * [codatify](https://github.com/devttys0/ida/tree/master/plugins/codatify) ⭐ 1,366 | 🐛 28 | 🌐 Python | 📅 2023-10-23 定义IDA自动化分析时miss的ASCII字符串、函数、代码。将data段的所有未定义字节转换为DWORD（于是IDA可识别函数和跳转表指针）
  * [fluorescence](https://github.com/devttys0/ida/tree/master/plugins/fluorescence) ⭐ 1,366 | 🐛 28 | 🌐 Python | 📅 2023-10-23 高亮函数调用指令
  * [leafblower](https://github.com/devttys0/ida/tree/master/plugins/leafblower) ⭐ 1,366 | 🐛 28 | 🌐 Python | 📅 2023-10-23 识别常用的POSIX函数：printf, sprintf, memcmp, strcpy等
  * [localxrefs](https://github.com/devttys0/ida/tree/master/plugins/localxrefs) ⭐ 1,366 | 🐛 28 | 🌐 Python | 📅 2023-10-23 在当前函数内部查找所有对任意选择文本的引用
  * [mipslocalvars](https://github.com/devttys0/ida/tree/master/plugins/mipslocalvars) ⭐ 1,366 | 🐛 28 | 🌐 Python | 📅 2023-10-23 对栈上只用于存储寄存器的变量进行命名，简化栈数据分析（MISP）
  * [mipsrop](https://github.com/devttys0/ida/tree/master/plugins/mipsrop) ⭐ 1,366 | 🐛 28 | 🌐 Python | 📅 2023-10-23 在MIPS可执行代码中搜寻ROP。查找常见的ROP
  * [rizzo](https://github.com/devttys0/ida/tree/master/plugins/rizzo) ⭐ 1,366 | 🐛 28 | 🌐 Python | 📅 2023-10-23 对2个或多个IDB之间的函数进行识别和重命名，基于：函数签名、对唯一字符串/常量的引用、模糊签名、调用图
...
* \[**5228**星]\[2m] \[Py] [refirmlabs/binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,227 | 🐛 91 | 🌐 Rust | 📅 2026-08-11 固件分析工具（命令行+IDA插件）
  * [IDA插件](https://github.com/ReFirmLabs/binwalk/tree/master/src/scripts) ⭐ 14,227 | 🐛 91 | 🌐 Rust | 📅 2026-08-11
  * [binwalk](https://github.com/ReFirmLabs/binwalk/tree/master/src/binwalk) ⭐ 14,227 | 🐛 91 | 🌐 Rust | 📅 2026-08-11
...
* \[**1554**星]\[13d] \[Py] [joxeankoret/diaphora](https://github.com/joxeankoret/diaphora) ⭐ 4,367 | 🐛 39 | 🌐 Python | 📅 2026-07-29 program diffing
...
* \[**449**星]\[2m] \[Py] [polymorf/findcrypt-yara](https://github.com/polymorf/findcrypt-yara) ⭐ 1,733 | 🐛 10 | 🌐 Python | 📅 2024-11-19 使用Yara规则查找加密常量
...
* \[**471**星]\[13d] \[C] [bootleg/ret-sync](https://github.com/bootleg/ret-sync) ⭐ 2,371 | 🐛 31 | 🌐 C | 📅 2026-02-15 在反汇编工具和调试器之间同步调试会话
  * [GDB插件](https://github.com/bootleg/ret-sync/tree/master/ext_gdb) ⭐ 2,371 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [Ghidra插件](https://github.com/bootleg/ret-sync/tree/master/ext_ghidra) ⭐ 2,371 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [IDA插件](https://github.com/bootleg/ret-sync/tree/master/ext_ida) ⭐ 2,371 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [LLDB](https://github.com/bootleg/ret-sync/tree/master/ext_lldb) ⭐ 2,371 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [OD](https://github.com/bootleg/ret-sync/tree/master/ext_olly1) ⭐ 2,371 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [OD2](https://github.com/bootleg/ret-sync/tree/master/ext_olly2) ⭐ 2,371 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [WinDgb](https://github.com/bootleg/ret-sync/tree/master/ext_windbg/sync) ⭐ 2,371 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [x64dbg](https://github.com/bootleg/ret-sync/tree/master/ext_x64dbg) ⭐ 2,371 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * 重复区段: [x64dbg->插件->新添加的](#da5688c7823802e734c39b539aa39df7) |
...
* \[**382**星]\[26d] \[C++] [google/binexport](https://github.com/google/binexport) ⭐ 1,200 | 🐛 41 | 🌐 C++ | 📅 2026-08-13 将反汇编以Protocol Buffer的形式导出为PostgreSQL数据库, 导入到BinNavi中使用
...
* \[**1365**星]\[3m] \[Py] [fireeye/flare-floss](https://github.com/fireeye/flare-floss) ⭐ 4,120 | 🐛 119 | 🌐 Python | 📅 2026-08-13 自动从恶意代码中提取反混淆后的字符串
  * [floss](https://github.com/fireeye/flare-floss/tree/master/floss) ⭐ 4,120 | 🐛 119 | 🌐 Python | 📅 2026-08-13
  * [IDA插件](https://github.com/fireeye/flare-floss/blob/master/scripts/idaplugin.py) ⭐ 4,120 | 🐛 119 | 🌐 Python | 📅 2026-08-13
...
* \[**727**星]\[1y] \[Py] [keystone-engine/keypatch](https://github.com/keystone-engine/keypatch) ⭐ 1,862 | 🐛 43 | 🌐 Python | 📅 2024-09-06 汇编/补丁插件, 支持多架构, 基于Keystone引擎
...
* \[**18649**星]\[10d] \[Java] [nationalsecurityagency/ghidra](https://github.com/nationalsecurityagency/ghidra) ⭐ 72,345 | 🐛 1,905 | 🌐 Java | 📅 2026-08-13 软件逆向框架
...
* \[**34576**星]\[1m] \[C++] [x64dbg/x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,157 | 🐛 577 | 🌐 C++ | 📅 2026-08-09 Windows平台x32/x64调试器
...
* \[**5195**星]\[19d] \[Py] [mobsf/mobile-security-framework-mobsf](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,595 | 🐛 20 | 🌐 JavaScript | 📅 2026-08-10 Mobile Security Framework (MobSF) is an automated, all-in-one mobile application (Android/iOS/Windows) pen-testing, malware analysis and security assessment framework capable of performing static and dynamic analysis.
* \[**5084**星]\[15d] \[HTML] [owasp/owasp-mstg](https://github.com/owasp/owasp-mstg) ⭐ 13,111 | 🐛 228 | 🌐 Python | 📅 2026-08-03 关于移动App安全开发、测试和逆向的相近手册
* \[**4306**星]\[15d] \[Shell] [ashishb/android-security-awesome](https://github.com/ashishb/android-security-awesome) ⭐ 9,607 | 🐛 2 | 🌐 Makefile | 📅 2026-08-10 A collection of android security related resources
* \[**2051**星]\[21d] \[Py] [sensepost/objection](https://github.com/sensepost/objection) ⭐ 9,315 | 🐛 55 | 🌐 Python | 📅 2026-07-23 runtimemobile exploration
...
* \[**820**星]\[11d] [proxymanapp/proxyman](https://github.com/proxymanapp/proxyman) ⭐ 6,939 | 🐛 1,863 | 📅 2026-08-12 Modern and Delightful HTTP Debugging Proxy for macOS, iOS and Android
...
* \[**4776**星]\[12d] \[C++] [facebook/redex](https://github.com/facebook/redex) ⭐ 6,299 | 🐛 72 | 🌐 C++ | 📅 2026-08-14 Android App字节码优化器
...
* \[**2011**星]\[8m] \[Py] [fsecurelabs/drozer](https://github.com/FSecureLABS/drozer) ⭐ 4,591 | 🐛 9 | 🌐 Python | 📅 2026-04-08 The Leading Security Assessment Framework for Android.
* \[**2314**星]\[1y] \[Java] [csploit/android](https://github.com/csploit/android) ⭐ 3,644 | 🐛 396 | 🌐 Java | 📅 2024-04-27 cSploit - The most complete and advanced IT security professional toolkit on Android.
* \[**431**星]\[13d] \[C] [guardianproject/orbot](https://github.com/guardianproject/orbot) ⭐ 3,469 | 🐛 90 | 🌐 Kotlin | 📅 2026-08-13 The Github home of Orbot: Tor on Android (Also available on gitlab!)
* \[**2120**星]\[9m] \[Py] [linkedin/qark](https://github.com/linkedin/qark) ⭐ 3,379 | 🐛 79 | 🌐 Python | 📅 2024-01-16 查找Android App的漏洞, 支持源码或APK文件
...
* \[**559**星]\[14d] \[Shell] [owasp/owasp-masvs](https://github.com/owasp/owasp-masvs) ⭐ 2,427 | 🐛 3 | 🌐 Python | 📅 2025-12-22 OWASP 移动App安全标准
...
* \[**546**星]\[2m] [nordicsemiconductor/android-nrf-connect](https://github.com/nordicsemiconductor/android-nrf-connect) ⭐ 1,675 | 🐛 56 | 📅 2025-08-28 Documentation and issue tracker for nRF Connect for Android.
...
* \[**409**星]\[3m] \[CSS] [angea/pocorgtfo](https://github.com/angea/pocorgtfo) ⭐ 1,600 | 🐛 1 | 🌐 TeX | 📅 2024-02-11 a "Proof of Concept or GTFO" mirror with extra article index, direct links and clean PDFs.
...
* \[**3462**星]\[27d] \[Java] [meituan-dianping/robust](https://github.com/meituan-dianping/robust) ⭐ 4,456 | 🐛 163 | 🌐 Java | 📅 2022-04-27 Robust is an Android HotFix solution with high compatibility and high stability. Robust can fix bugs immediately without a reboot.
...
* \[**12285**星]\[11d] \[Java] [signalapp/signal-android](https://github.com/signalapp/Signal-Android) ⭐ 29,194 | 🐛 475 | 🌐 Kotlin | 📅 2026-08-13 A private messenger for Android.

### <a id="7f353b27e45b5de6b0e6ac472b02cbf1"></a>Xposed

* \[**8756**星]\[2m] \[Java] [android-hacker/virtualxposed](https://github.com/android-hacker/virtualxposed) ⭐ 16,050 | 🐛 161 | 🌐 Java | 📅 2024-03-08 A simple app to use Xposed without root, unlock the bootloader or modify system image, etc.
* \[**2034**星]\[12d] \[Java] [elderdrivers/edxposed](https://github.com/elderdrivers/edxposed) ⭐ 5,665 | 🐛 55 | 🌐 Java | 📅 2022-04-12 Elder driver Xposed Framework.
...
* \[**1726**星]\[1y] \[Java] [ac-pm/inspeckage](https://github.com/ac-pm/inspeckage) ⭐ 2,979 | 🐛 59 | 🌐 Java | 📅 2020-09-22 Android Package Inspector - dynamic analysis with api hooks, start unexported activities and more. (Xposed Module)
...
* \[**1465**星]\[3m] \[C++] [vaibhavpandeyvpz/apkstudio](https://github.com/vaibhavpandeyvpz/apkstudio) ⭐ 4,607 | 🐛 3 | 🌐 C++ | 📅 2026-01-05 Open-source, cross platform Qt based IDE for reverse-engineering Android application packages.
* \[**1793**星]\[8m] \[C++] [wrbug/dumpdex](https://github.com/wrbug/dumpdex) ⭐ 3,152 | 🐛 38 | 🌐 C++ | 📅 2020-05-15 Android脱壳
* \[**366**星]\[3m] \[Java] [patrickfav/uber-apk-signer](https://github.com/patrickfav/uber-apk-signer) ⭐ 2,706 | 🐛 11 | 🌐 Java | 📅 2023-10-30 A cli tool that helps signing and zip aligning single or multiple Android application packages (APKs) with either debug or provided release certificates. It supports v1, v2 and v3 Android signing scheme has an embedded debug keystore and auto verifies after signing.
...
* \[**1494**星]\[9d] \[C++] [jmpews/dobby](https://github.com/jmpews/Dobby) ⭐ 4,808 | 🐛 98 | 🌐 C++ | 📅 2025-01-26 a lightweight, multi-platform, multi-architecture hook framework.
...
* \[**532**星]\[7m] \[Java] [limboemu/limbo](https://github.com/limboemu/limbo) ⭐ 3,390 | 🐛 54 | 🌐 Java | 📅 2024-08-18 Limbo is a QEMU-based emulator for Android. It currently supports PC & ARM emulation for Intel x86 and ARM architecture. See our wiki
* \[**1492**星]\[1y] \[C++] [f1xpl/openauto](https://github.com/f1xpl/openauto) ⭐ 2,905 | 🐛 37 | 🌐 C++ | 📅 2024-12-12 AndroidAuto headunit emulator
...
* \[**10794**星]\[1m] \[Java] [konloch/bytecode-viewer](https://github.com/konloch/bytecode-viewer) ⭐ 15,593 | 🐛 103 | 🌐 Java | 📅 2026-07-17 A Java 8+ Jar & Android APK Reverse Engineering Suite (Decompiler, Editor, Debugger & More)
...
* \[**3078**星]\[2m] \[Java] [calebfenton/simplify](https://github.com/calebfenton/simplify) ⭐ 4,658 | 🐛 32 | 🌐 Java | 📅 2022-04-30 Generic Android Deobfuscator
...
* \[**9285**星]\[1m] \[Java] [ibotpeaches/apktool](https://github.com/ibotpeaches/apktool) ⭐ 25,276 | 🐛 77 | 🌐 Java | 📅 2026-08-11 A tool for reverse engineering Android apk files
* \[**2053**星]\[1m] \[Java] [genymobile/gnirehtet](https://github.com/genymobile/gnirehtet) ⭐ 7,836 | 🐛 323 | 🌐 Java | 📅 2024-08-11 Gnirehtet provides reverse tethering for Android
...
* \[**2140**星]\[2m] \[Py] [jonathansalwan/ropgadget](https://github.com/jonathansalwan/ropgadget) ⭐ 4,463 | 🐛 15 | 🌐 Python | 📅 2026-06-24 This tool lets you search your gadgets on your binaries to facilitate your ROP exploitation. ROPgadget supports ELF, PE and Mach-O format on x86, x64, ARM, ARM64, PowerPC, SPARC and MIPS architectures.
...
* \[**399**星]\[2m] \[Logos] [limneos/classdump-dyld](https://github.com/limneos/classdump-dyld) ⭐ 620 | 🐛 14 | 🌐 Logos | 📅 2022-01-14 Class-dump any Mach-o file without extracting it from dyld\_shared\_cache
...
* \[**5451**星]\[3m] \[Py] [axi0mx/ipwndfu](https://github.com/axi0mx/ipwndfu) ⭐ 7,389 | 🐛 168 | 🌐 Python | 📅 2024-02-21 open-source jailbreaking tool for many iOS devices
...
* \[**1193**星]\[15d] \[JS] [alonemonkey/frida-ios-dump](https://github.com/alonemonkey/frida-ios-dump) ⭐ 3,906 | 🐛 107 | 🌐 JavaScript | 📅 2023-05-03 pull decrypted ipa from jailbreak device
...
* \[**4397**星]\[12d] \[Swift] [signalapp/signal-ios](https://github.com/signalapp/Signal-iOS) ⭐ 12,196 | 🐛 141 | 🌐 Swift | 📅 2026-08-13 A private messenger for iOS.
* \[**1215**星]\[16d] \[YARA] [horsicq/detect-it-easy](https://github.com/horsicq/detect-it-easy) ⭐ 11,342 | 🐛 33 | 🌐 JavaScript | 📅 2026-08-13 Program for determining types of files for Windows, Linux and MacOS.
...
* \[**4663**星]\[1m] \[C] [google/ios-webkit-debug-proxy](https://github.com/google/ios-webkit-debug-proxy) ⭐ 6,193 | 🐛 19 | 🌐 C | 📅 2025-07-02 A DevTools proxy (Chrome Remote Debugging Protocol) for iOS devices (Safari Remote Web Inspector).
...
* \[**2867**星]\[12d] \[ObjC] [facebook/idb](https://github.com/facebook/idb) ⭐ 5,272 | 🐛 182 | 🌐 Swift | 📅 2026-08-13 idb is a flexible command line interface for automating iOS simulators and devices
* \[**2753**星]\[1m] \[Makefile] [theos/theos](https://github.com/theos/theos) ⭐ 4,902 | 🐛 72 | 🌐 Makefile | 📅 2026-08-08 A cross-platform suite of tools for building and deploying software for iOS and other platforms.
...
* \[**2708**星]\[2m] \[ObjC] [kjcracks/clutch](https://github.com/kjcracks/clutch) ⭐ 3,822 | 🐛 43 | 🌐 Objective-C | 📅 2024-11-15 Fast iOS executable dumper
...
* \[**462**星]\[15d] \[Java] [dsheirer/sdrtrunk](https://github.com/dsheirer/sdrtrunk) ⭐ 2,158 | 🐛 436 | 🌐 Java | 📅 2026-08-01 A cross-platform java application for decoding, monitoring, recording and streaming trunked mobile and related radio protocols using Software Defined Radios (SDR). Website:
...
* \[**604**星]\[2m] [siguza/ios-resources](https://github.com/siguza/ios-resources) ⭐ 1,963 | 🐛 4 | 📅 2025-05-24 Useful resources for iOS hacking
...
* \[**1299**星]\[6m] \[JS] [feross/spoof](https://github.com/feross/spoof) ⭐ 1,864 | 🐛 14 | 🌐 JavaScript | 📅 2020-11-05 Easily spoof your MAC address in macOS, Windows, & Linux!
...
* \[**1228**星]\[12d] \[C] [dynamorio/dynamorio](https://github.com/dynamorio/dynamorio) ⭐ 3,132 | 🐛 1,800 | 🌐 C | 📅 2026-08-13 Dynamic Instrumentation Tool Platform
...
* \[**4516**星]\[13d] \[Makefile] [frida/frida](https://github.com/frida/frida) ⭐ 21,624 | 🐛 1,956 | 🌐 Meson | 📅 2026-08-13 Clone this repo to build Frida
...
* \[**332**星]\[15d] \[JS] [chichou/bagbak](https://github.com/ChiChou/bagbak) ⭐ 1,484 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-24 Yet another frida based iOS dumpdecrypted, works on iOS 13 with checkra1n and supports decrypting app extensions
* \[**559**星]\[1m] \[JS] [nccgroup/house](https://github.com/nccgroup/house) ⭐ 1,465 | 🐛 16 | 🌐 JavaScript | 📅 2021-06-03 运行时手机 App 分析工具包, 带Web GUI
* \[**645**星]\[16d] \[Py] [igio90/dwarf](https://github.com/igio90/dwarf) ⭐ 1,316 | 🐛 5 | 🌐 Python | 📅 2024-05-16 Full featured multi arch/os debugger built on top of PyQt5 and frida
...
* \[**228**星]\[13d] \[C] [frida/frida-gum](https://github.com/frida/frida-gum) ⭐ 1,003 | 🐛 206 | 🌐 C | 📅 2026-08-13 Low-level code instrumentation library used by frida-core
* \[**420**星]\[13d] \[C] [frida/frida-python](https://github.com/frida/frida-python) ⭐ 868 | 🐛 56 | 🌐 Python | 📅 2026-08-13 Frida Python bindings
...
* \[**321**星]\[1m] \[C] [frida/frida-core](https://github.com/frida/frida-core) ⭐ 763 | 🐛 145 | 🌐 Vala | 📅 2026-08-13 Frida core library intended for static linking into bindings
...
* \[**14349**星]\[2m] \[Py] [corentinj/real-time-voice-cloning](https://github.com/corentinj/real-time-voice-cloning) ⭐ 60,090 | 🐛 176 | 🌐 Python | 📅 2026-03-09 Clone a voice in 5 seconds to generate arbitrary speech in real-time
* \[**2687**星]\[11d] \[Go] [adguardteam/adguardhome](https://github.com/adguardteam/adguardhome) ⭐ 36,099 | 🐛 1,273 | 🌐 TypeScript | 📅 2026-08-14 Network-wide ads & trackers blocking DNS server
* \[**10378**星]\[11d] \[Go] [goharbor/harbor](https://github.com/goharbor/harbor) ⭐ 29,151 | 🐛 856 | 🌐 Go | 📅 2026-08-13 An open source trusted cloud native registry project that stores, signs, and scans content.
* \[**19766**星]\[3m] \[Jupyter Notebook] [camdavidsonpilon/probabilistic-programming-and-bayesian-methods-for-hackers](https://github.com/camdavidsonpilon/probabilistic-programming-and-bayesian-methods-for-hackers) ⭐ 28,196 | 🐛 203 | 🌐 Jupyter Notebook | 📅 2024-06-25 aka "Bayesian Methods for Hackers": An introduction to Bayesian methods + probabilistic programming with a computation/understanding-first, mathematics-second point of view. All in pure Python ;)
* \[**5420**星]\[12d] \[Py] [mlflow/mlflow](https://github.com/mlflow/mlflow) ⭐ 27,504 | 🐛 2,023 | 🌐 Python | 📅 2026-08-14 Open source platform for the machine learning lifecycle
* \[**11402**星]\[10d] \[Java] [oracle/graal](https://github.com/oracle/graal) ⭐ 21,662 | 🐛 842 | 🌐 Java | 📅 2026-08-13 Run Programs Faster Anywhere
* \[**7020**星]\[14d] \[Go] [nats-io/nats-server](https://github.com/nats-io/nats-server) ⭐ 20,495 | 🐛 541 | 🌐 Go | 📅 2026-08-13 High-Performance server for NATS, the cloud native messaging system.
* \[**5753**星]\[18d] \[Go] [casbin/casbin](https://github.com/casbin/casbin) ⭐ 20,322 | 🐛 42 | 🌐 Go | 📅 2026-08-13 An authorization library that supports access control models like ACL, RBAC, ABAC in Golang
* \[**3608**星]\[9d] \[Pascal] [cheat-engine/cheat-engine](https://github.com/cheat-engine/cheat-engine) ⭐ 18,953 | 🐛 1,306 | 🌐 Pascal | 📅 2025-04-19 Cheat Engine. A development environment focused on modding
* \[**4610**星]\[1y] \[C] [upx/upx](https://github.com/upx/upx) ⭐ 17,777 | 🐛 26 | 🌐 C++ | 📅 2026-08-13 UPX - the Ultimate Packer for eXecutables
* \[**5226**星]\[13d] \[Shell] [denisidoro/navi](https://github.com/denisidoro/navi) ⭐ 17,425 | 🐛 109 | 🌐 Rust | 📅 2026-07-28 An interactive cheatsheet tool for the command-line
* \[**11213**星]\[2m] \[Jupyter Notebook] [selfteaching/the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 16,334 | 🐛 199 | 🌐 Jupyter Notebook | 📅 2026-05-20 One has no future if one couldn't teach themself.
* \[**2815**星]\[20d] \[C] [processhacker/processhacker](https://github.com/processhacker/processhacker) ⭐ 15,633 | 🐛 283 | 🌐 C | 📅 2026-08-13 A free, powerful, multi-purpose tool that helps you monitor system resources, debug software and detect malware.
* \[**3295**星]\[15d] \[JS] [koenkk/zigbee2mqtt](https://github.com/koenkk/zigbee2mqtt) ⭐ 15,498 | 🐛 463 | 🌐 TypeScript | 📅 2026-08-13 Zigbee
...
* \[**7748**星]\[10d] \[Go] [git-lfs/git-lfs](https://github.com/git-lfs/git-lfs) ⭐ 14,421 | 🐛 481 | 🌐 Go | 📅 2026-08-07 Git extension for versioning large files
...
* \[**3129**星]\[13d] \[C] [qemu/qemu](https://github.com/qemu/qemu) ⭐ 13,567 | 🐛 0 | 🌐 C | 📅 2026-08-13 Official QEMU mirror. Please see
* \[**5229**星]\[4m] \[Py] [ytisf/thezoo](https://github.com/ytisf/thezoo) ⭐ 13,292 | 🐛 89 | 🌐 Python | 📅 2026-07-24 A repository of LIVE malwares for your own joy and pleasure. theZoo is a project created to make the possibility of malware analysis open and available to the public.
* \[**2344**星]\[16d] \[C] [tsl0922/ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,196 | 🐛 111 | 🌐 C | 📅 2026-08-12 Share your terminal over the web
* \[**3980**星]\[1m] \[Rust] [svenstaro/genact](https://github.com/svenstaro/genact) ⭐ 12,164 | 🐛 15 | 🌐 Rust | 📅 2026-08-01 a nonsense activity generator
* \[**3505**星]\[16d] \[C] [cyan4973/xxhash](https://github.com/cyan4973/xxhash) ⭐ 11,202 | 🐛 40 | 🌐 C | 📅 2026-07-27 Extremely fast non-cryptographic hash algorithm
* \[**4003**星]\[11d] \[Go] [dexidp/dex](https://github.com/dexidp/dex) ⭐ 11,035 | 🐛 521 | 🌐 Go | 📅 2026-08-10 OpenID Connect Identity (OIDC) and OAuth 2.0 Provider with Pluggable Connectors
* \[**2993**星]\[18d] \[Py] [quantaxis/quantaxis](https://github.com/quantaxis/quantaxis) ⭐ 11,005 | 🐛 239 | 🌐 Python | 📅 2026-02-28 支持任务调度 分布式部署的 股票/期货/自定义市场 数据/回测/模拟/交易/可视化 纯本地PAAS量化解决方案
* \[**3908**星]\[12d] \[C++] [baldurk/renderdoc](https://github.com/baldurk/renderdoc) ⭐ 10,969 | 🐛 50 | 🌐 C++ | 📅 2026-08-13 RenderDoc is a stand-alone graphics debugging tool.
* \[**2053**星]\[24d] \[C#] [mathewsachin/captura](https://github.com/mathewsachin/captura) ⭐ 10,784 | 🐛 116 | 🌐 C# | 📅 2026-05-25 Capture Screen, Audio, Cursor, Mouse Clicks and Keystrokes
* \[**2627**星]\[23d] \[JS] [popcorn-official/popcorn-desktop](https://github.com/popcorn-official/popcorn-desktop) ⭐ 10,632 | 🐛 65 | 🌐 TypeScript | 📅 2026-08-13 Popcorn Time is a multi-platform, free software BitTorrent client that includes an integrated media player. Desktop ( Windows / Mac / Linux ) a Butter-Project Fork
* \[**4597**星]\[12d] \[C++] [mozilla/rr](https://github.com/mozilla/rr) ⭐ 10,619 | 🐛 478 | 🌐 C++ | 📅 2026-08-11 记录与重放App的调试执行过程
* \[**5751**星]\[9m] \[C] [xoreaxeaxeax/movfuscator](https://github.com/xoreaxeaxeax/movfuscator) ⭐ 10,264 | 🐛 25 | 🌐 C | 📅 2024-05-29 C编译器，编译的二进制文件只有1个代码块。
...
* \[**3289**星]\[15d] \[C] [virustotal/yara](https://github.com/virustotal/yara) ⭐ 9,805 | 🐛 176 | 🌐 C | 📅 2026-07-30 The pattern matching swiss knife
* \[**5876**星]\[3m] \[Gnuplot] [nasa-jpl/open-source-rover](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,575 | 🐛 18 | 🌐 Prolog | 📅 2026-08-13 A build-it-yourself, 6-wheel rover based on the rovers on Mars!
* \[**5717**星]\[28d] \[JS] [swagger-api/swagger-editor](https://github.com/swagger-api/swagger-editor) ⭐ 9,460 | 🐛 42 | 🌐 JavaScript | 📅 2026-08-13 Swagger Editor
* \[**6353**星]\[2m] \[Py] [seatgeek/fuzzywuzzy](https://github.com/seatgeek/fuzzywuzzy) ⚠️ Archived Fuzzy String Matching in Python
* \[**3108**星]\[1m] \[C] [unicorn-engine/unicorn](https://github.com/unicorn-engine/unicorn) ⭐ 9,228 | 🐛 209 | 🌐 C | 📅 2026-07-30 Unicorn CPU emulator framework (ARM, AArch64, M68K, Mips, Sparc, X86)
* \[**3188**星]\[11d] \[C] [meetecho/janus-gateway](https://github.com/meetecho/janus-gateway) ⭐ 9,148 | 🐛 43 | 🌐 C | 📅 2026-07-27 Janus WebRTC Server
* \[**3960**星]\[11d] \[Py] [angr/angr](https://github.com/angr/angr) ⭐ 9,009 | 🐛 707 | 🌐 Python | 📅 2026-08-14 A powerful and user-friendly binary analysis platform!
* \[**3939**星]\[15d] \[C] [aquynh/capstone](https://github.com/aquynh/capstone) ⭐ 8,944 | 🐛 360 | 🌐 C | 📅 2026-08-13 Capstone disassembly/disassembler framework: Core (Arm, Arm64, BPF, EVM, M68K, M680X, MOS65xx, Mips, PPC, RISCV, Sparc, SystemZ, TMS320C64x, Web Assembly, X86, X86\_64, XCore) + bindings.
* \[**3844**星]\[2m] \[ObjC] [sveinbjornt/sloth](https://github.com/sveinbjornt/sloth) ⭐ 8,930 | 🐛 3 | 🌐 Objective-C | 📅 2026-05-28 Mac app that shows all open files, directories and sockets in use by all running processes. Nice GUI for lsof.
* \[**3451**星]\[19d] \[C] [mikebrady/shairport-sync](https://github.com/mikebrady/shairport-sync) ⭐ 8,808 | 🐛 14 | 🌐 C | 📅 2026-08-09 AirPlay audio player. Shairport Sync adds multi-room capability with Audio Synchronisation
* \[**2587**星]\[10d] \[C] [esnet/iperf](https://github.com/esnet/iperf) ⭐ 8,688 | 🐛 238 | 🌐 C | 📅 2026-07-10 A TCP, UDP, and SCTP network bandwidth measurement tool
* \[**4651**星]\[13d] [powershell/win32-openssh](https://github.com/powershell/win32-openssh) ⭐ 8,238 | 🐛 401 | 📅 2025-10-27 Win32 port of OpenSSH
* \[**4541**星]\[4m] \[TS] [apis-guru/graphql-voyager](https://github.com/apis-guru/graphql-voyager) ⭐ 8,158 | 🐛 106 | 🌐 TypeScript | 📅 2026-05-12
* \[**3306**星]\[19d] \[C] [microsoft/windows-driver-samples](https://github.com/microsoft/windows-driver-samples) ⭐ 7,818 | 🐛 125 | 🌐 C | 📅 2026-08-12 This repo contains driver samples prepared for use with Microsoft Visual Studio and the Windows Driver Kit (WDK). It contains both Universal Windows Driver and desktop-only driver samples.
* \[**2948**星]\[1m] \[C] [libfuse/sshfs](https://github.com/libfuse/sshfs) ⭐ 7,611 | 🐛 60 | 🌐 C | 📅 2026-08-08 A network filesystem client to connect to SSH servers
...
* \[**2194**星]\[13d] \[C] [armmbed/mbedtls](https://github.com/armmbed/mbedtls) ⭐ 6,869 | 🐛 1,731 | 🌐 C | 📅 2026-08-13 An open source, portable, easy to use, readable and flexible SSL library
...
* \[**2621**星]\[2m] [pditommaso/awesome-pipeline](https://github.com/pditommaso/awesome-pipeline) ⭐ 6,619 | 🐛 34 | 📅 2026-08-04 A curated list of awesome pipeline toolkits inspired by Awesome Sysadmin
...
* \[**2854**星]\[1m] \[Py] [espressif/esptool](https://github.com/espressif/esptool) ⭐ 6,439 | 🐛 13 | 🌐 Python | 📅 2026-08-10 ESP8266 and ESP32 serial bootloader utility
* \[**1698**星]\[21d] \[C++] [microsoft/detours](https://github.com/microsoft/detours) ⭐ 6,354 | 🐛 91 | 🌐 C++ | 📅 2026-08-05 Detours is a software package for monitoring and instrumenting API calls on Windows. It is distributed in source code form.
* \[**5007**星]\[2m] \[Py] [snare/voltron](https://github.com/snare/voltron) ⭐ 6,346 | 🐛 85 | 🌐 Python | 📅 2025-01-30 A hacky debugger UI for hackers
* \[**408**星]\[19d] \[Py] [crytic/slither](https://github.com/crytic/slither) ⭐ 6,341 | 🐛 470 | 🌐 Python | 📅 2026-08-12 Static Analyzer for Solidity
* \[**3233**星]\[25d] \[C] [tmate-io/tmate](https://github.com/tmate-io/tmate) ⭐ 6,103 | 🐛 129 | 🌐 C | 📅 2026-07-29 Instant Terminal Sharing
* \[**3690**星]\[21d] \[JS] [lesspass/lesspass](https://github.com/lesspass/lesspass) ⭐ 6,053 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-12
* \[**3954**星]\[16d] \[Go] [eranyanay/1m-go-websockets](https://github.com/eranyanay/1m-go-websockets) ⭐ 5,997 | 🐛 3 | 🌐 Go | 📅 2022-08-14 handling 1M websockets connections in Go
...
* \[**2631**星]\[8m] [leandromoreira/linux-network-performance-parameters](https://github.com/leandromoreira/linux-network-performance-parameters) ⭐ 5,810 | 🐛 3 | 📅 2026-06-03 Learn where some of the network sysctl variables fit into the Linux/Kernel network flow
* \[**3120**星]\[11d] \[Go] [tencent/bk-cmdb](https://github.com/tencent/bk-cmdb) ⭐ 5,734 | 🐛 85 | 🌐 Go | 📅 2026-08-07 蓝鲸智云配置平台(BlueKing CMDB)
* \[**2092**星]\[26d] [swiftonsecurity/sysmon-config](https://github.com/swiftonsecurity/sysmon-config) ⭐ 5,621 | 🐛 82 | 📅 2024-07-03 Sysmon configuration file template with default high-quality event tracing
* \[**1930**星]\[22d] \[C++] [mhammond/pywin32](https://github.com/mhammond/pywin32) ⭐ 5,596 | 🐛 398 | 🌐 C++ | 📅 2026-07-15 Python for Windows (pywin32) Extensions
...
* \[**1620**星]\[16d] \[C++] [lief-project/lief](https://github.com/lief-project/lief) ⭐ 5,525 | 🐛 32 | 🌐 C++ | 📅 2026-08-07 Library to Instrument Executable Formats
* \[**2898**星]\[8m] \[C] [p-h-c/phc-winner-argon2](https://github.com/p-h-c/phc-winner-argon2) ⭐ 5,348 | 🐛 102 | 🌐 C | 📅 2024-08-06 The password hash Argon2, winner of PHC
...
* \[**1816**星]\[29d] \[Go] [gdamore/tcell](https://github.com/gdamore/tcell) ⭐ 5,212 | 🐛 10 | 🌐 Go | 📅 2026-08-13 Tcell is an alternate terminal package, similar in some ways to termbox, but better in others.
* \[**3131**星]\[2m] \[CSS] [readthedocs/sphinx\_rtd\_theme](https://github.com/readthedocs/sphinx_rtd_theme) ⭐ 5,074 | 🐛 274 | 🌐 Sass | 📅 2026-01-12 Sphinx theme for readthedocs.org
* \[**2093**星]\[10d] \[C] [flatpak/flatpak](https://github.com/flatpak/flatpak) ⭐ 5,023 | 🐛 1,017 | 🌐 C | 📅 2026-08-12 Linux application sandboxing and distribution framework
...
* \[**2132**星]\[20d] [goq/telegram-list](https://github.com/goq/telegram-list) ⭐ 4,965 | 🐛 22 | 📅 2026-08-05 List of telegram groups, channels & bots // Список интересных групп, каналов и ботов телеграма // Список чатов для программистов
* \[**2391**星]\[21d] \[Java] [mock-server/mockserver](https://github.com/mock-server/mockserver) ⭐ 4,939 | 🐛 5 | 🌐 Java | 📅 2026-08-13 MockServer enables easy mocking of any system you integrate with via HTTP or HTTPS with clients written in Java, JavaScript and Ruby. MockServer also includes a proxy that introspects all proxied traffic including encrypted SSL traffic and supports Port Forwarding, Web Proxying (i.e. HTTP proxy), HTTPS Tunneling Proxying (using HTTP CONNECT) and…
...
* \[**2137**星]\[19d] \[Assembly] [pret/pokered](https://github.com/pret/pokered) ⭐ 4,877 | 🐛 22 | 🌐 Assembly | 📅 2026-08-13 disassembly of Pokémon Red/Blue
* \[**3749**星]\[12d] \[Go] [hashicorp/consul-template](https://github.com/hashicorp/consul-template) ⭐ 4,824 | 🐛 231 | 🌐 Go | 📅 2026-07-13 Template rendering, notifier, and supervisor for
* \[**1761**星]\[13d] \[C] [google/wuffs](https://github.com/google/wuffs) ⭐ 4,806 | 🐛 37 | 🌐 C | 📅 2026-08-08 Wrangling Untrusted File Formats Safely
...
* \[**2003**星]\[2m] \[C++] [asmjit/asmjit](https://github.com/asmjit/asmjit) ⭐ 4,575 | 🐛 25 | 🌐 C++ | 📅 2026-03-26 Complete x86/x64 JIT and AOT Assembler for C++
...
* \[**2340**星]\[2m] \[JS] [pa11y/pa11y](https://github.com/pa11y/pa11y) ⭐ 4,486 | 🐛 46 | 🌐 JavaScript | 📅 2026-08-10 Pa11y is your automated accessibility testing pal
...
* \[**2535**星]\[3m] \[Java] [jboss-javassist/javassist](https://github.com/jboss-javassist/javassist) ⭐ 4,233 | 🐛 254 | 🌐 Java | 📅 2026-06-21 Java bytecode engineering toolkit
...
* \[**1714**星]\[1m] \[Go] [hashicorp/memberlist](https://github.com/hashicorp/memberlist) ⭐ 4,094 | 🐛 95 | 🌐 Go | 📅 2026-08-03 Golang package for gossip based membership and failure detection
...
* \[**2052**星]\[13d] \[C++] [openthread/openthread](https://github.com/openthread/openthread) ⭐ 4,013 | 🐛 164 | 🌐 C++ | 📅 2026-08-13 OpenThread released by Google is an open-source implementation of the Thread networking protocol
...
* \[**1899**星]\[25d] \[C++] [acidanthera/lilu](https://github.com/acidanthera/Lilu) ⭐ 3,856 | 🐛 0 | 🌐 C | 📅 2026-03-20 Arbitrary kext and process patching on macOS
* \[**1637**星]\[12d] \[JS] [efforg/privacybadger](https://github.com/efforg/privacybadger) ⭐ 3,805 | 🐛 143 | 🌐 JavaScript | 📅 2026-08-12 Privacy Badger is a browser extension that automatically learns to block invisible trackers.
...
* \[**3052**星]\[4m] \[C++] [google/robotstxt](https://github.com/google/robotstxt) ⭐ 3,473 | 🐛 12 | 🌐 C++ | 📅 2026-04-01 The repository contains Google's robots.txt parser and matcher as a C++ library (compliant to C++11).
...
* \[**637**星]\[21d] \[PS] [olafhartong/sysmon-modular](https://github.com/olafhartong/sysmon-modular) ⭐ 3,112 | 🐛 49 | 🌐 PowerShell | 📅 2026-08-10 sysmon配置模块收集
...
* \[**1756**星]\[16d] \[PHP] [wordpress/wordpress-coding-standards](https://github.com/wordpress/wordpress-coding-standards) ⭐ 2,822 | 🐛 263 | 🌐 PHP | 📅 2026-08-10 PHP\_CodeSniffer rules (sniffs) to enforce WordPress coding conventions
...
* \[**1851**星]\[1y] \[Java] [yeriomin/yalpstore](https://github.com/yeriomin/yalpstore) ⭐ 2,543 | 🐛 19 | 🌐 Java | 📅 2022-09-27 Download apks from Google Play Store
...
* \[**1854**星]\[19d] \[C] [github/glb-director](https://github.com/github/glb-director) ⭐ 2,448 | 🐛 33 | 🌐 C | 📅 2026-08-04 GitHub Load Balancer Director and supporting tooling.
...
* \[**1676**星]\[10d] \[Java] [apache/geode](https://github.com/apache/geode) ⭐ 2,373 | 🐛 29 | 🌐 Java | 📅 2026-08-10 Apache Geode
...
* \[**1852**星]\[1y] \[Py] [jinnlynn/genpac](https://github.com/jinnlynn/genpac) ⭐ 2,187 | 🐛 0 | 🌐 Python | 📅 2026-08-14 PAC/Dnsmasq/Wingy file Generator, working with gfwlist, support custom rules.
* \[**906**星]\[7m] \[C++] [dfhack/dfhack](https://github.com/DFHack/dfhack) ⭐ 2,038 | 🐛 1,059 | 🌐 C++ | 📅 2026-08-08 Memory hacking library for Dwarf Fortress and a set of tools that use it
...
* \[**522**星]\[4m] \[Java] [java-deobfuscator/deobfuscator](https://github.com/java-deobfuscator/deobfuscator) ⭐ 1,752 | 🐛 126 | 🌐 Java | 📅 2023-04-26 Java 代码反混淆工具
...
* \[**587**星]\[6m] [nshalabi/sysmontools](https://github.com/nshalabi/sysmontools) ⭐ 1,656 | 🐛 0 | 🌐 TypeScript | 📅 2026-04-04 Utilities for Sysmon
* \[**449**星]\[12m] \[C++] [ntquery/scylla](https://github.com/ntquery/scylla) ⭐ 1,415 | 🐛 23 | 🌐 C++ | 📅 2023-04-05 Imports Reconstructor
...
* \[**291**星]\[28d] \[C] [tomb5/tomb5](https://github.com/tomb5/tomb5) ⭐ 514 | 🐛 26 | 🌐 C | 📅 2022-02-03 Chronicles Disassembly translated to C source code.
...
* \[**2214**星]\[18d] [getlantern/lantern-binaries](https://github.com/getlantern/lantern-binaries) ⭐ 119 | 🐛 14 | 📅 2026-08-14 Lantern installers binary downloads.
...
* \[**1422**星]\[17d] \[C++] [eteran/edb-debugger](https://github.com/eteran/edb-debugger) ⭐ 2,946 | 🐛 67 | 🌐 C++ | 📅 2026-08-10 edb is a cross platform AArch32/x86/x86-64 debugger.
...
* \[**1413**星]\[19d] \[Go] [cosmos72/gomacro](https://github.com/cosmos72/gomacro) ⭐ 2,287 | 🐛 49 | 🌐 Go | 📅 2026-08-02 Interactive Go interpreter and debugger with REPL, Eval, generics and Lisp-like macros
...
* \[**560**星]\[21d] \[C#] [microsoft/miengine](https://github.com/microsoft/miengine) ⭐ 858 | 🐛 162 | 🌐 C# | 📅 2026-08-13 The Visual Studio MI Debug Engine ("MIEngine") provides an open-source Visual Studio Debugger extension that works with MI-enabled debuggers such as gdb, lldb, and clrdbg.
...
* \[**418**星]\[26d] \[C++] [simonkagstrom/kcov](https://github.com/simonkagstrom/kcov) ⭐ 827 | 🐛 88 | 🌐 C++ | 📅 2026-08-07 Code coverage tool for compiled programs, Python and Bash which uses debugging information to collect and report data without special compilation options
* \[**239**星]\[8m] \[C++] [strivexjun/xantidebug](https://github.com/strivexjun/xantidebug) ⭐ 682 | 🐛 3 | 🌐 C++ | 📅 2019-05-11 VMProtect 3.x Anti-debug Method Improved
...
* \[**291**星]\[12d] \[Py] [sosreport/sos](https://github.com/sosreport/sos) ⭐ 595 | 🐛 162 | 🌐 Python | 📅 2026-08-13 A unified tool for collecting system logs and other debug information
* \[**200**星]\[6m] \[C++] [rainers/cv2pdb](https://github.com/rainers/cv2pdb) ⭐ 552 | 🐛 20 | 🌐 C++ | 📅 2026-08-13 converter of DMD CodeView/DWARF debug information to PDB files
* \[**332**星]\[8m] \[Py] [romanvm/python-web-pdb](https://github.com/romanvm/python-web-pdb) ⭐ 534 | 🐛 18 | 🌐 Python | 📅 2026-08-12 Web-based remote UI for Python's PDB debugger
...
* \[**299**星]\[17d] \[JS] [w3c/webappsec-trusted-types](https://github.com/w3c/webappsec-trusted-types) ⭐ 662 | 🐛 55 | 🌐 JavaScript | 📅 2026-08-10 A browser API to prevent DOM-Based Cross Site Scripting in modern web applications.
...
* \[**20779**星]\[8d] \[Java] [skylot/jadx](https://github.com/skylot/jadx) ⭐ 50,054 | 🐛 443 | 🌐 Java | 📅 2026-08-05 dex 转 java 的反编译器
* \[**7733**星]\[1m] \[Java] [java-decompiler/jd-gui](https://github.com/java-decompiler/jd-gui) ⭐ 15,171 | 🐛 248 | 🌐 Java | 📅 2024-07-08 A standalone Java Decompiler GUI
* \[**1867**星]\[1y] \[Java] [jindrapetrik/jpexs-decompiler](https://github.com/jindrapetrik/jpexs-decompiler) ⭐ 5,794 | 🐛 5 | 🌐 Java | 📅 2026-08-08 JPEXS Free Flash Decompiler
...
* \[**671**星]\[11m] \[C++] [zrax/pycdc](https://github.com/zrax/pycdc) ⭐ 4,582 | 🐛 234 | 🌐 C++ | 📅 2026-04-07 C++ python bytecode disassembler and decompiler
* \[**1652**星]\[12m] \[Java] [fesh0r/fernflower](https://github.com/fesh0r/fernflower) ⭐ 4,360 | 🐛 0 | 🌐 Java | 📅 2026-08-13 Unofficial mirror of FernFlower Java decompiler (All pulls should be submitted upstream)
* \[**1466**星]\[12d] \[Py] [rocky/python-uncompyle6](https://github.com/rocky/python-uncompyle6) ⭐ 4,317 | 🐛 42 | 🌐 Python | 📅 2026-04-24 Python反编译器，跨平台
* \[**331**星]\[11d] \[Java] [leibnitz27/cfr](https://github.com/leibnitz27/cfr) ⭐ 2,660 | 🐛 150 | 🌐 Java | 📅 2026-06-04 This is the public repository for the CFR Java decompiler
* \[**673**星]\[18d] \[C#] [uxmal/reko](https://github.com/uxmal/reko) ⭐ 2,599 | 🐛 165 | 🌐 C# | 📅 2026-08-12 Reko is a binary decompiler.
* \[**347**星]\[16d] \[C#] [steamdatabase/valveresourceformat](https://github.com/steamdatabase/valveresourceformat) ⭐ 2,370 | 🐛 71 | 🌐 C# | 📅 2026-08-14 Valve's Source 2 resource file format (also known as Stupid Valve Format) parser and decompiler.
...
* \[**764**星]\[12m] \[C++] [comaeio/porosity](https://github.com/comaeio/porosity) ⭐ 932 | 🐛 23 | 🌐 C++ | 📅 2019-01-10 *UNMAINTAINED* Decompiler and Security Analysis tool for Blockchain-based Ethereum Smart-Contracts
* \[**240**星]\[2m] \[Java] [ata4/bspsrc](https://github.com/ata4/bspsrc) ⭐ 858 | 🐛 39 | 🌐 Java | 📅 2026-08-13 A Source engine map decompiler
...
* \[**232**星]\[1y] \[C++] [wwwg/wasmdec](https://github.com/wwwg/wasmdec) ⭐ 424 | 🐛 12 | 🌐 C++ | 📅 2024-02-07 WebAssembly to C decompiler
* \[**226**星]\[11d] \[C++] [boomerangdecompiler/boomerang](https://github.com/BoomerangDecompiler/boomerang) ⭐ 407 | 🐛 38 | 🌐 C++ | 📅 2020-12-28 Boomerang Decompiler - Fighting the code-rot :)
...
* \[**1374**星]\[20d] \[C] [zyantific/zydis](https://github.com/zyantific/zydis) ⭐ 4,325 | 🐛 51 | 🌐 C | 📅 2026-07-27 快速的轻量级x86/x86-64 反汇编库
* \[**430**星]\[2m] \[C#] [0xd4d/iced](https://github.com/0xd4d/iced) ⭐ 3,547 | 🐛 55 | 🌐 Rust | 📅 2026-08-12 x86/x64 disassembler, instruction decoder & encoder
* \[**835**星]\[8d] \[GLSL] [khronosgroup/spirv-cross](https://github.com/khronosgroup/spirv-cross) ⭐ 2,485 | 🐛 150 | 🌐 GLSL | 📅 2026-07-31  a practical tool and library for performing reflection on SPIR-V and disassembling SPIR-V back to high level languages.
...
* \[**6052**星]\[13d] \[Py] [cyrus-and/gdb-dashboard](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,238 | 🐛 19 | 🌐 Python | 📅 2026-07-17 Modular visual interface for GDB in Python
* \[**2439**星]\[16d] \[Py] [pwndbg/pwndbg](https://github.com/pwndbg/pwndbg) ⭐ 10,760 | 🐛 206 | 🌐 Python | 📅 2026-08-13 GDB插件，辅助漏洞开发和逆向
...
* \[**1417**星]\[3m] \[Go] [hellogcc/100-gdb-tips](https://github.com/hellogcc/100-gdb-tips) ⭐ 3,196 | 🐛 4 | 🌐 Go | 📅 2023-10-30 A collection of gdb tips. 100 maybe just mean many here.
...
* \[**1419**星]\[9m] \[C] [namhyung/uftrace](https://github.com/namhyung/uftrace) ⭐ 3,453 | 🐛 398 | 🌐 C | 📅 2026-08-09 Function (graph) tracer for user-space
...
* \[**11588**星]\[12d] \[C] [radareorg/radare2](https://github.com/radareorg/radare2) ⭐ 24,566 | 🐛 820 | 🌐 C | 📅 2026-08-13 unix-like reverse engineering framework and commandline tools
...
* \[**2820**星]\[1m] \[Py] [androguard/androguard](https://github.com/androguard/androguard) ⭐ 6,194 | 🐛 46 | 🌐 Python | 📅 2026-08-13 Reverse engineering, Malware and goodware analysis of Android applications ... and more (ninja !)
* \[**328**星]\[5m] \[Py] [vector35/binaryninja-api](https://github.com/vector35/binaryninja-api) ⭐ 1,290 | 🐛 1,919 | 🌐 C++ | 📅 2026-08-14 Public API, examples, documentation and issues for Binary Ninja
...
* \[**634**星]\[10d] \[C] [thewover/donut](https://github.com/thewover/donut) ⭐ 4,685 | 🐛 36 | 🌐 C | 📅 2025-07-08 Generates x86, x64, or AMD64+x86 position-independent shellcode that loads .NET Assemblies, PE files, and other Windows payloads from memory and runs them with parameters
* \[**388**星]\[1y] \[Assembly] [hasherezade/pe\_to\_shellcode](https://github.com/hasherezade/pe_to_shellcode) ⭐ 2,789 | 🐛 16 | 🌐 C++ | 📅 2025-08-30 Converts PE into a shellcode
* \[**877**星]\[8m] \[Py] [erocarrera/pefile](https://github.com/erocarrera/pefile) ⭐ 2,061 | 🐛 66 | 🌐 Python | 📅 2026-08-12 pefile is a Python module to read and work with PE (Portable Executable) files
* \[**344**星]\[1y] \[Assembly] [egebalci/amber](https://github.com/egebalci/amber) ⭐ 1,434 | 🐛 5 | 🌐 Go | 📅 2024-02-22 反射式PE加壳器，用于绕过安全产品和缓解措施
...
* \[**1915**星]\[22d] \[C#] [lucasg/dependencies](https://github.com/lucasg/dependencies) ⭐ 11,756 | 🐛 142 | 🌐 C# | 📅 2024-05-15 A rewrite of the old legacy software "depends.exe" in C# for Windows devs to troubleshoot dll load dependencies issues.
* \[**1146**星]\[27d] \[C#] [perfare/il2cppdumper](https://github.com/perfare/il2cppdumper) ⭐ 9,297 | 🐛 156 | 🌐 C# | 📅 2024-08-18 Restore dll from Unity il2cpp binary file (except code)
* \[**1333**星]\[10m] \[C] [fancycode/memorymodule](https://github.com/fancycode/memorymodule) ⭐ 3,153 | 🐛 58 | 🌐 C | 📅 2024-01-03 Library to load a DLL from memory.
...
* \[**240**星]\[10m] \[C++] [wbenny/detoursnt](https://github.com/wbenny/detoursnt) ⭐ 683 | 🐛 1 | 🌐 C++ | 📅 2025-11-25 Detours with just single dependency - NTDLL
...
* \[**713**星]\[5m] \[C++] [darthton/xenos](https://github.com/darthton/xenos) ⭐ 2,630 | 🐛 51 | 🌐 C++ | 📅 2021-05-17 Windows DLL 注入器
...
* \[**2307**星]\[1m] \[PS] [k8gege/k8tools](https://github.com/k8gege/k8tools) ⭐ 6,195 | 🐛 10 | 🌐 PowerShell | 📅 2025-01-25 K8工具合集(内网渗透/提权工具/远程溢出/漏洞利用/扫描工具/密码破解/免杀工具/Exploit/APT/0day/Shellcode/Payload/priviledge/BypassUAC/OverFlow/WebShell/PenTest) Web GetShell Exploit(Struts2/Zimbra/Weblogic/Tomcat/Apache/Jboss/DotNetNuke/zabbix)
...
* \[**1228**星]\[10d] \[JS] [jpcertcc/logontracer](https://github.com/jpcertcc/logontracer) ⭐ 3,210 | 🐛 21 | 🌐 Python | 📅 2026-08-02 通过可视化和分析Windows事件日志来调查恶意的Windows登录
* \[**609**星]\[19d] \[PS] [sbousseaden/evtx-attack-samples](https://github.com/sbousseaden/evtx-attack-samples) ⭐ 2,605 | 🐛 5 | 🌐 HTML | 📅 2023-01-24 与特定攻击和利用后渗透技术相关的Windows事件样例
* \[**261**星]\[3m] \[C++] [gametechdev/presentmon](https://github.com/gametechdev/presentmon) ⭐ 2,521 | 🐛 195 | 🌐 C++ | 📅 2026-08-12 Tool for collection and processing of ETW events related to DXGI presentation.
...
* \[**249**星]\[3m] \[C++] [microsoft/krabsetw](https://github.com/microsoft/krabsetw) ⭐ 796 | 🐛 18 | 🌐 C++ | 📅 2026-08-14 KrabsETW provides a modern C++ wrapper and a .NET wrapper around the low-level ETW trace consumption functions.
...
* \[**341**星]\[1y] \[C++] [qax-a-team/eventcleaner](https://github.com/QAX-A-Team/EventCleaner) ⭐ 610 | 🐛 8 | 🌐 C++ | 📅 2018-09-07 A tool mainly to erase specified records from Windows event logs, with additional functionalities.
...
* \[**9261**星]\[11d] \[C#] [icsharpcode/ilspy](https://github.com/icsharpcode/ilspy) ⭐ 25,855 | 🐛 191 | 🌐 C# | 📅 2026-08-14 .NET Decompiler
...
* \[**1011**星]\[1y] \[C] [ionescu007/simplevisor](https://github.com/ionescu007/simplevisor) ⭐ 1,981 | 🐛 11 | 🌐 C | 📅 2024-05-08 英特尔VT-x虚拟机管理程序，简单、可移植。支持Windows和UEFI
...
* \[**570**星]\[12m] \[C] [asamy/ksm](https://github.com/asamy/ksm) ⭐ 864 | 🐛 13 | 🌐 C | 📅 2021-10-20 快速、hackable且简单的x64 VT-x虚拟机管理程序，支持Windows和Linux
  * 重复区段: [Linux->工具->新添加](#203d00ef3396d68f5277c90279f4ebf3) |

### <a id="c3cda3278305549f4c21df25cbf638a4"></a>内核&&驱动

* \[**781**星]\[19d] [axtmueller/windows-kernel-explorer](https://github.com/axtmueller/windows-kernel-explorer) ⭐ 2,717 | 🐛 0 | 📅 2025-12-14 Windows内核研究工具
* \[**510**星]\[5m] \[Py] [rabbitstack/fibratus](https://github.com/rabbitstack/fibratus) ⭐ 2,517 | 🐛 43 | 🌐 Go | 📅 2026-08-12 Windows内核探索和跟踪工具
* \[**479**星]\[1m] \[C] [jkornev/hidden](https://github.com/jkornev/hidden) ⭐ 2,051 | 🐛 13 | 🌐 C | 📅 2022-07-13 Windows驱动，带用户模式接口：隐藏文件系统和注册表对象、保护进程等
...
* \[**278**星]\[12d] \[PS] [microsoftdocs/windows-driver-docs](https://github.com/MicrosoftDocs/windows-driver-docs) ⭐ 1,057 | 🐛 7 | 🌐 OpenSCAD | 📅 2026-08-13 官方Windows驱动程序工具包文档
...
* \[**863**星]\[14d] \[C++] [henrypp/simplewall](https://github.com/henrypp/simplewall) ⭐ 8,839 | 🐛 143 | 🌐 C | 📅 2026-08-12 为Windows 过滤平台提供的配置界面
* \[**949**星]\[3m] \[C] [basil00/divert](https://github.com/basil00/divert) ⭐ 3,254 | 🐛 64 | 🌐 C | 📅 2023-03-15 用户模式数据包拦截库，适用于Win 7/8/10
* \[**360**星]\[12d] \[C#] [digitalruby/ipban](https://github.com/digitalruby/ipban) ⭐ 2,178 | 🐛 2 | 🌐 C# | 📅 2026-08-10 监视Windows/Linux系统的登录失败和不良行为，并封禁对应的IP地址。高度可配置，精简且功能强大。
...
* \[**210**星]\[3m] [adguardteam/adguardforwindows](https://github.com/adguardteam/adguardforwindows) ⭐ 877 | 🐛 212 | 📅 2026-07-28 Windows系统范围的AdBlocker
...
* \[**787**星]\[2m] \[C] [nixos/patchelf](https://github.com/nixos/patchelf) ⭐ 4,237 | 🐛 146 | 🌐 C | 📅 2026-07-27 A small utility to modify the dynamic linker and RPATH of ELF executables
* \[**930**星]\[15d] \[Py] [eliben/pyelftools](https://github.com/eliben/pyelftools) ⭐ 2,270 | 🐛 56 | 🌐 Python | 📅 2026-07-30 Parsing ELF and DWARF in Python
...
* \[**1450**星]\[2m] \[C] [feralinteractive/gamemode](https://github.com/feralinteractive/gamemode) ⭐ 5,966 | 🐛 216 | 🌐 C | 📅 2026-06-15 Optimise Linux system performance on demand
* \[**1413**星]\[21d] \[C++] [google/nsjail](https://github.com/google/nsjail) ⭐ 4,051 | 🐛 61 | 🌐 C++ | 📅 2026-07-27 A light-weight process isolation tool, making use of Linux namespaces and seccomp-bpf syscall filters (with help of the kafel bpf language)
* \[**759**星]\[1m] \[Py] [korcankaraokcu/pince](https://github.com/korcankaraokcu/pince) ⭐ 3,055 | 🐛 6 | 🌐 Python | 📅 2026-08-08 A reverse engineering tool that'll supply the place of Cheat Engine for linux
* \[**731**星]\[17d] \[C] [strace/strace](https://github.com/strace/strace) ⭐ 2,668 | 🐛 110 | 🌐 C | 📅 2026-08-10 strace is a diagnostic, debugging and instructional userspace utility for Linux
...
* \[**565**星]\[12d] \[C++] [intel/linux-sgx](https://github.com/intel/linux-sgx) ⭐ 1,448 | 🐛 140 | 🌐 C++ | 📅 2026-08-13 Intel SGX for Linux\*
...
* \[**468**星]\[9d] \[C] [libreswan/libreswan](https://github.com/libreswan/libreswan) ⭐ 1,004 | 🐛 640 | 🌐 C | 📅 2026-08-14 an Internet Key Exchange (IKE) implementation for Linux.
* \[**354**星]\[2m] \[C] [seccomp/libseccomp](https://github.com/seccomp/libseccomp) ⭐ 930 | 🐛 53 | 🌐 C | 📅 2026-07-01 an easy to use, platform independent, interface to the Linux Kernel's syscall filtering mechanism
* \[**570**星]\[12m] \[C] [asamy/ksm](https://github.com/asamy/ksm) ⭐ 864 | 🐛 13 | 🌐 C | 📅 2021-10-20 快速、hackable且简单的x64 VT-x虚拟机管理程序，支持Windows和Linux
