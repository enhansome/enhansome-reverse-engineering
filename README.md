...
* [全平台逆向资源: awesome-reverse-engineering](https://github.com/alphaSeclab/awesome-reverse-engineering) ⭐ 5,061 | 🐛 8 | 📅 2021-09-01:
...
* [开源远控和恶意远控分析报告: awesome-rat](https://github.com/alphaSeclab/awesome-rat) ⭐ 2,267 | 🐛 0 | 📅 2020-02-17: 开源远控工具: Windows/Linux/macOS/Android; 远控类恶意恶意代码的分析报告等
...
* [取证相关工具和文章: awesome-forensics](https://github.com/alphaSeclab/awesome-forensics) ⭐ 671 | 🐛 3 | 📅 2019-12-31: 近300个取开源证工具，近600与取证相关文章
* [收集的所有开源工具: sec-tool-list](https://github.com/alphaSeclab/sec-tool-list) ⭐ 621 | 🐛 4 | 📅 2020-05-25: 超过18K, 包括Markdown和Json两种格式
* [攻击性网络安全资源: awesome-cyber-security](https://github.com/alphaSeclab/awesome-cyber-security) ⭐ 502 | 🐛 0 | 📅 2019-12-23: 漏洞/渗透/物联网安全/数据渗透/Metasploit/BurpSuite/KaliLinux/C\&C/OWASP/免杀/CobaltStrike/侦查/OSINT/社工/密码/凭证/威胁狩猎/Payload/WifiHacking/无线攻击/后渗透/提权/UAC绕过/...
...
* 此页只包含部分内容. [查看完整版](https://github.com/alphaSeclab/awesome-reverse-engineering/blob/master/Readme_full.md) ⭐ 5,061 | 🐛 8 | 📅 2021-09-01
* 跟逆向有关的资源收集。当前包括的工具个数3500+，并根据功能进行了粗糙的分类。部分工具添加了中文描述。当前包括文章数2300+。

# 说明

[EnglishVersion](https://github.com/alphaSeclab/awesome-reverse-engineering/blob/master/Readme_en.md) ⭐ 5,061 | 🐛 8 | 📅 2021-09-01
...
* \[**737**星]\[7m] \[Py] [devttys0/ida](https://github.com/devttys0/ida) ⭐ 1,369 | 🐛 28 | 🌐 Python | 📅 2023-10-23 IDA插件/脚本/模块收集
  * [wpsearch](https://github.com/devttys0/ida/blob/master/scripts/wpsearch.py) ⭐ 1,369 | 🐛 28 | 🌐 Python | 📅 2023-10-23 查找在MIPS WPS checksum实现中常见的立即数
  * [md5hash](https://github.com/devttys0/ida/tree/master/modules/md5hash) ⭐ 1,369 | 🐛 28 | 🌐 Python | 📅 2023-10-23 纯Python版的MD5 hash实现（IDA的hashlib有问题）
  * [alleycat](https://github.com/devttys0/ida/tree/master/plugins/alleycat) ⭐ 1,369 | 🐛 28 | 🌐 Python | 📅 2023-10-23 查找向指定的函数内代码块的路径、查找两个或多个函数之间的路径、生成交互式调用图、可编程
  * [codatify](https://github.com/devttys0/ida/tree/master/plugins/codatify) ⭐ 1,369 | 🐛 28 | 🌐 Python | 📅 2023-10-23 定义IDA自动化分析时miss的ASCII字符串、函数、代码。将data段的所有未定义字节转换为DWORD（于是IDA可识别函数和跳转表指针）
  * [fluorescence](https://github.com/devttys0/ida/tree/master/plugins/fluorescence) ⭐ 1,369 | 🐛 28 | 🌐 Python | 📅 2023-10-23 高亮函数调用指令
  * [leafblower](https://github.com/devttys0/ida/tree/master/plugins/leafblower) ⭐ 1,369 | 🐛 28 | 🌐 Python | 📅 2023-10-23 识别常用的POSIX函数：printf, sprintf, memcmp, strcpy等
  * [localxrefs](https://github.com/devttys0/ida/tree/master/plugins/localxrefs) ⭐ 1,369 | 🐛 28 | 🌐 Python | 📅 2023-10-23 在当前函数内部查找所有对任意选择文本的引用
  * [mipslocalvars](https://github.com/devttys0/ida/tree/master/plugins/mipslocalvars) ⭐ 1,369 | 🐛 28 | 🌐 Python | 📅 2023-10-23 对栈上只用于存储寄存器的变量进行命名，简化栈数据分析（MISP）
  * [mipsrop](https://github.com/devttys0/ida/tree/master/plugins/mipsrop) ⭐ 1,369 | 🐛 28 | 🌐 Python | 📅 2023-10-23 在MIPS可执行代码中搜寻ROP。查找常见的ROP
  * [rizzo](https://github.com/devttys0/ida/tree/master/plugins/rizzo) ⭐ 1,369 | 🐛 28 | 🌐 Python | 📅 2023-10-23 对2个或多个IDB之间的函数进行识别和重命名，基于：函数签名、对唯一字符串/常量的引用、模糊签名、调用图
* \[**277**星]\[4m] \[Py] [jpcertcc/aa-tools](https://github.com/jpcertcc/aa-tools) ⭐ 463 | 🐛 3 | 🌐 Python | 📅 2025-08-14 多脚本
  * [apt17scan.py](https://github.com/jpcertcc/aa-tools/blob/master/apt17scan.py) ⭐ 463 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Volatility插件, 检测APT17相关的恶意代码并提取配置
  * [emdivi\_postdata\_decoder](https://github.com/jpcertcc/aa-tools/blob/master/emdivi_postdata_decoder.py) ⭐ 463 | 🐛 3 | 🌐 Python | 📅 2025-08-14 解码Emdivi post的数据
  * [emdivi\_string\_decryptor](https://github.com/jpcertcc/aa-tools/blob/master/emdivi_string_decryptor.py) ⭐ 463 | 🐛 3 | 🌐 Python | 📅 2025-08-14 IDAPython脚本, 解密Emdivi内的字符串
  * [citadel\_decryptor](https://github.com/jpcertcc/aa-tools/tree/master/citadel_decryptor) ⭐ 463 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Data decryption tool for Citadel
  * [adwind\_string\_decoder](https://github.com/jpcertcc/aa-tools/blob/master/adwind_string_decoder.py) ⭐ 463 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Python script for decoding strings inside Adwind
  * [redleavesscan](https://github.com/jpcertcc/aa-tools/blob/master/redleavesscan.py) ⭐ 463 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Volatility plugin for detecting RedLeaves and extracting its config
  * [datper\_splunk](https://github.com/jpcertcc/aa-tools/blob/master/datper_splunk.py) ⭐ 463 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Python script for detects Datper communication and adds result field to Splunk index
  * [datper\_elk](https://github.com/jpcertcc/aa-tools/blob/master/datper_elk.py) ⭐ 463 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Python script for detects Datper communication and adds result field to Elasticsearch index
  * [tscookie\_decode](https://github.com/jpcertcc/aa-tools/blob/master/tscookie_decode.py) ⭐ 463 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Python script for decrypting and parsing TSCookie configure data
  * [wellmess\_cookie\_decode](https://github.com/jpcertcc/aa-tools/blob/master/wellmess_cookie_decode.py) ⭐ 463 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Python script for decoding WellMess's cookie data (support Python2)
  * [cobaltstrikescan](https://github.com/jpcertcc/aa-tools/blob/master/cobaltstrikescan.py) ⭐ 463 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Volatility plugin for detecting Cobalt Strike Beacon and extracting its config
  * [tscookie\_data\_decode](https://github.com/jpcertcc/aa-tools/blob/master/tscookie_data_decode.py) ⭐ 463 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Python script for decrypting and parsing TSCookie configure data
...
* \[**931**星]\[25d] \[OCaml] [airbus-seclab/bincat](https://github.com/airbus-seclab/bincat) ⭐ 1,872 | 🐛 18 | 🌐 OCaml | 📅 2025-02-25 二进制代码静态分析工具。值分析（寄存器、内存）、污点分析、类型重建和传播（propagation）、前向/后向分析
  * 重复区段: [IDA->插件->污点分析](#34ac84853604a7741c61670f2a075d20) |
* \[**664**星]\[27d] \[Py] [igogo-x86/hexrayspytools](https://github.com/igogo-x86/hexrayspytools) ⭐ 1,537 | 🐛 32 | 🌐 Python | 📅 2024-08-11 结构体和类重建插件

#### <a id="4900b1626f10791748b20630af6d6123"></a>C++类&&虚表

* \[**607**星]\[3m] \[Py] [0xgalz/virtuailor](https://github.com/0xgalz/virtuailor) ⭐ 1,397 | 🐛 12 | 🌐 Python | 📅 2021-07-04 利用IDA调试获取的信息，自动创建C++的虚表
...
* \[**1771**星]\[10d] [onethawt/idaplugins-list](https://github.com/onethawt/idaplugins-list) ⭐ 3,836 | 🐛 8 | 📅 2024-05-31 IDA插件收集
* \[**363**星]\[9m] [fr0gger/awesome-ida-x64-olly-plugin](https://github.com/fr0gger/awesome-ida-x64-olly-plugin) ⭐ 1,586 | 🐛 2 | 📅 2026-02-20 IDA x64DBG OllyDBG 插件收集
...
* \[**5228**星]\[2m] \[Py] [refirmlabs/binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,356 | 🐛 94 | 🌐 Rust | 📅 2026-08-11 固件分析工具（命令行+IDA插件）
  * [IDA插件](https://github.com/ReFirmLabs/binwalk/tree/master/src/scripts) ⭐ 14,356 | 🐛 94 | 🌐 Rust | 📅 2026-08-11
  * [binwalk](https://github.com/ReFirmLabs/binwalk/tree/master/src/binwalk) ⭐ 14,356 | 🐛 94 | 🌐 Rust | 📅 2026-08-11
...
* \[**605**星]\[2m] \[Max] [maktm/flirtdb](https://github.com/Maktm/FLIRTDB) ⭐ 1,363 | 🐛 5 | 🌐 Max | 📅 2021-09-03 A community driven collection of IDA FLIRT signature files
...
* \[**1554**星]\[13d] \[Py] [joxeankoret/diaphora](https://github.com/joxeankoret/diaphora) ⭐ 4,394 | 🐛 35 | 🌐 Python | 📅 2026-09-04 program diffing
* \[**360**星]\[1m] \[Py] [checkpointsw/karta](https://github.com/checkpointsw/karta) ⭐ 910 | 🐛 10 | 🌐 Python | 📅 2026-03-31 source code assisted fast binary matching plugin for IDA
...
* \[**258**星]\[1y] \[C++] [dga-mi-ssi/yaco](https://github.com/dga-mi-ssi/yaco) ⭐ 325 | 🐛 13 | 🌐 C++ | 📅 2019-08-05 利用Git版本控制，同步多人对相同二进制文件的修改

### <a id="f7d311685152ac005cfce5753c006e4b"></a>与调试器同步&&通信&&交互

* \[**471**星]\[13d] \[C] [bootleg/ret-sync](https://github.com/bootleg/ret-sync) ⭐ 2,384 | 🐛 31 | 🌐 C | 📅 2026-02-15 在反汇编工具和调试器之间同步调试会话
  * [GDB插件](https://github.com/bootleg/ret-sync/tree/master/ext_gdb) ⭐ 2,384 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [Ghidra插件](https://github.com/bootleg/ret-sync/tree/master/ext_ghidra) ⭐ 2,384 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [IDA插件](https://github.com/bootleg/ret-sync/tree/master/ext_ida) ⭐ 2,384 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [LLDB](https://github.com/bootleg/ret-sync/tree/master/ext_lldb) ⭐ 2,384 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [OD](https://github.com/bootleg/ret-sync/tree/master/ext_olly1) ⭐ 2,384 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [OD2](https://github.com/bootleg/ret-sync/tree/master/ext_olly2) ⭐ 2,384 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [WinDgb](https://github.com/bootleg/ret-sync/tree/master/ext_windbg/sync) ⭐ 2,384 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [x64dbg](https://github.com/bootleg/ret-sync/tree/master/ext_x64dbg) ⭐ 2,384 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * 重复区段: [x64dbg->插件->新添加的](#da5688c7823802e734c39b539aa39df7) |
* \[**292**星]\[11m] \[C] [a1ext/labeless](https://github.com/a1ext/labeless) ⭐ 584 | 🐛 21 | 🌐 C++ | 📅 2026-02-23 在IDA和调试器之间无缝同步Label/注释等
  * [IDA插件](https://github.com/a1ext/labeless/tree/master/labeless_ida) ⭐ 584 | 🐛 21 | 🌐 C++ | 📅 2026-02-23
  * [OD](https://github.com/a1ext/labeless/tree/master/labeless_olly) ⭐ 584 | 🐛 21 | 🌐 C++ | 📅 2026-02-23
  * [OD2](https://github.com/a1ext/labeless/tree/master/labeless_olly2) ⭐ 584 | 🐛 21 | 🌐 C++ | 📅 2026-02-23
  * [x64dbg](https://github.com/a1ext/labeless/tree/master/labeless_x64dbg) ⭐ 584 | 🐛 21 | 🌐 C++ | 📅 2026-02-23
...
* \[**299**星]\[4m] \[Py] [cisco-talos/ghida](https://github.com/cisco-talos/ghida) ⭐ 818 | 🐛 13 | 🌐 Python | 📅 2021-02-19 在IDA中集成Ghidra反编译器
  * 重复区段: [Ghidra->插件->与其他工具交互->IDA](#d832a81018c188bf585fcefa3ae23062) |
* \[**238**星]\[9m] \[Py] [daenerys-sre/source](https://github.com/daenerys-sre/source) ⭐ 308 | 🐛 0 | 🌐 Python | 📅 2019-04-01 使IDA和Ghidra脚本通用, 无需修改
  * 重复区段: [Ghidra->插件->与其他工具交互->IDA](#d832a81018c188bf585fcefa3ae23062) |

#### <a id="11139e7d6db4c1cef22718868f29fe12"></a>BinNavi

* \[**382**星]\[26d] \[C++] [google/binexport](https://github.com/google/binexport) ⭐ 1,204 | 🐛 42 | 🌐 C++ | 📅 2026-09-15 将反汇编以Protocol Buffer的形式导出为PostgreSQL数据库, 导入到BinNavi中使用
...
* \[**306**星]\[1y] \[Py] [fsecurelabs/win\_driver\_plugin](https://github.com/FSecureLABS/win_driver_plugin) ⭐ 440 | 🐛 2 | 🌐 Python | 📅 2018-08-22 A tool to help when dealing with Windows IOCTL codes or reversing Windows drivers.
...
* \[**258**星]\[28d] \[Py] [inforion/idapython-cheatsheet](https://github.com/inforion/idapython-cheatsheet) ⭐ 686 | 🐛 2 | 🌐 Python | 📅 2023-11-02 Scripts and cheatsheets for IDAPython
...
* \[**269**星]\[1m] \[Py] [eset/ipyida](https://github.com/eset/ipyida) ⭐ 856 | 🐛 7 | 🌐 Python | 📅 2026-08-27 集成IPython控制台
...
* \[**395**星]\[1y] \[C++] [cseagle/sk3wldbg](https://github.com/cseagle/sk3wldbg) ⭐ 563 | 🐛 9 | 🌐 C++ | 📅 2024-06-20 用Unicorn引擎做后端的调试插件
  * 重复区段: [IDA->插件->模拟器集成](#b38dab81610be087bd5bc7785269b8cc) |

#### <a id="0fbd352f703b507853c610a664f024d1"></a>DBI数据

* \[**943**星]\[1y] \[Py] [gaasedelen/lighthouse](https://github.com/gaasedelen/lighthouse) ⭐ 2,580 | 🐛 34 | 🌐 Python | 📅 2026-02-14 从DBI中收集代码覆盖情况，在IDA/Binja中映射、浏览、查看
  * [coverage-frida](https://github.com/gaasedelen/lighthouse/blob/master/coverage/frida/README.md) ⭐ 2,580 | 🐛 34 | 🌐 Python | 📅 2026-02-14 使用Frida收集信息
  * [coverage-pin](https://github.com/gaasedelen/lighthouse/blob/master/coverage/pin/README.md) ⭐ 2,580 | 🐛 34 | 🌐 Python | 📅 2026-02-14 使用Pin收集覆盖信息
  * [插件](https://github.com/gaasedelen/lighthouse/blob/master/plugin/lighthouse_plugin.py) ⭐ 2,580 | 🐛 34 | 🌐 Python | 📅 2026-02-14 支持IDA和BinNinja
...
* \[**386**星]\[5m] \[Py] [ynvb/die](https://github.com/ynvb/die) ⭐ 477 | 🐛 16 | 🌐 Python | 📅 2022-03-02 使用IDA调试器收集动态运行信息, 辅助静态分析
...
* \[**1672**星]\[7m] \[C++] [yegord/snowman](https://github.com/yegord/snowman) ⚠️ Archived Snowman反编译器，支持x86, AMD64, ARM。有独立的GUI工具、命令行工具、IDA/Radare2/x64dbg插件，也可以作为库使用
  ...
  * 重复区段: [x64dbg->插件->新添加的](#da5688c7823802e734c39b539aa39df7) |
* \[**418**星]\[3m] \[C++] [avast/retdec-idaplugin](https://github.com/avast/retdec-idaplugin) ⭐ 798 | 🐛 14 | 🌐 C++ | 📅 2025-02-03 retdec 的 IDA 插件
...
* \[**1365**星]\[3m] \[Py] [fireeye/flare-floss](https://github.com/fireeye/flare-floss) ⭐ 4,158 | 🐛 120 | 🌐 Python | 📅 2026-09-17 自动从恶意代码中提取反混淆后的字符串
  * [floss](https://github.com/fireeye/flare-floss/tree/master/floss) ⭐ 4,158 | 🐛 120 | 🌐 Python | 📅 2026-09-17
  * [IDA插件](https://github.com/fireeye/flare-floss/blob/master/scripts/idaplugin.py) ⭐ 4,158 | 🐛 120 | 🌐 Python | 📅 2026-09-17
...
* \[**372**星]\[3m] \[Py] [l4ys/lazyida](https://github.com/l4ys/lazyida) ⭐ 1,441 | 🐛 1 | 🌐 Python | 📅 2026-01-31 若干快速访问功能, 扫描字符串格式化漏洞
...
* \[**329**星]\[4m] \[Py] [pfalcon/scratchabit](https://github.com/pfalcon/scratchabit) ⭐ 412 | 🐛 29 | 🌐 Python | 📅 2020-11-25 交互式反汇编工具, 有与IDAPython兼容的插件API
...
* \[**246**星]\[28d] \[C++] [strazzere/android-scripts](https://github.com/strazzere/android-scripts) ⭐ 423 | 🐛 0 | 🌐 C++ | 📅 2020-05-03 Android逆向脚本收集
...
* \[**504**星]\[20d] \[Py] [alexhude/uemu](https://github.com/alexhude/uemu) ⭐ 1,239 | 🐛 5 | 🌐 Python | 📅 2026-08-19 基于Unicorn的模拟器插件
* \[**282**星]\[2m] \[Py] [fireeye/flare-emu](https://github.com/fireeye/flare-emu) ⭐ 955 | 🐛 7 | 🌐 Python | 📅 2025-08-14 结合Unicorn引擎, 简化模拟脚本的编写
...
* \[**492**星]\[7m] \[Py] [danigargu/heap-viewer](https://github.com/danigargu/heap-viewer) ⭐ 772 | 🐛 5 | 🌐 Python | 📅 2022-07-25 查看glibc堆, 主要用于漏洞开发

#### <a id="cf2efa7e3edb24975b92d2e26ca825d2"></a>ROP

### <a id="7d557bc3d677d206ef6c5a35ca8b3a14"></a>补丁&\&Patch

* \[**727**星]\[1y] \[Py] [keystone-engine/keypatch](https://github.com/keystone-engine/keypatch) ⭐ 1,867 | 🐛 43 | 🌐 Python | 📅 2024-09-06 汇编/补丁插件, 支持多架构, 基于Keystone引擎
...
* \[**291**星]\[3m] \[Py] [a1ext/auto\_re](https://github.com/a1ext/auto_re) ⭐ 791 | 🐛 2 | 🌐 Python | 📅 2026-08-19 自动化函数重命名
...
* \[**18649**星]\[10d] \[Java] [nationalsecurityagency/ghidra](https://github.com/nationalsecurityagency/ghidra) ⭐ 79,071 | 🐛 1,963 | 🌐 Java | 📅 2026-09-18 软件逆向框架

### <a id="ce70b8d45be0a3d29705763564623aca"></a>新添加的

* \[**455**星]\[9m] \[YARA] [ghidraninja/ghidra\_scripts](https://github.com/ghidraninja/ghidra_scripts) ⭐ 1,170 | 🐛 13 | 🌐 YARA | 📅 2020-10-07 Ghidra脚本
  * [binwalk](https://github.com/ghidraninja/ghidra_scripts/blob/master/binwalk.py) ⭐ 1,170 | 🐛 13 | 🌐 YARA | 📅 2020-10-07 对当前程序运行BinWalk, 标注找到的内容
  * [yara](https://github.com/ghidraninja/ghidra_scripts/blob/master/yara.py) ⭐ 1,170 | 🐛 13 | 🌐 YARA | 📅 2020-10-07 使用Yara查找加密常量
  * [swift\_demangler](https://github.com/ghidraninja/ghidra_scripts/blob/master/swift_demangler.py) ⭐ 1,170 | 🐛 13 | 🌐 YARA | 📅 2020-10-07 自动demangle Swift函数名
  * [golang\_renamer](https://github.com/ghidraninja/ghidra_scripts/blob/master/golang_renamer.py) ⭐ 1,170 | 🐛 13 | 🌐 YARA | 📅 2020-10-07 恢复stripped Go二进制文件的函数名
* \[**204**星]\[8m] \[Java] [rolfrolles/ghidrapal](https://github.com/rolfrolles/ghidrapal) ⭐ 350 | 🐛 8 | 🌐 Java | 📅 2023-06-28 Ghidra 程序分析库(无文档)
...
* \[**34576**星]\[1m] \[C++] [x64dbg/x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,560 | 🐛 572 | 🌐 C++ | 📅 2026-09-19 Windows平台x32/x64调试器
...
* \[**1341**星]\[1m] \[C] [x64dbg/x64dbgpy](https://github.com/x64dbg/x64dbgpy) ⭐ 1,508 | 🐛 28 | 🌐 C | 📅 2023-04-05 Automating x64dbg using Python, Snapshots:
...
* \[**230**星]\[9m] \[C++] [microsoft/windbg-samples](https://github.com/microsoft/windbg-samples) ⭐ 827 | 🐛 6 | 🌐 C++ | 📅 2026-06-30 Sample extensions, scripts, and API uses for WinDbg.
* \[**279**星]\[1m] \[Py] [hugsy/defcon\_27\_windbg\_workshop](https://github.com/hugsy/defcon_27_windbg_workshop) ⭐ 746 | 🐛 0 | 🌐 Python | 📅 2024-11-01 DEFCON 27 workshop - Modern Debugging with WinDbg Preview
...
* \[**5195**星]\[19d] \[Py] [mobsf/mobile-security-framework-mobsf](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,797 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-09 Mobile Security Framework (MobSF) is an automated, all-in-one mobile application (Android/iOS/Windows) pen-testing, malware analysis and security assessment framework capable of performing static and dynamic analysis.
* \[**5084**星]\[15d] \[HTML] [owasp/owasp-mstg](https://github.com/owasp/owasp-mstg) ⭐ 13,187 | 🐛 239 | 🌐 Python | 📅 2026-09-18 关于移动App安全开发、测试和逆向的相近手册
* \[**4306**星]\[15d] \[Shell] [ashishb/android-security-awesome](https://github.com/ashishb/android-security-awesome) ⭐ 9,701 | 🐛 0 | 🌐 Makefile | 📅 2026-09-07 A collection of android security related resources
* \[**2051**星]\[21d] \[Py] [sensepost/objection](https://github.com/sensepost/objection) ⭐ 9,401 | 🐛 57 | 🌐 Python | 📅 2026-09-17 runtimemobile exploration
...
* \[**820**星]\[11d] [proxymanapp/proxyman](https://github.com/proxymanapp/proxyman) ⭐ 6,981 | 🐛 1,894 | 📅 2026-09-07 Modern and Delightful HTTP Debugging Proxy for macOS, iOS and Android
* \[**4882**星]\[24d] \[Java] [guardianproject/haven](https://github.com/guardianproject/haven) ⭐ 6,816 | 🐛 149 | 🌐 Java | 📅 2022-10-26 通过Android应用和设备上的传感器保护自己的个人空间和财产而又不损害
* \[**4776**星]\[12d] \[C++] [facebook/redex](https://github.com/facebook/redex) ⭐ 6,302 | 🐛 73 | 🌐 C++ | 📅 2026-09-19 Android App字节码优化器
* \[**1925**星]\[7m] \[Java] [fuzion24/justtrustme](https://github.com/fuzion24/justtrustme) ⭐ 5,364 | 🐛 22 | 🌐 Java | 📅 2024-09-02 An xposed module that disables SSL certificate checking for the purposes of auditing an app with cert pinning
* \[**443**星]\[1m] \[TS] [shroudedcode/apk-mitm](https://github.com/shroudedcode/apk-mitm) ⭐ 5,111 | 🐛 83 | 🌐 TypeScript | 📅 2024-07-24
* \[**2011**星]\[8m] \[Py] [fsecurelabs/drozer](https://github.com/FSecureLABS/drozer) ⭐ 4,616 | 🐛 9 | 🌐 Python | 📅 2026-04-08 The Leading Security Assessment Framework for Android.
* \[**2314**星]\[1y] \[Java] [csploit/android](https://github.com/csploit/android) ⭐ 3,654 | 🐛 400 | 🌐 Java | 📅 2024-04-27 cSploit - The most complete and advanced IT security professional toolkit on Android.
* \[**431**星]\[13d] \[C] [guardianproject/orbot](https://github.com/guardianproject/orbot) ⭐ 3,553 | 🐛 78 | 🌐 Kotlin | 📅 2026-09-18 The Github home of Orbot: Tor on Android (Also available on gitlab!)
* \[**2120**星]\[9m] \[Py] [linkedin/qark](https://github.com/linkedin/qark) ⭐ 3,390 | 🐛 79 | 🌐 Python | 📅 2024-01-16 查找Android App的漏洞, 支持源码或APK文件
* \[**2095**星]\[10m] [jermic/android-crack-tool](https://github.com/jermic/android-crack-tool) ⭐ 2,941 | 🐛 15 | 📅 2022-06-23
* \[**1976**星]\[9d] \[Java] [kyson/androidgodeye](https://github.com/kyson/androidgodeye) ⭐ 2,640 | 🐛 17 | 🌐 Java | 📅 2023-01-26 AndroidGodEye:A performance monitor tool , like "Android Studio profiler" for Android , you can easily monitor the performance of your app real time in pc browser
...
* \[**559**星]\[14d] \[Shell] [owasp/owasp-masvs](https://github.com/owasp/owasp-masvs) ⭐ 2,451 | 🐛 8 | 🌐 Python | 📅 2026-09-18 OWASP 移动App安全标准
* \[**1235**星]\[2m] \[Java] [find-sec-bugs/find-sec-bugs](https://github.com/find-sec-bugs/find-sec-bugs) ⭐ 2,448 | 🐛 115 | 🌐 Java | 📅 2026-03-26 The SpotBugs plugin for security audits of Java web applications and Android applications. (Also work with Kotlin, Groovy and Scala projects)
* \[**426**星]\[19d] \[Py] [thehackingsage/hacktronian](https://github.com/thehackingsage/hacktronian) ⭐ 2,202 | 🐛 32 | 🌐 Python | 📅 2023-11-18 All in One Hacking Tool for Linux & Android
* \[**885**星]\[2m] \[C] [504ensicslabs/lime](https://github.com/504ensicslabs/lime) ⭐ 2,038 | 🐛 35 | 🌐 C | 📅 2026-04-05 LiME (formerly DMD) is a Loadable Kernel Module (LKM), which allows the acquisition of volatile memory from Linux and Linux-based devices, such as those powered by Android. The tool supports acquiring memory either to the file system of the device or over the network. LiME is unique in that it is the first tool that allows full memory captures f…
* \[**518**星]\[4m] \[Java] [megatronking/stringfog](https://github.com/megatronking/stringfog) ⭐ 2,019 | 🐛 44 | 🌐 Java | 📅 2024-07-09 一款自动对字节码中的字符串进行加密Android插件工具
* \[**358**星]\[5m] [b3nac/android-reports-and-resources](https://github.com/b3nac/android-reports-and-resources) ⭐ 1,713 | 🐛 0 | 📅 2025-09-10 A big list of Android Hackerone disclosed reports and other resources.
* \[**546**星]\[2m] [nordicsemiconductor/android-nrf-connect](https://github.com/nordicsemiconductor/android-nrf-connect) ⭐ 1,699 | 🐛 57 | 📅 2025-08-28 Documentation and issue tracker for nRF Connect for Android.
* \[**1134**星]\[1m] \[Java] [huangyz0918/androidwm](https://github.com/huangyz0918/androidwm) ⭐ 1,627 | 🐛 41 | 🌐 Java | 📅 2024-05-10 一个支持不可见数字水印（隐写术）的android图像水印库。
* \[**409**星]\[3m] \[CSS] [angea/pocorgtfo](https://github.com/angea/pocorgtfo) ⭐ 1,617 | 🐛 1 | 🌐 TeX | 📅 2024-02-11 a "Proof of Concept or GTFO" mirror with extra article index, direct links and clean PDFs.
* \[**265**星]\[11d] \[Py] [den4uk/andriller](https://github.com/den4uk/andriller) ⭐ 1,608 | 🐛 12 | 🌐 Python | 📅 2022-06-27 a collection of forensic tools for smartphones
...
* \[**1208**星]\[4m] \[Java] [javiersantos/piracychecker](https://github.com/javiersantos/piracychecker) ⭐ 1,569 | 🐛 26 | 🌐 Java | 📅 2026-06-04 An Android library that prevents your app from being pirated / cracked using Google Play Licensing (LVL), APK signature protection and more. API 14+ required.
* \[**527**星]\[4m] \[JS] [wooyundota/droidsslunpinning](https://github.com/wooyundota/droidsslunpinning) ⭐ 1,511 | 🐛 4 | 🌐 JavaScript | 📅 2020-04-07 Android certificate pinning disable tools
...
* \[**1241**星]\[3m] \[Java] [whataa/pandora](https://github.com/whataa/pandora) ⭐ 1,493 | 🐛 13 | 🌐 Java | 📅 2023-11-01 an android library for debugging what we care about directly in app.
...
* \[**769**星]\[1y] \[C] [ele7enxxh/android-inline-hook](https://github.com/ele7enxxh/android-inline-hook) ⭐ 1,401 | 🐛 15 | 🌐 C | 📅 2020-06-23 thumb16 thumb32 arm32 inlineHook in Android
* \[**267**星]\[4m] \[Py] [amimo/dcc](https://github.com/amimo/dcc) ⭐ 1,315 | 🐛 27 | 🌐 Python | 📅 2024-02-07 DCC (Dex-to-C Compiler) is method-based aot compiler that can translate DEX code to C code.
* \[**379**星]\[6m] \[Makefile] [crifan/android\_app\_security\_crack](https://github.com/crifan/android_app_security_crack) ⭐ 1,314 | 🐛 4 | 🌐 Makefile | 📅 2024-10-07 安卓应用的安全和破解
* \[**800**星]\[3m] [sh4hin/androl4b](https://github.com/sh4hin/androl4b) ⭐ 1,170 | 🐛 5 | 📅 2023-05-31 用于评估Android应用程序，逆向工程和恶意软件分析的虚拟机
* \[**668**星]\[2m] [doridori/android-security-reference](https://github.com/doridori/android-security-reference) ⭐ 995 | 🐛 5 | 📅 2025-03-24 A W\.I.P Android Security Ref
...
* \[**608**星]\[7m] \[JS] [vincentcox/stacoan](https://github.com/vincentcox/stacoan) ⭐ 869 | 🐛 11 | 🌐 JavaScript | 📅 2021-04-27 StaCoAn is a crossplatform tool which aids developers, bugbounty hunters and ethical hackers performing static code analysis on mobile applications.
...
* \[**541**星]\[1y] \[Java] [jaredrummler/apkparser](https://github.com/jaredrummler/apkparser) ⭐ 672 | 🐛 14 | 🌐 Java | 📅 2024-06-24 APK parser for Android
* \[**333**星]\[25d] \[Java] [datatheorem/trustkit-android](https://github.com/datatheorem/trustkit-android) ⭐ 604 | 🐛 22 | 🌐 Java | 📅 2026-08-26 Easy SSL pinning validation and reporting for Android.
* \[**450**星]\[12m] \[Kotlin] [shadowsocks/kcptun-android](https://github.com/shadowsocks/kcptun-android) ⭐ 578 | 🐛 8 | 🌐 Shell | 📅 2023-02-18 kcptun for Android.
...
* \[**1213**星]\[2m] \[JS] [megatronking/httpcanary](https://github.com/megatronking/httpcanary) ⭐ 509 | 🐛 5 | 📅 2024-07-03 A powerful capture and injection tool for the Android platform
* \[**208**星]\[26d] \[C] [derrekr/fastboot3ds](https://github.com/derrekr/fastboot3ds) ⭐ 451 | 🐛 9 | 🌐 C | 📅 2022-05-26 A homebrew bootloader for the Nintendo 3DS that is similar to android's fastboot.
...
* \[**14557**星]\[13d] \[Java] [tencent/tinker](https://github.com/tencent/tinker) ⭐ 17,648 | 🐛 571 | 🌐 Java | 📅 2026-08-12 Tinker is a hot-fix solution library for Android, it supports dex, library and resources update without reinstall apk.
...
* \[**5080**星]\[2m] \[Java] [meituan-dianping/walle](https://github.com/meituan-dianping/walle) ⭐ 6,857 | 🐛 109 | 🌐 Java | 📅 2024-05-30 Android Signature V2 Scheme签名下的新一代渠道包打包神器

### <a id="767078c52aca04c452c095f49ad73956"></a>收集

### <a id="17408290519e1ca7745233afea62c43c"></a>各类App

* \[**12285**星]\[11d] \[Java] [signalapp/signal-android](https://github.com/signalapp/Signal-Android) ⭐ 29,364 | 🐛 503 | 🌐 Kotlin | 📅 2026-09-18 A private messenger for Android.

### <a id="7f353b27e45b5de6b0e6ac472b02cbf1"></a>Xposed

* \[**8756**星]\[2m] \[Java] [android-hacker/virtualxposed](https://github.com/android-hacker/virtualxposed) ⭐ 16,064 | 🐛 162 | 🌐 Java | 📅 2024-03-08 A simple app to use Xposed without root, unlock the bootloader or modify system image, etc.
* \[**2034**星]\[12d] \[Java] [elderdrivers/edxposed](https://github.com/elderdrivers/edxposed) ⭐ 5,669 | 🐛 54 | 🌐 Java | 📅 2022-04-12 Elder driver Xposed Framework.
...
* \[**669**星]\[12d] \[Java] [ganyao114/sandhook](https://github.com/ganyao114/sandhook) ⭐ 2,226 | 🐛 47 | 🌐 Java | 📅 2023-01-19 Android ART Hook/Native Inline Hook/Single Instruction Hook - support 4.4 - 10.0 32/64 bit - Xposed API Compat
* \[**1296**星]\[2m] \[Java] [android-hacker/exposed](https://github.com/android-hacker/exposed) ⭐ 1,554 | 🐛 5 | 🌐 Java | 📅 2021-12-01 A library to use Xposed without root or recovery(or modify system image etc..).
* \[**309**星]\[13d] \[Java] [ganyao114/sandvxposed](https://github.com/ganyao114/sandvxposed) ⭐ 1,057 | 🐛 45 | 🌐 Java | 📅 2021-11-18 Xposed environment without root (OS 5.0 - 10.0)
...
* \[**309**星]\[1m] [bigsinger/androididchanger](https://github.com/bigsinger/androididchanger) ⭐ 633 | 🐛 28 | 🌐 Java | 📅 2026-08-14 Xposed Module for Changing Android Device Info
...
* \[**1465**星]\[3m] \[C++] [vaibhavpandeyvpz/apkstudio](https://github.com/vaibhavpandeyvpz/apkstudio) ⭐ 4,656 | 🐛 4 | 🌐 C++ | 📅 2026-01-05 Open-source, cross platform Qt based IDE for reverse-engineering Android application packages.
* \[**1793**星]\[8m] \[C++] [wrbug/dumpdex](https://github.com/wrbug/dumpdex) ⭐ 3,158 | 🐛 38 | 🌐 C++ | 📅 2020-05-15 Android脱壳
* \[**366**星]\[3m] \[Java] [patrickfav/uber-apk-signer](https://github.com/patrickfav/uber-apk-signer) ⭐ 2,753 | 🐛 11 | 🌐 Java | 📅 2023-10-30 A cli tool that helps signing and zip aligning single or multiple Android application packages (APKs) with either debug or provided release certificates. It supports v1, v2 and v3 Android signing scheme has an embedded debug keystore and auto verifies after signing.
* \[**712**星]\[2m] \[YARA] [rednaga/apkid](https://github.com/rednaga/apkid) ⭐ 2,577 | 🐛 84 | 🌐 YARA | 📅 2026-09-02 Android Application Identifier for Packers, Protectors, Obfuscators and Oddities - PEiD for Android
* \[**811**星]\[4m] \[C] [strazzere/android-unpacker](https://github.com/strazzere/android-unpacker) ⭐ 1,177 | 🐛 0 | 🌐 C | 📅 2020-01-20 Android Unpacker presented at Defcon 22: Android Hacker Protection Level 0
* \[**322**星]\[6m] \[Shell] [1n3/reverseapk](https://github.com/1n3/reverseapk) ⭐ 871 | 🐛 1 | 🌐 Shell | 📅 2022-12-21 Quickly analyze and reverse engineer Android packages

### <a id="596b6cf8fd36bc4c819335f12850a915"></a>HOOK

* \[**1494**星]\[9d] \[C++] [jmpews/dobby](https://github.com/jmpews/Dobby) ⭐ 4,829 | 🐛 98 | 🌐 C++ | 📅 2025-01-26 a lightweight, multi-platform, multi-architecture hook framework.
* \[**1500**星]\[27d] \[C] [iqiyi/xhook](https://github.com/iqiyi/xhook) ⭐ 4,347 | 🐛 44 | 🌐 C | 📅 2025-06-27 a PLT (Procedure Linkage Table) hook library for Android native ELF
* \[**804**星]\[25d] \[C++] [aslody/whale](https://github.com/aslody/whale) ⭐ 1,665 | 🐛 50 | 🌐 C++ | 📅 2020-12-13 Hook Framework for Android/IOS/Linux/MacOS
...
* \[**532**星]\[7m] \[Java] [limboemu/limbo](https://github.com/limboemu/limbo) ⭐ 3,419 | 🐛 54 | 🌐 Java | 📅 2024-08-18 Limbo is a QEMU-based emulator for Android. It currently supports PC & ARM emulation for Intel x86 and ARM architecture. See our wiki
* \[**1492**星]\[1y] \[C++] [f1xpl/openauto](https://github.com/f1xpl/openauto) ⭐ 2,922 | 🐛 37 | 🌐 C++ | 📅 2024-12-12 AndroidAuto headunit emulator
* \[**471**星]\[3m] \[Java] [strazzere/anti-emulator](https://github.com/strazzere/anti-emulator) ⭐ 839 | 🐛 4 | 🌐 Java | 📅 2021-01-22 Android Anti-Emulator

### <a id="0a668d220ce74e11ed2738c4e3ae3c9e"></a>IDA

### <a id="bb9f8e636857320abf0502c19af6c763"></a>Debug&&调试

* \[**10794**星]\[1m] \[Java] [konloch/bytecode-viewer](https://github.com/konloch/bytecode-viewer) ⭐ 15,649 | 🐛 103 | 🌐 Java | 📅 2026-07-17 A Java 8+ Jar & Android APK Reverse Engineering Suite (Decompiler, Editor, Debugger & More)
* \[**6762**星]\[10m] \[Java] [amitshekhariitbhu/android-debug-database](https://github.com/amitshekhariitbhu/android-debug-database) ⭐ 8,681 | 🐛 83 | 🌐 Java | 📅 2026-02-05 A library for debugging android databases and shared preferences - Make Debugging Great Again

### <a id="f975a85510f714ec3cc2551e868e75b8"></a>Malware&&恶意代码

* \[**429**星]\[4m] \[Shell] [ashishb/android-malware](https://github.com/ashishb/android-malware) ⭐ 1,227 | 🐛 0 | 🌐 Shell | 📅 2025-12-31 Collection of android malware samples
* \[**347**星]\[3m] \[Java] [droidefense/engine](https://github.com/droidefense/engine) ⭐ 479 | 🐛 27 | 🌐 Java | 📅 2022-12-14 Droidefense: Advance Android Malware Analysis Framework

### <a id="1d83ca6d8b02950be10ac8e4b8a2d976"></a>Obfuscate&&混淆

* \[**3078**星]\[2m] \[Java] [calebfenton/simplify](https://github.com/calebfenton/simplify) ⭐ 4,664 | 🐛 33 | 🌐 Java | 📅 2022-04-30 Generic Android Deobfuscator
...
* \[**9285**星]\[1m] \[Java] [ibotpeaches/apktool](https://github.com/ibotpeaches/apktool) ⭐ 25,611 | 🐛 77 | 🌐 Java | 📅 2026-09-19 A tool for reverse engineering Android apk files
* \[**2053**星]\[1m] \[Java] [genymobile/gnirehtet](https://github.com/genymobile/gnirehtet) ⭐ 7,923 | 🐛 326 | 🌐 Java | 📅 2024-08-11 Gnirehtet provides reverse tethering for Android
* \[**545**星]\[20d] [maddiestone/androidappre](https://github.com/maddiestone/androidappre) ⭐ 1,559 | 🐛 5 | 📅 2024-04-10 Android App Reverse Engineering Workshop
...
* \[**2140**星]\[2m] \[Py] [jonathansalwan/ropgadget](https://github.com/jonathansalwan/ropgadget) ⭐ 4,479 | 🐛 15 | 🌐 Python | 📅 2026-06-24 This tool lets you search your gadgets on your binaries to facilitate your ROP exploitation. ROPgadget supports ELF, PE and Mach-O format on x86, x64, ARM, ARM64, PowerPC, SPARC and MIPS architectures.
* \[**2540**星]\[10m] \[ObjC] [nygard/class-dump](https://github.com/nygard/class-dump) ⭐ 3,587 | 🐛 41 | 🌐 Objective-C | 📅 2022-04-06 Generate Objective-C headers from Mach-O files.
...
* \[**5451**星]\[3m] \[Py] [axi0mx/ipwndfu](https://github.com/axi0mx/ipwndfu) ⭐ 7,418 | 🐛 168 | 🌐 Python | 📅 2024-02-21 open-source jailbreaking tool for many iOS devices
* \[**4248**星]\[8m] \[ObjC] [alonemonkey/monkeydev](https://github.com/alonemonkey/monkeydev) ⭐ 6,795 | 🐛 186 | 🌐 Objective-C | 📅 2022-07-09 CaptainHook Tweak、Logos Tweak and Command-line Tool、Patch iOS Apps, Without Jailbreak.
* \[**5390**星]\[6m] \[C] [pwn20wndstuff/undecimus](https://github.com/pwn20wndstuff/undecimus) ⭐ 6,612 | 🐛 197 | 🌐 C | 📅 2021-08-01 unc0ver jailbreak for iOS 11.0 - 12.4
* \[**3221**星]\[5m] \[ObjC] [naituw/ipapatch](https://github.com/naituw/ipapatch) ⭐ 5,285 | 🐛 43 | 🌐 Objective-C | 📅 2026-02-27 Patch iOS Apps, The Easy Way, Without Jailbreak.
* \[**1193**星]\[15d] \[JS] [alonemonkey/frida-ios-dump](https://github.com/alonemonkey/frida-ios-dump) ⭐ 3,928 | 🐛 107 | 🌐 JavaScript | 📅 2023-05-03 pull decrypted ipa from jailbreak device
  * 重复区段: [DBI->Frida->工具->新添加的](#54836a155de0c15b56f43634cd9cfecf) |
* \[**287**星]\[7m] \[Shell] [0ki/mikrotik-tools](https://github.com/0ki/mikrotik-tools) ⭐ 594 | 🐛 3 | 🌐 Shell | 📅 2020-02-19 Tools for Mikrotik devices -  universal jailbreak tool
...
* \[**8031**星]\[3m] \[Py] [facebook/chisel](https://github.com/facebook/chisel) ⭐ 9,176 | 🐛 50 | 🌐 Python | 📅 2026-03-15 Chisel is a collection of LLDB commands to assist debugging iOS apps.
* \[**492**星]\[28d] \[Rust] [vadimcn/vscode-lldb](https://github.com/vadimcn/vscode-lldb) ⭐ 3,305 | 🐛 172 | 🌐 Rust | 📅 2026-08-23 A native debugger extension for VSCode based on LLDB
* \[**784**星]\[3m] \[C++] [nodejs/llnode](https://github.com/nodejs/llnode) ⭐ 1,169 | 🐛 70 | 🌐 C++ | 📅 2024-12-21 An lldb plugin for Node.js and V8, which enables inspection of JavaScript states for insights into Node.js processes and their core dumps.
...
* \[**6203**星]\[3m] \[ObjC] [johnno1962/injectionforxcode](https://github.com/johnno1962/injectionforxcode) ⭐ 6,535 | 🐛 76 | 🌐 Objective-C | 📅 2022-08-04 Runtime Code Injection for Objective-C & Swift
* \[**1409**星]\[1m] \[Swift] [johnno1962/injectioniii](https://github.com/johnno1962/injectioniii) ⭐ 4,642 | 🐛 5 | 🌐 Objective-C | 📅 2026-06-14 Re-write of Injection for Xcode in (mostly) Swift4
* \[**2057**星]\[19d] \[ObjC] [ios-control/ios-deploy](https://github.com/ios-control/ios-deploy) ⭐ 3,635 | 🐛 45 | 🌐 Objective-C | 📅 2024-06-24 Install and debug iPhone apps from the command line, without using Xcode
...
* \[**572**星]\[1m] \[ObjC] [hdb-li/lldebugtool](https://github.com/hdb-li/lldebugtool) ⭐ 742 | 🐛 24 | 🌐 Objective-C | 📅 2024-07-16 LLDebugTool is a debugging tool for developers and testers that can help you analyze and manipulate data in non-xcode situations.
* \[**384**星]\[3m] \[JS] [johnno1962/xprobeplugin](https://github.com/johnno1962/xprobeplugin) ⭐ 398 | 🐛 0 | 🌐 Objective-C++ | 📅 2024-09-24 Live Memory Browser for Apps & Xcode
...
* \[**10966**星]\[10d] \[ObjC] [flipboard/flex](https://github.com/flipboard/flex) ⭐ 14,637 | 🐛 50 | 🌐 Objective-C | 📅 2026-06-11 An in-app debugging and exploration tool for iOS
* \[**4397**星]\[12d] \[Swift] [signalapp/signal-ios](https://github.com/signalapp/Signal-iOS) ⭐ 12,242 | 🐛 148 | 🌐 Swift | 📅 2026-09-18 A private messenger for iOS.
* \[**1215**星]\[16d] \[YARA] [horsicq/detect-it-easy](https://github.com/horsicq/detect-it-easy) ⭐ 11,560 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-19 Program for determining types of files for Windows, Linux and MacOS.
* \[**2733**星]\[26d] \[ObjC] [dantheman827/ios-app-signer](https://github.com/dantheman827/ios-app-signer) ⭐ 6,318 | 🐛 123 | 🌐 Objective-C | 📅 2026-09-17 This is an app for OS X that can (re)sign apps and bundle them into ipa files that are ready to be installed on an iOS device.
...
* \[**3686**星]\[4m] \[C] [facebook/fishhook](https://github.com/facebook/fishhook) ⭐ 5,431 | 🐛 39 | 🌐 C | 📅 2024-08-01 A library that enables dynamically rebinding symbols in Mach-O binaries running on iOS.
* \[**2867**星]\[12d] \[ObjC] [facebook/idb](https://github.com/facebook/idb) ⭐ 5,335 | 🐛 175 | 🌐 Swift | 📅 2026-09-19 idb is a flexible command line interface for automating iOS simulators and devices
* \[**2753**星]\[1m] \[Makefile] [theos/theos](https://github.com/theos/theos) ⭐ 4,918 | 🐛 72 | 🌐 Makefile | 📅 2026-09-18 A cross-platform suite of tools for building and deploying software for iOS and other platforms.
* \[**3327**星]\[3m] \[Swift] [yagiz/bagel](https://github.com/yagiz/bagel) ⭐ 4,421 | 🐛 37 | 🌐 Swift | 📅 2024-08-20 a little native network debugging tool for iOS
...
* \[**840**星]\[9d] \[JS] [cypress-io/cypress-example-recipes](https://github.com/cypress-io/cypress-example-recipes) ⭐ 3,479 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-01 Various recipes for testing common scenarios with Cypress
* \[**1442**星]\[28d] \[ObjC] [nabla-c0d3/ssl-kill-switch2](https://github.com/nabla-c0d3/ssl-kill-switch2) ⭐ 3,317 | 🐛 19 | 🌐 Objective-C | 📅 2023-07-09 Blackbox tool to disable SSL certificate validation - including certificate pinning - within iOS and OS X Apps
* \[**3071**星]\[10m] \[JS] [jipegit/osxauditor](https://github.com/jipegit/osxauditor) ⭐ 3,132 | 🐛 9 | 🌐 JavaScript | 📅 2020-07-27 OS X Auditor is a free Mac OS X computer forensics tool
* \[**1630**星]\[1m] [ivrodriguezca/re-ios-apps](https://github.com/ivrodriguezca/re-ios-apps) ⭐ 2,914 | 🐛 2 | 📅 2024-04-17 A completely free, open source and online course about Reverse Engineering iOS Applications.
* \[**310**星]\[28d] \[Swift] [securing/iossecuritysuite](https://github.com/securing/iossecuritysuite) ⭐ 2,725 | 🐛 7 | 🌐 Swift | 📅 2026-08-05 iOS platform security & anti-tampering Swift library
* \[**1801**星]\[1y] [aozhimin/ios-monitor-platform](https://github.com/aozhimin/ios-monitor-platform) ⭐ 2,620 | 🐛 23 | 📅 2018-10-13
* \[**1683**星]\[2m] \[Swift] [pmusolino/wormholy](https://github.com/pmusolino/wormholy) ⭐ 2,617 | 🐛 12 | 🌐 Swift | 📅 2026-09-17 iOS network debugging, like a wizard 🧙‍♂️
* \[**1642**星]\[7m] \[Objective-C++] [tencent/oomdetector](https://github.com/tencent/oomdetector) ⭐ 2,346 | 🐛 38 | 🌐 Objective-C++ | 📅 2023-02-21 OOMDetector is a memory monitoring component for iOS which provides you with OOM monitoring, memory allocation monitoring, memory leak detection and other functions.
* \[**462**星]\[15d] \[Java] [dsheirer/sdrtrunk](https://github.com/dsheirer/sdrtrunk) ⭐ 2,189 | 🐛 450 | 🌐 Java | 📅 2026-08-01 A cross-platform java application for decoding, monitoring, recording and streaming trunked mobile and related radio protocols using Software Defined Radios (SDR). Website:
* \[**1239**星]\[8d] \[C] [datatheorem/trustkit](https://github.com/datatheorem/trustkit) ⭐ 2,143 | 🐛 35 | 🌐 Objective-C | 📅 2026-08-12 Easy SSL pinning validation and reporting for iOS, macOS, tvOS and watchOS.
* \[**604**星]\[2m] [siguza/ios-resources](https://github.com/siguza/ios-resources) ⭐ 1,972 | 🐛 4 | 📅 2025-05-24 Useful resources for iOS hacking
...
* \[**796**星]\[13d] \[Shell] [aqzt/kjyw](https://github.com/aqzt/kjyw) ⭐ 1,868 | 🐛 7 | 🌐 Shell | 📅 2025-07-01 快捷运维，代号kjyw，项目基于shell、python，运维脚本工具库，收集各类运维常用工具脚本，实现快速安装nginx、mysql、php、redis、nagios、运维经常使用的脚本等等...
* \[**1299**星]\[6m] \[JS] [feross/spoof](https://github.com/feross/spoof) ⭐ 1,866 | 🐛 14 | 🌐 JavaScript | 📅 2020-11-05 Easily spoof your MAC address in macOS, Windows, & Linux!
* \[**1113**星]\[1y] \[ObjC] [neoneggplant/eggshell](https://github.com/neoneggplant/eggshell) ⭐ 1,770 | 🐛 56 | 🌐 Objective-C | 📅 2021-03-25 iOS/macOS/Linux Remote Administration Tool
* \[**1252**星]\[17d] [michalmalik/osx-re-101](https://github.com/michalmalik/osx-re-101) ⭐ 1,731 | 🐛 1 | 📅 2019-12-19 OSX/iOS逆向资源收集
...
* \[**263**星]\[14d] \[ObjC] [strongbox-password-safe/strongbox](https://github.com/strongbox-password-safe/strongbox) ⭐ 1,464 | 🐛 230 | 🌐 Objective-C | 📅 2026-07-17 A KeePass/Password Safe Client for iOS and OS X
* \[**346**星]\[4m] \[TS] [bacher09/pwgen-for-bios](https://github.com/bacher09/pwgen-for-bios) ⭐ 1,446 | 🐛 184 | 🌐 TypeScript | 📅 2026-02-05 Password generator for BIOS
* \[**907**星]\[4m] \[ObjC] [ptoomey3/keychain-dumper](https://github.com/ptoomey3/keychain-dumper) ⭐ 1,423 | 🐛 19 | 🌐 Objective-C | 📅 2024-08-15 A tool to check which keychain items are available to an attacker once an iOS device has been jailbroken
* \[**396**星]\[4m] [ansjdnakjdnajkd/ios](https://github.com/ansjdnakjdnajkd/ios) ⭐ 1,316 | 🐛 0 | 📅 2023-11-06 iOS渗透测试最有用的工具
...
* \[**662**星]\[1y] \[Py] [deepzec/bad-pdf](https://github.com/deepzec/bad-pdf) ⭐ 1,157 | 🐛 2 | 🌐 Python | 📅 2025-10-20 create malicious PDF file to steal NTLM(NTLMv1/NTLMv2) Hashes from windows machines
* \[**1001**星]\[2m] \[ObjC] [lmirosevic/gbdeviceinfo](https://github.com/lmirosevic/gbdeviceinfo) ⭐ 1,142 | 🐛 1 | 🌐 Objective-C | 📅 2026-09-16 Detects the hardware, software and display of the current iOS or Mac OS X device at runtime.
* \[**430**星]\[11m] [captainarash/the\_holy\_book\_of\_x86](https://github.com/captainarash/the_holy_book_of_x86) ⭐ 979 | 🐛 0 | 📅 2019-01-27 A simple guide to x86 architecture, assembly, memory management, paging, segmentation, SMM, BIOS....
* \[**651**星]\[9m] \[ObjC] [chenxiancai/stcobfuscator](https://github.com/chenxiancai/stcobfuscator) ⭐ 823 | 🐛 28 | 🌐 Objective-C | 📅 2019-03-25 iOS全局自动化 代码混淆 工具！支持cocoapod组件代码一并 混淆，完美避开hardcode方法、静态库方法和系统库方法！
* \[**482**星]\[1y] \[Swift] [icepa/icepa](https://github.com/icepa/icepa) ⭐ 771 | 🐛 1 | 🌐 Swift | 📅 2024-06-02 iOS system-wide VPN based Tor client
* \[**322**星]\[2m] \[ObjC] [auth0/simplekeychain](https://github.com/auth0/simplekeychain) ⭐ 726 | 🐛 5 | 🌐 Swift | 📅 2026-09-18 A Keychain helper for iOS to make it very simple to store/obtain values from iOS Keychain
* \[**471**星]\[8m] \[C++] [everettjf/machoexplorer](https://github.com/everettjf/machoexplorer) ⭐ 639 | 🐛 0 | 🌐 C++ | 📅 2026-08-23 MachO文件查看器，支持Windows和macOS
* \[**238**星]\[4m] \[Swift] [shadowsocksr-live/ishadowsocksr](https://github.com/shadowsocksr-live/ishadowsocksr) ⭐ 602 | 🐛 12 | 🌐 C | 📅 2024-04-29 ShadowsocksR for iOS, come from
* \[**349**星]\[19d] \[C] [jedisct1/swift-sodium](https://github.com/jedisct1/swift-sodium) ⭐ 553 | 🐛 1 | 🌐 C | 📅 2026-05-04 Safe and easy to use crypto for iOS and macOS
* \[**340**星]\[3m] \[C] [trailofbits/cb-multios](https://github.com/trailofbits/cb-multios) ⭐ 542 | 🐛 26 | 🌐 C | 📅 2023-06-29 DARPA Challenges Sets for Linux, Windows, and macOS
...
* \[**371**星]\[18d] \[Shell] [matthewpierson/1033-ota-downgrader](https://github.com/matthewpierson/1033-ota-downgrader) ⭐ 503 | 🐛 43 | 🌐 Shell | 📅 2019-12-13 First ever tool to downgrade ANY iPhone 5s, ANY iPad Air and (almost any) iPad Mini 2 to 10.3.3 with OTA blobs + checkm8!
...
* \[**219**星]\[6m] \[ObjC] [rickyzhang82/tethering](https://github.com/rickyzhang82/tethering) ⭐ 368 | 🐛 0 | 🌐 Objective-C | 📅 2025-08-25 Proxy and DNS Server on iOS
...
* \[**211**星]\[13d] \[TS] [bevry/getmac](https://github.com/bevry/getmac) ⭐ 359 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-13 Get the mac address of the current machine you are on via Node.js
...
* \[**244**星]\[7m] \[JS] [we11cheng/wcshadowrocket](https://github.com/we11cheng/wcshadowrocket) ⭐ 353 | 🐛 9 | 🌐 JavaScript | 📅 2021-05-18 iOS Shadowrocket(砸壳重签,仅供参考,添加节点存在问题)。另一个fq项目potatso源码参见:
...
* \[**239**星]\[1y] \[ObjC] [lmirosevic/gbping](https://github.com/lmirosevic/gbping) ⭐ 275 | 🐛 18 | 🌐 Objective-C | 📅 2019-03-20 Highly accurate ICMP Ping controller for iOS
...
* \[**308**星]\[2m] \[Py] [hatching/vmcloak](https://github.com/hatching/vmcloak) ⭐ 521 | 🐛 65 | 🌐 Python | 📅 2024-05-14 Automated Virtual Machine Generation and Cloaking for Cuckoo Sandbox.
* \[**225**星]\[1y] \[PHP] [cuckoosandbox/monitor](https://github.com/cuckoosandbox/monitor) ⭐ 354 | 🐛 46 | 🌐 PHP | 📅 2024-06-28 The new Cuckoo Monitor.
* \[**238**星]\[7m] \[Py] [cuckoosandbox/community](https://github.com/cuckoosandbox/community) ⭐ 339 | 🐛 134 | 🌐 Python | 📅 2023-02-22 Repository of modules and signatures contributed by the community
...
* \[**1228**星]\[12d] \[C] [dynamorio/dynamorio](https://github.com/dynamorio/dynamorio) ⭐ 3,162 | 🐛 1,811 | 🌐 C | 📅 2026-09-19 Dynamic Instrumentation Tool Platform
* \[**1388**星]\[12d] \[C] [dynamorio/drmemory](https://github.com/dynamorio/drmemory) ⭐ 2,747 | 🐛 1,047 | 🌐 C | 📅 2025-12-13 Memory Debugger for Windows, Linux, Mac, and Android

#### <a id="ff0abe26a37095f6575195950e0b7f94"></a>新添加的

* \[**1364**星]\[3m] \[C] [googleprojectzero/winafl](https://github.com/googleprojectzero/winafl) ⭐ 2,607 | 🐛 170 | 🌐 C | 📅 2026-03-13 A fork of AFL for fuzzing Windows binaries
...
* \[**4516**星]\[13d] \[Makefile] [frida/frida](https://github.com/frida/frida) ⭐ 21,976 | 🐛 1,964 | 🌐 Meson | 📅 2026-09-16 Clone this repo to build Frida
...
* \[**332**星]\[15d] \[JS] [chichou/bagbak](https://github.com/ChiChou/bagbak) ⭐ 1,503 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-24 Yet another frida based iOS dumpdecrypted, works on iOS 13 with checkra1n and supports decrypting app extensions
* \[**559**星]\[1m] \[JS] [nccgroup/house](https://github.com/nccgroup/house) ⭐ 1,466 | 🐛 16 | 🌐 JavaScript | 📅 2021-06-03 运行时手机 App 分析工具包, 带Web GUI
* \[**645**星]\[16d] \[Py] [igio90/dwarf](https://github.com/igio90/dwarf) ⭐ 1,319 | 🐛 5 | 🌐 Python | 📅 2024-05-16 Full featured multi arch/os debugger built on top of PyQt5 and frida
* \[**243**星]\[19d] \[JS] [frenchyeti/dexcalibur](https://github.com/frenchyeti/dexcalibur) ⭐ 1,173 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-18 Dynamic binary instrumentation tool designed for Android application and powered by Frida. It disassembles dex, analyzes it statically, generates hooks, discovers reflected methods, stores intercepted data and does new things from it. Its aim is to be an all-in-one Android reverse engineering platform.
* \[**228**星]\[13d] \[C] [frida/frida-gum](https://github.com/frida/frida-gum) ⭐ 1,019 | 🐛 211 | 🌐 C | 📅 2026-09-16 Low-level code instrumentation library used by frida-core
* \[**420**星]\[13d] \[C] [frida/frida-python](https://github.com/frida/frida-python) ⭐ 873 | 🐛 56 | 🌐 Python | 📅 2026-09-17 Frida Python bindings
...
* \[**321**星]\[1m] \[C] [frida/frida-core](https://github.com/frida/frida-core) ⭐ 771 | 🐛 149 | 🌐 Vala | 📅 2026-09-18 Frida core library intended for static linking into bindings
...
* \[**584**星]\[1y] \[Java] [federicodotta/brida](https://github.com/federicodotta/brida) ⭐ 1,895 | 🐛 11 | 🌐 Java | 📅 2025-10-30 The new bridge between Burp Suite and Frida!
...
* \[**378**星]\[27d] \[JS] [nowsecure/r2frida](https://github.com/nowsecure/r2frida) ⭐ 1,440 | 🐛 46 | 🌐 TypeScript | 📅 2026-09-19 Radare2 and Frida better together.
...
* \[**578**星]\[1y] \[C++] [qbdi/qbdi](https://github.com/QBDI/QBDI) ⭐ 1,818 | 🐛 20 | 🌐 C++ | 📅 2026-09-02 A Dynamic Binary Instrumentation framework based on LLVM.
...
* \[**14349**星]\[2m] \[Py] [corentinj/real-time-voice-cloning](https://github.com/corentinj/real-time-voice-cloning) ⭐ 60,143 | 🐛 177 | 🌐 Python | 📅 2026-03-09 Clone a voice in 5 seconds to generate arbitrary speech in real-time
* \[**2687**星]\[11d] \[Go] [adguardteam/adguardhome](https://github.com/adguardteam/adguardhome) ⭐ 36,990 | 🐛 1,256 | 🌐 TypeScript | 📅 2026-09-18 Network-wide ads & trackers blocking DNS server
* \[**10378**星]\[11d] \[Go] [goharbor/harbor](https://github.com/goharbor/harbor) ⭐ 29,417 | 🐛 902 | 🌐 Go | 📅 2026-09-18 An open source trusted cloud native registry project that stores, signs, and scans content.
* \[**19766**星]\[3m] \[Jupyter Notebook] [camdavidsonpilon/probabilistic-programming-and-bayesian-methods-for-hackers](https://github.com/camdavidsonpilon/probabilistic-programming-and-bayesian-methods-for-hackers) ⭐ 28,192 | 🐛 203 | 🌐 Jupyter Notebook | 📅 2024-06-25 aka "Bayesian Methods for Hackers": An introduction to Bayesian methods + probabilistic programming with a computation/understanding-first, mathematics-second point of view. All in pure Python ;)
* \[**5420**星]\[12d] \[Py] [mlflow/mlflow](https://github.com/mlflow/mlflow) ⭐ 28,048 | 🐛 2,120 | 🌐 Python | 📅 2026-09-20 Open source platform for the machine learning lifecycle
* \[**11402**星]\[10d] \[Java] [oracle/graal](https://github.com/oracle/graal) ⭐ 21,705 | 🐛 848 | 🌐 Java | 📅 2026-09-18 Run Programs Faster Anywhere
* \[**7020**星]\[14d] \[Go] [nats-io/nats-server](https://github.com/nats-io/nats-server) ⭐ 20,751 | 🐛 473 | 🌐 Go | 📅 2026-09-19 High-Performance server for NATS, the cloud native messaging system.
* \[**5753**星]\[18d] \[Go] [casbin/casbin](https://github.com/casbin/casbin) ⭐ 20,399 | 🐛 38 | 🌐 Go | 📅 2026-09-11 An authorization library that supports access control models like ACL, RBAC, ABAC in Golang
* \[**3608**星]\[9d] \[Pascal] [cheat-engine/cheat-engine](https://github.com/cheat-engine/cheat-engine) ⭐ 19,189 | 🐛 1,310 | 🌐 Pascal | 📅 2025-04-19 Cheat Engine. A development environment focused on modding
* \[**4610**星]\[1y] \[C] [upx/upx](https://github.com/upx/upx) ⭐ 17,883 | 🐛 21 | 🌐 C++ | 📅 2026-09-18 UPX - the Ultimate Packer for eXecutables
* \[**5226**星]\[13d] \[Shell] [denisidoro/navi](https://github.com/denisidoro/navi) ⭐ 17,573 | 🐛 111 | 🌐 Rust | 📅 2026-09-15 An interactive cheatsheet tool for the command-line
* \[**11213**星]\[2m] \[Jupyter Notebook] [selfteaching/the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 16,826 | 🐛 200 | 🌐 Jupyter Notebook | 📅 2026-05-20 One has no future if one couldn't teach themself.
* \[**2815**星]\[20d] \[C] [processhacker/processhacker](https://github.com/processhacker/processhacker) ⭐ 16,047 | 🐛 289 | 🌐 C | 📅 2026-09-16 A free, powerful, multi-purpose tool that helps you monitor system resources, debug software and detect malware.
* \[**3295**星]\[15d] \[JS] [koenkk/zigbee2mqtt](https://github.com/koenkk/zigbee2mqtt) ⭐ 15,653 | 🐛 456 | 🌐 TypeScript | 📅 2026-09-19 Zigbee
* \[**6894**星]\[2m] \[Go] [sqshq/sampler](https://github.com/sqshq/sampler) ⭐ 14,802 | 🐛 62 | 🌐 Go | 📅 2024-02-22 A tool for shell commands execution, visualization and alerting. Configured with a simple YAML file.
* \[**7748**星]\[10d] \[Go] [git-lfs/git-lfs](https://github.com/git-lfs/git-lfs) ⭐ 14,506 | 🐛 480 | 🌐 Go | 📅 2026-09-02 Git extension for versioning large files
* \[**5116**星]\[11d] \[ASP] [hq450/fancyss](https://github.com/hq450/fancyss) ⭐ 13,766 | 🐛 225 | 🌐 Shell | 📅 2026-06-01 fancyss is a project providing tools to across the GFW on asuswrt/merlin based router.
* \[**3129**星]\[13d] \[C] [qemu/qemu](https://github.com/qemu/qemu) ⭐ 13,739 | 🐛 0 | 🌐 C | 📅 2026-09-20 Official QEMU mirror. Please see
* \[**5229**星]\[4m] \[Py] [ytisf/thezoo](https://github.com/ytisf/thezoo) ⭐ 13,398 | 🐛 89 | 🌐 Python | 📅 2026-09-14 A repository of LIVE malwares for your own joy and pleasure. theZoo is a project created to make the possibility of malware analysis open and available to the public.
* \[**2344**星]\[16d] \[C] [tsl0922/ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,391 | 🐛 116 | 🌐 C | 📅 2026-08-12 Share your terminal over the web
* \[**3980**星]\[1m] \[Rust] [svenstaro/genact](https://github.com/svenstaro/genact) ⭐ 12,197 | 🐛 16 | 🌐 Rust | 📅 2026-09-01 a nonsense activity generator
* \[**3505**星]\[16d] \[C] [cyan4973/xxhash](https://github.com/cyan4973/xxhash) ⭐ 11,267 | 🐛 7 | 🌐 C | 📅 2026-09-20 Extremely fast non-cryptographic hash algorithm
* \[**2993**星]\[18d] \[Py] [quantaxis/quantaxis](https://github.com/quantaxis/quantaxis) ⭐ 11,211 | 🐛 240 | 🌐 Python | 📅 2026-09-18 支持任务调度 分布式部署的 股票/期货/自定义市场 数据/回测/模拟/交易/可视化 纯本地PAAS量化解决方案
* \[**4003**星]\[11d] \[Go] [dexidp/dex](https://github.com/dexidp/dex) ⭐ 11,105 | 🐛 547 | 🌐 Go | 📅 2026-09-18 OpenID Connect Identity (OIDC) and OAuth 2.0 Provider with Pluggable Connectors
* \[**3908**星]\[12d] \[C++] [baldurk/renderdoc](https://github.com/baldurk/renderdoc) ⭐ 11,104 | 🐛 50 | 🌐 C++ | 📅 2026-09-18 RenderDoc is a stand-alone graphics debugging tool.
* \[**2053**星]\[24d] \[C#] [mathewsachin/captura](https://github.com/mathewsachin/captura) ⭐ 10,835 | 🐛 116 | 🌐 C# | 📅 2026-05-25 Capture Screen, Audio, Cursor, Mouse Clicks and Keystrokes
* \[**2627**星]\[23d] \[JS] [popcorn-official/popcorn-desktop](https://github.com/popcorn-official/popcorn-desktop) ⭐ 10,685 | 🐛 65 | 🌐 TypeScript | 📅 2026-09-04 Popcorn Time is a multi-platform, free software BitTorrent client that includes an integrated media player. Desktop ( Windows / Mac / Linux ) a Butter-Project Fork
* \[**4597**星]\[12d] \[C++] [mozilla/rr](https://github.com/mozilla/rr) ⭐ 10,652 | 🐛 481 | 🌐 C++ | 📅 2026-09-19 记录与重放App的调试执行过程
* \[**5751**星]\[9m] \[C] [xoreaxeaxeax/movfuscator](https://github.com/xoreaxeaxeax/movfuscator) ⭐ 10,507 | 🐛 25 | 🌐 C | 📅 2024-05-29 C编译器，编译的二进制文件只有1个代码块。
* \[**2718**星]\[3m] \[Py] [drivendata/cookiecutter-data-science](https://github.com/drivendata/cookiecutter-data-science) ⭐ 10,068 | 🐛 34 | 🌐 Python | 📅 2026-08-07 A logical, reasonably standardized, but flexible project structure for doing and sharing data science work.
* \[**4857**星]\[13d] \[Go] [gcla/termshark](https://github.com/gcla/termshark) ⭐ 10,016 | 🐛 51 | 🌐 Go | 📅 2024-04-30 A terminal UI for tshark, inspired by Wireshark
* \[**3289**星]\[15d] \[C] [virustotal/yara](https://github.com/virustotal/yara) ⭐ 9,881 | 🐛 172 | 🌐 C | 📅 2026-08-25 The pattern matching swiss knife
* \[**5876**星]\[3m] \[Gnuplot] [nasa-jpl/open-source-rover](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,657 | 🐛 15 | 🌐 HTML | 📅 2026-09-03 A build-it-yourself, 6-wheel rover based on the rovers on Mars!
* \[**5717**星]\[28d] \[JS] [swagger-api/swagger-editor](https://github.com/swagger-api/swagger-editor) ⭐ 9,463 | 🐛 30 | 🌐 JavaScript | 📅 2026-09-19 Swagger Editor
* \[**3108**星]\[1m] \[C] [unicorn-engine/unicorn](https://github.com/unicorn-engine/unicorn) ⭐ 9,354 | 🐛 217 | 🌐 C | 📅 2026-08-28 Unicorn CPU emulator framework (ARM, AArch64, M68K, Mips, Sparc, X86)
* \[**6353**星]\[2m] \[Py] [seatgeek/fuzzywuzzy](https://github.com/seatgeek/fuzzywuzzy) ⚠️ Archived Fuzzy String Matching in Python
* \[**3188**星]\[11d] \[C] [meetecho/janus-gateway](https://github.com/meetecho/janus-gateway) ⭐ 9,168 | 🐛 45 | 🌐 C | 📅 2026-09-15 Janus WebRTC Server
* \[**3960**星]\[11d] \[Py] [angr/angr](https://github.com/angr/angr) ⭐ 9,101 | 🐛 721 | 🌐 Python | 📅 2026-09-19 A powerful and user-friendly binary analysis platform!
* \[**3939**星]\[15d] \[C] [aquynh/capstone](https://github.com/aquynh/capstone) ⭐ 9,032 | 🐛 355 | 🌐 C | 📅 2026-09-19 Capstone disassembly/disassembler framework: Core (Arm, Arm64, BPF, EVM, M68K, M680X, MOS65xx, Mips, PPC, RISCV, Sparc, SystemZ, TMS320C64x, Web Assembly, X86, X86\_64, XCore) + bindings.
* \[**3844**星]\[2m] \[ObjC] [sveinbjornt/sloth](https://github.com/sveinbjornt/sloth) ⭐ 8,964 | 🐛 2 | 🌐 Objective-C | 📅 2026-08-30 Mac app that shows all open files, directories and sockets in use by all running processes. Nice GUI for lsof.
* \[**3451**星]\[19d] \[C] [mikebrady/shairport-sync](https://github.com/mikebrady/shairport-sync) ⭐ 8,860 | 🐛 12 | 🌐 C | 📅 2026-09-18 AirPlay audio player. Shairport Sync adds multi-room capability with Audio Synchronisation
* \[**2587**星]\[10d] \[C] [esnet/iperf](https://github.com/esnet/iperf) ⭐ 8,769 | 🐛 238 | 🌐 C | 📅 2026-07-10 A TCP, UDP, and SCTP network bandwidth measurement tool
* \[**4651**星]\[13d] [powershell/win32-openssh](https://github.com/powershell/win32-openssh) ⭐ 8,282 | 🐛 410 | 📅 2026-09-15 Win32 port of OpenSSH
* \[**4541**星]\[4m] \[TS] [apis-guru/graphql-voyager](https://github.com/apis-guru/graphql-voyager) ⭐ 8,171 | 🐛 106 | 🌐 TypeScript | 📅 2026-05-12
* \[**3306**星]\[19d] \[C] [microsoft/windows-driver-samples](https://github.com/microsoft/windows-driver-samples) ⭐ 7,848 | 🐛 129 | 🌐 C | 📅 2026-09-18 This repo contains driver samples prepared for use with Microsoft Visual Studio and the Windows Driver Kit (WDK). It contains both Universal Windows Driver and desktop-only driver samples.
* \[**2948**星]\[1m] \[C] [libfuse/sshfs](https://github.com/libfuse/sshfs) ⭐ 7,671 | 🐛 61 | 🌐 C | 📅 2026-09-16 A network filesystem client to connect to SSH servers
* \[**4314**星]\[15d] \[Rust] [timvisee/ffsend](https://github.com/timvisee/ffsend) ⭐ 7,414 | 🐛 33 | 🌐 Rust | 📅 2025-11-20 Easily and securely share files from the command line
* \[**4747**星]\[8d] \[C++] [paddlepaddle/paddle-lite](https://github.com/PaddlePaddle/Paddle-Lite) ⭐ 7,276 | 🐛 47 | 🌐 C++ | 📅 2026-04-27 Multi-platform high performance deep learning inference engine (『飞桨』多平台高性能深度学习预测引擎）
...
* \[**2194**星]\[13d] \[C] [armmbed/mbedtls](https://github.com/armmbed/mbedtls) ⭐ 6,963 | 🐛 1,725 | 🌐 C | 📅 2026-09-17 An open source, portable, easy to use, readable and flexible SSL library
* \[**6454**星]\[9m] \[HTML] [open-power-workgroup/hospital](https://github.com/open-power-workgroup/hospital) ⭐ 6,709 | 🐛 48 | 🌐 HTML | 📅 2020-10-27 OpenPower工作组收集汇总的医院开放数据
* \[**2621**星]\[2m] [pditommaso/awesome-pipeline](https://github.com/pditommaso/awesome-pipeline) ⭐ 6,626 | 🐛 34 | 📅 2026-09-19 A curated list of awesome pipeline toolkits inspired by Awesome Sysadmin
...
* \[**2854**星]\[1m] \[Py] [espressif/esptool](https://github.com/espressif/esptool) ⭐ 6,482 | 🐛 14 | 🌐 Python | 📅 2026-09-18 ESP8266 and ESP32 serial bootloader utility
* \[**1698**星]\[21d] \[C++] [microsoft/detours](https://github.com/microsoft/detours) ⭐ 6,383 | 🐛 94 | 🌐 C++ | 📅 2026-08-24 Detours is a software package for monitoring and instrumenting API calls on Windows. It is distributed in source code form.
* \[**408**星]\[19d] \[Py] [crytic/slither](https://github.com/crytic/slither) ⭐ 6,364 | 🐛 478 | 🌐 Python | 📅 2026-09-09 Static Analyzer for Solidity
* \[**5007**星]\[2m] \[Py] [snare/voltron](https://github.com/snare/voltron) ⭐ 6,342 | 🐛 85 | 🌐 Python | 📅 2025-01-30 A hacky debugger UI for hackers
* \[**3233**星]\[25d] \[C] [tmate-io/tmate](https://github.com/tmate-io/tmate) ⭐ 6,127 | 🐛 129 | 🌐 C | 📅 2026-07-29 Instant Terminal Sharing
* \[**3690**星]\[21d] \[JS] [lesspass/lesspass](https://github.com/lesspass/lesspass) ⭐ 6,062 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-13
...
* \[**3768**星]\[2m] \[Go] [microsoft/ethr](https://github.com/microsoft/ethr) ⭐ 5,868 | 🐛 51 | 🌐 Go | 📅 2026-07-03 Ethr is a Network Performance Measurement Tool for TCP, UDP & HTTP.
* \[**2631**星]\[8m] [leandromoreira/linux-network-performance-parameters](https://github.com/leandromoreira/linux-network-performance-parameters) ⭐ 5,821 | 🐛 3 | 📅 2026-06-03 Learn where some of the network sysctl variables fit into the Linux/Kernel network flow
* \[**3120**星]\[11d] \[Go] [tencent/bk-cmdb](https://github.com/tencent/bk-cmdb) ⭐ 5,750 | 🐛 92 | 🌐 Go | 📅 2026-09-15 蓝鲸智云配置平台(BlueKing CMDB)
* \[**2092**星]\[26d] [swiftonsecurity/sysmon-config](https://github.com/swiftonsecurity/sysmon-config) ⭐ 5,652 | 🐛 82 | 📅 2024-07-03 Sysmon configuration file template with default high-quality event tracing
* \[**1930**星]\[22d] \[C++] [mhammond/pywin32](https://github.com/mhammond/pywin32) ⭐ 5,605 | 🐛 397 | 🌐 C++ | 📅 2026-09-08 Python for Windows (pywin32) Extensions
* \[**1620**星]\[16d] \[C++] [lief-project/lief](https://github.com/lief-project/lief) ⭐ 5,566 | 🐛 33 | 🌐 C++ | 📅 2026-09-06 Library to Instrument Executable Formats
* \[**2211**星]\[1m] \[C++] [google/bloaty](https://github.com/google/bloaty) ⭐ 5,547 | 🐛 73 | 🌐 C++ | 📅 2026-09-10 Bloaty McBloatface: a size profiler for binaries
* \[**2898**星]\[8m] \[C] [p-h-c/phc-winner-argon2](https://github.com/p-h-c/phc-winner-argon2) ⭐ 5,372 | 🐛 102 | 🌐 C | 📅 2024-08-06 The password hash Argon2, winner of PHC
* \[**2833**星]\[2m] \[Assembly] [cirosantilli/x86-bare-metal-examples](https://github.com/cirosantilli/x86-bare-metal-examples) ⭐ 5,368 | 🐛 7 | 🌐 Assembly | 📅 2022-07-18 几十个用于学习 x86 系统编程的小型操作系统
* \[**2872**星]\[14d] \[C] [lxc/lxc](https://github.com/lxc/lxc) ⭐ 5,262 | 🐛 151 | 🌐 C | 📅 2026-09-07 LXC - Linux Containers
* \[**1816**星]\[29d] \[Go] [gdamore/tcell](https://github.com/gdamore/tcell) ⭐ 5,218 | 🐛 10 | 🌐 Go | 📅 2026-09-15 Tcell is an alternate terminal package, similar in some ways to termbox, but better in others.
* \[**3131**星]\[2m] \[CSS] [readthedocs/sphinx\_rtd\_theme](https://github.com/readthedocs/sphinx_rtd_theme) ⭐ 5,087 | 🐛 276 | 🌐 Sass | 📅 2026-01-12 Sphinx theme for readthedocs.org
* \[**2093**星]\[10d] \[C] [flatpak/flatpak](https://github.com/flatpak/flatpak) ⭐ 5,068 | 🐛 1,023 | 🌐 C | 📅 2026-09-19 Linux application sandboxing and distribution framework
...
* \[**2132**星]\[20d] [goq/telegram-list](https://github.com/goq/telegram-list) ⭐ 4,976 | 🐛 23 | 📅 2026-08-30 List of telegram groups, channels & bots // Список интересных групп, каналов и ботов телеграма // Список чатов для программистов
* \[**2391**星]\[21d] \[Java] [mock-server/mockserver](https://github.com/mock-server/mockserver) ⭐ 4,973 | 🐛 0 | 🌐 Java | 📅 2026-09-20 MockServer enables easy mocking of any system you integrate with via HTTP or HTTPS with clients written in Java, JavaScript and Ruby. MockServer also includes a proxy that introspects all proxied traffic including encrypted SSL traffic and supports Port Forwarding, Web Proxying (i.e. HTTP proxy), HTTPS Tunneling Proxying (using HTTP CONNECT) and…
* \[**2137**星]\[19d] \[Assembly] [pret/pokered](https://github.com/pret/pokered) ⭐ 4,933 | 🐛 22 | 🌐 Assembly | 📅 2026-08-27 disassembly of Pokémon Red/Blue
...
* \[**1761**星]\[13d] \[C] [google/wuffs](https://github.com/google/wuffs) ⭐ 4,841 | 🐛 37 | 🌐 C | 📅 2026-09-16 Wrangling Untrusted File Formats Safely
* \[**3749**星]\[12d] \[Go] [hashicorp/consul-template](https://github.com/hashicorp/consul-template) ⭐ 4,823 | 🐛 230 | 🌐 Go | 📅 2026-09-11 Template rendering, notifier, and supervisor for
* \[**3202**星]\[1y] \[Shell] [toyodadoubi/doubi](https://github.com/toyodadoubi/doubi) ⭐ 4,685 | 🐛 13 | 🌐 Shell | 📅 2020-10-20 一个逗比写的各种逗比脚本\~
...
* \[**2003**星]\[2m] \[C++] [asmjit/asmjit](https://github.com/asmjit/asmjit) ⭐ 4,605 | 🐛 19 | 🌐 C++ | 📅 2026-09-15 Complete x86/x64 JIT and AOT Assembler for C++
* \[**2340**星]\[2m] \[JS] [pa11y/pa11y](https://github.com/pa11y/pa11y) ⭐ 4,533 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-07 Pa11y is your automated accessibility testing pal
...
* \[**4258**星]\[12m] \[JS] [butterproject/butter-desktop](https://github.com/butterproject/butter-desktop) ⭐ 4,251 | 🐛 80 | 🌐 JavaScript | 📅 2020-11-01 All the free parts of Popcorn Time
* \[**2535**星]\[3m] \[Java] [jboss-javassist/javassist](https://github.com/jboss-javassist/javassist) ⭐ 4,229 | 🐛 252 | 🌐 Java | 📅 2026-09-02 Java bytecode engineering toolkit
...
* \[**2848**星]\[6m] \[Py] [instantbox/instantbox](https://github.com/instantbox/instantbox) ⭐ 4,172 | 🐛 8 | 🌐 Python | 📅 2024-03-12 Get a clean, ready-to-go Linux box in seconds.
* \[**1714**星]\[1m] \[Go] [hashicorp/memberlist](https://github.com/hashicorp/memberlist) ⭐ 4,108 | 🐛 100 | 🌐 Go | 📅 2026-09-16 Golang package for gossip based membership and failure detection
* \[**1779**星]\[29d] [17mon/china\_ip\_list](https://github.com/17mon/china_ip_list) ⭐ 4,096 | 🐛 19 | 📅 2025-03-04
* \[**2052**星]\[13d] \[C++] [openthread/openthread](https://github.com/openthread/openthread) ⭐ 4,034 | 🐛 158 | 🌐 C++ | 📅 2026-09-18 OpenThread released by Google is an open-source implementation of the Thread networking protocol
* \[**2217**星]\[14d] \[Go] [google/mtail](https://github.com/google/mtail) ⭐ 4,031 | 🐛 59 | 🌐 Go | 📅 2026-03-19 extract whitebox monitoring data from application logs for collection in a timeseries database
* \[**3280**星]\[29d] \[Java] [oldmanpushcart/greys-anatomy](https://github.com/oldmanpushcart/greys-anatomy) ⭐ 4,003 | 🐛 75 | 🌐 Java | 📅 2022-10-25 Java诊断工具
* \[**1668**星]\[3m] \[Py] [boppreh/keyboard](https://github.com/boppreh/keyboard) ⭐ 3,969 | 🐛 414 | 🌐 Python | 📅 2026-07-10 Hook and simulate global keyboard events on Windows and Linux.
* \[**1727**星]\[8d] \[TSQL] [brentozarultd/sql-server-first-responder-kit](https://github.com/brentozarultd/sql-server-first-responder-kit) ⭐ 3,905 | 🐛 2 | 🌐 TSQL | 📅 2026-09-19 sp\_Blitz, sp\_BlitzCache, sp\_BlitzFirst, sp\_BlitzIndex, and other SQL Server scripts for health checks and performance tuning.
* \[**1899**星]\[25d] \[C++] [acidanthera/lilu](https://github.com/acidanthera/Lilu) ⭐ 3,859 | 🐛 0 | 🌐 C | 📅 2026-03-20 Arbitrary kext and process patching on macOS
...
* \[**1637**星]\[12d] \[JS] [efforg/privacybadger](https://github.com/efforg/privacybadger) ⭐ 3,845 | 🐛 133 | 🌐 JavaScript | 📅 2026-09-18 Privacy Badger is a browser extension that automatically learns to block invisible trackers.
* \[**2364**星]\[10d] \[C] [domoticz/domoticz](https://github.com/domoticz/domoticz) ⭐ 3,810 | 🐛 25 | 🌐 C++ | 📅 2026-09-16 monitor and configure various devices like: Lights, Switches, various sensors/meters like Temperature, Rain, Wind, UV, Electra, Gas, Water and much more
* \[**2031**星]\[10m] \[C] [dekunukem/nintendo\_switch\_reverse\_engineering](https://github.com/dekunukem/nintendo_switch_reverse_engineering) ⭐ 3,784 | 🐛 92 | 🌐 C | 📅 2026-08-21 A look at inner workings of Joycon and Nintendo Switch
...
* \[**2760**星]\[10d] \[TS] [webhintio/hint](https://github.com/webhintio/hint) ⭐ 3,703 | 🐛 531 | 🌐 TypeScript | 📅 2026-07-21
* \[**2474**星]\[25d] \[JS] [vitaly-t/pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,552 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-20 PostgreSQL interface for Node.js
* \[**1722**星]\[4m] \[Py] [anorov/cloudflare-scrape](https://github.com/anorov/cloudflare-scrape) ⭐ 3,538 | 🐛 128 | 🌐 Python | 📅 2023-10-14 A Python module to bypass Cloudflare's anti-bot page.
* \[**3219**星]\[2m] \[TS] [google/incremental-dom](https://github.com/google/incremental-dom) ⚠️ Archived An in-place DOM diffing library
* \[**3052**星]\[4m] \[C++] [google/robotstxt](https://github.com/google/robotstxt) ⭐ 3,471 | 🐛 13 | 🌐 C++ | 📅 2026-04-01 The repository contains Google's robots.txt parser and matcher as a C++ library (compliant to C++11).
* \[**1781**星]\[26d] \[PHP] [ezyang/htmlpurifier](https://github.com/ezyang/htmlpurifier) ⭐ 3,354 | 🐛 131 | 🌐 PHP | 📅 2026-09-15 Standards compliant HTML filter written in PHP
* \[**1624**星]\[9m] \[JS] [localtunnel/server](https://github.com/localtunnel/server) ⭐ 3,320 | 🐛 93 | 🌐 JavaScript | 📅 2024-03-20 server for localtunnel.me
* \[**1863**星]\[10d] \[C++] [pytorch/glow](https://github.com/pytorch/glow) ⚠️ Archived Compiler for Neural Network hardware accelerators
* \[**1877**星]\[25d] \[Java] [adoptopenjdk/jitwatch](https://github.com/adoptopenjdk/jitwatch) ⭐ 3,311 | 🐛 20 | 🌐 Java | 📅 2026-09-18 Log analyser / visualiser for Java HotSpot JIT compiler. Inspect inlining decisions, hot methods, bytecode, and assembly. View results in the JavaFX user interface.
...
* \[**637**星]\[21d] \[PS] [olafhartong/sysmon-modular](https://github.com/olafhartong/sysmon-modular) ⭐ 3,134 | 🐛 49 | 🌐 Go | 📅 2026-09-18 sysmon配置模块收集
* \[**1949**星]\[17d] \[C] [microsoft/procdump-for-linux](https://github.com/microsoft/procdump-for-linux) ⭐ 3,084 | 🐛 22 | 🌐 C | 📅 2026-09-14 Linux 版本的 ProcDump
* \[**2808**星]\[10m] \[Py] [plasma-disassembler/plasma](https://github.com/plasma-disassembler/plasma) ⭐ 3,070 | 🐛 15 | 🌐 Python | 📅 2021-08-31 Plasma is an interactive disassembler for x86/ARM/MIPS. It can generates indented pseudo-code with colored syntax.
* \[**2260**星]\[13d] [dumb-password-rules/dumb-password-rules](https://github.com/dumb-password-rules/dumb-password-rules) ⭐ 3,021 | 🐛 62 | 🌐 Nunjucks | 📅 2026-09-08 Shaming sites with dumb password rules.
* \[**1786**星]\[1m] \[C++] [apitrace/apitrace](https://github.com/apitrace/apitrace) ⭐ 2,861 | 🐛 160 | 🌐 C++ | 📅 2026-09-17 Tools for tracing OpenGL, Direct3D, and other graphics APIs
* \[**1756**星]\[16d] \[PHP] [wordpress/wordpress-coding-standards](https://github.com/wordpress/wordpress-coding-standards) ⭐ 2,830 | 🐛 263 | 🌐 PHP | 📅 2026-09-11 PHP\_CodeSniffer rules (sniffs) to enforce WordPress coding conventions
* \[**2619**星]\[2m] \[Swift] [zhuhaow/nekit](https://github.com/zhuhaow/nekit) ⚠️ Archived A toolkit for Network Extension Framework
* \[**2053**星]\[4m] \[Go] [maxmcd/webtty](https://github.com/maxmcd/webtty) ⭐ 2,812 | 🐛 18 | 🌐 Go | 📅 2024-12-11 Share a terminal session over WebRTC
...
* \[**1851**星]\[1y] \[Java] [yeriomin/yalpstore](https://github.com/yeriomin/yalpstore) ⭐ 2,548 | 🐛 19 | 🌐 Java | 📅 2022-09-27 Download apks from Google Play Store
...
* \[**2345**星]\[4m] \[Go] [vuvuzela/vuvuzela](https://github.com/vuvuzela/vuvuzela) ⭐ 2,486 | 🐛 21 | 🌐 Go | 📅 2019-09-12 Private messaging system that hides metadata
...
* \[**1592**星]\[2m] \[ObjC] [ealeksandrov/provisionql](https://github.com/ealeksandrov/provisionql) ⭐ 2,461 | 🐛 4 | 🌐 Swift | 📅 2026-08-16 Quick Look plugin for apps and provisioning profile files
* \[**1854**星]\[19d] \[C] [github/glb-director](https://github.com/github/glb-director) ⭐ 2,456 | 🐛 33 | 🌐 C | 📅 2026-09-14 GitHub Load Balancer Director and supporting tooling.
* \[**1761**星]\[1y] \[JS] [puppeteer/examples](https://github.com/puppeteer/examples) ⭐ 2,417 | 🐛 39 | 🌐 JavaScript | 📅 2026-06-21 Use case-driven examples for using Puppeteer and headless chrome
* \[**1676**星]\[10d] \[Java] [apache/geode](https://github.com/apache/geode) ⭐ 2,386 | 🐛 23 | 🌐 Java | 📅 2026-09-19 Apache Geode
* \[**1837**星]\[3m] \[Go] [influxdata/kapacitor](https://github.com/influxdata/kapacitor) ⭐ 2,377 | 🐛 834 | 🌐 Go | 📅 2026-09-18 Open source framework for processing, monitoring, and alerting on time series data
...
* \[**1852**星]\[1y] \[Py] [jinnlynn/genpac](https://github.com/jinnlynn/genpac) ⭐ 2,182 | 🐛 0 | 🌐 Python | 📅 2026-09-20 PAC/Dnsmasq/Wingy file Generator, working with gfwlist, support custom rules.
* \[**906**星]\[7m] \[C++] [dfhack/dfhack](https://github.com/DFHack/dfhack) ⭐ 2,045 | 🐛 1,070 | 🌐 C++ | 📅 2026-09-20 Memory hacking library for Dwarf Fortress and a set of tools that use it
* \[**1848**星]\[9m] \[Py] [netflix-skunkworks/stethoscope](https://github.com/Netflix-Skunkworks/stethoscope) ⭐ 2,004 | 🐛 44 | 🌐 Python | 📅 2023-08-01 Personalized, user-focused recommendations for employee information security.
* \[**1572**星]\[1m] \[C] [codahale/bcrypt-ruby](https://github.com/codahale/bcrypt-ruby) ⭐ 1,993 | 🐛 24 | 🌐 C | 📅 2026-06-19  Ruby binding for the OpenBSD bcrypt() password hashing algorithm, allowing you to easily store a secure hash of your users' passwords.
* \[**1659**星]\[25d] \[JS] [tylerbrock/mongo-hacker](https://github.com/tylerbrock/mongo-hacker) ⭐ 1,793 | 🐛 5 | 🌐 JavaScript | 📅 2022-09-17 MongoDB Shell Enhancements for Hackers
...
* \[**522**星]\[4m] \[Java] [java-deobfuscator/deobfuscator](https://github.com/java-deobfuscator/deobfuscator) ⭐ 1,764 | 🐛 127 | 🌐 Java | 📅 2023-04-26 Java 代码反混淆工具
* \[**587**星]\[6m] [nshalabi/sysmontools](https://github.com/nshalabi/sysmontools) ⭐ 1,663 | 🐛 1 | 🌐 TypeScript | 📅 2026-04-04 Utilities for Sysmon
...
* \[**449**星]\[12m] \[C++] [ntquery/scylla](https://github.com/ntquery/scylla) ⭐ 1,434 | 🐛 23 | 🌐 C++ | 📅 2023-04-05 Imports Reconstructor
* \[**306**星]\[2m] \[C] [nagyd/sdlpop](https://github.com/nagyd/sdlpop) ⭐ 1,284 | 🐛 80 | 🌐 C | 📅 2025-12-24 An open-source port of Prince of Persia, based on the disassembly of the DOS version.
...
* \[**895**星]\[12m] \[JS] [levskaya/jslinux-deobfuscated](https://github.com/levskaya/jslinux-deobfuscated) ⭐ 1,076 | 🐛 0 | 🌐 JavaScript | 📅 2019-01-15 An old version of Mr. Bellard's JSLinux rewritten to be human readable, hand deobfuscated and annotated.
* \[**568**星]\[11m] \[JS] [raineorshine/solgraph](https://github.com/raineorshine/solgraph) ⭐ 1,025 | 🐛 5 | 🌐 JavaScript | 📅 2022-12-04 Visualize Solidity control flow for smart contract security analysis.
...
* \[**507**星]\[8m] \[JS] [mindedsecurity/jstillery](https://github.com/mindedsecurity/jstillery) ⭐ 898 | 🐛 22 | 🌐 JavaScript | 📅 2019-05-30 Advanced JavaScript Deobfuscation via Partial Evaluation
* \[**265**星]\[3m] \[Assembly] [pret/pokeyellow](https://github.com/pret/pokeyellow) ⭐ 874 | 🐛 3 | 🌐 Assembly | 📅 2026-09-02 Disassembly of Pokemon Yellow
...
* \[**383**星]\[1y] \[HTML] [maestron/reverse-engineering-tutorials](https://github.com/maestron/reverse-engineering-tutorials) ⭐ 533 | 🐛 0 | 🌐 HTML | 📅 2018-09-02 Reverse Engineering Tutorials
...
* \[**1955**星]\[11d] \[Go] [solo-io/gloo](https://github.com/solo-io/gloo) ⭐ 169 | 🐛 1,867 | 🌐 Go | 📅 2026-09-19 An Envoy-Powered API Gateway
* \[**2214**星]\[18d] [getlantern/lantern-binaries](https://github.com/getlantern/lantern-binaries) ⭐ 120 | 🐛 14 | 📅 2026-09-20 Lantern installers binary downloads.
...
* \[**1422**星]\[17d] \[C++] [eteran/edb-debugger](https://github.com/eteran/edb-debugger) ⭐ 2,961 | 🐛 67 | 🌐 C++ | 📅 2026-09-05 edb is a cross platform AArch32/x86/x86-64 debugger.
* \[**836**星]\[8d] \[C++] [tasvideos/bizhawk](https://github.com/tasvideos/bizhawk) ⭐ 2,761 | 🐛 811 | 🌐 C# | 📅 2026-09-12 BizHawk is a multi-system emulator written in C#. BizHawk provides nice features for casual gamers such as full screen, and joypad support in addition to full rerecording and debugging tools for all system cores.
...
* \[**1147**星]\[5m] \[C++] [cgdb/cgdb](https://github.com/cgdb/cgdb) ⭐ 1,844 | 🐛 46 | 🌐 C | 📅 2026-02-27 Console front-end to the GNU debugger
* \[**1275**星]\[4m] \[Go] [solo-io/squash](https://github.com/solo-io/squash) ⭐ 1,764 | 🐛 87 | 🌐 Go | 📅 2022-06-09 The debugger for microservices
...
* \[**423**星]\[4m] \[C++] [cobaltfusion/debugviewpp](https://github.com/cobaltfusion/debugviewpp) ⭐ 1,265 | 🐛 98 | 🌐 C++ | 📅 2026-04-25 DebugView++, collects, views, filters your application logs, and highlights information that is important to you!
* \[**560**星]\[21d] \[C#] [microsoft/miengine](https://github.com/microsoft/miengine) ⭐ 859 | 🐛 164 | 🌐 C# | 📅 2026-08-27 The Visual Studio MI Debug Engine ("MIEngine") provides an open-source Visual Studio Debugger extension that works with MI-enabled debuggers such as gdb, lldb, and clrdbg.
* \[**285**星]\[2m] \[C++] [changeofpace/viviennevmm](https://github.com/changeofpace/viviennevmm) ⭐ 833 | 🐛 3 | 🌐 C++ | 📅 2020-09-07 VivienneVMM is a stealthy debugging framework implemented via an Intel VT-x hypervisor.
* \[**418**星]\[26d] \[C++] [simonkagstrom/kcov](https://github.com/simonkagstrom/kcov) ⭐ 829 | 🐛 88 | 🌐 C++ | 📅 2026-09-03 Code coverage tool for compiled programs, Python and Bash which uses debugging information to collect and report data without special compilation options
* \[**239**星]\[8m] \[C++] [strivexjun/xantidebug](https://github.com/strivexjun/xantidebug) ⭐ 691 | 🐛 3 | 🌐 C++ | 📅 2019-05-11 VMProtect 3.x Anti-debug Method Improved
...
* \[**291**星]\[12d] \[Py] [sosreport/sos](https://github.com/sosreport/sos) ⭐ 599 | 🐛 153 | 🌐 Python | 📅 2026-09-17 A unified tool for collecting system logs and other debug information
* \[**200**星]\[6m] \[C++] [rainers/cv2pdb](https://github.com/rainers/cv2pdb) ⭐ 554 | 🐛 20 | 🌐 C++ | 📅 2026-08-16 converter of DMD CodeView/DWARF debug information to PDB files
* \[**332**星]\[8m] \[Py] [romanvm/python-web-pdb](https://github.com/romanvm/python-web-pdb) ⭐ 534 | 🐛 16 | 🌐 Python | 📅 2026-09-13 Web-based remote UI for Python's PDB debugger
* \[**306**星]\[21d] \[Java] [widdix/aws-s3-virusscan](https://github.com/widdix/aws-s3-virusscan) ⚠️ Archived Free Antivirus for S3 Buckets
* \[**462**星]\[5m] \[C++] [emoon/prodbg](https://github.com/emoon/prodbg) ⭐ 521 | 🐛 114 | 🌐 C++ | 📅 2021-04-09 Debugging the way it's meant to be done
* \[**272**星]\[4m] \[Py] [mariovilas/winappdbg](https://github.com/mariovilas/winappdbg) ⭐ 485 | 🐛 3 | 🌐 Python | 📅 2026-03-24 WinAppDbg Debugger
* \[**270**星]\[21d] \[Py] [ionelmc/python-manhole](https://github.com/ionelmc/python-manhole) ⭐ 401 | 🐛 9 | 🌐 Python | 📅 2024-07-04 Debugging manhole for python applications.
...
* \[**250**星]\[2m] \[Py] [quantopian/qdb](https://github.com/quantopian/qdb) ⭐ 319 | 🐛 6 | 🌐 Python | 📅 2023-09-25 Quantopian Remote Debugger for Python
...
* \[**209**星]\[2m] \[C] [joyent/mdb\_v8](https://github.com/joyent/mdb_v8) ⭐ 242 | 🐛 36 | 🌐 C | 📅 2024-11-15 postmortem debugging for Node.js and other V8-based programs
...
* \[**1106**星]\[14d] \[OCaml] [binaryanalysisplatform/bap](https://github.com/binaryanalysisplatform/bap) ⭐ 2,256 | 🐛 43 | 🌐 OCaml | 📅 2026-05-07 Binary Analysis Platform
* \[**411**星]\[13d] \[HTML] [w3c/webappsec](https://github.com/w3c/webappsec) ⭐ 672 | 🐛 106 | 🌐 HTML | 📅 2026-06-10 Web App安全工作组
* \[**299**星]\[17d] \[JS] [w3c/webappsec-trusted-types](https://github.com/w3c/webappsec-trusted-types) ⭐ 662 | 🐛 58 | 🌐 JavaScript | 📅 2026-09-08 A browser API to prevent DOM-Based Cross Site Scripting in modern web applications.
...
* \[**20779**星]\[8d] \[Java] [skylot/jadx](https://github.com/skylot/jadx) ⭐ 50,529 | 🐛 449 | 🌐 Java | 📅 2026-09-12 dex 转 java 的反编译器
* \[**7733**星]\[1m] \[Java] [java-decompiler/jd-gui](https://github.com/java-decompiler/jd-gui) ⭐ 15,198 | 🐛 248 | 🌐 Java | 📅 2024-07-08 A standalone Java Decompiler GUI
* \[**1867**星]\[1y] \[Java] [jindrapetrik/jpexs-decompiler](https://github.com/jindrapetrik/jpexs-decompiler) ⭐ 5,878 | 🐛 2 | 🌐 Java | 📅 2026-09-19 JPEXS Free Flash Decompiler
...
* \[**671**星]\[11m] \[C++] [zrax/pycdc](https://github.com/zrax/pycdc) ⭐ 4,623 | 🐛 233 | 🌐 C++ | 📅 2026-04-07 C++ python bytecode disassembler and decompiler
* \[**1652**星]\[12m] \[Java] [fesh0r/fernflower](https://github.com/fesh0r/fernflower) ⭐ 4,402 | 🐛 0 | 🌐 Java | 📅 2026-09-18 Unofficial mirror of FernFlower Java decompiler (All pulls should be submitted upstream)
* \[**1466**星]\[12d] \[Py] [rocky/python-uncompyle6](https://github.com/rocky/python-uncompyle6) ⭐ 4,322 | 🐛 42 | 🌐 Python | 📅 2026-04-24 Python反编译器，跨平台
* \[**331**星]\[11d] \[Java] [leibnitz27/cfr](https://github.com/leibnitz27/cfr) ⭐ 2,698 | 🐛 150 | 🌐 Java | 📅 2026-06-04 This is the public repository for the CFR Java decompiler
* \[**673**星]\[18d] \[C#] [uxmal/reko](https://github.com/uxmal/reko) ⭐ 2,604 | 🐛 165 | 🌐 C# | 📅 2026-09-11 Reko is a binary decompiler.
* \[**347**星]\[16d] \[C#] [steamdatabase/valveresourceformat](https://github.com/steamdatabase/valveresourceformat) ⭐ 2,435 | 🐛 64 | 🌐 C# | 📅 2026-09-19 Valve's Source 2 resource file format (also known as Stupid Valve Format) parser and decompiler.
* \[**1084**星]\[4m] \[Py] [storyyeller/krakatau](https://github.com/storyyeller/krakatau) ⭐ 2,251 | 🐛 26 | 🌐 Rust | 📅 2026-09-11 Java decompiler, assembler, and disassembler
...
* \[**240**星]\[2m] \[Java] [ata4/bspsrc](https://github.com/ata4/bspsrc) ⭐ 867 | 🐛 39 | 🌐 Java | 📅 2026-08-13 A Source engine map decompiler
...
* \[**243**星]\[3m] \[Java] [kwart/jd-cmd](https://github.com/kwart/jd-cmd) ⭐ 654 | 🐛 8 | 🌐 Java | 📅 2026-09-14 Command line Java Decompiler
...
* \[**1374**星]\[20d] \[C] [zyantific/zydis](https://github.com/zyantific/zydis) ⭐ 4,370 | 🐛 51 | 🌐 C | 📅 2026-07-27 快速的轻量级x86/x86-64 反汇编库
* \[**430**星]\[2m] \[C#] [0xd4d/iced](https://github.com/0xd4d/iced) ⭐ 3,563 | 🐛 61 | 🌐 Rust | 📅 2026-09-16 x86/x64 disassembler, instruction decoder & encoder
* \[**835**星]\[8d] \[GLSL] [khronosgroup/spirv-cross](https://github.com/khronosgroup/spirv-cross) ⭐ 2,516 | 🐛 146 | 🌐 GLSL | 📅 2026-09-18  a practical tool and library for performing reflection on SPIR-V and disassembling SPIR-V back to high level languages.
...
* \[**627**星]\[3m] \[C] [gdabah/distorm](https://github.com/gdabah/distorm) ⭐ 1,341 | 🐛 15 | 🌐 C | 📅 2023-10-10 Powerful Disassembler Library For x86/AMD64
...
* \[**6052**星]\[13d] \[Py] [cyrus-and/gdb-dashboard](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,254 | 🐛 19 | 🌐 Python | 📅 2026-07-17 Modular visual interface for GDB in Python
* \[**2439**星]\[16d] \[Py] [pwndbg/pwndbg](https://github.com/pwndbg/pwndbg) ⭐ 10,872 | 🐛 220 | 🌐 Python | 📅 2026-09-18 GDB插件，辅助漏洞开发和逆向
* \[**7019**星]\[10d] \[JS] [cs01/gdbgui](https://github.com/cs01/gdbgui) ⭐ 10,349 | 🐛 180 | 🌐 TypeScript | 📅 2025-06-29 Browser-based frontend to gdb (gnu debugger). Add breakpoints, view the stack, visualize data structures, and more in C, C++, Go, Rust, and Fortran. Run gdbgui from the terminal and a new tab will open in your browser.
* \[**2568**星]\[1m] \[Py] [hugsy/gef](https://github.com/hugsy/gef) ⭐ 8,362 | 🐛 15 | 🌐 Python | 📅 2026-08-20 gdb增强工具，使用Python API，用于漏洞开发和逆向分析。
* \[**3784**星]\[11m] \[Py] [longld/peda](https://github.com/longld/peda) ⭐ 6,150 | 🐛 76 | 🌐 Python | 📅 2024-07-29 Python Exploit Development Assistance for GDB
...
* \[**244**星]\[2m] \[JS] [bet4it/hyperpwn](https://github.com/bet4it/hyperpwn) ⭐ 639 | 🐛 3 | 🌐 JavaScript | 📅 2025-04-28 A hyper plugin to provide a flexible GDB GUI with the help of GEF, pwndbg or peda
...
* \[**1419**星]\[9m] \[C] [namhyung/uftrace](https://github.com/namhyung/uftrace) ⭐ 3,474 | 🐛 401 | 🌐 C | 📅 2026-09-07 Function (graph) tracer for user-space
...
* \[**11588**星]\[12d] \[C] [radareorg/radare2](https://github.com/radareorg/radare2) ⭐ 24,831 | 🐛 829 | 🌐 C | 📅 2026-09-20 unix-like reverse engineering framework and commandline tools

### <a id="6922457cb0d4b6b87a34caf39aa31dfe"></a>新添加的

* \[**339**星]\[28d] \[TeX] [radareorg/radare2book](https://github.com/radareorg/radare2book) ⭐ 913 | 🐛 42 | 🌐 C | 📅 2026-09-13 Radare2 official book
* \[**259**星]\[1m] \[C] [radareorg/r2dec-js](https://github.com/radareorg/r2dec-js) ⭐ 610 | 🐛 35 | 🌐 JavaScript | 📅 2026-08-16 radare2插件,将汇编代码反编译为C伪代码
...
* \[**258**星]\[4m] \[Rust] [radareorg/radeco](https://github.com/radareorg/radeco) ⭐ 398 | 🐛 91 | 🌐 Rust | 📅 2026-05-06 radare2-based decompiler and symbol executor
...
* \[**2820**星]\[1m] \[Py] [androguard/androguard](https://github.com/androguard/androguard) ⭐ 6,270 | 🐛 45 | 🌐 Python | 📅 2026-09-19 Reverse engineering, Malware and goodware analysis of Android applications ... and more (ninja !)
* \[**328**星]\[5m] \[Py] [vector35/binaryninja-api](https://github.com/vector35/binaryninja-api) ⭐ 1,316 | 🐛 1,963 | 🌐 C++ | 📅 2026-09-19 Public API, examples, documentation and issues for Binary Ninja
...
* \[**201**星]\[14d] \[JS] [ret2got/disasm.pro](https://github.com/ret2got/disasm.pro) ⭐ 297 | 🐛 11 | 🌐 JavaScript | 📅 2025-08-03 A realtime assembler/disassembler (formerly known as disasm.ninja)
...
* \[**634**星]\[10d] \[C] [thewover/donut](https://github.com/thewover/donut) ⭐ 4,704 | 🐛 37 | 🌐 C | 📅 2025-07-08 Generates x86, x64, or AMD64+x86 position-independent shellcode that loads .NET Assemblies, PE files, and other Windows payloads from memory and runs them with parameters
* \[**388**星]\[1y] \[Assembly] [hasherezade/pe\_to\_shellcode](https://github.com/hasherezade/pe_to_shellcode) ⭐ 2,794 | 🐛 16 | 🌐 C++ | 📅 2025-08-30 Converts PE into a shellcode
* \[**877**星]\[8m] \[Py] [erocarrera/pefile](https://github.com/erocarrera/pefile) ⭐ 2,068 | 🐛 62 | 🌐 Python | 📅 2026-09-18 pefile is a Python module to read and work with PE (Portable Executable) files
* \[**344**星]\[1y] \[Assembly] [egebalci/amber](https://github.com/egebalci/amber) ⭐ 1,443 | 🐛 5 | 🌐 Go | 📅 2024-02-22 反射式PE加壳器，用于绕过安全产品和缓解措施
* \[**296**星]\[12d] \[C++] [hasherezade/libpeconv](https://github.com/hasherezade/libpeconv) ⭐ 1,388 | 🐛 18 | 🌐 C++ | 📅 2026-04-18 用于映射和取消映射PE 文件的库
...
* \[**316**星]\[24d] \[C++] [trailofbits/pe-parse](https://github.com/trailofbits/pe-parse) ⭐ 911 | 🐛 18 | 🌐 C++ | 📅 2026-08-05 Principled, lightweight C/C++ PE parser
...
* \[**285**星]\[7m] \[Java] [katjahahn/portex](https://github.com/katjahahn/portex) ⭐ 538 | 🐛 3 | 🌐 Scala | 📅 2026-04-03 Java library to analyse Portable Executable files with a special focus on malware analysis and PE malformation robustness
...
* \[**1915**星]\[22d] \[C#] [lucasg/dependencies](https://github.com/lucasg/dependencies) ⭐ 11,846 | 🐛 141 | 🌐 C# | 📅 2024-05-15 A rewrite of the old legacy software "depends.exe" in C# for Windows devs to troubleshoot dll load dependencies issues.
* \[**1146**星]\[27d] \[C#] [perfare/il2cppdumper](https://github.com/perfare/il2cppdumper) ⭐ 9,412 | 🐛 155 | 🌐 C# | 📅 2024-08-18 Restore dll from Unity il2cpp binary file (except code)
* \[**1333**星]\[10m] \[C] [fancycode/memorymodule](https://github.com/fancycode/memorymodule) ⭐ 3,156 | 🐛 58 | 🌐 C | 📅 2024-01-03 Library to load a DLL from memory.
...
* \[**363**星]\[19d] \[C#] [3f/dllexport](https://github.com/3f/dllexport) ⭐ 1,095 | 🐛 22 | 🌐 C# | 📅 2025-06-08 .NET DllExport
* \[**230**星]\[1y] \[C#] [misaka-mikoto-tech/monohooker](https://github.com/Misaka-Mikoto-Tech/MonoHooker) ⭐ 1,061 | 🐛 9 | 🌐 C# | 📅 2023-09-22 hook C# method at runtime without modify dll file (such as UnityEditor.dll)
* \[**215**星]\[6m] \[C#] [erfg12/memory.dll](https://github.com/erfg12/memory.dll) ⭐ 972 | 🐛 23 | 🌐 C# | 📅 2025-11-26 C# Hacking library for making PC game trainers.
...
* \[**214**星]\[26d] \[C++] [chuyu-team/mint](https://github.com/Chuyu-Team/MINT) ⭐ 434 | 🐛 0 | 🌐 C | 📅 2024-08-12 Contains the definitions for the Windows Internal UserMode API from ntdll.dll, samlib.dll and winsta.dll.
...
* \[**713**星]\[5m] \[C++] [darthton/xenos](https://github.com/darthton/xenos) ⭐ 2,663 | 🐛 52 | 🌐 C++ | 📅 2021-05-17 Windows DLL 注入器
* \[**588**星]\[2m] \[PS] [monoxgas/srdi](https://github.com/monoxgas/srdi) ⭐ 2,548 | 🐛 16 | 🌐 PowerShell | 📅 2023-11-15 Shellcode implementation of Reflective DLL Injection. Convert DLLs to position independent shellcode
...
* \[**299**星]\[11m] \[C++] [anhkgg/superdllhijack](https://github.com/anhkgg/superdllhijack) ⭐ 1,039 | 🐛 5 | 🌐 C++ | 📅 2021-11-10 一种通用Dll劫持技术，不再需要手工导出Dll的函数接口了
...
* \[**2355**星]\[11d] \[C] [hfiref0x/uacme](https://github.com/hfiref0x/uacme) ⭐ 7,798 | 🐛 0 | 🌐 C | 📅 2026-07-24 Defeating Windows User Account Control
* \[**2307**星]\[1m] \[PS] [k8gege/k8tools](https://github.com/k8gege/k8tools) ⭐ 6,219 | 🐛 10 | 🌐 PowerShell | 📅 2025-01-25 K8工具合集(内网渗透/提权工具/远程溢出/漏洞利用/扫描工具/密码破解/免杀工具/Exploit/APT/0day/Shellcode/Payload/priviledge/BypassUAC/OverFlow/WebShell/PenTest) Web GetShell Exploit(Struts2/Zimbra/Weblogic/Tomcat/Apache/Jboss/DotNetNuke/zabbix)
...
* \[**206**星]\[1y] \[JS] [jpcertcc/sysmonsearch](https://github.com/jpcertcc/sysmonsearch) ⭐ 433 | 🐛 15 | 🌐 JavaScript | 📅 2023-12-22 Investigate suspicious activity by visualizing Sysmon's event log
...
* \[**1228**星]\[10d] \[JS] [jpcertcc/logontracer](https://github.com/jpcertcc/logontracer) ⭐ 3,233 | 🐛 22 | 🌐 Python | 📅 2026-08-02 通过可视化和分析Windows事件日志来调查恶意的Windows登录
* \[**609**星]\[19d] \[PS] [sbousseaden/evtx-attack-samples](https://github.com/sbousseaden/evtx-attack-samples) ⭐ 2,630 | 🐛 5 | 🌐 HTML | 📅 2023-01-24 与特定攻击和利用后渗透技术相关的Windows事件样例
* \[**261**星]\[3m] \[C++] [gametechdev/presentmon](https://github.com/gametechdev/presentmon) ⭐ 2,567 | 🐛 201 | 🌐 C++ | 📅 2026-09-13 Tool for collection and processing of ETW events related to DXGI presentation.
* \[**479**星]\[5m] \[PS] [sans-blue-team/deepbluecli](https://github.com/sans-blue-team/deepbluecli) ⭐ 2,431 | 🐛 14 | 🌐 PowerShell | 📅 2023-10-14 a PowerShell Module for Threat Hunting via Windows Event Logs
...
* \[**654**星]\[10m] \[Roff] [palantir/windows-event-forwarding](https://github.com/palantir/windows-event-forwarding) ⭐ 1,341 | 🐛 23 | 🌐 Roff | 📅 2025-09-08 使用 Windows 事件转发实现网络事件监测和防御
* \[**446**星]\[9m] \[PS] [nsacyber/event-forwarding-guidance](https://github.com/nsacyber/Event-Forwarding-Guidance) ⭐ 891 | 🐛 8 | 🌐 PowerShell | 📅 2020-11-17 帮助管理员使用Windows事件转发（WEF）收集与安全相关的Windows事件日志
* \[**282**星]\[3m] \[C#] [fireeye/silketw](https://github.com/fireeye/silketw) ⚠️ Archived flexible C# wrappers for ETW
* \[**249**星]\[3m] \[C++] [microsoft/krabsetw](https://github.com/microsoft/krabsetw) ⭐ 801 | 🐛 21 | 🌐 C++ | 📅 2026-09-19 KrabsETW provides a modern C++ wrapper and a .NET wrapper around the low-level ETW trace consumption functions.
* \[**393**星]\[10m] \[Py] [williballenthin/python-evtx](https://github.com/williballenthin/python-evtx) ⭐ 781 | 🐛 24 | 🌐 Python | 📅 2026-03-19 纯Python编写的Windows事件日志解析器
* \[**504**星]\[10m] \[C#] [lowleveldesign/wtrace](https://github.com/lowleveldesign/wtrace) ⭐ 696 | 🐛 0 | 🌐 C# | 📅 2025-10-15 Command line tracing tool for Windows, based on ETW.
* \[**341**星]\[1y] \[C++] [qax-a-team/eventcleaner](https://github.com/QAX-A-Team/EventCleaner) ⭐ 608 | 🐛 8 | 🌐 C++ | 📅 2018-09-07 A tool mainly to erase specified records from Windows event logs, with additional functionalities.
...
* \[**921**星]\[7m] \[PS] [api0cradle/ultimateapplockerbypasslist](https://github.com/api0cradle/ultimateapplockerbypasslist) ⭐ 2,084 | 🐛 10 | 🌐 PowerShell | 📅 2023-09-11 The goal of this repository is to document the most common techniques to bypass AppLocker.
...
* \[**9261**星]\[11d] \[C#] [icsharpcode/ilspy](https://github.com/icsharpcode/ilspy) ⭐ 26,099 | 🐛 176 | 🌐 C# | 📅 2026-09-20 .NET Decompiler
...
* \[**1657**星]\[14d] \[C#] [jbevain/cecil](https://github.com/jbevain/cecil) ⭐ 2,997 | 🐛 112 | 🌐 C# | 📅 2025-09-11 C#库, 探查/修改/生成 .NET App/库
...
* \[**508**星]\[17d] \[PS] [stefanscherer/packer-windows](https://github.com/stefanscherer/packer-windows) ⭐ 1,362 | 🐛 17 | 🌐 PowerShell | 📅 2025-06-08 Windows Packer 模板：Win10, Server 2016, 1709, 1803, 1809, 2019, 1903, Insider with Docker
...
* \[**1011**星]\[1y] \[C] [ionescu007/simplevisor](https://github.com/ionescu007/simplevisor) ⭐ 1,999 | 🐛 11 | 🌐 C | 📅 2024-05-08 英特尔VT-x虚拟机管理程序，简单、可移植。支持Windows和UEFI
...
* \[**781**星]\[19d] [axtmueller/windows-kernel-explorer](https://github.com/axtmueller/windows-kernel-explorer) ⭐ 2,722 | 🐛 0 | 📅 2025-12-14 Windows内核研究工具
* \[**510**星]\[5m] \[Py] [rabbitstack/fibratus](https://github.com/rabbitstack/fibratus) ⭐ 2,547 | 🐛 45 | 🌐 Go | 📅 2026-09-19 Windows内核探索和跟踪工具
* \[**479**星]\[1m] \[C] [jkornev/hidden](https://github.com/jkornev/hidden) ⭐ 2,056 | 🐛 13 | 🌐 C | 📅 2022-07-13 Windows驱动，带用户模式接口：隐藏文件系统和注册表对象、保护进程等
* \[**933**星]\[9m] \[C] [microsoft/windows-driver-frameworks](https://github.com/microsoft/windows-driver-frameworks) ⭐ 1,327 | 🐛 8 | 🌐 C | 📅 2024-09-10 Windows驱动框架(WDF)
* \[**278**星]\[12d] \[PS] [microsoftdocs/windows-driver-docs](https://github.com/MicrosoftDocs/windows-driver-docs) ⭐ 1,066 | 🐛 9 | 🌐 OpenSCAD | 📅 2026-09-15 官方Windows驱动程序工具包文档
...
* \[**725**星]\[2m] \[HTML] [j00ru/windows-syscalls](https://github.com/j00ru/windows-syscalls) ⭐ 2,641 | 🐛 3 | 🌐 HTML | 📅 2025-12-30 Windows 系统调用表(NT/2000/XP/2003/Vista/2008/7/2012/8/10)
* \[**328**星]\[2m] \[C] [hfiref0x/syscalltables](https://github.com/hfiref0x/syscalltables) ⭐ 1,472 | 🐛 0 | 🌐 C | 📅 2026-09-04 Windows NT x64系统调用表

### <a id="1afda3039b4ab9a3a1f60b179ccb3e76"></a>其他

* \[**863**星]\[14d] \[C++] [henrypp/simplewall](https://github.com/henrypp/simplewall) ⭐ 9,011 | 🐛 144 | 🌐 C | 📅 2026-09-18 为Windows 过滤平台提供的配置界面
* \[**949**星]\[3m] \[C] [basil00/divert](https://github.com/basil00/divert) ⭐ 3,295 | 🐛 65 | 🌐 C | 📅 2023-03-15 用户模式数据包拦截库，适用于Win 7/8/10
* \[**360**星]\[12d] \[C#] [digitalruby/ipban](https://github.com/digitalruby/ipban) ⭐ 2,194 | 🐛 2 | 🌐 C# | 📅 2026-08-21 监视Windows/Linux系统的登录失败和不良行为，并封禁对应的IP地址。高度可配置，精简且功能强大。
...
* \[**570**星]\[1m] \[C] [hfiref0x/winobjex64](https://github.com/hfiref0x/winobjex64) ⭐ 1,977 | 🐛 0 | 🌐 C | 📅 2026-09-01 Windows对象浏览器. x64
* \[**418**星]\[15d] \[C] [samba-team/samba](https://github.com/samba-team/samba) ⭐ 1,143 | 🐛 1 | 🌐 C | 📅 2026-09-18 适用于Linux和Unix的标准Windows interoperability程序套件
* \[**726**星]\[2m] \[Py] [diyan/pywinrm](https://github.com/diyan/pywinrm) ⭐ 1,135 | 🐛 54 | 🌐 Python | 📅 2026-08-04 Python实现的WinRM客户端
* \[**228**星]\[3m] \[C] [leecher1337/ntvdmx64](https://github.com/leecher1337/ntvdmx64) ⭐ 952 | 🐛 91 | 🌐 C | 📅 2026-08-28 在64位版本上执行Windows DOS版的 NTVDM
* \[**208**星]\[10m] \[C] [hzqst/unicorn\_pe](https://github.com/hzqst/unicorn_pe) ⚠️ Archived 模拟Windows PE文件的代码执行，基于Unicorn
* \[**210**星]\[3m] [adguardteam/adguardforwindows](https://github.com/adguardteam/adguardforwindows) ⭐ 887 | 🐛 168 | 📅 2026-09-09 Windows系统范围的AdBlocker
* \[**389**星]\[2m] \[C#] [microsoft/binskim](https://github.com/microsoft/binskim) ⭐ 860 | 🐛 152 | 🌐 C# | 📅 2026-09-18 二进制静态分析工具，可为PE和ELF二进制格式提供安全性和正确性分析
* \[**238**星]\[5m] \[PS] [microsoft/aaronlocker](https://github.com/microsoft/aaronlocker) ⭐ 707 | 🐛 16 | 🌐 PowerShell | 📅 2022-08-12 Windows应用程序白名单
* \[**463**星]\[8m] \[C#] [microsoft/dbgshell](https://github.com/microsoft/dbgshell) ⭐ 699 | 🐛 22 | 🌐 C# | 📅 2024-04-03 PowerShell编写的Windows调试器引擎前端
...
* \[**233**星]\[10m] \[Go] [masterzen/winrm](https://github.com/masterzen/winrm) ⭐ 479 | 🐛 53 | 🌐 Go | 📅 2026-04-07 Windows远程命令执行，命令行工具+库，Go编写
* \[**370**星]\[27d] \[Ruby] [winrb/winrm](https://github.com/winrb/winrm) ⭐ 423 | 🐛 22 | 🌐 Ruby | 📅 2026-09-16 在Windows中使用WinRM的功能调用原生对象的SOAP库。Ruby编写
...
* \[**787**星]\[2m] \[C] [nixos/patchelf](https://github.com/nixos/patchelf) ⭐ 4,264 | 🐛 149 | 🌐 C | 📅 2026-07-27 A small utility to modify the dynamic linker and RPATH of ELF executables
* \[**930**星]\[15d] \[Py] [eliben/pyelftools](https://github.com/eliben/pyelftools) ⭐ 2,281 | 🐛 55 | 🌐 Python | 📅 2026-07-30 Parsing ELF and DWARF in Python
...
* \[**1450**星]\[2m] \[C] [feralinteractive/gamemode](https://github.com/feralinteractive/gamemode) ⭐ 6,018 | 🐛 219 | 🌐 C | 📅 2026-06-15 Optimise Linux system performance on demand
* \[**1413**星]\[21d] \[C++] [google/nsjail](https://github.com/google/nsjail) ⭐ 4,116 | 🐛 39 | 🌐 C++ | 📅 2026-08-27 A light-weight process isolation tool, making use of Linux namespaces and seccomp-bpf syscall filters (with help of the kafel bpf language)
* \[**759**星]\[1m] \[Py] [korcankaraokcu/pince](https://github.com/korcankaraokcu/pince) ⭐ 3,095 | 🐛 6 | 🌐 Python | 📅 2026-09-18 A reverse engineering tool that'll supply the place of Cheat Engine for linux
* \[**731**星]\[17d] \[C] [strace/strace](https://github.com/strace/strace) ⭐ 2,702 | 🐛 108 | 🌐 C | 📅 2026-09-15 strace is a diagnostic, debugging and instructional userspace utility for Linux
* \[**895**星]\[29d] \[C] [buserror/simavr](https://github.com/buserror/simavr) ⭐ 1,785 | 🐛 47 | 🌐 C | 📅 2026-09-10 simavr is a lean, mean and hackable AVR simulator for linux & OSX
* \[**565**星]\[12d] \[C++] [intel/linux-sgx](https://github.com/intel/linux-sgx) ⭐ 1,456 | 🐛 130 | 🌐 C++ | 📅 2026-08-13 Intel SGX for Linux\*
* \[**741**星]\[2m] \[C] [yrp604/rappel](https://github.com/yrp604/rappel) ⭐ 1,282 | 🐛 2 | 🌐 C | 📅 2024-03-07 A linux-based assembly REPL for x86, amd64, armv7, and armv8
...
* \[**468**星]\[9d] \[C] [libreswan/libreswan](https://github.com/libreswan/libreswan) ⭐ 1,004 | 🐛 664 | 🌐 C | 📅 2026-09-19 an Internet Key Exchange (IKE) implementation for Linux.
* \[**354**星]\[2m] \[C] [seccomp/libseccomp](https://github.com/seccomp/libseccomp) ⭐ 934 | 🐛 58 | 🌐 C | 📅 2026-07-01 an easy to use, platform independent, interface to the Linux Kernel's syscall filtering mechanism
* \[**570**星]\[12m] \[C] [asamy/ksm](https://github.com/asamy/ksm) ⭐ 869 | 🐛 13 | 🌐 C | 📅 2021-10-20 快速、hackable且简单的x64 VT-x虚拟机管理程序，支持Windows和Linux
...
* \[**560**星]\[2m] \[Py] [autotest/autotest](https://github.com/autotest/autotest) ⭐ 724 | 🐛 122 | 🌐 Python | 📅 2026-08-18 Fully automated tests on Linux
* \[**441**星]\[12d] \[C] [facebook/openbmc](https://github.com/facebook/openbmc) ⭐ 688 | 🐛 56 | 🌐 C | 📅 2026-09-18 OpenBMC is an open software framework to build a complete Linux image for a Board Management Controller (BMC).
