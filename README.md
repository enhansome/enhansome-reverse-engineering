...
* [全平台逆向资源: awesome-reverse-engineering](https://github.com/alphaSeclab/awesome-reverse-engineering) ⭐ 5,045 | 🐛 7 | 📅 2021-09-01:
...
* [开源远控和恶意远控分析报告: awesome-rat](https://github.com/alphaSeclab/awesome-rat) ⭐ 2,265 | 🐛 0 | 📅 2020-02-17: 开源远控工具: Windows/Linux/macOS/Android; 远控类恶意恶意代码的分析报告等
...
* [攻击性网络安全资源: awesome-cyber-security](https://github.com/alphaSeclab/awesome-cyber-security) ⭐ 501 | 🐛 0 | 📅 2019-12-23: 漏洞/渗透/物联网安全/数据渗透/Metasploit/BurpSuite/KaliLinux/C\&C/OWASP/免杀/CobaltStrike/侦查/OSINT/社工/密码/凭证/威胁狩猎/Payload/WifiHacking/无线攻击/后渗透/提权/UAC绕过/...
...
* 此页只包含部分内容. [查看完整版](https://github.com/alphaSeclab/awesome-reverse-engineering/blob/master/Readme_full.md) ⭐ 5,045 | 🐛 7 | 📅 2021-09-01
* 跟逆向有关的资源收集。当前包括的工具个数3500+，并根据功能进行了粗糙的分类。部分工具添加了中文描述。当前包括文章数2300+。

# 说明

[EnglishVersion](https://github.com/alphaSeclab/awesome-reverse-engineering/blob/master/Readme_en.md) ⭐ 5,045 | 🐛 7 | 📅 2021-09-01
...
* \[**277**星]\[4m] \[Py] [jpcertcc/aa-tools](https://github.com/jpcertcc/aa-tools) ⭐ 462 | 🐛 3 | 🌐 Python | 📅 2025-08-14 多脚本
  * [apt17scan.py](https://github.com/jpcertcc/aa-tools/blob/master/apt17scan.py) ⭐ 462 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Volatility插件, 检测APT17相关的恶意代码并提取配置
  * [emdivi\_postdata\_decoder](https://github.com/jpcertcc/aa-tools/blob/master/emdivi_postdata_decoder.py) ⭐ 462 | 🐛 3 | 🌐 Python | 📅 2025-08-14 解码Emdivi post的数据
  * [emdivi\_string\_decryptor](https://github.com/jpcertcc/aa-tools/blob/master/emdivi_string_decryptor.py) ⭐ 462 | 🐛 3 | 🌐 Python | 📅 2025-08-14 IDAPython脚本, 解密Emdivi内的字符串
  * [citadel\_decryptor](https://github.com/jpcertcc/aa-tools/tree/master/citadel_decryptor) ⭐ 462 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Data decryption tool for Citadel
  * [adwind\_string\_decoder](https://github.com/jpcertcc/aa-tools/blob/master/adwind_string_decoder.py) ⭐ 462 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Python script for decoding strings inside Adwind
  * [redleavesscan](https://github.com/jpcertcc/aa-tools/blob/master/redleavesscan.py) ⭐ 462 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Volatility plugin for detecting RedLeaves and extracting its config
  * [datper\_splunk](https://github.com/jpcertcc/aa-tools/blob/master/datper_splunk.py) ⭐ 462 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Python script for detects Datper communication and adds result field to Splunk index
  * [datper\_elk](https://github.com/jpcertcc/aa-tools/blob/master/datper_elk.py) ⭐ 462 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Python script for detects Datper communication and adds result field to Elasticsearch index
  * [tscookie\_decode](https://github.com/jpcertcc/aa-tools/blob/master/tscookie_decode.py) ⭐ 462 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Python script for decrypting and parsing TSCookie configure data
  * [wellmess\_cookie\_decode](https://github.com/jpcertcc/aa-tools/blob/master/wellmess_cookie_decode.py) ⭐ 462 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Python script for decoding WellMess's cookie data (support Python2)
  * [cobaltstrikescan](https://github.com/jpcertcc/aa-tools/blob/master/cobaltstrikescan.py) ⭐ 462 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Volatility plugin for detecting Cobalt Strike Beacon and extracting its config
  * [tscookie\_data\_decode](https://github.com/jpcertcc/aa-tools/blob/master/tscookie_data_decode.py) ⭐ 462 | 🐛 3 | 🌐 Python | 📅 2025-08-14 Python script for decrypting and parsing TSCookie configure data
...
* \[**931**星]\[25d] \[OCaml] [airbus-seclab/bincat](https://github.com/airbus-seclab/bincat) ⭐ 1,873 | 🐛 18 | 🌐 OCaml | 📅 2025-02-25 二进制代码静态分析工具。值分析（寄存器、内存）、污点分析、类型重建和传播（propagation）、前向/后向分析
  * 重复区段: [IDA->插件->污点分析](#34ac84853604a7741c61670f2a075d20) |
* \[**664**星]\[27d] \[Py] [igogo-x86/hexrayspytools](https://github.com/igogo-x86/hexrayspytools) ⭐ 1,536 | 🐛 32 | 🌐 Python | 📅 2024-08-11 结构体和类重建插件
...
* \[**5228**星]\[2m] \[Py] [refirmlabs/binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,331 | 🐛 93 | 🌐 Rust | 📅 2026-08-11 固件分析工具（命令行+IDA插件）
  * [IDA插件](https://github.com/ReFirmLabs/binwalk/tree/master/src/scripts) ⭐ 14,331 | 🐛 93 | 🌐 Rust | 📅 2026-08-11
  * [binwalk](https://github.com/ReFirmLabs/binwalk/tree/master/src/binwalk) ⭐ 14,331 | 🐛 93 | 🌐 Rust | 📅 2026-08-11
...
* \[**471**星]\[13d] \[C] [bootleg/ret-sync](https://github.com/bootleg/ret-sync) ⭐ 2,385 | 🐛 31 | 🌐 C | 📅 2026-02-15 在反汇编工具和调试器之间同步调试会话
  * [GDB插件](https://github.com/bootleg/ret-sync/tree/master/ext_gdb) ⭐ 2,385 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [Ghidra插件](https://github.com/bootleg/ret-sync/tree/master/ext_ghidra) ⭐ 2,385 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [IDA插件](https://github.com/bootleg/ret-sync/tree/master/ext_ida) ⭐ 2,385 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [LLDB](https://github.com/bootleg/ret-sync/tree/master/ext_lldb) ⭐ 2,385 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [OD](https://github.com/bootleg/ret-sync/tree/master/ext_olly1) ⭐ 2,385 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [OD2](https://github.com/bootleg/ret-sync/tree/master/ext_olly2) ⭐ 2,385 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [WinDgb](https://github.com/bootleg/ret-sync/tree/master/ext_windbg/sync) ⭐ 2,385 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * [x64dbg](https://github.com/bootleg/ret-sync/tree/master/ext_x64dbg) ⭐ 2,385 | 🐛 31 | 🌐 C | 📅 2026-02-15
  * 重复区段: [x64dbg->插件->新添加的](#da5688c7823802e734c39b539aa39df7) |
* \[**292**星]\[11m] \[C] [a1ext/labeless](https://github.com/a1ext/labeless) ⭐ 586 | 🐛 21 | 🌐 C++ | 📅 2026-02-23 在IDA和调试器之间无缝同步Label/注释等
  * [IDA插件](https://github.com/a1ext/labeless/tree/master/labeless_ida) ⭐ 586 | 🐛 21 | 🌐 C++ | 📅 2026-02-23
  * [OD](https://github.com/a1ext/labeless/tree/master/labeless_olly) ⭐ 586 | 🐛 21 | 🌐 C++ | 📅 2026-02-23
  * [OD2](https://github.com/a1ext/labeless/tree/master/labeless_olly2) ⭐ 586 | 🐛 21 | 🌐 C++ | 📅 2026-02-23
  * [x64dbg](https://github.com/a1ext/labeless/tree/master/labeless_x64dbg) ⭐ 586 | 🐛 21 | 🌐 C++ | 📅 2026-02-23
...
* \[**382**星]\[26d] \[C++] [google/binexport](https://github.com/google/binexport) ⭐ 1,203 | 🐛 41 | 🌐 C++ | 📅 2026-09-10 将反汇编以Protocol Buffer的形式导出为PostgreSQL数据库, 导入到BinNavi中使用
...
* \[**386**星]\[5m] \[Py] [ynvb/die](https://github.com/ynvb/die) ⭐ 476 | 🐛 16 | 🌐 Python | 📅 2022-03-02 使用IDA调试器收集动态运行信息, 辅助静态分析
...
* \[**1365**星]\[3m] \[Py] [fireeye/flare-floss](https://github.com/fireeye/flare-floss) ⭐ 4,147 | 🐛 116 | 🌐 Python | 📅 2026-09-10 自动从恶意代码中提取反混淆后的字符串
  * [floss](https://github.com/fireeye/flare-floss/tree/master/floss) ⭐ 4,147 | 🐛 116 | 🌐 Python | 📅 2026-09-10
  * [IDA插件](https://github.com/fireeye/flare-floss/blob/master/scripts/idaplugin.py) ⭐ 4,147 | 🐛 116 | 🌐 Python | 📅 2026-09-10
...
* \[**504**星]\[20d] \[Py] [alexhude/uemu](https://github.com/alexhude/uemu) ⭐ 1,240 | 🐛 5 | 🌐 Python | 📅 2026-08-19 基于Unicorn的模拟器插件
* \[**282**星]\[2m] \[Py] [fireeye/flare-emu](https://github.com/fireeye/flare-emu) ⭐ 955 | 🐛 7 | 🌐 Python | 📅 2025-08-14 结合Unicorn引擎, 简化模拟脚本的编写
...
* \[**18649**星]\[10d] \[Java] [nationalsecurityagency/ghidra](https://github.com/nationalsecurityagency/ghidra) ⭐ 74,787 | 🐛 1,947 | 🌐 Java | 📅 2026-09-08 软件逆向框架

### <a id="ce70b8d45be0a3d29705763564623aca"></a>新添加的

* \[**455**星]\[9m] \[YARA] [ghidraninja/ghidra\_scripts](https://github.com/ghidraninja/ghidra_scripts) ⭐ 1,168 | 🐛 13 | 🌐 YARA | 📅 2020-10-07 Ghidra脚本
  * [binwalk](https://github.com/ghidraninja/ghidra_scripts/blob/master/binwalk.py) ⭐ 1,168 | 🐛 13 | 🌐 YARA | 📅 2020-10-07 对当前程序运行BinWalk, 标注找到的内容
  * [yara](https://github.com/ghidraninja/ghidra_scripts/blob/master/yara.py) ⭐ 1,168 | 🐛 13 | 🌐 YARA | 📅 2020-10-07 使用Yara查找加密常量
  * [swift\_demangler](https://github.com/ghidraninja/ghidra_scripts/blob/master/swift_demangler.py) ⭐ 1,168 | 🐛 13 | 🌐 YARA | 📅 2020-10-07 自动demangle Swift函数名
  * [golang\_renamer](https://github.com/ghidraninja/ghidra_scripts/blob/master/golang_renamer.py) ⭐ 1,168 | 🐛 13 | 🌐 YARA | 📅 2020-10-07 恢复stripped Go二进制文件的函数名
...
* \[**34576**星]\[1m] \[C++] [x64dbg/x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,474 | 🐛 580 | 🌐 C++ | 📅 2026-09-10 Windows平台x32/x64调试器
...
* \[**1341**星]\[1m] \[C] [x64dbg/x64dbgpy](https://github.com/x64dbg/x64dbgpy) ⭐ 1,506 | 🐛 28 | 🌐 C | 📅 2023-04-05 Automating x64dbg using Python, Snapshots:
...
* \[**230**星]\[9m] \[C++] [microsoft/windbg-samples](https://github.com/microsoft/windbg-samples) ⭐ 826 | 🐛 6 | 🌐 C++ | 📅 2026-06-30 Sample extensions, scripts, and API uses for WinDbg.
...
* \[**5195**星]\[19d] \[Py] [mobsf/mobile-security-framework-mobsf](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,746 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-09 Mobile Security Framework (MobSF) is an automated, all-in-one mobile application (Android/iOS/Windows) pen-testing, malware analysis and security assessment framework capable of performing static and dynamic analysis.
* \[**5084**星]\[15d] \[HTML] [owasp/owasp-mstg](https://github.com/owasp/owasp-mstg) ⭐ 13,176 | 🐛 238 | 🌐 Python | 📅 2026-09-09 关于移动App安全开发、测试和逆向的相近手册
* \[**4306**星]\[15d] \[Shell] [ashishb/android-security-awesome](https://github.com/ashishb/android-security-awesome) ⭐ 9,683 | 🐛 0 | 🌐 Makefile | 📅 2026-09-07 A collection of android security related resources
* \[**2051**星]\[21d] \[Py] [sensepost/objection](https://github.com/sensepost/objection) ⭐ 9,379 | 🐛 57 | 🌐 Python | 📅 2026-07-23 runtimemobile exploration
...
* \[**820**星]\[11d] [proxymanapp/proxyman](https://github.com/proxymanapp/proxyman) ⭐ 6,968 | 🐛 1,885 | 📅 2026-09-07 Modern and Delightful HTTP Debugging Proxy for macOS, iOS and Android
* \[**4882**星]\[24d] \[Java] [guardianproject/haven](https://github.com/guardianproject/haven) ⭐ 6,814 | 🐛 149 | 🌐 Java | 📅 2022-10-26 通过Android应用和设备上的传感器保护自己的个人空间和财产而又不损害
* \[**4776**星]\[12d] \[C++] [facebook/redex](https://github.com/facebook/redex) ⭐ 6,300 | 🐛 73 | 🌐 C++ | 📅 2026-09-10 Android App字节码优化器
...
* \[**443**星]\[1m] \[TS] [shroudedcode/apk-mitm](https://github.com/shroudedcode/apk-mitm) ⭐ 5,107 | 🐛 83 | 🌐 TypeScript | 📅 2024-07-24
* \[**2011**星]\[8m] \[Py] [fsecurelabs/drozer](https://github.com/FSecureLABS/drozer) ⭐ 4,608 | 🐛 9 | 🌐 Python | 📅 2026-04-08 The Leading Security Assessment Framework for Android.
* \[**2314**星]\[1y] \[Java] [csploit/android](https://github.com/csploit/android) ⭐ 3,650 | 🐛 400 | 🌐 Java | 📅 2024-04-27 cSploit - The most complete and advanced IT security professional toolkit on Android.
* \[**431**星]\[13d] \[C] [guardianproject/orbot](https://github.com/guardianproject/orbot) ⭐ 3,531 | 🐛 93 | 🌐 Kotlin | 📅 2026-09-09 The Github home of Orbot: Tor on Android (Also available on gitlab!)
* \[**2120**星]\[9m] \[Py] [linkedin/qark](https://github.com/linkedin/qark) ⭐ 3,384 | 🐛 79 | 🌐 Python | 📅 2024-01-16 查找Android App的漏洞, 支持源码或APK文件
...
* \[**559**星]\[14d] \[Shell] [owasp/owasp-masvs](https://github.com/owasp/owasp-masvs) ⭐ 2,445 | 🐛 3 | 🌐 Python | 📅 2025-12-22 OWASP 移动App安全标准
* \[**1235**星]\[2m] \[Java] [find-sec-bugs/find-sec-bugs](https://github.com/find-sec-bugs/find-sec-bugs) ⭐ 2,443 | 🐛 115 | 🌐 Java | 📅 2026-03-26 The SpotBugs plugin for security audits of Java web applications and Android applications. (Also work with Kotlin, Groovy and Scala projects)
...
* \[**358**星]\[5m] [b3nac/android-reports-and-resources](https://github.com/b3nac/android-reports-and-resources) ⭐ 1,710 | 🐛 0 | 📅 2025-09-10 A big list of Android Hackerone disclosed reports and other resources.
* \[**546**星]\[2m] [nordicsemiconductor/android-nrf-connect](https://github.com/nordicsemiconductor/android-nrf-connect) ⭐ 1,691 | 🐛 57 | 📅 2025-08-28 Documentation and issue tracker for nRF Connect for Android.
...
* \[**409**星]\[3m] \[CSS] [angea/pocorgtfo](https://github.com/angea/pocorgtfo) ⭐ 1,609 | 🐛 1 | 🌐 TeX | 📅 2024-02-11 a "Proof of Concept or GTFO" mirror with extra article index, direct links and clean PDFs.
...
* \[**265**星]\[11d] \[Py] [den4uk/andriller](https://github.com/den4uk/andriller) ⭐ 1,604 | 🐛 11 | 🌐 Python | 📅 2022-06-27 a collection of forensic tools for smartphones
* \[**1208**星]\[4m] \[Java] [javiersantos/piracychecker](https://github.com/javiersantos/piracychecker) ⭐ 1,568 | 🐛 25 | 🌐 Java | 📅 2026-06-04 An Android library that prevents your app from being pirated / cracked using Google Play Licensing (LVL), APK signature protection and more. API 14+ required.
* \[**527**星]\[4m] \[JS] [wooyundota/droidsslunpinning](https://github.com/wooyundota/droidsslunpinning) ⭐ 1,512 | 🐛 4 | 🌐 JavaScript | 📅 2020-04-07 Android certificate pinning disable tools
...
* \[**1241**星]\[3m] \[Java] [whataa/pandora](https://github.com/whataa/pandora) ⭐ 1,494 | 🐛 13 | 🌐 Java | 📅 2023-11-01 an android library for debugging what we care about directly in app.
...
* \[**769**星]\[1y] \[C] [ele7enxxh/android-inline-hook](https://github.com/ele7enxxh/android-inline-hook) ⭐ 1,402 | 🐛 15 | 🌐 C | 📅 2020-06-23 thumb16 thumb32 arm32 inlineHook in Android
...
* \[**800**星]\[3m] [sh4hin/androl4b](https://github.com/sh4hin/androl4b) ⭐ 1,168 | 🐛 5 | 📅 2023-05-31 用于评估Android应用程序，逆向工程和恶意软件分析的虚拟机
* \[**668**星]\[2m] [doridori/android-security-reference](https://github.com/doridori/android-security-reference) ⭐ 994 | 🐛 5 | 📅 2025-03-24 A W\.I.P Android Security Ref
...
* \[**1213**星]\[2m] \[JS] [megatronking/httpcanary](https://github.com/megatronking/httpcanary) ⭐ 507 | 🐛 5 | 📅 2024-07-03 A powerful capture and injection tool for the Android platform
...
* \[**5080**星]\[2m] \[Java] [meituan-dianping/walle](https://github.com/meituan-dianping/walle) ⭐ 6,858 | 🐛 109 | 🌐 Java | 📅 2024-05-30 Android Signature V2 Scheme签名下的新一代渠道包打包神器

### <a id="767078c52aca04c452c095f49ad73956"></a>收集

### <a id="17408290519e1ca7745233afea62c43c"></a>各类App

* \[**12285**星]\[11d] \[Java] [signalapp/signal-android](https://github.com/signalapp/Signal-Android) ⭐ 29,311 | 🐛 498 | 🌐 Kotlin | 📅 2026-09-10 A private messenger for Android.

### <a id="7f353b27e45b5de6b0e6ac472b02cbf1"></a>Xposed

* \[**8756**星]\[2m] \[Java] [android-hacker/virtualxposed](https://github.com/android-hacker/virtualxposed) ⭐ 16,057 | 🐛 162 | 🌐 Java | 📅 2024-03-08 A simple app to use Xposed without root, unlock the bootloader or modify system image, etc.
...
* \[**669**星]\[12d] \[Java] [ganyao114/sandhook](https://github.com/ganyao114/sandhook) ⭐ 2,230 | 🐛 46 | 🌐 Java | 📅 2023-01-19 Android ART Hook/Native Inline Hook/Single Instruction Hook - support 4.4 - 10.0 32/64 bit - Xposed API Compat
...
* \[**309**星]\[13d] \[Java] [ganyao114/sandvxposed](https://github.com/ganyao114/sandvxposed) ⭐ 1,058 | 🐛 45 | 🌐 Java | 📅 2021-11-18 Xposed environment without root (OS 5.0 - 10.0)
...
* \[**309**星]\[1m] [bigsinger/androididchanger](https://github.com/bigsinger/androididchanger) ⭐ 632 | 🐛 28 | 🌐 Java | 📅 2026-08-14 Xposed Module for Changing Android Device Info
...
* \[**1465**星]\[3m] \[C++] [vaibhavpandeyvpz/apkstudio](https://github.com/vaibhavpandeyvpz/apkstudio) ⭐ 4,644 | 🐛 4 | 🌐 C++ | 📅 2026-01-05 Open-source, cross platform Qt based IDE for reverse-engineering Android application packages.
* \[**1793**星]\[8m] \[C++] [wrbug/dumpdex](https://github.com/wrbug/dumpdex) ⭐ 3,159 | 🐛 38 | 🌐 C++ | 📅 2020-05-15 Android脱壳
* \[**366**星]\[3m] \[Java] [patrickfav/uber-apk-signer](https://github.com/patrickfav/uber-apk-signer) ⭐ 2,739 | 🐛 11 | 🌐 Java | 📅 2023-10-30 A cli tool that helps signing and zip aligning single or multiple Android application packages (APKs) with either debug or provided release certificates. It supports v1, v2 and v3 Android signing scheme has an embedded debug keystore and auto verifies after signing.
* \[**712**星]\[2m] \[YARA] [rednaga/apkid](https://github.com/rednaga/apkid) ⭐ 2,572 | 🐛 84 | 🌐 YARA | 📅 2026-09-02 Android Application Identifier for Packers, Protectors, Obfuscators and Oddities - PEiD for Android
...
* \[**322**星]\[6m] \[Shell] [1n3/reverseapk](https://github.com/1n3/reverseapk) ⭐ 869 | 🐛 1 | 🌐 Shell | 📅 2022-12-21 Quickly analyze and reverse engineer Android packages

### <a id="596b6cf8fd36bc4c819335f12850a915"></a>HOOK

* \[**1494**星]\[9d] \[C++] [jmpews/dobby](https://github.com/jmpews/Dobby) ⭐ 4,831 | 🐛 99 | 🌐 C++ | 📅 2025-01-26 a lightweight, multi-platform, multi-architecture hook framework.
...
* \[**804**星]\[25d] \[C++] [aslody/whale](https://github.com/aslody/whale) ⭐ 1,666 | 🐛 50 | 🌐 C++ | 📅 2020-12-13 Hook Framework for Android/IOS/Linux/MacOS
...
* \[**532**星]\[7m] \[Java] [limboemu/limbo](https://github.com/limboemu/limbo) ⭐ 3,410 | 🐛 54 | 🌐 Java | 📅 2024-08-18 Limbo is a QEMU-based emulator for Android. It currently supports PC & ARM emulation for Intel x86 and ARM architecture. See our wiki
* \[**1492**星]\[1y] \[C++] [f1xpl/openauto](https://github.com/f1xpl/openauto) ⭐ 2,918 | 🐛 37 | 🌐 C++ | 📅 2024-12-12 AndroidAuto headunit emulator
...
* \[**10794**星]\[1m] \[Java] [konloch/bytecode-viewer](https://github.com/konloch/bytecode-viewer) ⭐ 15,638 | 🐛 103 | 🌐 Java | 📅 2026-07-17 A Java 8+ Jar & Android APK Reverse Engineering Suite (Decompiler, Editor, Debugger & More)
...
* \[**429**星]\[4m] \[Shell] [ashishb/android-malware](https://github.com/ashishb/android-malware) ⭐ 1,225 | 🐛 0 | 🌐 Shell | 📅 2025-12-31 Collection of android malware samples
...
* \[**3078**星]\[2m] \[Java] [calebfenton/simplify](https://github.com/calebfenton/simplify) ⭐ 4,662 | 🐛 33 | 🌐 Java | 📅 2022-04-30 Generic Android Deobfuscator
...
* \[**9285**星]\[1m] \[Java] [ibotpeaches/apktool](https://github.com/ibotpeaches/apktool) ⭐ 25,527 | 🐛 77 | 🌐 Java | 📅 2026-09-04 A tool for reverse engineering Android apk files
* \[**2053**星]\[1m] \[Java] [genymobile/gnirehtet](https://github.com/genymobile/gnirehtet) ⭐ 7,897 | 🐛 326 | 🌐 Java | 📅 2024-08-11 Gnirehtet provides reverse tethering for Android
...
* \[**2140**星]\[2m] \[Py] [jonathansalwan/ropgadget](https://github.com/jonathansalwan/ropgadget) ⭐ 4,478 | 🐛 15 | 🌐 Python | 📅 2026-06-24 This tool lets you search your gadgets on your binaries to facilitate your ROP exploitation. ROPgadget supports ELF, PE and Mach-O format on x86, x64, ARM, ARM64, PowerPC, SPARC and MIPS architectures.
...
* \[**5451**星]\[3m] \[Py] [axi0mx/ipwndfu](https://github.com/axi0mx/ipwndfu) ⭐ 7,408 | 🐛 168 | 🌐 Python | 📅 2024-02-21 open-source jailbreaking tool for many iOS devices
...
* \[**5390**星]\[6m] \[C] [pwn20wndstuff/undecimus](https://github.com/pwn20wndstuff/undecimus) ⭐ 6,618 | 🐛 197 | 🌐 C | 📅 2021-08-01 unc0ver jailbreak for iOS 11.0 - 12.4
* \[**3221**星]\[5m] \[ObjC] [naituw/ipapatch](https://github.com/naituw/ipapatch) ⭐ 5,280 | 🐛 43 | 🌐 Objective-C | 📅 2026-02-27 Patch iOS Apps, The Easy Way, Without Jailbreak.
* \[**1193**星]\[15d] \[JS] [alonemonkey/frida-ios-dump](https://github.com/alonemonkey/frida-ios-dump) ⭐ 3,927 | 🐛 107 | 🌐 JavaScript | 📅 2023-05-03 pull decrypted ipa from jailbreak device
  * 重复区段: [DBI->Frida->工具->新添加的](#54836a155de0c15b56f43634cd9cfecf) |
* \[**287**星]\[7m] \[Shell] [0ki/mikrotik-tools](https://github.com/0ki/mikrotik-tools) ⭐ 593 | 🐛 3 | 🌐 Shell | 📅 2020-02-19 Tools for Mikrotik devices -  universal jailbreak tool
...
* \[**492**星]\[28d] \[Rust] [vadimcn/vscode-lldb](https://github.com/vadimcn/vscode-lldb) ⭐ 3,294 | 🐛 169 | 🌐 Rust | 📅 2026-08-23 A native debugger extension for VSCode based on LLDB
* \[**784**星]\[3m] \[C++] [nodejs/llnode](https://github.com/nodejs/llnode) ⭐ 1,168 | 🐛 70 | 🌐 C++ | 📅 2024-12-21 An lldb plugin for Node.js and V8, which enables inspection of JavaScript states for insights into Node.js processes and their core dumps.
...
* \[**1409**星]\[1m] \[Swift] [johnno1962/injectioniii](https://github.com/johnno1962/injectioniii) ⭐ 4,641 | 🐛 5 | 🌐 Objective-C | 📅 2026-06-14 Re-write of Injection for Xcode in (mostly) Swift4
...
* \[**10966**星]\[10d] \[ObjC] [flipboard/flex](https://github.com/flipboard/flex) ⭐ 14,638 | 🐛 50 | 🌐 Objective-C | 📅 2026-06-11 An in-app debugging and exploration tool for iOS
* \[**4397**星]\[12d] \[Swift] [signalapp/signal-ios](https://github.com/signalapp/Signal-iOS) ⭐ 12,228 | 🐛 147 | 🌐 Swift | 📅 2026-09-10 A private messenger for iOS.
* \[**1215**星]\[16d] \[YARA] [horsicq/detect-it-easy](https://github.com/horsicq/detect-it-easy) ⭐ 11,511 | 🐛 33 | 🌐 JavaScript | 📅 2026-09-11 Program for determining types of files for Windows, Linux and MacOS.
* \[**2733**星]\[26d] \[ObjC] [dantheman827/ios-app-signer](https://github.com/dantheman827/ios-app-signer) ⭐ 6,316 | 🐛 124 | 🌐 Objective-C | 📅 2025-09-01 This is an app for OS X that can (re)sign apps and bundle them into ipa files that are ready to be installed on an iOS device.
* \[**4663**星]\[1m] \[C] [google/ios-webkit-debug-proxy](https://github.com/google/ios-webkit-debug-proxy) ⭐ 6,203 | 🐛 20 | 🌐 C | 📅 2025-07-02 A DevTools proxy (Chrome Remote Debugging Protocol) for iOS devices (Safari Remote Web Inspector).
...
* \[**3686**星]\[4m] \[C] [facebook/fishhook](https://github.com/facebook/fishhook) ⭐ 5,430 | 🐛 39 | 🌐 C | 📅 2024-08-01 A library that enables dynamically rebinding symbols in Mach-O binaries running on iOS.
* \[**2867**星]\[12d] \[ObjC] [facebook/idb](https://github.com/facebook/idb) ⭐ 5,325 | 🐛 184 | 🌐 Swift | 📅 2026-09-10 idb is a flexible command line interface for automating iOS simulators and devices
* \[**2753**星]\[1m] \[Makefile] [theos/theos](https://github.com/theos/theos) ⭐ 4,916 | 🐛 72 | 🌐 Makefile | 📅 2026-08-08 A cross-platform suite of tools for building and deploying software for iOS and other platforms.
...
* \[**1442**星]\[28d] \[ObjC] [nabla-c0d3/ssl-kill-switch2](https://github.com/nabla-c0d3/ssl-kill-switch2) ⭐ 3,313 | 🐛 19 | 🌐 Objective-C | 📅 2023-07-09 Blackbox tool to disable SSL certificate validation - including certificate pinning - within iOS and OS X Apps
* \[**3071**星]\[10m] \[JS] [jipegit/osxauditor](https://github.com/jipegit/osxauditor) ⭐ 3,132 | 🐛 8 | 🌐 JavaScript | 📅 2020-07-27 OS X Auditor is a free Mac OS X computer forensics tool
* \[**1630**星]\[1m] [ivrodriguezca/re-ios-apps](https://github.com/ivrodriguezca/re-ios-apps) ⭐ 2,910 | 🐛 2 | 📅 2024-04-17 A completely free, open source and online course about Reverse Engineering iOS Applications.
* \[**310**星]\[28d] \[Swift] [securing/iossecuritysuite](https://github.com/securing/iossecuritysuite) ⭐ 2,721 | 🐛 8 | 🌐 Swift | 📅 2026-08-05 iOS platform security & anti-tampering Swift library
* \[**1801**星]\[1y] [aozhimin/ios-monitor-platform](https://github.com/aozhimin/ios-monitor-platform) ⭐ 2,620 | 🐛 23 | 📅 2018-10-13
* \[**1683**星]\[2m] \[Swift] [pmusolino/wormholy](https://github.com/pmusolino/wormholy) ⭐ 2,616 | 🐛 13 | 🌐 Swift | 📅 2026-05-23 iOS network debugging, like a wizard 🧙‍♂️
...
* \[**462**星]\[15d] \[Java] [dsheirer/sdrtrunk](https://github.com/dsheirer/sdrtrunk) ⭐ 2,178 | 🐛 446 | 🌐 Java | 📅 2026-08-01 A cross-platform java application for decoding, monitoring, recording and streaming trunked mobile and related radio protocols using Software Defined Radios (SDR). Website:
...
* \[**604**星]\[2m] [siguza/ios-resources](https://github.com/siguza/ios-resources) ⭐ 1,973 | 🐛 4 | 📅 2025-05-24 Useful resources for iOS hacking
...
* \[**1113**星]\[1y] \[ObjC] [neoneggplant/eggshell](https://github.com/neoneggplant/eggshell) ⭐ 1,771 | 🐛 56 | 🌐 Objective-C | 📅 2021-03-25 iOS/macOS/Linux Remote Administration Tool
...
* \[**263**星]\[14d] \[ObjC] [strongbox-password-safe/strongbox](https://github.com/strongbox-password-safe/strongbox) ⭐ 1,459 | 🐛 227 | 🌐 Objective-C | 📅 2026-07-17 A KeePass/Password Safe Client for iOS and OS X
* \[**346**星]\[4m] \[TS] [bacher09/pwgen-for-bios](https://github.com/bacher09/pwgen-for-bios) ⭐ 1,442 | 🐛 184 | 🌐 TypeScript | 📅 2026-02-05 Password generator for BIOS
* \[**907**星]\[4m] \[ObjC] [ptoomey3/keychain-dumper](https://github.com/ptoomey3/keychain-dumper) ⭐ 1,422 | 🐛 19 | 🌐 Objective-C | 📅 2024-08-15 A tool to check which keychain items are available to an attacker once an iOS device has been jailbroken
* \[**396**星]\[4m] [ansjdnakjdnajkd/ios](https://github.com/ansjdnakjdnajkd/ios) ⭐ 1,313 | 🐛 0 | 📅 2023-11-06 iOS渗透测试最有用的工具
...
* \[**662**星]\[1y] \[Py] [deepzec/bad-pdf](https://github.com/deepzec/bad-pdf) ⭐ 1,153 | 🐛 2 | 🌐 Python | 📅 2025-10-20 create malicious PDF file to steal NTLM(NTLMv1/NTLMv2) Hashes from windows machines
* \[**1001**星]\[2m] \[ObjC] [lmirosevic/gbdeviceinfo](https://github.com/lmirosevic/gbdeviceinfo) ⭐ 1,142 | 🐛 3 | 🌐 Objective-C | 📅 2026-01-02 Detects the hardware, software and display of the current iOS or Mac OS X device at runtime.
* \[**430**星]\[11m] [captainarash/the\_holy\_book\_of\_x86](https://github.com/captainarash/the_holy_book_of_x86) ⭐ 978 | 🐛 0 | 📅 2019-01-27 A simple guide to x86 architecture, assembly, memory management, paging, segmentation, SMM, BIOS....
...
* \[**322**星]\[2m] \[ObjC] [auth0/simplekeychain](https://github.com/auth0/simplekeychain) ⭐ 726 | 🐛 4 | 🌐 Swift | 📅 2026-08-31 A Keychain helper for iOS to make it very simple to store/obtain values from iOS Keychain
...
* \[**211**星]\[13d] \[TS] [bevry/getmac](https://github.com/bevry/getmac) ⭐ 360 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-12 Get the mac address of the current machine you are on via Node.js
...
* \[**238**星]\[7m] \[Py] [cuckoosandbox/community](https://github.com/cuckoosandbox/community) ⭐ 338 | 🐛 134 | 🌐 Python | 📅 2023-02-22 Repository of modules and signatures contributed by the community
...
* \[**1228**星]\[12d] \[C] [dynamorio/dynamorio](https://github.com/dynamorio/dynamorio) ⭐ 3,159 | 🐛 1,806 | 🌐 C | 📅 2026-09-11 Dynamic Instrumentation Tool Platform
* \[**1388**星]\[12d] \[C] [dynamorio/drmemory](https://github.com/dynamorio/drmemory) ⭐ 2,746 | 🐛 1,047 | 🌐 C | 📅 2025-12-13 Memory Debugger for Windows, Linux, Mac, and Android
...
* \[**4516**星]\[13d] \[Makefile] [frida/frida](https://github.com/frida/frida) ⭐ 21,885 | 🐛 1,962 | 🌐 Meson | 📅 2026-09-09 Clone this repo to build Frida

#### <a id="54836a155de0c15b56f43634cd9cfecf"></a>新添加的

* \[**1193**星]\[15d] \[JS] [alonemonkey/frida-ios-dump](https://github.com/alonemonkey/frida-ios-dump) ⭐ 3,927 | 🐛 107 | 🌐 JavaScript | 📅 2023-05-03 pull decrypted ipa from jailbreak device
  * 重复区段: [Apple->越狱->工具](#ff19d5d94315d035bbcb3ef0c348c75b) |
* \[**513**星]\[1m] \[JS] [iddoeldor/frida-snippets](https://github.com/iddoeldor/frida-snippets) ⭐ 2,536 | 🐛 5 | 🌐 JavaScript | 📅 2024-11-29 Hand-crafted Frida examples
...
* \[**422**星]\[1y] \[Py] [dstmath/frida-unpack](https://github.com/dstmath/frida-unpack) ⭐ 1,615 | 🐛 12 | 🌐 Python | 📅 2025-06-11 基于Frida的脱壳工具
* \[**332**星]\[15d] \[JS] [chichou/bagbak](https://github.com/ChiChou/bagbak) ⭐ 1,500 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-24 Yet another frida based iOS dumpdecrypted, works on iOS 13 with checkra1n and supports decrypting app extensions
...
* \[**243**星]\[19d] \[JS] [frenchyeti/dexcalibur](https://github.com/frenchyeti/dexcalibur) ⭐ 1,172 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-06 Dynamic binary instrumentation tool designed for Android application and powered by Frida. It disassembles dex, analyzes it statically, generates hooks, discovers reflected methods, stores intercepted data and does new things from it. Its aim is to be an all-in-one Android reverse engineering platform.
* \[**228**星]\[13d] \[C] [frida/frida-gum](https://github.com/frida/frida-gum) ⭐ 1,017 | 🐛 207 | 🌐 C | 📅 2026-09-09 Low-level code instrumentation library used by frida-core
* \[**420**星]\[13d] \[C] [frida/frida-python](https://github.com/frida/frida-python) ⭐ 871 | 🐛 56 | 🌐 Python | 📅 2026-09-09 Frida Python bindings
* \[**283**星]\[8m] \[Py] [nightbringer21/fridump](https://github.com/nightbringer21/fridump) ⭐ 860 | 🐛 27 | 🌐 Python | 📅 2024-08-07 A universal memory dumper using Frida
* \[**321**星]\[1m] \[C] [frida/frida-core](https://github.com/frida/frida-core) ⭐ 768 | 🐛 146 | 🌐 Vala | 📅 2026-09-09 Frida core library intended for static linking into bindings
...
* \[**584**星]\[1y] \[Java] [federicodotta/brida](https://github.com/federicodotta/brida) ⭐ 1,892 | 🐛 11 | 🌐 Java | 📅 2025-10-30 The new bridge between Burp Suite and Frida!
...
* \[**378**星]\[27d] \[JS] [nowsecure/r2frida](https://github.com/nowsecure/r2frida) ⭐ 1,439 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-09 Radare2 and Frida better together.
...
* \[**578**星]\[1y] \[C++] [qbdi/qbdi](https://github.com/QBDI/QBDI) ⭐ 1,819 | 🐛 20 | 🌐 C++ | 📅 2026-09-02 A Dynamic Binary Instrumentation framework based on LLVM.
...
* \[**14349**星]\[2m] \[Py] [corentinj/real-time-voice-cloning](https://github.com/corentinj/real-time-voice-cloning) ⭐ 60,124 | 🐛 177 | 🌐 Python | 📅 2026-03-09 Clone a voice in 5 seconds to generate arbitrary speech in real-time
* \[**2687**星]\[11d] \[Go] [adguardteam/adguardhome](https://github.com/adguardteam/adguardhome) ⭐ 36,829 | 🐛 1,243 | 🌐 TypeScript | 📅 2026-09-07 Network-wide ads & trackers blocking DNS server
* \[**10378**星]\[11d] \[Go] [goharbor/harbor](https://github.com/goharbor/harbor) ⭐ 29,353 | 🐛 876 | 🌐 Go | 📅 2026-09-11 An open source trusted cloud native registry project that stores, signs, and scans content.
* \[**19766**星]\[3m] \[Jupyter Notebook] [camdavidsonpilon/probabilistic-programming-and-bayesian-methods-for-hackers](https://github.com/camdavidsonpilon/probabilistic-programming-and-bayesian-methods-for-hackers) ⭐ 28,181 | 🐛 203 | 🌐 Jupyter Notebook | 📅 2024-06-25 aka "Bayesian Methods for Hackers": An introduction to Bayesian methods + probabilistic programming with a computation/understanding-first, mathematics-second point of view. All in pure Python ;)
* \[**5420**星]\[12d] \[Py] [mlflow/mlflow](https://github.com/mlflow/mlflow) ⭐ 27,907 | 🐛 2,087 | 🌐 Python | 📅 2026-09-11 Open source platform for the machine learning lifecycle
* \[**11402**星]\[10d] \[Java] [oracle/graal](https://github.com/oracle/graal) ⭐ 21,696 | 🐛 848 | 🌐 Java | 📅 2026-09-10 Run Programs Faster Anywhere
* \[**7020**星]\[14d] \[Go] [nats-io/nats-server](https://github.com/nats-io/nats-server) ⭐ 20,693 | 🐛 532 | 🌐 Go | 📅 2026-09-10 High-Performance server for NATS, the cloud native messaging system.
* \[**5753**星]\[18d] \[Go] [casbin/casbin](https://github.com/casbin/casbin) ⭐ 20,380 | 🐛 38 | 🌐 Go | 📅 2026-09-11 An authorization library that supports access control models like ACL, RBAC, ABAC in Golang
* \[**3608**星]\[9d] \[Pascal] [cheat-engine/cheat-engine](https://github.com/cheat-engine/cheat-engine) ⭐ 19,160 | 🐛 1,307 | 🌐 Pascal | 📅 2025-04-19 Cheat Engine. A development environment focused on modding
* \[**4610**星]\[1y] \[C] [upx/upx](https://github.com/upx/upx) ⭐ 17,859 | 🐛 23 | 🌐 C++ | 📅 2026-09-10 UPX - the Ultimate Packer for eXecutables
* \[**5226**星]\[13d] \[Shell] [denisidoro/navi](https://github.com/denisidoro/navi) ⭐ 17,530 | 🐛 112 | 🌐 Rust | 📅 2026-07-28 An interactive cheatsheet tool for the command-line
* \[**11213**星]\[2m] \[Jupyter Notebook] [selfteaching/the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 16,767 | 🐛 200 | 🌐 Jupyter Notebook | 📅 2026-05-20 One has no future if one couldn't teach themself.
* \[**2815**星]\[20d] \[C] [processhacker/processhacker](https://github.com/processhacker/processhacker) ⭐ 15,937 | 🐛 290 | 🌐 C | 📅 2026-09-10 A free, powerful, multi-purpose tool that helps you monitor system resources, debug software and detect malware.
* \[**3295**星]\[15d] \[JS] [koenkk/zigbee2mqtt](https://github.com/koenkk/zigbee2mqtt) ⭐ 15,624 | 🐛 452 | 🌐 TypeScript | 📅 2026-09-11 Zigbee
* \[**6894**星]\[2m] \[Go] [sqshq/sampler](https://github.com/sqshq/sampler) ⭐ 14,796 | 🐛 62 | 🌐 Go | 📅 2024-02-22 A tool for shell commands execution, visualization and alerting. Configured with a simple YAML file.
* \[**7748**星]\[10d] \[Go] [git-lfs/git-lfs](https://github.com/git-lfs/git-lfs) ⭐ 14,487 | 🐛 477 | 🌐 Go | 📅 2026-09-02 Git extension for versioning large files
* \[**5116**星]\[11d] \[ASP] [hq450/fancyss](https://github.com/hq450/fancyss) ⭐ 13,744 | 🐛 223 | 🌐 Shell | 📅 2026-06-01 fancyss is a project providing tools to across the GFW on asuswrt/merlin based router.
* \[**3129**星]\[13d] \[C] [qemu/qemu](https://github.com/qemu/qemu) ⭐ 13,704 | 🐛 0 | 🌐 C | 📅 2026-09-11 Official QEMU mirror. Please see
* \[**5229**星]\[4m] \[Py] [ytisf/thezoo](https://github.com/ytisf/thezoo) ⭐ 13,375 | 🐛 89 | 🌐 Python | 📅 2026-07-24 A repository of LIVE malwares for your own joy and pleasure. theZoo is a project created to make the possibility of malware analysis open and available to the public.
* \[**2344**星]\[16d] \[C] [tsl0922/ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,345 | 🐛 113 | 🌐 C | 📅 2026-08-12 Share your terminal over the web
* \[**3980**星]\[1m] \[Rust] [svenstaro/genact](https://github.com/svenstaro/genact) ⭐ 12,187 | 🐛 17 | 🌐 Rust | 📅 2026-09-01 a nonsense activity generator
* \[**3505**星]\[16d] \[C] [cyan4973/xxhash](https://github.com/cyan4973/xxhash) ⭐ 11,244 | 🐛 44 | 🌐 C | 📅 2026-07-27 Extremely fast non-cryptographic hash algorithm
* \[**2993**星]\[18d] \[Py] [quantaxis/quantaxis](https://github.com/quantaxis/quantaxis) ⭐ 11,171 | 🐛 239 | 🌐 Python | 📅 2026-09-01 支持任务调度 分布式部署的 股票/期货/自定义市场 数据/回测/模拟/交易/可视化 纯本地PAAS量化解决方案
* \[**4003**星]\[11d] \[Go] [dexidp/dex](https://github.com/dexidp/dex) ⭐ 11,085 | 🐛 537 | 🌐 Go | 📅 2026-09-10 OpenID Connect Identity (OIDC) and OAuth 2.0 Provider with Pluggable Connectors
* \[**3908**星]\[12d] \[C++] [baldurk/renderdoc](https://github.com/baldurk/renderdoc) ⭐ 11,074 | 🐛 51 | 🌐 C++ | 📅 2026-09-10 RenderDoc is a stand-alone graphics debugging tool.
* \[**2053**星]\[24d] \[C#] [mathewsachin/captura](https://github.com/mathewsachin/captura) ⭐ 10,821 | 🐛 116 | 🌐 C# | 📅 2026-05-25 Capture Screen, Audio, Cursor, Mouse Clicks and Keystrokes
* \[**2627**星]\[23d] \[JS] [popcorn-official/popcorn-desktop](https://github.com/popcorn-official/popcorn-desktop) ⭐ 10,682 | 🐛 66 | 🌐 TypeScript | 📅 2026-09-04 Popcorn Time is a multi-platform, free software BitTorrent client that includes an integrated media player. Desktop ( Windows / Mac / Linux ) a Butter-Project Fork
* \[**4597**星]\[12d] \[C++] [mozilla/rr](https://github.com/mozilla/rr) ⭐ 10,649 | 🐛 482 | 🌐 C++ | 📅 2026-08-16 记录与重放App的调试执行过程
* \[**5751**星]\[9m] \[C] [xoreaxeaxeax/movfuscator](https://github.com/xoreaxeaxeax/movfuscator) ⭐ 10,506 | 🐛 25 | 🌐 C | 📅 2024-05-29 C编译器，编译的二进制文件只有1个代码块。
* \[**2718**星]\[3m] \[Py] [drivendata/cookiecutter-data-science](https://github.com/drivendata/cookiecutter-data-science) ⭐ 10,049 | 🐛 34 | 🌐 Python | 📅 2026-08-07 A logical, reasonably standardized, but flexible project structure for doing and sharing data science work.
* \[**4857**星]\[13d] \[Go] [gcla/termshark](https://github.com/gcla/termshark) ⭐ 10,010 | 🐛 51 | 🌐 Go | 📅 2024-04-30 A terminal UI for tshark, inspired by Wireshark
* \[**3289**星]\[15d] \[C] [virustotal/yara](https://github.com/virustotal/yara) ⭐ 9,861 | 🐛 170 | 🌐 C | 📅 2026-08-25 The pattern matching swiss knife
* \[**5876**星]\[3m] \[Gnuplot] [nasa-jpl/open-source-rover](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,635 | 🐛 14 | 🌐 HTML | 📅 2026-09-03 A build-it-yourself, 6-wheel rover based on the rovers on Mars!
* \[**5717**星]\[28d] \[JS] [swagger-api/swagger-editor](https://github.com/swagger-api/swagger-editor) ⭐ 9,461 | 🐛 34 | 🌐 JavaScript | 📅 2026-09-08 Swagger Editor
* \[**3108**星]\[1m] \[C] [unicorn-engine/unicorn](https://github.com/unicorn-engine/unicorn) ⭐ 9,319 | 🐛 215 | 🌐 C | 📅 2026-08-28 Unicorn CPU emulator framework (ARM, AArch64, M68K, Mips, Sparc, X86)
* \[**6353**星]\[2m] \[Py] [seatgeek/fuzzywuzzy](https://github.com/seatgeek/fuzzywuzzy) ⚠️ Archived Fuzzy String Matching in Python
* \[**3188**星]\[11d] \[C] [meetecho/janus-gateway](https://github.com/meetecho/janus-gateway) ⭐ 9,163 | 🐛 46 | 🌐 C | 📅 2026-09-10 Janus WebRTC Server
* \[**3960**星]\[11d] \[Py] [angr/angr](https://github.com/angr/angr) ⭐ 9,081 | 🐛 739 | 🌐 Python | 📅 2026-09-11 A powerful and user-friendly binary analysis platform!
* \[**3939**星]\[15d] \[C] [aquynh/capstone](https://github.com/aquynh/capstone) ⭐ 9,009 | 🐛 356 | 🌐 C | 📅 2026-09-10 Capstone disassembly/disassembler framework: Core (Arm, Arm64, BPF, EVM, M68K, M680X, MOS65xx, Mips, PPC, RISCV, Sparc, SystemZ, TMS320C64x, Web Assembly, X86, X86\_64, XCore) + bindings.
* \[**3844**星]\[2m] \[ObjC] [sveinbjornt/sloth](https://github.com/sveinbjornt/sloth) ⭐ 8,957 | 🐛 2 | 🌐 Objective-C | 📅 2026-08-30 Mac app that shows all open files, directories and sockets in use by all running processes. Nice GUI for lsof.
* \[**3451**星]\[19d] \[C] [mikebrady/shairport-sync](https://github.com/mikebrady/shairport-sync) ⭐ 8,846 | 🐛 20 | 🌐 C | 📅 2026-09-10 AirPlay audio player. Shairport Sync adds multi-room capability with Audio Synchronisation
* \[**2587**星]\[10d] \[C] [esnet/iperf](https://github.com/esnet/iperf) ⭐ 8,747 | 🐛 237 | 🌐 C | 📅 2026-07-10 A TCP, UDP, and SCTP network bandwidth measurement tool
* \[**4651**星]\[13d] [powershell/win32-openssh](https://github.com/powershell/win32-openssh) ⭐ 8,274 | 🐛 405 | 📅 2025-10-27 Win32 port of OpenSSH
* \[**4541**星]\[4m] \[TS] [apis-guru/graphql-voyager](https://github.com/apis-guru/graphql-voyager) ⭐ 8,168 | 🐛 106 | 🌐 TypeScript | 📅 2026-05-12
* \[**3306**星]\[19d] \[C] [microsoft/windows-driver-samples](https://github.com/microsoft/windows-driver-samples) ⭐ 7,842 | 🐛 127 | 🌐 C | 📅 2026-09-10 This repo contains driver samples prepared for use with Microsoft Visual Studio and the Windows Driver Kit (WDK). It contains both Universal Windows Driver and desktop-only driver samples.
* \[**2948**星]\[1m] \[C] [libfuse/sshfs](https://github.com/libfuse/sshfs) ⭐ 7,664 | 🐛 62 | 🌐 C | 📅 2026-08-08 A network filesystem client to connect to SSH servers
* \[**4314**星]\[15d] \[Rust] [timvisee/ffsend](https://github.com/timvisee/ffsend) ⭐ 7,411 | 🐛 33 | 🌐 Rust | 📅 2025-11-20 Easily and securely share files from the command line
* \[**4747**星]\[8d] \[C++] [paddlepaddle/paddle-lite](https://github.com/PaddlePaddle/Paddle-Lite) ⭐ 7,274 | 🐛 48 | 🌐 C++ | 📅 2026-04-27 Multi-platform high performance deep learning inference engine (『飞桨』多平台高性能深度学习预测引擎）
* \[**5829**星]\[7m] \[JS] [sindresorhus/fkill-cli](https://github.com/sindresorhus/fkill-cli) ⭐ 7,004 | 🐛 6 | 🌐 JavaScript | 📅 2025-11-09 Fabulously kill processes. Cross-platform.
* \[**2194**星]\[13d] \[C] [armmbed/mbedtls](https://github.com/armmbed/mbedtls) ⭐ 6,954 | 🐛 1,718 | 🌐 C | 📅 2026-09-10 An open source, portable, easy to use, readable and flexible SSL library
...
* \[**2621**星]\[2m] [pditommaso/awesome-pipeline](https://github.com/pditommaso/awesome-pipeline) ⭐ 6,625 | 🐛 33 | 📅 2026-09-08 A curated list of awesome pipeline toolkits inspired by Awesome Sysadmin
* \[**4060**星]\[2m] \[JS] [sigalor/whatsapp-web-reveng](https://github.com/sigalor/whatsapp-web-reveng) ⭐ 6,494 | 🐛 157 | 🌐 JavaScript | 📅 2024-04-22 WhatsApp Web API逆向与重新实现
* \[**2854**星]\[1m] \[Py] [espressif/esptool](https://github.com/espressif/esptool) ⭐ 6,470 | 🐛 14 | 🌐 Python | 📅 2026-09-10 ESP8266 and ESP32 serial bootloader utility
* \[**1698**星]\[21d] \[C++] [microsoft/detours](https://github.com/microsoft/detours) ⭐ 6,384 | 🐛 93 | 🌐 C++ | 📅 2026-08-24 Detours is a software package for monitoring and instrumenting API calls on Windows. It is distributed in source code form.
* \[**408**星]\[19d] \[Py] [crytic/slither](https://github.com/crytic/slither) ⭐ 6,361 | 🐛 478 | 🌐 Python | 📅 2026-09-09 Static Analyzer for Solidity
* \[**5007**星]\[2m] \[Py] [snare/voltron](https://github.com/snare/voltron) ⭐ 6,343 | 🐛 85 | 🌐 Python | 📅 2025-01-30 A hacky debugger UI for hackers
* \[**3233**星]\[25d] \[C] [tmate-io/tmate](https://github.com/tmate-io/tmate) ⭐ 6,124 | 🐛 130 | 🌐 C | 📅 2026-07-29 Instant Terminal Sharing
* \[**3690**星]\[21d] \[JS] [lesspass/lesspass](https://github.com/lesspass/lesspass) ⭐ 6,059 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-11
...
* \[**2631**星]\[8m] [leandromoreira/linux-network-performance-parameters](https://github.com/leandromoreira/linux-network-performance-parameters) ⭐ 5,817 | 🐛 3 | 📅 2026-06-03 Learn where some of the network sysctl variables fit into the Linux/Kernel network flow
* \[**3120**星]\[11d] \[Go] [tencent/bk-cmdb](https://github.com/tencent/bk-cmdb) ⭐ 5,745 | 🐛 93 | 🌐 Go | 📅 2026-09-04 蓝鲸智云配置平台(BlueKing CMDB)
* \[**2092**星]\[26d] [swiftonsecurity/sysmon-config](https://github.com/swiftonsecurity/sysmon-config) ⭐ 5,642 | 🐛 82 | 📅 2024-07-03 Sysmon configuration file template with default high-quality event tracing
* \[**1930**星]\[22d] \[C++] [mhammond/pywin32](https://github.com/mhammond/pywin32) ⭐ 5,601 | 🐛 397 | 🌐 C++ | 📅 2026-09-08 Python for Windows (pywin32) Extensions
* \[**1620**星]\[16d] \[C++] [lief-project/lief](https://github.com/lief-project/lief) ⭐ 5,560 | 🐛 30 | 🌐 C++ | 📅 2026-09-06 Library to Instrument Executable Formats
* \[**2211**星]\[1m] \[C++] [google/bloaty](https://github.com/google/bloaty) ⭐ 5,540 | 🐛 72 | 🌐 C++ | 📅 2026-09-10 Bloaty McBloatface: a size profiler for binaries
* \[**2898**星]\[8m] \[C] [p-h-c/phc-winner-argon2](https://github.com/p-h-c/phc-winner-argon2) ⭐ 5,369 | 🐛 102 | 🌐 C | 📅 2024-08-06 The password hash Argon2, winner of PHC
* \[**2833**星]\[2m] \[Assembly] [cirosantilli/x86-bare-metal-examples](https://github.com/cirosantilli/x86-bare-metal-examples) ⭐ 5,357 | 🐛 7 | 🌐 Assembly | 📅 2022-07-18 几十个用于学习 x86 系统编程的小型操作系统
* \[**2872**星]\[14d] \[C] [lxc/lxc](https://github.com/lxc/lxc) ⭐ 5,258 | 🐛 148 | 🌐 C | 📅 2026-09-07 LXC - Linux Containers
* \[**1816**星]\[29d] \[Go] [gdamore/tcell](https://github.com/gdamore/tcell) ⭐ 5,219 | 🐛 10 | 🌐 Go | 📅 2026-09-06 Tcell is an alternate terminal package, similar in some ways to termbox, but better in others.
* \[**3131**星]\[2m] \[CSS] [readthedocs/sphinx\_rtd\_theme](https://github.com/readthedocs/sphinx_rtd_theme) ⭐ 5,084 | 🐛 275 | 🌐 Sass | 📅 2026-01-12 Sphinx theme for readthedocs.org
* \[**2093**星]\[10d] \[C] [flatpak/flatpak](https://github.com/flatpak/flatpak) ⭐ 5,063 | 🐛 1,028 | 🌐 C | 📅 2026-09-07 Linux application sandboxing and distribution framework
...
* \[**2391**星]\[21d] \[Java] [mock-server/mockserver](https://github.com/mock-server/mockserver) ⭐ 4,969 | 🐛 1 | 🌐 Java | 📅 2026-09-11 MockServer enables easy mocking of any system you integrate with via HTTP or HTTPS with clients written in Java, JavaScript and Ruby. MockServer also includes a proxy that introspects all proxied traffic including encrypted SSL traffic and supports Port Forwarding, Web Proxying (i.e. HTTP proxy), HTTPS Tunneling Proxying (using HTTP CONNECT) and…
* \[**2132**星]\[20d] [goq/telegram-list](https://github.com/goq/telegram-list) ⭐ 4,968 | 🐛 22 | 📅 2026-08-30 List of telegram groups, channels & bots // Список интересных групп, каналов и ботов телеграма // Список чатов для программистов
* \[**4600**星]\[12m] \[Py] [ecthros/uncaptcha2](https://github.com/ecthros/uncaptcha2) ⭐ 4,916 | 🐛 7 | 🌐 Python | 📅 2019-01-18 defeating the latest version of ReCaptcha with 91% accuracy
* \[**2137**星]\[19d] \[Assembly] [pret/pokered](https://github.com/pret/pokered) ⭐ 4,913 | 🐛 22 | 🌐 Assembly | 📅 2026-08-27 disassembly of Pokémon Red/Blue
...
* \[**3749**星]\[12d] \[Go] [hashicorp/consul-template](https://github.com/hashicorp/consul-template) ⭐ 4,823 | 🐛 229 | 🌐 Go | 📅 2026-09-10 Template rendering, notifier, and supervisor for
* \[**1761**星]\[13d] \[C] [google/wuffs](https://github.com/google/wuffs) ⭐ 4,822 | 🐛 37 | 🌐 C | 📅 2026-09-02 Wrangling Untrusted File Formats Safely
* \[**3202**星]\[1y] \[Shell] [toyodadoubi/doubi](https://github.com/toyodadoubi/doubi) ⭐ 4,684 | 🐛 13 | 🌐 Shell | 📅 2020-10-20 一个逗比写的各种逗比脚本\~
* \[**2615**星]\[1m] \[JS] [knownsec/kcon](https://github.com/knownsec/kcon) ⭐ 4,653 | 🐛 5 | 🌐 JavaScript | 📅 2024-08-28 KCon is a famous Hacker Con powered by Knownsec Team.
* \[**2003**星]\[2m] \[C++] [asmjit/asmjit](https://github.com/asmjit/asmjit) ⭐ 4,602 | 🐛 19 | 🌐 C++ | 📅 2026-09-08 Complete x86/x64 JIT and AOT Assembler for C++
* \[**2340**星]\[2m] \[JS] [pa11y/pa11y](https://github.com/pa11y/pa11y) ⭐ 4,523 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-07 Pa11y is your automated accessibility testing pal
...
* \[**2535**星]\[3m] \[Java] [jboss-javassist/javassist](https://github.com/jboss-javassist/javassist) ⭐ 4,232 | 🐛 252 | 🌐 Java | 📅 2026-09-02 Java bytecode engineering toolkit
* \[**3688**星]\[29d] \[HTML] [hamukazu/lets-get-arrested](https://github.com/hamukazu/lets-get-arrested) ⭐ 4,174 | 🐛 71 | 🌐 HTML | 📅 2024-06-10 This project is intended to protest against the police in Japan
...
* \[**1714**星]\[1m] \[Go] [hashicorp/memberlist](https://github.com/hashicorp/memberlist) ⭐ 4,102 | 🐛 96 | 🌐 Go | 📅 2026-08-27 Golang package for gossip based membership and failure detection
* \[**1779**星]\[29d] [17mon/china\_ip\_list](https://github.com/17mon/china_ip_list) ⭐ 4,098 | 🐛 19 | 📅 2025-03-04
* \[**2217**星]\[14d] \[Go] [google/mtail](https://github.com/google/mtail) ⭐ 4,027 | 🐛 59 | 🌐 Go | 📅 2026-03-19 extract whitebox monitoring data from application logs for collection in a timeseries database
* \[**2052**星]\[13d] \[C++] [openthread/openthread](https://github.com/openthread/openthread) ⭐ 4,027 | 🐛 154 | 🌐 C++ | 📅 2026-09-11 OpenThread released by Google is an open-source implementation of the Thread networking protocol
* \[**3280**星]\[29d] \[Java] [oldmanpushcart/greys-anatomy](https://github.com/oldmanpushcart/greys-anatomy) ⭐ 4,004 | 🐛 75 | 🌐 Java | 📅 2022-10-25 Java诊断工具
...
* \[**1727**星]\[8d] \[TSQL] [brentozarultd/sql-server-first-responder-kit](https://github.com/brentozarultd/sql-server-first-responder-kit) ⭐ 3,898 | 🐛 13 | 🌐 TSQL | 📅 2026-08-23 sp\_Blitz, sp\_BlitzCache, sp\_BlitzFirst, sp\_BlitzIndex, and other SQL Server scripts for health checks and performance tuning.
* \[**1899**星]\[25d] \[C++] [acidanthera/lilu](https://github.com/acidanthera/Lilu) ⭐ 3,855 | 🐛 0 | 🌐 C | 📅 2026-03-20 Arbitrary kext and process patching on macOS
...
* \[**1637**星]\[12d] \[JS] [efforg/privacybadger](https://github.com/efforg/privacybadger) ⭐ 3,836 | 🐛 138 | 🌐 JavaScript | 📅 2026-09-10 Privacy Badger is a browser extension that automatically learns to block invisible trackers.
* \[**2364**星]\[10d] \[C] [domoticz/domoticz](https://github.com/domoticz/domoticz) ⭐ 3,802 | 🐛 23 | 🌐 C++ | 📅 2026-09-10 monitor and configure various devices like: Lights, Switches, various sensors/meters like Temperature, Rain, Wind, UV, Electra, Gas, Water and much more
* \[**2031**星]\[10m] \[C] [dekunukem/nintendo\_switch\_reverse\_engineering](https://github.com/dekunukem/nintendo_switch_reverse_engineering) ⭐ 3,780 | 🐛 92 | 🌐 C | 📅 2026-08-21 A look at inner workings of Joycon and Nintendo Switch
...
* \[**2760**星]\[10d] \[TS] [webhintio/hint](https://github.com/webhintio/hint) ⭐ 3,699 | 🐛 531 | 🌐 TypeScript | 📅 2026-07-21
* \[**2474**星]\[25d] \[JS] [vitaly-t/pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,553 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-20 PostgreSQL interface for Node.js
...
* \[**3052**星]\[4m] \[C++] [google/robotstxt](https://github.com/google/robotstxt) ⭐ 3,468 | 🐛 13 | 🌐 C++ | 📅 2026-04-01 The repository contains Google's robots.txt parser and matcher as a C++ library (compliant to C++11).
* \[**1781**星]\[26d] \[PHP] [ezyang/htmlpurifier](https://github.com/ezyang/htmlpurifier) ⭐ 3,354 | 🐛 134 | 🌐 PHP | 📅 2026-09-05 Standards compliant HTML filter written in PHP
...
* \[**1877**星]\[25d] \[Java] [adoptopenjdk/jitwatch](https://github.com/adoptopenjdk/jitwatch) ⭐ 3,306 | 🐛 18 | 🌐 Java | 📅 2026-09-09 Log analyser / visualiser for Java HotSpot JIT compiler. Inspect inlining decisions, hot methods, bytecode, and assembly. View results in the JavaFX user interface.
* \[**1672**星]\[7m] \[C] [easyhook/easyhook](https://github.com/easyhook/easyhook) ⭐ 3,291 | 🐛 186 | 🌐 C | 📅 2024-01-25 The reinvention of Windows API Hooking
...
* \[**637**星]\[21d] \[PS] [olafhartong/sysmon-modular](https://github.com/olafhartong/sysmon-modular) ⭐ 3,129 | 🐛 49 | 🌐 PowerShell | 📅 2026-09-09 sysmon配置模块收集
* \[**1949**星]\[17d] \[C] [microsoft/procdump-for-linux](https://github.com/microsoft/procdump-for-linux) ⭐ 3,081 | 🐛 22 | 🌐 C | 📅 2026-09-10 Linux 版本的 ProcDump
* \[**2808**星]\[10m] \[Py] [plasma-disassembler/plasma](https://github.com/plasma-disassembler/plasma) ⭐ 3,069 | 🐛 15 | 🌐 Python | 📅 2021-08-31 Plasma is an interactive disassembler for x86/ARM/MIPS. It can generates indented pseudo-code with colored syntax.
* \[**2260**星]\[13d] [dumb-password-rules/dumb-password-rules](https://github.com/dumb-password-rules/dumb-password-rules) ⭐ 3,022 | 🐛 62 | 🌐 Nunjucks | 📅 2026-09-08 Shaming sites with dumb password rules.
* \[**1786**星]\[1m] \[C++] [apitrace/apitrace](https://github.com/apitrace/apitrace) ⭐ 2,860 | 🐛 158 | 🌐 C++ | 📅 2026-09-10 Tools for tracing OpenGL, Direct3D, and other graphics APIs
* \[**1756**星]\[16d] \[PHP] [wordpress/wordpress-coding-standards](https://github.com/wordpress/wordpress-coding-standards) ⭐ 2,830 | 🐛 264 | 🌐 PHP | 📅 2026-09-05 PHP\_CodeSniffer rules (sniffs) to enforce WordPress coding conventions
* \[**2619**星]\[2m] \[Swift] [zhuhaow/nekit](https://github.com/zhuhaow/nekit) ⚠️ Archived A toolkit for Network Extension Framework
* \[**2053**星]\[4m] \[Go] [maxmcd/webtty](https://github.com/maxmcd/webtty) ⭐ 2,810 | 🐛 18 | 🌐 Go | 📅 2024-12-11 Share a terminal session over WebRTC
* \[**2286**星]\[1m] \[JS] [talkingdata/inmap](https://github.com/talkingdata/inmap) ⭐ 2,807 | 🐛 56 | 🌐 JavaScript | 📅 2024-03-04 大数据地理可视化
...
* \[**1592**星]\[2m] \[ObjC] [ealeksandrov/provisionql](https://github.com/ealeksandrov/provisionql) ⭐ 2,458 | 🐛 4 | 🌐 Swift | 📅 2026-08-16 Quick Look plugin for apps and provisioning profile files
* \[**1854**星]\[19d] \[C] [github/glb-director](https://github.com/github/glb-director) ⭐ 2,455 | 🐛 34 | 🌐 C | 📅 2026-09-10 GitHub Load Balancer Director and supporting tooling.
...
* \[**1676**星]\[10d] \[Java] [apache/geode](https://github.com/apache/geode) ⭐ 2,382 | 🐛 27 | 🌐 Java | 📅 2026-09-09 Apache Geode
* \[**1837**星]\[3m] \[Go] [influxdata/kapacitor](https://github.com/influxdata/kapacitor) ⭐ 2,376 | 🐛 835 | 🌐 Go | 📅 2026-09-09 Open source framework for processing, monitoring, and alerting on time series data
...
* \[**1852**星]\[1y] \[Py] [jinnlynn/genpac](https://github.com/jinnlynn/genpac) ⭐ 2,183 | 🐛 0 | 🌐 Python | 📅 2026-09-11 PAC/Dnsmasq/Wingy file Generator, working with gfwlist, support custom rules.
* \[**906**星]\[7m] \[C++] [dfhack/dfhack](https://github.com/DFHack/dfhack) ⭐ 2,045 | 🐛 1,064 | 🌐 C++ | 📅 2026-09-08 Memory hacking library for Dwarf Fortress and a set of tools that use it
...
* \[**1572**星]\[1m] \[C] [codahale/bcrypt-ruby](https://github.com/codahale/bcrypt-ruby) ⭐ 1,992 | 🐛 24 | 🌐 C | 📅 2026-06-19  Ruby binding for the OpenBSD bcrypt() password hashing algorithm, allowing you to easily store a secure hash of your users' passwords.
* \[**1659**星]\[25d] \[JS] [tylerbrock/mongo-hacker](https://github.com/tylerbrock/mongo-hacker) ⭐ 1,792 | 🐛 5 | 🌐 JavaScript | 📅 2022-09-17 MongoDB Shell Enhancements for Hackers
...
* \[**522**星]\[4m] \[Java] [java-deobfuscator/deobfuscator](https://github.com/java-deobfuscator/deobfuscator) ⭐ 1,763 | 🐛 126 | 🌐 Java | 📅 2023-04-26 Java 代码反混淆工具
...
* \[**587**星]\[6m] [nshalabi/sysmontools](https://github.com/nshalabi/sysmontools) ⭐ 1,661 | 🐛 1 | 🌐 TypeScript | 📅 2026-04-04 Utilities for Sysmon
* \[**449**星]\[12m] \[C++] [ntquery/scylla](https://github.com/ntquery/scylla) ⭐ 1,426 | 🐛 23 | 🌐 C++ | 📅 2023-04-05 Imports Reconstructor
* \[**306**星]\[2m] \[C] [nagyd/sdlpop](https://github.com/nagyd/sdlpop) ⭐ 1,282 | 🐛 80 | 🌐 C | 📅 2025-12-24 An open-source port of Prince of Persia, based on the disassembly of the DOS version.
...
* \[**568**星]\[11m] \[JS] [raineorshine/solgraph](https://github.com/raineorshine/solgraph) ⭐ 1,026 | 🐛 5 | 🌐 JavaScript | 📅 2022-12-04 Visualize Solidity control flow for smart contract security analysis.
...
* \[**265**星]\[3m] \[Assembly] [pret/pokeyellow](https://github.com/pret/pokeyellow) ⭐ 873 | 🐛 3 | 🌐 Assembly | 📅 2026-09-02 Disassembly of Pokemon Yellow
...
* \[**291**星]\[28d] \[C] [tomb5/tomb5](https://github.com/tomb5/tomb5) ⭐ 518 | 🐛 26 | 🌐 C | 📅 2022-02-03 Chronicles Disassembly translated to C source code.
...
* \[**1955**星]\[11d] \[Go] [solo-io/gloo](https://github.com/solo-io/gloo) ⭐ 170 | 🐛 1,878 | 🌐 Go | 📅 2026-09-10 An Envoy-Powered API Gateway
* \[**2214**星]\[18d] [getlantern/lantern-binaries](https://github.com/getlantern/lantern-binaries) ⭐ 120 | 🐛 14 | 📅 2026-09-11 Lantern installers binary downloads.
...
* \[**1422**星]\[17d] \[C++] [eteran/edb-debugger](https://github.com/eteran/edb-debugger) ⭐ 2,959 | 🐛 67 | 🌐 C++ | 📅 2026-09-05 edb is a cross platform AArch32/x86/x86-64 debugger.
* \[**836**星]\[8d] \[C++] [tasvideos/bizhawk](https://github.com/tasvideos/bizhawk) ⭐ 2,756 | 🐛 805 | 🌐 C# | 📅 2026-09-03 BizHawk is a multi-system emulator written in C#. BizHawk provides nice features for casual gamers such as full screen, and joypad support in addition to full rerecording and debugging tools for all system cores.
* \[**1413**星]\[19d] \[Go] [cosmos72/gomacro](https://github.com/cosmos72/gomacro) ⭐ 2,300 | 🐛 49 | 🌐 Go | 📅 2026-09-01 Interactive Go interpreter and debugger with REPL, Eval, generics and Lisp-like macros
...
* \[**1147**星]\[5m] \[C++] [cgdb/cgdb](https://github.com/cgdb/cgdb) ⭐ 1,842 | 🐛 46 | 🌐 C | 📅 2026-02-27 Console front-end to the GNU debugger
...
* \[**423**星]\[4m] \[C++] [cobaltfusion/debugviewpp](https://github.com/cobaltfusion/debugviewpp) ⭐ 1,268 | 🐛 93 | 🌐 C++ | 📅 2026-04-25 DebugView++, collects, views, filters your application logs, and highlights information that is important to you!
* \[**560**星]\[21d] \[C#] [microsoft/miengine](https://github.com/microsoft/miengine) ⭐ 858 | 🐛 164 | 🌐 C# | 📅 2026-08-27 The Visual Studio MI Debug Engine ("MIEngine") provides an open-source Visual Studio Debugger extension that works with MI-enabled debuggers such as gdb, lldb, and clrdbg.
* \[**285**星]\[2m] \[C++] [changeofpace/viviennevmm](https://github.com/changeofpace/viviennevmm) ⭐ 835 | 🐛 3 | 🌐 C++ | 📅 2020-09-07 VivienneVMM is a stealthy debugging framework implemented via an Intel VT-x hypervisor.
* \[**418**星]\[26d] \[C++] [simonkagstrom/kcov](https://github.com/simonkagstrom/kcov) ⭐ 828 | 🐛 88 | 🌐 C++ | 📅 2026-09-03 Code coverage tool for compiled programs, Python and Bash which uses debugging information to collect and report data without special compilation options
* \[**239**星]\[8m] \[C++] [strivexjun/xantidebug](https://github.com/strivexjun/xantidebug) ⭐ 692 | 🐛 3 | 🌐 C++ | 📅 2019-05-11 VMProtect 3.x Anti-debug Method Improved
...
* \[**213**星]\[12d] \[C++] [thalium/icebox](https://github.com/thalium/icebox) ⭐ 602 | 🐛 4 | 🌐 C++ | 📅 2022-02-22 Virtual Machine Introspection, Tracing & Debugging
* \[**291**星]\[12d] \[Py] [sosreport/sos](https://github.com/sosreport/sos) ⭐ 598 | 🐛 164 | 🌐 Python | 📅 2026-09-10 A unified tool for collecting system logs and other debug information
...
* \[**332**星]\[8m] \[Py] [romanvm/python-web-pdb](https://github.com/romanvm/python-web-pdb) ⭐ 534 | 🐛 15 | 🌐 Python | 📅 2026-09-10 Web-based remote UI for Python's PDB debugger
...
* \[**272**星]\[4m] \[Py] [mariovilas/winappdbg](https://github.com/mariovilas/winappdbg) ⭐ 487 | 🐛 3 | 🌐 Python | 📅 2026-03-24 WinAppDbg Debugger
...
* \[**1106**星]\[14d] \[OCaml] [binaryanalysisplatform/bap](https://github.com/binaryanalysisplatform/bap) ⭐ 2,255 | 🐛 43 | 🌐 OCaml | 📅 2026-05-07 Binary Analysis Platform
* \[**411**星]\[13d] \[HTML] [w3c/webappsec](https://github.com/w3c/webappsec) ⭐ 670 | 🐛 104 | 🌐 HTML | 📅 2026-06-10 Web App安全工作组
...
* \[**20779**星]\[8d] \[Java] [skylot/jadx](https://github.com/skylot/jadx) ⭐ 50,409 | 🐛 446 | 🌐 Java | 📅 2026-09-08 dex 转 java 的反编译器
* \[**7733**星]\[1m] \[Java] [java-decompiler/jd-gui](https://github.com/java-decompiler/jd-gui) ⭐ 15,199 | 🐛 248 | 🌐 Java | 📅 2024-07-08 A standalone Java Decompiler GUI
* \[**1867**星]\[1y] \[Java] [jindrapetrik/jpexs-decompiler](https://github.com/jindrapetrik/jpexs-decompiler) ⭐ 5,860 | 🐛 5 | 🌐 Java | 📅 2026-08-08 JPEXS Free Flash Decompiler
* \[**3135**星]\[26d] \[Java] [deathmarine/luyten](https://github.com/deathmarine/luyten) ⭐ 5,113 | 🐛 193 | 🌐 Java | 📅 2024-07-11 An Open Source Java Decompiler Gui for Procyon
* \[**671**星]\[11m] \[C++] [zrax/pycdc](https://github.com/zrax/pycdc) ⭐ 4,615 | 🐛 233 | 🌐 C++ | 📅 2026-04-07 C++ python bytecode disassembler and decompiler
* \[**1652**星]\[12m] \[Java] [fesh0r/fernflower](https://github.com/fesh0r/fernflower) ⭐ 4,394 | 🐛 0 | 🌐 Java | 📅 2026-09-09 Unofficial mirror of FernFlower Java decompiler (All pulls should be submitted upstream)
* \[**1466**星]\[12d] \[Py] [rocky/python-uncompyle6](https://github.com/rocky/python-uncompyle6) ⭐ 4,321 | 🐛 42 | 🌐 Python | 📅 2026-04-24 Python反编译器，跨平台
* \[**331**星]\[11d] \[Java] [leibnitz27/cfr](https://github.com/leibnitz27/cfr) ⭐ 2,694 | 🐛 150 | 🌐 Java | 📅 2026-06-04 This is the public repository for the CFR Java decompiler
* \[**673**星]\[18d] \[C#] [uxmal/reko](https://github.com/uxmal/reko) ⭐ 2,602 | 🐛 165 | 🌐 C# | 📅 2026-09-07 Reko is a binary decompiler.
* \[**347**星]\[16d] \[C#] [steamdatabase/valveresourceformat](https://github.com/steamdatabase/valveresourceformat) ⭐ 2,419 | 🐛 65 | 🌐 C# | 📅 2026-09-10 Valve's Source 2 resource file format (also known as Stupid Valve Format) parser and decompiler.
* \[**1084**星]\[4m] \[Py] [storyyeller/krakatau](https://github.com/storyyeller/krakatau) ⭐ 2,249 | 🐛 25 | 🌐 Rust | 📅 2026-04-07 Java decompiler, assembler, and disassembler
...
* \[**243**星]\[3m] \[Java] [kwart/jd-cmd](https://github.com/kwart/jd-cmd) ⭐ 654 | 🐛 10 | 🌐 Java | 📅 2026-09-07 Command line Java Decompiler
* \[**232**星]\[1y] \[C++] [wwwg/wasmdec](https://github.com/wwwg/wasmdec) ⭐ 424 | 🐛 12 | 🌐 C++ | 📅 2024-02-07 WebAssembly to C decompiler
* \[**226**星]\[11d] \[C++] [boomerangdecompiler/boomerang](https://github.com/BoomerangDecompiler/boomerang) ⭐ 405 | 🐛 38 | 🌐 C++ | 📅 2020-12-28 Boomerang Decompiler - Fighting the code-rot :)
...
* \[**1374**星]\[20d] \[C] [zyantific/zydis](https://github.com/zyantific/zydis) ⭐ 4,362 | 🐛 51 | 🌐 C | 📅 2026-07-27 快速的轻量级x86/x86-64 反汇编库
* \[**430**星]\[2m] \[C#] [0xd4d/iced](https://github.com/0xd4d/iced) ⭐ 3,561 | 🐛 61 | 🌐 Rust | 📅 2026-09-09 x86/x64 disassembler, instruction decoder & encoder
* \[**835**星]\[8d] \[GLSL] [khronosgroup/spirv-cross](https://github.com/khronosgroup/spirv-cross) ⭐ 2,511 | 🐛 151 | 🌐 GLSL | 📅 2026-09-07  a practical tool and library for performing reflection on SPIR-V and disassembling SPIR-V back to high level languages.
...
* \[**246**星]\[5m] \[Py] [bontchev/pcodedmp](https://github.com/bontchev/pcodedmp) ⭐ 491 | 🐛 3 | 🌐 Python | 📅 2021-06-12 A VBA p-code disassembler
* \[**351**星]\[21d] \[Ruby] [jjyg/metasm](https://github.com/jjyg/metasm) ⭐ 476 | 🐛 2 | 🌐 Ruby | 📅 2026-03-10 This is the main repository for metasm, a free assembler / disassembler / compiler written in ruby
...
* \[**6052**星]\[13d] \[Py] [cyrus-and/gdb-dashboard](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,248 | 🐛 19 | 🌐 Python | 📅 2026-07-17 Modular visual interface for GDB in Python
* \[**2439**星]\[16d] \[Py] [pwndbg/pwndbg](https://github.com/pwndbg/pwndbg) ⭐ 10,853 | 🐛 228 | 🌐 Python | 📅 2026-09-09 GDB插件，辅助漏洞开发和逆向
* \[**7019**星]\[10d] \[JS] [cs01/gdbgui](https://github.com/cs01/gdbgui) ⭐ 10,351 | 🐛 180 | 🌐 TypeScript | 📅 2025-06-29 Browser-based frontend to gdb (gnu debugger). Add breakpoints, view the stack, visualize data structures, and more in C, C++, Go, Rust, and Fortran. Run gdbgui from the terminal and a new tab will open in your browser.
* \[**2568**星]\[1m] \[Py] [hugsy/gef](https://github.com/hugsy/gef) ⭐ 8,349 | 🐛 14 | 🌐 Python | 📅 2026-08-20 gdb增强工具，使用Python API，用于漏洞开发和逆向分析。
...
* \[**452**星]\[3m] \[Py] [scwuaptx/pwngdb](https://github.com/scwuaptx/pwngdb) ⭐ 972 | 🐛 14 | 🌐 Python | 📅 2025-08-29 gdb for pwn
...
* \[**1419**星]\[9m] \[C] [namhyung/uftrace](https://github.com/namhyung/uftrace) ⭐ 3,471 | 🐛 399 | 🌐 C | 📅 2026-09-07 Function (graph) tracer for user-space
...
* \[**11588**星]\[12d] \[C] [radareorg/radare2](https://github.com/radareorg/radare2) ⭐ 24,778 | 🐛 823 | 🌐 C | 📅 2026-09-11 unix-like reverse engineering framework and commandline tools

### <a id="6922457cb0d4b6b87a34caf39aa31dfe"></a>新添加的

* \[**339**星]\[28d] \[TeX] [radareorg/radare2book](https://github.com/radareorg/radare2book) ⭐ 912 | 🐛 42 | 🌐 C | 📅 2026-08-11 Radare2 official book
* \[**259**星]\[1m] \[C] [radareorg/r2dec-js](https://github.com/radareorg/r2dec-js) ⭐ 609 | 🐛 35 | 🌐 JavaScript | 📅 2026-08-16 radare2插件,将汇编代码反编译为C伪代码
...
* \[**2820**星]\[1m] \[Py] [androguard/androguard](https://github.com/androguard/androguard) ⭐ 6,238 | 🐛 46 | 🌐 Python | 📅 2026-09-04 Reverse engineering, Malware and goodware analysis of Android applications ... and more (ninja !)
* \[**328**星]\[5m] \[Py] [vector35/binaryninja-api](https://github.com/vector35/binaryninja-api) ⭐ 1,310 | 🐛 1,960 | 🌐 C++ | 📅 2026-09-10 Public API, examples, documentation and issues for Binary Ninja
...
* \[**201**星]\[14d] \[JS] [ret2got/disasm.pro](https://github.com/ret2got/disasm.pro) ⭐ 297 | 🐛 10 | 🌐 JavaScript | 📅 2025-08-03 A realtime assembler/disassembler (formerly known as disasm.ninja)
...
* \[**634**星]\[10d] \[C] [thewover/donut](https://github.com/thewover/donut) ⭐ 4,700 | 🐛 37 | 🌐 C | 📅 2025-07-08 Generates x86, x64, or AMD64+x86 position-independent shellcode that loads .NET Assemblies, PE files, and other Windows payloads from memory and runs them with parameters
...
* \[**877**星]\[8m] \[Py] [erocarrera/pefile](https://github.com/erocarrera/pefile) ⭐ 2,065 | 🐛 62 | 🌐 Python | 📅 2026-09-09 pefile is a Python module to read and work with PE (Portable Executable) files
* \[**344**星]\[1y] \[Assembly] [egebalci/amber](https://github.com/egebalci/amber) ⭐ 1,444 | 🐛 5 | 🌐 Go | 📅 2024-02-22 反射式PE加壳器，用于绕过安全产品和缓解措施
...
* \[**316**星]\[24d] \[C++] [trailofbits/pe-parse](https://github.com/trailofbits/pe-parse) ⭐ 910 | 🐛 17 | 🌐 C++ | 📅 2026-08-05 Principled, lightweight C/C++ PE parser
...
* \[**285**星]\[7m] \[Java] [katjahahn/portex](https://github.com/katjahahn/portex) ⭐ 536 | 🐛 3 | 🌐 Scala | 📅 2026-04-03 Java library to analyse Portable Executable files with a special focus on malware analysis and PE malformation robustness
...
* \[**1915**星]\[22d] \[C#] [lucasg/dependencies](https://github.com/lucasg/dependencies) ⭐ 11,834 | 🐛 142 | 🌐 C# | 📅 2024-05-15 A rewrite of the old legacy software "depends.exe" in C# for Windows devs to troubleshoot dll load dependencies issues.
* \[**1146**星]\[27d] \[C#] [perfare/il2cppdumper](https://github.com/perfare/il2cppdumper) ⭐ 9,379 | 🐛 154 | 🌐 C# | 📅 2024-08-18 Restore dll from Unity il2cpp binary file (except code)
* \[**1333**星]\[10m] \[C] [fancycode/memorymodule](https://github.com/fancycode/memorymodule) ⭐ 3,160 | 🐛 58 | 🌐 C | 📅 2024-01-03 Library to load a DLL from memory.
...
* \[**230**星]\[1y] \[C#] [misaka-mikoto-tech/monohooker](https://github.com/Misaka-Mikoto-Tech/MonoHooker) ⭐ 1,062 | 🐛 9 | 🌐 C# | 📅 2023-09-22 hook C# method at runtime without modify dll file (such as UnityEditor.dll)
...
* \[**713**星]\[5m] \[C++] [darthton/xenos](https://github.com/darthton/xenos) ⭐ 2,659 | 🐛 51 | 🌐 C++ | 📅 2021-05-17 Windows DLL 注入器
...
* \[**299**星]\[11m] \[C++] [anhkgg/superdllhijack](https://github.com/anhkgg/superdllhijack) ⭐ 1,038 | 🐛 5 | 🌐 C++ | 📅 2021-11-10 一种通用Dll劫持技术，不再需要手工导出Dll的函数接口了
...
* \[**2355**星]\[11d] \[C] [hfiref0x/uacme](https://github.com/hfiref0x/uacme) ⭐ 7,789 | 🐛 0 | 🌐 C | 📅 2026-07-24 Defeating Windows User Account Control
* \[**2307**星]\[1m] \[PS] [k8gege/k8tools](https://github.com/k8gege/k8tools) ⭐ 6,213 | 🐛 10 | 🌐 PowerShell | 📅 2025-01-25 K8工具合集(内网渗透/提权工具/远程溢出/漏洞利用/扫描工具/密码破解/免杀工具/Exploit/APT/0day/Shellcode/Payload/priviledge/BypassUAC/OverFlow/WebShell/PenTest) Web GetShell Exploit(Struts2/Zimbra/Weblogic/Tomcat/Apache/Jboss/DotNetNuke/zabbix)
* \[**1688**星]\[3m] \[Py] [rootm0s/winpwnage](https://github.com/rootm0s/winpwnage) ⭐ 2,754 | 🐛 5 | 🌐 Python | 📅 2023-02-13 UAC bypass, Elevate, Persistence and Execution methods
...
* \[**609**星]\[19d] \[PS] [sbousseaden/evtx-attack-samples](https://github.com/sbousseaden/evtx-attack-samples) ⭐ 2,624 | 🐛 5 | 🌐 HTML | 📅 2023-01-24 与特定攻击和利用后渗透技术相关的Windows事件样例
* \[**261**星]\[3m] \[C++] [gametechdev/presentmon](https://github.com/gametechdev/presentmon) ⭐ 2,557 | 🐛 202 | 🌐 C++ | 📅 2026-09-11 Tool for collection and processing of ETW events related to DXGI presentation.
* \[**479**星]\[5m] \[PS] [sans-blue-team/deepbluecli](https://github.com/sans-blue-team/deepbluecli) ⭐ 2,429 | 🐛 13 | 🌐 PowerShell | 📅 2023-10-14 a PowerShell Module for Threat Hunting via Windows Event Logs
...
* \[**654**星]\[10m] \[Roff] [palantir/windows-event-forwarding](https://github.com/palantir/windows-event-forwarding) ⭐ 1,341 | 🐛 21 | 🌐 Roff | 📅 2025-09-08 使用 Windows 事件转发实现网络事件监测和防御
...
* \[**249**星]\[3m] \[C++] [microsoft/krabsetw](https://github.com/microsoft/krabsetw) ⭐ 803 | 🐛 20 | 🌐 C++ | 📅 2026-08-22 KrabsETW provides a modern C++ wrapper and a .NET wrapper around the low-level ETW trace consumption functions.
...
* \[**921**星]\[7m] \[PS] [api0cradle/ultimateapplockerbypasslist](https://github.com/api0cradle/ultimateapplockerbypasslist) ⭐ 2,083 | 🐛 10 | 🌐 PowerShell | 📅 2023-09-11 The goal of this repository is to document the most common techniques to bypass AppLocker.
...
* \[**9261**星]\[11d] \[C#] [icsharpcode/ilspy](https://github.com/icsharpcode/ilspy) ⭐ 26,046 | 🐛 171 | 🌐 C# | 📅 2026-09-10 .NET Decompiler
* \[**3694**星]\[27d] \[C#] [0xd4d/de4dot](https://github.com/0xd4d/de4dot) ⚠️ Archived .NET deobfuscator and unpacker.
* \[**3263**星]\[7m] \[JS] [sindresorhus/speed-test](https://github.com/sindresorhus/speed-test) ⭐ 3,949 | 🐛 4 | 🌐 JavaScript | 📅 2021-12-03 Test your internet connection speed and ping using speedtest.net from the CLI
* \[**1657**星]\[14d] \[C#] [jbevain/cecil](https://github.com/jbevain/cecil) ⭐ 2,994 | 🐛 112 | 🌐 C# | 📅 2025-09-11 C#库, 探查/修改/生成 .NET App/库
...
* \[**1347**星]\[1m] \[Go] [securitywithoutborders/hardentools](https://github.com/securitywithoutborders/hardentools) ⭐ 3,109 | 🐛 12 | 🌐 Go | 📅 2025-08-10 禁用许多有危险的Windows功能
...
* \[**508**星]\[17d] \[PS] [stefanscherer/packer-windows](https://github.com/stefanscherer/packer-windows) ⭐ 1,363 | 🐛 17 | 🌐 PowerShell | 📅 2025-06-08 Windows Packer 模板：Win10, Server 2016, 1709, 1803, 1809, 2019, 1903, Insider with Docker
...
* \[**510**星]\[5m] \[Py] [rabbitstack/fibratus](https://github.com/rabbitstack/fibratus) ⭐ 2,541 | 🐛 45 | 🌐 Go | 📅 2026-09-10 Windows内核探索和跟踪工具
* \[**479**星]\[1m] \[C] [jkornev/hidden](https://github.com/jkornev/hidden) ⭐ 2,054 | 🐛 13 | 🌐 C | 📅 2022-07-13 Windows驱动，带用户模式接口：隐藏文件系统和注册表对象、保护进程等
* \[**933**星]\[9m] \[C] [microsoft/windows-driver-frameworks](https://github.com/microsoft/windows-driver-frameworks) ⭐ 1,328 | 🐛 8 | 🌐 C | 📅 2024-09-10 Windows驱动框架(WDF)
* \[**278**星]\[12d] \[PS] [microsoftdocs/windows-driver-docs](https://github.com/MicrosoftDocs/windows-driver-docs) ⭐ 1,064 | 🐛 9 | 🌐 OpenSCAD | 📅 2026-08-26 官方Windows驱动程序工具包文档
...
* \[**725**星]\[2m] \[HTML] [j00ru/windows-syscalls](https://github.com/j00ru/windows-syscalls) ⭐ 2,639 | 🐛 3 | 🌐 HTML | 📅 2025-12-30 Windows 系统调用表(NT/2000/XP/2003/Vista/2008/7/2012/8/10)
* \[**328**星]\[2m] \[C] [hfiref0x/syscalltables](https://github.com/hfiref0x/syscalltables) ⭐ 1,470 | 🐛 0 | 🌐 C | 📅 2026-09-04 Windows NT x64系统调用表

### <a id="1afda3039b4ab9a3a1f60b179ccb3e76"></a>其他

* \[**863**星]\[14d] \[C++] [henrypp/simplewall](https://github.com/henrypp/simplewall) ⭐ 8,935 | 🐛 143 | 🌐 C | 📅 2026-09-08 为Windows 过滤平台提供的配置界面
* \[**949**星]\[3m] \[C] [basil00/divert](https://github.com/basil00/divert) ⭐ 3,289 | 🐛 64 | 🌐 C | 📅 2023-03-15 用户模式数据包拦截库，适用于Win 7/8/10
* \[**360**星]\[12d] \[C#] [digitalruby/ipban](https://github.com/digitalruby/ipban) ⭐ 2,184 | 🐛 2 | 🌐 C# | 📅 2026-08-21 监视Windows/Linux系统的登录失败和不良行为，并封禁对应的IP地址。高度可配置，精简且功能强大。
...
* \[**570**星]\[1m] \[C] [hfiref0x/winobjex64](https://github.com/hfiref0x/winobjex64) ⭐ 1,974 | 🐛 0 | 🌐 C | 📅 2026-09-01 Windows对象浏览器. x64
* \[**418**星]\[15d] \[C] [samba-team/samba](https://github.com/samba-team/samba) ⭐ 1,137 | 🐛 1 | 🌐 C | 📅 2026-09-09 适用于Linux和Unix的标准Windows interoperability程序套件
* \[**726**星]\[2m] \[Py] [diyan/pywinrm](https://github.com/diyan/pywinrm) ⭐ 1,134 | 🐛 54 | 🌐 Python | 📅 2026-08-04 Python实现的WinRM客户端
...
* \[**210**星]\[3m] [adguardteam/adguardforwindows](https://github.com/adguardteam/adguardforwindows) ⭐ 890 | 🐛 160 | 📅 2026-09-09 Windows系统范围的AdBlocker
* \[**389**星]\[2m] \[C#] [microsoft/binskim](https://github.com/microsoft/binskim) ⭐ 860 | 🐛 162 | 🌐 C# | 📅 2026-09-03 二进制静态分析工具，可为PE和ELF二进制格式提供安全性和正确性分析
* \[**238**星]\[5m] \[PS] [microsoft/aaronlocker](https://github.com/microsoft/aaronlocker) ⭐ 708 | 🐛 16 | 🌐 PowerShell | 📅 2022-08-12 Windows应用程序白名单
...
* \[**370**星]\[27d] \[Ruby] [winrb/winrm](https://github.com/winrb/winrm) ⭐ 423 | 🐛 25 | 🌐 Ruby | 📅 2026-09-10 在Windows中使用WinRM的功能调用原生对象的SOAP库。Ruby编写
...
* \[**787**星]\[2m] \[C] [nixos/patchelf](https://github.com/nixos/patchelf) ⭐ 4,258 | 🐛 148 | 🌐 C | 📅 2026-07-27 A small utility to modify the dynamic linker and RPATH of ELF executables
* \[**930**星]\[15d] \[Py] [eliben/pyelftools](https://github.com/eliben/pyelftools) ⭐ 2,279 | 🐛 55 | 🌐 Python | 📅 2026-07-30 Parsing ELF and DWARF in Python
...
* \[**1450**星]\[2m] \[C] [feralinteractive/gamemode](https://github.com/feralinteractive/gamemode) ⭐ 6,007 | 🐛 219 | 🌐 C | 📅 2026-06-15 Optimise Linux system performance on demand
* \[**1413**星]\[21d] \[C++] [google/nsjail](https://github.com/google/nsjail) ⭐ 4,096 | 🐛 29 | 🌐 C++ | 📅 2026-08-27 A light-weight process isolation tool, making use of Linux namespaces and seccomp-bpf syscall filters (with help of the kafel bpf language)
* \[**759**星]\[1m] \[Py] [korcankaraokcu/pince](https://github.com/korcankaraokcu/pince) ⭐ 3,083 | 🐛 6 | 🌐 Python | 📅 2026-08-24 A reverse engineering tool that'll supply the place of Cheat Engine for linux
* \[**731**星]\[17d] \[C] [strace/strace](https://github.com/strace/strace) ⭐ 2,695 | 🐛 110 | 🌐 C | 📅 2026-09-09 strace is a diagnostic, debugging and instructional userspace utility for Linux
* \[**895**星]\[29d] \[C] [buserror/simavr](https://github.com/buserror/simavr) ⭐ 1,784 | 🐛 47 | 🌐 C | 📅 2026-09-10 simavr is a lean, mean and hackable AVR simulator for linux & OSX
* \[**565**星]\[12d] \[C++] [intel/linux-sgx](https://github.com/intel/linux-sgx) ⭐ 1,454 | 🐛 130 | 🌐 C++ | 📅 2026-08-13 Intel SGX for Linux\*
...
* \[**468**星]\[9d] \[C] [libreswan/libreswan](https://github.com/libreswan/libreswan) ⭐ 1,005 | 🐛 655 | 🌐 C | 📅 2026-09-11 an Internet Key Exchange (IKE) implementation for Linux.
* \[**354**星]\[2m] \[C] [seccomp/libseccomp](https://github.com/seccomp/libseccomp) ⭐ 932 | 🐛 55 | 🌐 C | 📅 2026-07-01 an easy to use, platform independent, interface to the Linux Kernel's syscall filtering mechanism
* \[**570**星]\[12m] \[C] [asamy/ksm](https://github.com/asamy/ksm) ⭐ 866 | 🐛 13 | 🌐 C | 📅 2021-10-20 快速、hackable且简单的x64 VT-x虚拟机管理程序，支持Windows和Linux
...
* \[**441**星]\[12d] \[C] [facebook/openbmc](https://github.com/facebook/openbmc) ⭐ 687 | 🐛 59 | 🌐 C | 📅 2026-09-11 OpenBMC is an open software framework to build a complete Linux image for a Board Management Controller (BMC).
